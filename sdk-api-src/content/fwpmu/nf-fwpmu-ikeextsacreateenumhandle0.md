...
ms.topic: function
f1_keywords: ["fwpmu/IkeextSaCreateEnumHandle0"]
req.header: fwpmu.h
req.include-header: 
...
Type: <b>const <a href="https://docs.microsoft.com/windows/desktop/api/iketypes/ns-iketypes-ikeext_sa_enum_template0_">IKEEXT_SA_ENUM_TEMPLATE0</a>*</b>
