...
<ul>
<li>Call <a href="https://msdn.microsoft.com/library/ff551140.aspx">FwpsCalloutRegister0</a> (documented in the Windows Driver Kit (WDK)), to register the callout with the filter engine.</li>
