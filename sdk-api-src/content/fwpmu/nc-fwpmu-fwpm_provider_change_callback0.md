...
Call <a href="/windows/desktop/api/fwpmu/nf-fwpmu-fwpmprovidersubscribechanges0">FwpmProviderSubscribeChanges0</a> to register this callback function.

<b>FWPM_PROVIDER_CHANGE_CALLBACK0</b> is a specific implementation of FWPM_PROVIDER_CHANGE_CALLBACK. See <a href="/windows/desktop/FWP/wfp-version-independent-names-and-targeting-specific-versions-of-windows">WFP Version-Independent Names and Targeting Specific Versions of Windows</a>  for more information.

## -see-also

[FWPM_PROVIDER_CHANGE0](/windows/desktop/api/fwpmtypes/ns-fwpmtypes-fwpm_provider_change0)
