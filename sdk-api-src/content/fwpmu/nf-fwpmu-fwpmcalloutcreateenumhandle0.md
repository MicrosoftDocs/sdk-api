...
ms.topic: function
f1_keywords: ["fwpmu/FwpmCalloutCreateEnumHandle0"]
req.header: fwpmu.h
req.include-header: 
...
Type: <b>const <a href="https://docs.microsoft.com/windows/desktop/api/fwpmtypes/ns-fwpmtypes-fwpm_callout_enum_template0_">FWPM_CALLOUT_ENUM_TEMPLATE0</a>*</b>
