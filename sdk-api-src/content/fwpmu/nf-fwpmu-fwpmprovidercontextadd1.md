...
ms.topic: function
f1_keywords: ["fwpmu/FwpmProviderContextAdd1"]
req.header: fwpmu.h
req.include-header: 
...
Some fields in the <a href="https://docs.microsoft.com/windows/desktop/api/fwpmtypes/ns-fwpmtypes-fwpm_provider_context1_">FWPM_PROVIDER_CONTEXT1</a> structure are assigned by the system, not the caller, and are ignored in the call to <b>FwpmProviderContextAdd1</b>. 
