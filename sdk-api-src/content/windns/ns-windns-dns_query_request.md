...
A pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/windns/ns-windns-_dnsaddrarray">DNS_ADDR_ARRAY</a> structure that contains a list of DNS servers to use in the query.
