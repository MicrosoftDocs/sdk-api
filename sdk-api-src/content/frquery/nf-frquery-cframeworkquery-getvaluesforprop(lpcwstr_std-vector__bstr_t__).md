...
title: CFrameworkQuery::GetValuesForProp(LPCWSTR,std
...
For example, the following list lists the values that would be returned by <a href="https://msdn.microsoft.com/b5ed4b48-f622-4a55-897d-d800ada0270f">GetValuesForProp</a> for a variety of queries when called with <i>wszPropName</i> set to "Drive".
...
<tr>
<td>
SELECT * FROM  <a href="https://msdn.microsoft.com/d61cb5ee-8e87-4604-95e6-325c9b543411">Win32_Directory</a>
...
WHERE  <a href="https://msdn.microsoft.com/cc0d2c56-bb69-4008-8688-0166714ea5fd">Path</a> = "\DOS"
...
The <a href="https://msdn.microsoft.com/b5ed4b48-f622-4a55-897d-d800ada0270f">GetValuesForProp</a> method only supports string types.
