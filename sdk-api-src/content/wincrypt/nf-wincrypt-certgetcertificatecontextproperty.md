...
Your code can use a macro to evaluate the class of hash for a certificate context. For more information, see <a href="https://msdn.microsoft.com/library/Aa376573(v=VS.85).aspx">CertSetCertificateContextProperty</a>.
