...
ms.topic: struct
f1_keywords: ["wincrypt/OCSP_SIGNED_REQUEST_INFO"]
...
The <b>OCSP_SIGNED_REQUEST_INFO</b> structure contains information for an <a href="https://docs.microsoft.com/windows/desktop/SecGloss/o-gly">online certificate status protocol</a> (OCSP) request with optional signature information.
...
A pointer to an <a href="https://docs.microsoft.com/windows/desktop/api/wincrypt/ns-wincrypt-_ocsp_signature_info">OCSP_SIGNATURE_INFO</a> structure that contains optional signature information.
