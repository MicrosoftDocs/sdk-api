...
description: Retrieves the first or next types of cryptographic service provider (CSP) supported on the computer. (Unicode)
helpviewer_keywords: ["CryptEnumProviderTypes", "CryptEnumProviderTypes function [Security]", "CryptEnumProviderTypesW", "_crypto2_cryptenumprovidertypes", "security.cryptenumprovidertypes", "wincrypt/CryptEnumProviderTypes", "wincrypt/CryptEnumProviderTypesW"]
...
f1_keywords:
 ...
 - wincrypt/CryptEnumProviderTypesW
dev_langs:
 - c++
topic_type:
 - APIRef
