...
ms.topic: struct
f1_keywords: ["wincrypt/CMSG_CTRL_KEY_TRANS_DECRYPT_PARA"]
...
A pointer to a 
<a href="https://docs.microsoft.com/windows/desktop/api/wincrypt/ns-wincrypt-_cmsg_key_trans_recipient_info">CMSG_KEY_TRANS_RECIPIENT_INFO</a> structure.
