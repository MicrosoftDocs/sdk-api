...
ms.topic: function
f1_keywords: ["wincrypt/CertDeleteCertificateFromStore"]
...
A pointer to the 
<a href="https://docs.microsoft.com/windows/desktop/api/wincrypt/ns-wincrypt-_cert_context">CERT_CONTEXT</a> structure to be deleted.
