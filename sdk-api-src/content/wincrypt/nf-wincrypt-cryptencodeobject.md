...
ms.topic: function
f1_keywords: ["wincrypt/CryptEncodeObject"]
...
<a href="https://docs.microsoft.com/windows/desktop/SecCrypto/example-c-program-making-a-certificate-request">Example C Program: Making a Certificate Request</a> and 
