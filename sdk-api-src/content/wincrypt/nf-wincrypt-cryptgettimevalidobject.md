...
A pointer to an <a href="https://msdn.microsoft.com/e6be8932-015e-4058-b249-1671b3fea521">object identifier</a> (OID) that identifies the object being requested. If the <a href="https://www.bing.com/search?q=HIWORD">HIWORD</a> of the <i>pszTimeValidOid</i> parameter is zero, the <a href="https://www.bing.com/search?q=LOWORD">LOWORD</a> specifies the integer identifier for the type of the specified structure. 
