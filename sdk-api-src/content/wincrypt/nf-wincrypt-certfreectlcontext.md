...
ms.topic: function
f1_keywords: ["wincrypt/CertFreeCTLContext"]
...
A pointer to the 
<a href="https://docs.microsoft.com/windows/desktop/api/wincrypt/ns-wincrypt-_ctl_context">CTL_CONTEXT</a> to be freed.
