...
ms.topic: struct
f1_keywords: ["wincrypt/CMC_ADD_ATTRIBUTES_INFO"]
...
<a href="https://docs.microsoft.com/windows/desktop/api/wincrypt/ns-wincrypt-_crypt_attribute">CRYPT_ATTRIBUTE</a> certificate attributes to be added.
