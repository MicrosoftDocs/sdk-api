...
A pointer to a <b>BYTE</b> buffer to receive the <a href="https://msdn.microsoft.com/library/windows/hardware/dn965962">plaintext</a>. This parameter can be <b>NULL</b>. For more information, see 
