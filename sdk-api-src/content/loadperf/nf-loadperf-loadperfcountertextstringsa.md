...
description: Loads onto the computer the performance objects and counters defined in the specified initialization file. (ANSI)
helpviewer_keywords: ["LoadPerfCounterTextStringsA", "loadperf/LoadPerfCounterTextStringsA"]
