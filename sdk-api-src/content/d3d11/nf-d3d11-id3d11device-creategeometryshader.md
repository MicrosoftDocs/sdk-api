...
After it is created, the shader can be set to the device by calling <a href="https://msdn.microsoft.com/en-us/library/Ff476438(v=VS.85).aspx">ID3D11DeviceContext::GSSetShader</a>.
