...
If the application wants the shader to access other parts of the buffer, it must call the <a href="https://msdn.microsoft.com/en-us/library/Hh446795(v=VS.85).aspx">VSSetConstantBuffers1</a> method instead.
