...
Specifies format of the data in the index buffer (see <a href="https://msdn.microsoft.com/library/Bb173059(v=VS.85).aspx">DXGI_FORMAT</a>). These formats provide the size and type of 
