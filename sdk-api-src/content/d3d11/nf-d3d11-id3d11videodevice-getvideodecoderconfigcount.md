...
title: ID3D11VideoDevice::GetVideoDecoderConfigCount method
...
ms.date: 4/23/2018
ms.keywords: GetVideoDecoderConfigCount method [Media Foundation], GetVideoDecoderConfigCount method [Media Foundation], ID3D11VideoDevice interface, GetVideoDecoderConfigCount,ID3D11VideoDevice.GetVideoDecoderConfigCount, ID3D11VideoDevice, ID3D11VideoDevice interface [Media Foundation], GetVideoDecoderConfigCount method, ID3D11VideoDevice::GetVideoDecoderConfigCount, d3d11/ID3D11VideoDevice::GetVideoDecoderConfigCount, mf.id3d11videodevice_getvideodecoderconfigcount
...
# ID3D11VideoDevice::GetVideoDecoderConfigCount method
