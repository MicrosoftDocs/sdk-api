...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">ID3D11Query</b> interface inherits from <a href="https://msdn.microsoft.com/en-us/library/Ff476347(v=VS.85).aspx">ID3D11Asynchronous</a>. <b>ID3D11Query</b> also has these types of members:
<ul>
...
There are, however, some queries that do not require calls to <a href="https://msdn.microsoft.com/en-us/library/Ff476386(v=VS.85).aspx">Begin</a>. For a list of possible queries see <a href="https://msdn.microsoft.com/en-us/library/Ff476191(v=VS.85).aspx">D3D11_QUERY</a>.
...
When using a query that does not require a call to <a href="https://msdn.microsoft.com/en-us/library/Ff476386(v=VS.85).aspx">Begin</a>, it still requires a call to <a href="https://msdn.microsoft.com/en-us/library/Ff476422(v=VS.85).aspx">End</a>. The call to <b>End</b> causes the data returned by <a href="https://msdn.microsoft.com/en-us/library/Ff476428(v=VS.85).aspx">GetData</a> to be accurate up until the last call to <b>End</b>.
