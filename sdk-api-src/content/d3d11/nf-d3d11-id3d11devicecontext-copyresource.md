...
A pointer to the <a href="https://msdn.microsoft.com/en-us/library/Ff476584(v=VS.85).aspx">ID3D11Resource</a> interface that represents the destination resource.
...
A pointer to the <a href="https://msdn.microsoft.com/en-us/library/Ff476584(v=VS.85).aspx">ID3D11Resource</a> interface that represents the source resource.
...
We recommend to use <a href="https://msdn.microsoft.com/en-us/library/Ff476394(v=VS.85).aspx">ID3D11DeviceContext::CopySubresourceRegion</a> instead if you only need to copy a portion of the data in a resource.
