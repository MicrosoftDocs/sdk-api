...
title: ID3D11VideoDevice::GetVideoDecoderConfig method
...
ms.date: 4/23/2018
ms.keywords: GetVideoDecoderConfig method [Media Foundation], GetVideoDecoderConfig method [Media Foundation], ID3D11VideoDevice interface, GetVideoDecoderConfig,ID3D11VideoDevice.GetVideoDecoderConfig, ID3D11VideoDevice, ID3D11VideoDevice interface [Media Foundation], GetVideoDecoderConfig method, ID3D11VideoDevice::GetVideoDecoderConfig, d3d11/ID3D11VideoDevice::GetVideoDecoderConfig, mf.id3d11videodevice_getvideodecoderconfig
...
# ID3D11VideoDevice::GetVideoDecoderConfig method
