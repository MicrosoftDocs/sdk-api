...
title: ID3D11VideoProcessorOutputView
...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">ID3D11VideoProcessorOutputView</b> interface inherits from <a href="https://msdn.microsoft.com/en-us/library/Ff476642(v=VS.85).aspx">ID3D11View</a>. <b>ID3D11VideoProcessorOutputView</b> also has these types of members:
<ul>
...
<a href="https://msdn.microsoft.com/en-us/library/Hh447810(v=VS.85).aspx">GetDesc</a>
</td>
...
To get a pointer to this interface, call <a href="https://msdn.microsoft.com/en-us/library/Hh447791(v=VS.85).aspx">ID3D11VideoDevice::CreateVideoProcessorOutputView</a>.
