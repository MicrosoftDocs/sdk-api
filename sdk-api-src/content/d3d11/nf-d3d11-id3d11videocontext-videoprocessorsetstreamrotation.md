...
This is an optional state and the application should only use it if    <a href="https://msdn.microsoft.com/en-us/library/Hh447655(v=VS.85).aspx">D3D11_VIDEO_PROCESSOR_FEATURE_CAPS_ROTATION</a> is reported in  <a href="https://msdn.microsoft.com/en-us/library/Hh447650(v=VS.85).aspx">D3D11_VIDEO_PROCESSOR_CAPS.FeatureCaps</a>.
