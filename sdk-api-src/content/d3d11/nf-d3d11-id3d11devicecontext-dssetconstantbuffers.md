...
If the application wants the shader to access other parts of the buffer, it must call the <a href="https://msdn.microsoft.com/en-us/library/Hh404632(v=VS.85).aspx">DSSetConstantBuffers1</a> method instead.
