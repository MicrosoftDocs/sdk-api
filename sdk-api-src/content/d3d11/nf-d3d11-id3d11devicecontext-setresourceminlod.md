...
A pointer to an <a href="https://msdn.microsoft.com/en-us/library/Ff476584(v=VS.85).aspx">ID3D11Resource</a> that represents the resource.
...
To use a resource with <b>SetResourceMinLOD</b>, you must set the <a href="https://msdn.microsoft.com/en-us/library/Ff476203(v=VS.85).aspx">D3D11_RESOURCE_MISC_RESOURCE_CLAMP</a> flag when you create that resource.
