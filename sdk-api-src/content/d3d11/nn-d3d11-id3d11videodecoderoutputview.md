...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">ID3D11VideoDecoderOutputView</b> interface inherits from <a href="https://msdn.microsoft.com/en-us/library/Ff476642(v=VS.85).aspx">ID3D11View</a>. <b>ID3D11VideoDecoderOutputView</b> also has these types of members:
<ul>
...
<a href="https://msdn.microsoft.com/en-us/library/Hh447768(v=VS.85).aspx">GetDesc</a>
</td>
...
To get a pointer to this interface, call <a href="https://msdn.microsoft.com/en-us/library/Hh447787(v=VS.85).aspx">ID3D11VideoDevice::CreateVideoDecoderOutputView</a>.
