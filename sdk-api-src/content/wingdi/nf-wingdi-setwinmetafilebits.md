...
A pointer to a <a href="https://msdn.microsoft.com/library/ms649017(v=VS.85).aspx">METAFILEPICT</a> structure that contains the suggested size of the metafile picture and the mapping mode that was used when the picture was created.
...
<a href="https://msdn.microsoft.com/library/ms649017(v=VS.85).aspx">METAFILEPICT</a>
