...
The <b>SetColorSpace</b> function defines the input <a href="https://msdn.microsoft.com/library/Aa380689(v=VS.85).aspx">color space</a> for a given device context.
