...
<b>StretchDIBits</b> creates a top-down image if the sign of the <b>biHeight</b> member of the <a href="/previous-versions/dd183376(v=vs.85)">BITMAPINFOHEADER</a> structure for the DIB is negative. For a code example, see <a href="/windows/desktop/gdi/sizing-a-jpeg-or-png-image">Sizing a JPEG or PNG Image</a>.
