...
The <b>SetDeviceGammaRamp</b> function sets the <a href="https://msdn.microsoft.com/library/ms708499(v=VS.85).aspx">gamma ramp</a> on direct color display boards having drivers that support downloadable gamma ramps in hardware.
