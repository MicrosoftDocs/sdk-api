...
ms.topic: function
f1_keywords: ["wingdi/GetTextExtentPointI"]
req.header: wingdi.h
...
Pointer to a <a href="https://docs.microsoft.com/previous-versions//dd145106(v=vs.85)">SIZE</a> structure that receives the dimensions of the string, in logical units.
