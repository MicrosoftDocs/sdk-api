...
The <b>GetLogColorSpace</b> function retrieves the <a href="https://msdn.microsoft.com/library/Aa380689(v=VS.85).aspx">color space</a> definition identified by a specified handle.
