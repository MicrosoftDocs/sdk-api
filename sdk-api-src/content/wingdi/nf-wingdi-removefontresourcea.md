...
title: RemoveFontResourceA function
...
We recommend that if an app adds or removes fonts from the system font table that it notify other windows of the change by sending a <a href="https://msdn.microsoft.com/4774308e-2f18-4a35-a769-56871f3c29a2">WM_FONTCHANGE</a> message to all top-level windows in the system. The app sends this message by calling the <a href="https://msdn.microsoft.com/library/windows/hardware/jj151552">SendMessage</a> function with the <i>hwnd</i> parameter set to HWND_BROADCAST.
