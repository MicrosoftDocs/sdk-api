...
description: Gets or sets a signing certificate that has been encoded by using Distinguished Encoding Rules (DER). An Online Certificate Status Protocol (OCSP) responder service uses this certificate to sign its responses to certificate status requests. (Put)
...
f1_keywords:
 ...
 - certadm/IOCSPCAConfiguration::put_SigningCertificate
dev_langs:
 - c++
topic_type:
 - APIRef
