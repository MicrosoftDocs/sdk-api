...
The <b>ItemByName</b> property gets a <a href="https://msdn.microsoft.com/en-us/library/ms721572(v=VS.85).aspx">certification authority</a> (CA) configuration identified by name in the configuration set.
