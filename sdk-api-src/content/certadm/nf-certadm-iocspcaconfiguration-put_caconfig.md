...
The <b>CAConfig</b> property gets or sets a <a href="https://msdn.microsoft.com/en-us/library/ms721572(v=VS.85).aspx">certification authority</a> (CA) name with which a signing certificate must be signed.
