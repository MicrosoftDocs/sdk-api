...
Identifies the types of events associated with a <a href="https://msdn.microsoft.com/library/Dd316811(v=VS.85).aspx">Ribbon</a>.
...
The <a href="https://msdn.microsoft.com/library/Dd371601(v=VS.85).aspx">ApplicationMenu</a> opened.


### -field UI_EVENTTYPE_RibbonMinimized

The <a href="https://msdn.microsoft.com/library/Dd316811(v=VS.85).aspx">Ribbon</a> minimized.


### -field UI_EVENTTYPE_RibbonExpanded

The <a href="https://msdn.microsoft.com/library/Dd316811(v=VS.85).aspx">Ribbon</a> expanded.


### -field UI_EVENTTYPE_ApplicationModeSwitched

The <a href="https://msdn.microsoft.com/library/Dd940486(v=VS.85).aspx">application mode</a> changed.


### -field UI_EVENTTYPE_TabActivated

A <a href="https://msdn.microsoft.com/library/Dd316894(v=VS.85).aspx">Tab</a> activated.
...
A <a href="https://msdn.microsoft.com/library/Dd371615(v=VS.85).aspx">Command</a> executed.


### -field UI_EVENTTYPE_TooltipShown

A <a href="https://msdn.microsoft.com/library/Dd371615(v=VS.85).aspx">Command</a> tooltip displayed.
...
<b>UI_EVENTTYPE_TabActivated</b> is fired for both core tabs and contextual tabs; the <a href="https://msdn.microsoft.com/library/Dd316811(v=VS.85).aspx">Ribbon</a> event system does not distinguish between the two.
...
No event is fired when the <a href="https://msdn.microsoft.com/library/Dd371713(v=VS.85).aspx">QuickAccessToolbar</a> menu is opened or closed.
