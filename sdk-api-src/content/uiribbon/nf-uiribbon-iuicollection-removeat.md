...
Removes an item from the <a href="https://msdn.microsoft.com/library/Dd371519(v=VS.85).aspx">IUICollection</a> at the specified index.
...
Type: <b>UINT32</b>
					...
					The zero-based index of the item to remove from the <a href="https://msdn.microsoft.com/library/Dd371519(v=VS.85).aspx">IUICollection</a>.
