...
When this method returns, contains an interface pointer to an object that implements the <a href="/previous-versions/windows/desktop/api/oaidl/nn-oaidl-ienumvariant.md">IEnumVARIANT</a> interface.
