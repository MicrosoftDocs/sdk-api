...
Retrieves the current duty cycle percentage for a pin or channel. The control code returns the percentage as a <a href="/windows/desktop/DevIO/pwm-pin-get-active-duty-cycle-percentage-output">PWM_PIN_GET_ACTIVE_DUTY_CYCLE_PERCENTAGE_OUTPUT</a> structure.
...
A pointer to the buffer that contains a <a href="/windows/desktop/DevIO/pwm-pin-get-active-duty-cycle-percentage-output">PWM_PIN_GET_ACTIVE_DUTY_CYCLE_PERCENTAGE_OUTPUT</a> struct. This represents the current duty cycle percentage for the PWM controller
