...
Stops generation of Pulse Width Modulation (PWM) signal on a pin or channel. To check whether a pin is started, use <a href="/windows/desktop/api/pwm/ni-pwm-ioctl_pwm_pin_is_started.md">IOCTL_PWM_PIN_IS_STARTED</a>.
...
<pre class="syntax">BOOL 
   ...
   DeviceIoControl( (HANDLE)       hDevice,         // handle to device
                    (DWORD)        IOCTL_PWM_PIN_STOP, // dwIoControlCode
