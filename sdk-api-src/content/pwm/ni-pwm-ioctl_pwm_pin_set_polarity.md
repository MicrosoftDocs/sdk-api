...
Sets the signal polarity of the pin or channel. The control code sets the signal polarity based on a <a href="/windows/desktop/api/pwm/ns-pwm-pwm_pin_set_polarity_input">PWM_PIN_SET_POLARITY_INPUT</a> structure. The signal polarity is either Active High or Active Low, as  defined in the <a href="/windows/desktop/api/pwm/ne-pwm-pwm_polarity">PWM_POLARITY</a> enumeration.
