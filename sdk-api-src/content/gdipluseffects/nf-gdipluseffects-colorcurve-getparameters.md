...
The <b>ColorCurve::GetParameters</b> gets the current values of the parameters of this <a href="https://msdn.microsoft.com/library/ms534429(v=VS.85).aspx">ColorCurve</a> object.
...
Pointer to a <b>UINT</b> that specifies the size, in bytes, of a <a href="https://msdn.microsoft.com/library/ms534060(v=VS.85).aspx">ColorCurveParams</a> structure.


### -param parameters [out]

Type: <b><a href="https://msdn.microsoft.com/library/ms534060(v=VS.85).aspx">ColorCurveParams</a>*</b>

Pointer to a <a href="https://msdn.microsoft.com/library/ms534060(v=VS.85).aspx">ColorCurveParams</a> structure that receives the parameter values.
