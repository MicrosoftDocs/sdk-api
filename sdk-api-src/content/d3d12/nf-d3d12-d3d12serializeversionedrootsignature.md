...
Serializes a root signature of any version that can be passed to <a href="https://msdn.microsoft.com/en-us/library/Dn899182(v=VS.85).aspx">ID3D12Device::CreateRootSignature</a>.
...
Specifies a <a href="https://msdn.microsoft.com/en-us/library/Mt709125(v=VS.85).aspx">D3D12_VERSIONED_ROOT_SIGNATURE_DESC</a> that contains a description of any version of a root signature.
...
If an application procedurally generates a <a href="https://msdn.microsoft.com/en-us/library/Mt709124(v=VS.85).aspx">D3D12_ROOT_SIGNATURE_DESC1</a> data structure, it must pass a pointer to this <b>D3D12_ROOT_SIGNATURE_DESC1</b> in a call to <b>D3D12SerializeVersionedRootSignature</b> to make the serialized form.
...
This function was released with the Windows 10 Anniversary Update (14393) and supersedes <a href="https://msdn.microsoft.com/en-us/library/Dn859363(v=VS.85).aspx">D3D12SerializeRootSignature</a>.
...
<a href="https://msdn.microsoft.com/en-us/library/Mt491209(v=VS.85).aspx">D3DX12SerializeVersionedRootSignature</a>
