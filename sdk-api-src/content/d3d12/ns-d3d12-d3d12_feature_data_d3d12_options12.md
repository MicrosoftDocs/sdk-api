...
Enhanced Barriers is not currently a hardware or driver requirement. You must check for optional driver support before using command list Barrier APIs or resource Create methods using InitialLayout.
