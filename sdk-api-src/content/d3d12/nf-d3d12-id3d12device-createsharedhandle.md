...
Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d12/nn-d3d12-id3d12devicechild">ID3D12DeviceChild</a>*</b>
...
Both heaps and committed resources can be shared.
        ...
        For Direct3D 12, shared handles are opened with the <a href="https://docs.microsoft.com/en-us/windows/win32/api/d3d12/nf-d3d12-id3d12device-opensharedhandle">ID3D12Device::OpenSharedHandle</a> member function or the ID3D12Device::OpenSharedHandleByName member function.
