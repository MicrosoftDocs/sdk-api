...
The type of the serialized data. For more information, see <a href="http://docs.microsoft.com/windows/desktop/d3d12/ne-d3d12-d3d12_serialized_data_type">D3D12_SERIALIZED_DATA_TYPE</a>.


### -param pIdentifierToCheck [in]

Identifier from the header of the serialized data to check with the driver. For more information, see <a href="http://docs.microsoft.com/windows/desktop/d3d12/ns-d3d12-d3d12_serialized_data_driver_matching_identifier">D3D12_SERIALIZED_DATA_DRIVER_MATCHING_IDENTIFIER</a>.
...
The returned compatibility status. For more information, see <a href="http://docs.microsoft.com/windows/desktop/d3d12/ns-d3d12-d3d12_driver_matching_identifier_status">D3D12_DRIVER_MATCHING_IDENTIFIER_STATUS</a>.
