...
ms.topic: interface
f1_keywords: ["d3d12/ID3D12Device2"]
req.header: d3d12.h
req.include-header: 
...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">ID3D12Device2</b> interface inherits from <a href="https://docs.microsoft.com/windows/desktop/api/d3d12/nn-d3d12-id3d12device1">ID3D12Device1</a>. <b>ID3D12Device2</b> also has these types of members:
<ul>
...
<a href="https://docs.microsoft.com/windows/desktop/api/d3d12/nf-d3d12-id3d12device2-createpipelinestate">CreatePipelineState</a>
</td>
