...
The state object to set on the command list. In the current release, this can only be of type <a href="direct3d12.d3d12_state_object_type">D3D12_STATE_OBJECT_TYPE_RAYTRACING_PIPELINE</a>.
