...
Indicates support for [**D3D12_HEAP_FLAG_ALLOW_SHADER_ATOMICS**](/windows/win32/api/d3d12/ne-d3d12-d3d12_heap_flags) on heaps that are visible to multiple nodes.
