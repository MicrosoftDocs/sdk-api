...
ms.topic: struct
f1_keywords: ["d3d12/D3D12_ROOT_DESCRIPTOR_TABLE1"]
req.header: d3d12.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/d3d12/ns-d3d12-d3d12_root_descriptor_table">D3D12_ROOT_DESCRIPTOR_TABLE</a>
