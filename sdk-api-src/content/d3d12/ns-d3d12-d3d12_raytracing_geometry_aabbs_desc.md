...
title: D3D12_RAYTRACING_GEOMETRY_AABBS_DESC
...
Describes a set of Axis-aligned bounding boxes that are used in the <a href="direct3d12.d3d12_build_raytracing_acceleration_structure_inputs">D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_INPUTS</a> structure to provide input data to a raytracing acceleration structure build operation.
