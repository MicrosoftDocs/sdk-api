...
Specifies the type of geometry used for raytracing. Use a value from this enumeration to specify the geometry type in a <a href="direct3d12.d3d12_raytracing_geometry_desc">D3D12_RAYTRACING_GEOMETRY_DESC</a>.
...
The geometry procedurally is defined during raytracing by intersection shaders.  For the purpose of acceleration structure builds, the geometry’s bounds are described with axis-aligned bounding boxes using the  <a href="direct3d12.d3d12_raytracing_geometry_aabbs_desc">D3D12_RAYTRACING_GEOMETRY_AABBS_DESC</a> structure.
