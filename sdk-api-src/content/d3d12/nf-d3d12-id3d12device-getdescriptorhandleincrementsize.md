...
title: ID3D12Device::GetDescriptorHandleIncrementSize method
...
ms.date: 3/14/2018
ms.keywords: GetDescriptorHandleIncrementSize method, GetDescriptorHandleIncrementSize method, ID3D12Device interface, GetDescriptorHandleIncrementSize,ID3D12Device.GetDescriptorHandleIncrementSize, ID3D12Device, ID3D12Device interface, GetDescriptorHandleIncrementSize method, ID3D12Device::GetDescriptorHandleIncrementSize, d3d12/ID3D12Device::GetDescriptorHandleIncrementSize, direct3d12.id3d12device_getdescriptorhandleincrementsize
