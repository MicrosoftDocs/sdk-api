...
ms.topic: enum
f1_keywords: ["d3d12/D3D12_WRITEBUFFERIMMEDIATE_MODE"]
req.header: d3d12.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/d3d12/nn-d3d12-id3d12graphicscommandlist2">ID3D12GraphicsCommandList::WriteBufferImmediate</a>
 
