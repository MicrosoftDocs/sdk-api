...
title: ID3D12Device3::OpenExistingHeapFromFileMapping method
author: windows-driver-content
description: Creates a special-purpose diagnostic heap in system memory from a file mapping handle. The created heap can persist even in the event of a GPU-fault or device-removed scenario.
old-location: direct3d12\id3d12device3_openexistingheapfromfilemapping.htm
...
-	d3d12.dll
api_name:
-	Id3d12device3.CreatePipelineStateOpenExistingHeapFromFileMapping
product: Windows
targetos: Windows
req.lib: D3d12.lib
req.dll: D3d12.dll
