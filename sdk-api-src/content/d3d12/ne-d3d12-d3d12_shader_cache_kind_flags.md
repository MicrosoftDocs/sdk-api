...
### -field D3D12_SHADER_CACHE_KIND_FLAG_IMPLICIT_D3D_CACHE_FOR_DRIVER

Specifies a cache that's managed by Direct3D 12 to store driver compilations of application shaders.

### -field D3D12_SHADER_CACHE_KIND_FLAG_IMPLICIT_D3D_CONVERSIONS
...
### -field D3D12_SHADER_CACHE_KIND_FLAG_IMPLICIT_DRIVER_MANAGED

Specifies a cache that's managed by the driver. Operations for this cache are hints.

### -field D3D12_SHADER_CACHE_KIND_FLAG_APPLICATION_MANAGED
