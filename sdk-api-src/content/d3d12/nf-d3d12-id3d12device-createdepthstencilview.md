...
ms.topic: method
f1_keywords: ["d3d12/ID3D12Device.CreateDepthStencilView"]
req.header: d3d12.h
req.include-header: 
...
Type: <b>const <a href="https://docs.microsoft.com/windows/desktop/api/d3d12/ns-d3d12-d3d12_depth_stencil_view_desc">D3D12_DEPTH_STENCIL_VIEW_DESC</a>*</b>
