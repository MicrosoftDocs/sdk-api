...
<li>
            If the <b>HS</b> and <b>DS</b> members are specified, the <b>PrimitiveTopologyType</b> member for topology type must be set to <a href="https://msdn.microsoft.com/library/Dn770385(v=VS.85).aspx">D3D12_PRIMITIVE_TOPOLOGY_TYPE_PATCH</a>.
          </li>
<li>
...
<div class="alert"><b>Note</b>  
        You can create pipeline objects that don't specify any shader objects.
      </div>
<div> </div>
