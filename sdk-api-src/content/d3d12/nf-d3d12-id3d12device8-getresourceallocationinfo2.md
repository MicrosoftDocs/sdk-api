...
Gets rich info about the size and alignment of memory required for a collection of resources on this adapter. Also see [ID3D12Device4::GetResourceAllocationInfo1](/windows/win32/api/d3d12/nf-d3d12-id3d12device4-getresourceallocationinfo1).

This version also returns an array of [D3D12_RESOURCE_DESC1](/windows/win32/api/d3d12/ns-d3d12-d3d12_resource_desc1) structures.
...
For remarks, see [ID3D12Device4::GetResourceAllocationInfo1](/windows/win32/api/d3d12/nf-d3d12-id3d12device4-getresourceallocationinfo1).

## -see-also

* [ID3D12Device8](/windows/win32/api/d3d12/nn-d3d12-id3d12device8)
