...
description: The root drive for the user. In a network environment, this property is a string that contains a drive specification (a drive letter followed by a colon) to which the UNC path specified as the root directory is mapped. (Get)
...
f1_keywords:
 ...
 - tsuserex/IADsTSUserEx::get_TerminalServicesHomeDrive
dev_langs:
 - c++
topic_type:
 - APIRef
