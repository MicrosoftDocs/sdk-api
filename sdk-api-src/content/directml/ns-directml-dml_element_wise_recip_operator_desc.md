...
description: Describes a DirectML math operator that performs a reciprocal function on every element in the input, f(x) = 1 / (x * scale + bias), where the scale and bias terms are optional.
old-location: direct3d12\dml_element_wise_recip_operator_desc.htm
tech.root: direct3d12
ms.assetid: B5198895-7F09-4163-8F9E-F23FE0D92724
ms.author: windowssdkdev
ms.date: 12/5/2018
ms.keywords: DML_ELEMENT_WISE_RECIP_OPERATOR_DESC, DML_ELEMENT_WISE_RECIP_OPERATOR_DESC structure, direct3d12.dml_element_wise_recip_operator_desc, directml/DML_ELEMENT_WISE_RECIP_OPERATOR_DESC
ms.topic: struct
f1_keywords: ["directml/DML_ELEMENT_WISE_RECIP_OPERATOR_DESC"]
...
Describes a DirectML math operator that performs a reciprocal function on every element in the input, f(x) = 1 / (x * scale + bias), where the scale and bias terms are optional.
