...
description: Performs a logical *greater than* on each pair of corresponding elements of the input tensors, placing the result (1 for true, 0 for false) into the corresponding element of *OutputTensor*.
...
f1_keywords:
 ...
 - directml/DML_ELEMENT_WISE_LOGICAL_GREATER_THAN_OPERATOR_DESC
dev_langs:
 - c++
topic_type:
 - APIRef
