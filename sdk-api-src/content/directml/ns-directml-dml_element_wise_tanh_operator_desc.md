...
f1_keywords:
 - directml/DML_ELEMENT_WISE_TANH_OPERATOR_DESC
dev_langs:
 - c++
---
...
Describes a DirectML trigonometric operator that performs the element-wise inverse hyperbolic tangent function f(x) = tanh(x) * scale + bias, where the scale and bias terms are optional.
