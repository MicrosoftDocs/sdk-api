---
UID: NS:directml.DML_ELEMENT_WISE_ASIN_OPERATOR_DESC
title: DML_ELEMENT_WISE_ASIN_OPERATOR_DESC
...
ms.topic: struct
f1_keywords: ["directml/DML_ELEMENT_WISE_ASIN_OPERATOR_DESC"]
...
Describes a DirectML trigonometric operator that performs the element-wise arcsine function f(x) = asin(x * scale + bias), where the scale and bias terms are optional.
