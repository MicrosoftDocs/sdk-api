...
ms.topic: struct
f1_keywords: ["directml/DML_ELEMENT_WISE_LOG_OPERATOR_DESC"]
...
Describes a DirectML math operator that performs the element-wise natural logarithm function f(x) = log(x * scale + bias), where the scale and bias terms are optional.
