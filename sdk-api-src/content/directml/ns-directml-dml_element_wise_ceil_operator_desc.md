...
description: Computes the ceiling for each element of *InputTensor*, placing the result into the corresponding element of *OutputTensor*. The ceiling of x is the smallest integer that is greater than or equal to x.
