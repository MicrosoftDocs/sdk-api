...
description: Performs a logical left shift of each element of *ATensor* by a number of bits given by the corresponding element of *BTensor*, placing the result into the corresponding element of *OutputTensor*.
helpviewer_keywords: ["DML_ELEMENT_WISE_BIT_SHIFT_LEFT_OPERATOR_DESC","DML_ELEMENT_WISE_BIT_SHIFT_LEFT_OPERATOR_DESC structure","direct3d12.dml_element_wise_bit_shift_left_operator_desc","directml/DML_ELEMENT_WISE_BIT_SHIFT_LEFT_OPERATOR_DESC"]
tech.root: directml
ms.date: 10/29/2020
