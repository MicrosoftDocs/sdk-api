...
ms.date: 08/29/2022
targetos: Windows
description: The CONTAINING_RECORD macro returns the base address of an instance of a structure given the type and the address of a field inside the containing structure.
prerelease: false
req.assembly: 
