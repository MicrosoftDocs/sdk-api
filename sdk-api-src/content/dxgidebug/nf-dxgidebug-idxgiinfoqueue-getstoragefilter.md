...
ms.topic: method
f1_keywords: ["dxgidebug/IDXGIInfoQueue.GetStorageFilter"]
...
### -param Producer [in]
 ...
 A <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-debug-id">DXGI_DEBUG_ID</a> value that identifies the entity that gets the filter.
