...
A combination of <a href="https://msdn.microsoft.com/1ACBABF2-A0C5-419B-9723-BD0FEEEDF478">D3D11_TILE_COPY_FLAG</a>-typed values that are combined by using a bitwise OR operation. The only valid value is <b>D3D11_TILE_COPY_NO_OVERWRITE</b>.
...
<b>UpdateTiles</b> drops write operations to unmapped areas (except on <a href="https://msdn.microsoft.com/F2E58CDC-4E65-4166-976A-E58B6DC7B1E8">Tier_1</a> tiled resources, where writing to unmapped areas is invalid).  
