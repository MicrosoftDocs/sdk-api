...
A member of the <a href="https://msdn.microsoft.com/en-us/library/Dd692958(v=VS.85).aspx">MC_POSITION_TYPE</a> enumeration, specifying whether to set the horizontal position or the vertical position.
