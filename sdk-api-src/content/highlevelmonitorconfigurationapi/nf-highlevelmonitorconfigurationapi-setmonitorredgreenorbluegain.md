...
ms.topic: function
f1_keywords: ["highlevelmonitorconfigurationapi/SetMonitorRedGreenOrBlueGain"]
...
A member of the <a href="https://docs.microsoft.com/windows/desktop/api/highlevelmonitorconfigurationapi/ne-highlevelmonitorconfigurationapi-_mc_gain_type">MC_GAIN_TYPE</a> enumeration, specifying whether to set the red, green, or blue gain.
