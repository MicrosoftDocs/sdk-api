...
ms.date: 05/31/2024
targetos: Windows
description: Specifies the data field identifiers for the FWPS_LAYER_INBOUND_ICMP_ERROR_V4 and FWPS_LAYER_INBOUND_ICMP_ERROR_V4_DISCARD run-time filtering layers.
prerelease: false
...
Specifies the data field identifiers for the [FWPS_LAYER_INBOUND_ICMP_ERROR_V4](./ne-fwpsu-fwps_builtin_layers.md) and **FWPS_LAYER_INBOUND_ICMP_ERROR_V4_DISCARD** run-time filtering layers.
