...
ms.date: 05/31/2024
targetos: Windows
description: Specifies the data field identifiers for the FWPS_LAYER_EGRESS_VSWITCH_TRANSPORT_V4 run-time filtering layer.
prerelease: false
...
Specifies the data field identifiers for the [FWPS_LAYER_EGRESS_VSWITCH_TRANSPORT_V4](./ne-fwpsu-fwps_builtin_layers.md) run-time filtering layer.
