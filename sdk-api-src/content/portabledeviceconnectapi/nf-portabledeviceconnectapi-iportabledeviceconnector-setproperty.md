...
title: IPortableDeviceConnector::SetProperty method
...
ms.date: 2/15/2018
ms.keywords: IPortableDeviceConnector, IPortableDeviceConnector interface [Windows Portable Devices SDK], SetProperty method, IPortableDeviceConnector::SetProperty, SetProperty method [Windows Portable Devices SDK], SetProperty method [Windows Portable Devices SDK], IPortableDeviceConnector interface, SetProperty,IPortableDeviceConnector.SetProperty, devpkey/IPortableDeviceConnector::SetProperty, portabledeviceconnectapi/IPortableDeviceConnector::SetProperty, wpdsdk.iportabledeviceconnector_setproperty
...
# IPortableDeviceConnector::SetProperty method
