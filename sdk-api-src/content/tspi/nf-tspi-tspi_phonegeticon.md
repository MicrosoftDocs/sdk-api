...
<a href="https://msdn.microsoft.com/library/ms648072(v=VS.85).aspx">LoadIcon</a> function) associated with the specified phone. The icon handle is for a resource associated with the provider.
