...
ms.topic: function
f1_keywords: ["tspi/TUISPI_lineConfigDialog"]
req.header: tspi.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/tspi/nf-tspi-tspi_lineconfigdialog">TSPI_lineConfigDialog</a> function obsolete in version 2.0 and later (supported in version 1.4 and earlier).
