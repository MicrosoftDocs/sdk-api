...
ms.topic: function
f1_keywords: ["tspi/TSPI_providerRemove"]
req.header: tspi.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/tspi/nf-tspi-tspi_providerinstall">TSPI_providerInstall</a>. It is the responsibility of the caller to ensure this.
