...
ms.topic: function
f1_keywords: ["tspi/TSPI_providerInstall"]
req.header: tspi.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/tspi/nf-tspi-tspi_providerremove">TSPI_providerRemove</a>. It must be called before any other TSPI-defined function.
...
<a href="https://docs.microsoft.com/windows/desktop/api/tspi/nf-tspi-tspi_providerconfig">TSPI_providerConfig</a> for the "add" command.
