...
title: IFsrmQuotaManager::EnumEffectiveQuotas method
...
ms.date: 3/14/2018
ms.keywords: EnumEffectiveQuotas method [File Server Resource Manager], EnumEffectiveQuotas method [File Server Resource Manager], FsrmQuotaManager class, EnumEffectiveQuotas method [File Server Resource Manager], IFsrmQuotaManager interface, EnumEffectiveQuotas method [File Server Resource Manager], IFsrmQuotaManagerEx interface, EnumEffectiveQuotas,IFsrmQuotaManager.EnumEffectiveQuotas, FsrmQuotaManager class [File Server Resource Manager], EnumEffectiveQuotas method, IFsrmQuotaManager, IFsrmQuotaManager interface [File Server Resource Manager], EnumEffectiveQuotas method, IFsrmQuotaManager::EnumEffectiveQuotas, IFsrmQuotaManagerEx interface [File Server Resource Manager], EnumEffectiveQuotas method, IFsrmQuotaManagerEx::EnumEffectiveQuotas, fs.ifsrmquotamanager_enumeffectivequotas, fsrm.ifsrmquotamanager_enumeffectivequotas, fsrmquota/IFsrmQuotaManager::EnumEffectiveQuotas, fsrmquota/IFsrmQuotaManagerEx::EnumEffectiveQuotas
...
# IFsrmQuotaManager::EnumEffectiveQuotas method
