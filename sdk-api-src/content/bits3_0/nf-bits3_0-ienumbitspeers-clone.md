...
Creates another 
<a href="https://msdn.microsoft.com/en-us/library/Aa964308(v=VS.85).aspx">IEnumBitsPeers</a> enumerator that contains the same enumeration state as the current one.
