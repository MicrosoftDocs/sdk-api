---
UID: NF:wincon.WriteConsoleOutputCharacterA
title: WriteConsoleOutputCharacterA function
...
old-location: consoles\writeconsoleoutputcharacter.htm
old-project: consoles
ms.assetid: 7cc935ea-6b19-4494-b746-259aa7aaa9cc
ms.author: windowsdriverdev
ms.date: 3/27/2018
ms.keywords: WriteConsoleOutputCharacter, WriteConsoleOutputCharacter function [Consoles], WriteConsoleOutputCharacterA, WriteConsoleOutputCharacterW, _win32_writeconsoleoutputcharacter, base.writeconsoleoutputcharacter, consoles.writeconsoleoutputcharacter, wincon/WriteConsoleOutputCharacter, wincon/WriteConsoleOutputCharacterA, wincon/WriteConsoleOutputCharacterW
...
req.umdf-ver: 
req.ddi-compliance: 
req.unicode-ansi: WriteConsoleOutputCharacterW (Unicode) and WriteConsoleOutputCharacterA (ANSI)
req.idl: 
req.max-support: 
req.namespace: 
req.assembly: 
...
# WriteConsoleOutputCharacterA function
...
A 
<a href="https://msdn.microsoft.com/d730c46e-ea17-475e-b956-8ee5f4f5c04e">COORD</a> structure that specifies the character coordinates of the first cell in the console screen buffer to which characters will be written.
