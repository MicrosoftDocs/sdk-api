...
Extends the existing <a href="https://msdn.microsoft.com/32408600-5118-47fb-890b-9c31faef2299">MoveClusterGroup</a> method with the addition of flags and a buffer. The flags control the behavior of the cluster failover policy, and the input buffer enables the client to send special instructions to the resources in the group.
