---
UID: NC:clusapi.PCLUSAPI_CLUSTER_RESOURCE_CLOSE_ENUM
title: PCLUSAPI_CLUSTER_RESOURCE_CLOSE_ENUM
...
ms.date: 06/08/2018
ms.keywords: PCLUSAPI_CLUSTER_RESOURCE_CLOSE_ENUM, PCLUSAPI_CLUSTER_RESOURCE_CLOSE_ENUM callback, PCLUSAPI_CLUSTER_RESOURCE_CLOSE_ENUM callback function [Failover Cluster], _wolf_clusterresourcecloseenum, clusapi/PCLUSAPI_CLUSTER_RESOURCE_CLOSE_ENUM, mscs.clusterresourcecloseenum
ms.prod: windows
...
Closes a  <a href="https://msdn.microsoft.com/en-us/library/Aa372152(v=VS.85).aspx">resource</a> enumeration handle. The <b>PCLUSAPI_CLUSTER_RESOURCE_CLOSE_ENUM</b> type defines a pointer to this function.
