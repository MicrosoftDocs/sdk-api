---
UID: NC:clusapi.PCLUSAPI_CLUSTER_NETWORK_ENUM
title: PCLUSAPI_CLUSTER_NETWORK_ENUM
...
ms.date: 05/10/2018
ms.keywords: CLUSTER_NETWORK_ENUM_NETINTERFACES, PCLUSAPI_CLUSTER_NETWORK_ENUM, PCLUSAPI_CLUSTER_NETWORK_ENUM callback, PCLUSAPI_CLUSTER_NETWORK_ENUM callback function [Failover Cluster], _wolf_clusternetworkenum, clusapi/PCLUSAPI_CLUSTER_NETWORK_ENUM, mscs.clusternetworkenum
ms.prod: windows
...
# PCLUSAPI_CLUSTER_NETWORK_ENUM callback function
...
The index used to identify the next entry to be enumerated. This parameter should be zero for the first call 
       to <i>ClusterNetworkEnum</i> and then incremented for 
       subsequent calls.
...
The <i>ClusterNetworkEnum</i> function is typically 
     ...
     the application calls <i>ClusterNetworkEnum</i> 
