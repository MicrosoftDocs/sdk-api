...
The queue receives a notification when a 
       <a href="https://msdn.microsoft.com/en-us/library/Aa369094(v=VS.85).aspx">cluster database</a> key's attributes are changed. The only 
...
The queue receives a notification when a value of the specified cluster database key is changed or deleted. 
       ...
       <a href="https://msdn.microsoft.com/en-us/library/Aa368995(v=VS.85).aspx">ClusterRegDeleteValue</a> function.
...
The queue receives a notification when the 
       <a href="https://msdn.microsoft.com/en-us/library/Aa371517(v=VS.85).aspx">properties</a> of an existing network change.
