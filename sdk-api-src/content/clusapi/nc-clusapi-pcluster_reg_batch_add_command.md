...
ms.date: 3/27/2018
ms.keywords: CLUSREG_CREATE_KEY, CLUSREG_DELETE_KEY, CLUSREG_DELETE_VALUE, CLUSREG_SET_VALUE, PCLUSTER_REG_BATCH_ADD_COMMAND, PCLUSTER_REG_BATCH_ADD_COMMAND callback function [Failover Cluster], clusapi/PCLUSTER_REG_BATCH_ADD_COMMAND, mscs.clusterregbatchaddcommand
...
# PCLUSTER_REG_BATCH_ADD_COMMAND callback
