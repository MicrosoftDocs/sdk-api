...
ms.date: 4/24/2018
ms.keywords: CLUSTER_RESOURCE_ENUM_DEPENDS, CLUSTER_RESOURCE_ENUM_NODES, CLUSTER_RESOURCE_ENUM_PROVIDES, PCLUSAPI_CLUSTER_RESOURCE_ENUM, PCLUSAPI_CLUSTER_RESOURCE_ENUM callback function [Failover Cluster], _wolf_clusterresourceenum, clusapi/PCLUSAPI_CLUSTER_RESOURCE_ENUM, mscs.clusterresourceenum
...
# PCLUSAPI_CLUSTER_RESOURCE_ENUM callback
...
The index of the resource or node object to return. This parameter should be zero for the first call to the 
       <i>ClusterResourceEnum</i> function and then 
...
Do not call <i>ClusterResourceEnum</i> from any 
     resource DLL entry point function. 
     <i>ClusterResourceEnum</i> can safely be called from a 
