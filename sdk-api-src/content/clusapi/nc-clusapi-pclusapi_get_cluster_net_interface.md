...
Returns the name of a  <a href="https://msdn.microsoft.com/en-us/library/Aa371745(v=VS.85).aspx">node's</a> interface to a  <a href="https://msdn.microsoft.com/en-us/library/Aa371501(v=VS.85).aspx">network</a> in a <a href="https://msdn.microsoft.com/en-us/library/Aa369114(v=VS.85).aspx">cluster</a>. The <b>PCLUSAPI_GET_CLUSTER_NET_INTERFACE</b> type defines a pointer to this function.
