...
description: CLUSTER_NETWORK_ENUM (clusapi.h) describes the type of cluster object being enumerated by the ClusterNetworkEnum and ClusterNetworkOpenEnum functions.
