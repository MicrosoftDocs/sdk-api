...
ms.topic: enum
f1_keywords: ["clusapi/CLUSTER_PROPERTY_SYNTAX"]
...
Describes a <a href="https://docs.microsoft.com/windows/desktop/api/winnt/ns-winnt-_security_descriptor">SECURITY_DESCRIPTOR</a> in 
