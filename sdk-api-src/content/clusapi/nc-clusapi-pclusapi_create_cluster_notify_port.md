...
# PCLUSAPI_CREATE_CLUSTER_NOTIFY_PORT callback function
...
Creates 
    ...
    <a href="https://msdn.microsoft.com/en-us/library/Aa371823(v=VS.85).aspx">Receiving Cluster Events</a>. The <b>PCLUSAPI_CREATE_CLUSTER_NOTIFY_PORT</b> type defines a pointer to this function.
...
Handle to the <a href="https://msdn.microsoft.com/en-us/library/Aa369114(v=VS.85).aspx">cluster</a> to be associated with the 
...
Bitmask of flags enumerated from the <a href="https://msdn.microsoft.com/en-us/library/Bb309133(v=VS.85).aspx">CLUSTER_CHANGE</a> 
...
The queue receives a notification when the 
         <a href="https://msdn.microsoft.com/en-us/library/ms692124(v=VS.85).aspx">properties</a> of a group change or when a 
...
The queue receives a notification when the 
         <a href="https://msdn.microsoft.com/en-us/library/ms692124(v=VS.85).aspx">properties</a> of an existing network 
         interface change.
...
The queue receives a notification when a 
         <a href="https://msdn.microsoft.com/en-us/library/Aa369094(v=VS.85).aspx">cluster database</a> key's attributes are changed. The 
...
The queue receives a notification when the 
         <a href="https://msdn.microsoft.com/en-us/library/ms692124(v=VS.85).aspx">properties</a>, 
...
The queue receives a notification when the 
         <a href="https://msdn.microsoft.com/en-us/library/ms692124(v=VS.85).aspx">properties</a> of a resource type 
         change.
