---
UID: NC:clusapi.PCLUSAPI_CREATE_CLUSTER_NAME_ACCOUNT
title: PCLUSAPI_CREATE_CLUSTER_NAME_ACCOUNT
...
A pointer to the <a href="https://msdn.microsoft.com/en-us/library/Dn806630(v=VS.85).aspx">CREATE_CLUSTER_NAME_ACCOUNT</a> structure that contains the information about the <a href="https://msdn.microsoft.com/en-us/library/Aa371733(v=VS.85).aspx">cluster name</a> resource to create, and the domain credentials to use.
