...
ms.date: 3/26/2018
ms.keywords: FALSE, PFSCE_QUERY_INFO, PFSCE_QUERY_INFO function pointer [Security], SCESVC_ANALYSIS_INFO, SCESVC_CONFIGURATION_INFO, SCE_SERVICE_ANALYSIS_INFO, SCE_SERVICE_CONFIGURATION_INFO, TRUE, _config_pfsce_query_info, scesvc/PFSCE_QUERY_INFO, security.pfsce_query_info
