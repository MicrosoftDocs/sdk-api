...
Pointer to a <a href="https://msdn.microsoft.com/library/Bb174523(v=VS.85).aspx">IDXGIAdapter</a>.
...
The type of driver for the device. See <a href="https://msdn.microsoft.com/library/Bb205042(v=VS.85).aspx">D3D10_DRIVER_TYPE</a>.
...
Optional. Device creation flags (see <a href="https://msdn.microsoft.com/library/Bb204909(v=VS.85).aspx">D3D10_CREATE_DEVICE_FLAG</a>) that enable <a href="https://msdn.microsoft.com/library/Bb205068(v=VS.85).aspx">API layers</a>. These flags can be bitwise OR'd together.
...
Type: <b><a href="https://msdn.microsoft.com/library/Bb173075(v=VS.85).aspx">DXGI_SWAP_CHAIN_DESC</a>*</b>

Description of the swap chain. See <a href="https://msdn.microsoft.com/library/Bb173075(v=VS.85).aspx">DXGI_SWAP_CHAIN_DESC</a>.
...
Address of a pointer to an <a href="https://msdn.microsoft.com/library/Bb174569(v=VS.85).aspx">IDXGISwapChain</a>.
...
Address of a pointer to an <a href="https://msdn.microsoft.com/library/Bb173528(v=VS.85).aspx">ID3D10Device Interface</a> that will receive the newly created device.
...
To create a device without creating a swap chain, see <a href="https://msdn.microsoft.com/library/Bb205086(v=VS.85).aspx">D3D10CreateDevice</a>.
