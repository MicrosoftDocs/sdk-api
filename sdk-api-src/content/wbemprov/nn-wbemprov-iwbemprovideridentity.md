...
<a href="https://msdn.microsoft.com/41e0d938-00c6-4f4c-8027-8b8512398dee">__Win32Provider</a>) with the same <a href="https://msdn.microsoft.com/library/ms688628(v=VS.85).aspx">CLSID</a> value. The class provides a mechanism for distinguishing which named provider should be used.
