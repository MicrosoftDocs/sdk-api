...
Use validate prior to calling a draw method (for example, <a href="https://msdn.microsoft.com/en-us/library/Ff476407(v=VS.85).aspx">ID3D11DeviceContext::Draw</a>); validation requires the debug layer.
