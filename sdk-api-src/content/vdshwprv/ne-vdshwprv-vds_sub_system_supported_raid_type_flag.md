...
description: The VDS_SUB_SYSTEM_SUPPORTED_RAID_TYPE_FLAG enumeration (vdshwprv.h) defines the set of RAID levels that can be supported by subsystems. 
...
f1_keywords:
 ...
 - vdshwprv/_VDS_SUB_SYSTEM_SUPPORTED_RAID_TYPE_FLAG
 - PVDS_SUB_SYSTEM_SUPPORTED_RAID_TYPE_FLAG
 - vdshwprv/PVDS_SUB_SYSTEM_SUPPORTED_RAID_TYPE_FLAG
 - VDS_SUB_SYSTEM_SUPPORTED_RAID_TYPE_FLAG
