...
ms.topic: method
f1_keywords: ["vdshwprv/IVdsIscsiPortalGroup.GetTarget"]
...
The address of an <a href="https://docs.microsoft.com/windows/desktop/api/vdshwprv/nn-vdshwprv-ivdsiscsitarget">IVdsIscsiTarget</a>. VDS initializes the 
