...
description: The VDS_SUB_SYSTEM_STATUS enumeration (vdshwprv.h) defines the set of object status values for a subsystem.  
...
f1_keywords:
 ...
 - vdshwprv/_VDS_SUB_SYSTEM_STATUS
 - PVDS_SUB_SYSTEM_STATUS
 - vdshwprv/PVDS_SUB_SYSTEM_STATUS
