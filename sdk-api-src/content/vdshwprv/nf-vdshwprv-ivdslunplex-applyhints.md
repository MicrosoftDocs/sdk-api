...
Pointer to the hints to be applied to the LUN plex. See the <a href="https://msdn.microsoft.com/2c9f04bb-a014-401e-9656-affbac11f810">VDS_HINTS</a> structure. Only fields relevant to a LUN plex are expected to be set; irrelevant fields are ignored.
...
Use the <a href="https://msdn.microsoft.com/4ecb0840-8eaf-47c9-b8a9-98c738ed7daf">IVdsLunPlex::QueryHints</a> method to get the current hints for the LUN plex.
