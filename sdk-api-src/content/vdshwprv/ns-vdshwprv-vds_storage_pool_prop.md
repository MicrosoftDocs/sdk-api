...
description: The VDS_STORAGE_POOL_PROP structure (vdshwprv.h) defines the properties of a storage pool object.
...
f1_keywords:
 ...
 - vdshwprv/_VDS_STORAGE_POOL_PROP
 - PVDS_STORAGE_POOL_PROP
 - vdshwprv/PVDS_STORAGE_POOL_PROP
