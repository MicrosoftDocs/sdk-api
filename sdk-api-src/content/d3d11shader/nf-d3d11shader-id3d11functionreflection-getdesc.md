...
Type: <b><a href="https://msdn.microsoft.com/en-us/library/Dn280416(v=VS.85).aspx">D3D11_FUNCTION_DESC</a>*</b>

A pointer to a <a href="https://msdn.microsoft.com/en-us/library/Dn280416(v=VS.85).aspx">D3D11_FUNCTION_DESC</a> structure that receives a description of the function.
