...
A <a href="https://msdn.microsoft.com/en-us/library/Ff728733(v=VS.85).aspx">D3D_SHADER_VARIABLE_CLASS</a>-typed value that identifies the variable class as one of scalar, vector, matrix, object, and so on.
...
A <a href="https://msdn.microsoft.com/en-us/library/Ff728735(v=VS.85).aspx">D3D_SHADER_VARIABLE_TYPE</a>-typed value that identifies the variable type.
...
Name of the shader-variable type. This member can be <b>NULL</b> if it isn't used. This member supports dynamic shader linkage interface types, which have names. For more info about dynamic shader linkage, see <a href="https://msdn.microsoft.com/en-us/library/Ff471420(v=VS.85).aspx">Dynamic Linking</a>.
...
Get a shader-variable-type description by calling <a href="https://msdn.microsoft.com/en-us/library/Ff476597(v=VS.85).aspx">ID3D11ShaderReflectionType::GetDesc</a>.
