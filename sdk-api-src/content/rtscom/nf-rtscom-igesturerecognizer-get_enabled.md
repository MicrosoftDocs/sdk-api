...
description: Gets or sets a value that indicates whether gesture recognition is enabled. (Get)
...
f1_keywords:
 ...
 - rtscom/IGestureRecognizer::get_Enabled
dev_langs:
 - c++
topic_type:
 - APIRef
...
<a href="/windows/desktop/api/rtscom/nf-rtscom-igesturerecognizer-get_maxstrokecount">IGestureRecognizer::MaxStrokeCount Property</a>
