...
Pointer to an <a href="https://msdn.microsoft.com/library/ms221053(v=VS.85).aspx">IEnumVARIANT</a> interface pointer that receives the enumerator object created for the specified container object.
...
The <b>ADsBuildEnumerator</b> helper function wraps the calls used to retrieve the <a href="https://msdn.microsoft.com/library/ms221053(v=VS.85).aspx">IEnumVARIANT</a> interface on the enumerator object.

<p class="proch"><img alt="" src="../common/wedge.gif"/><b> To enumerate the available objects in a container</b>

<ol>
<li>Call the <b>ADsBuildEnumerator</b> function to create an <a href="https://msdn.microsoft.com/library/ms221053(v=VS.85).aspx">IEnumVARIANT</a> object that will enumerate the contents of the container.</li>
