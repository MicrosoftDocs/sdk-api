...
You must call  <a href="https://msdn.microsoft.com/en-us/library/Ff808380(v=VS.85).aspx">InitializeInstallDefaults</a> before calling <b>SetProperty</b>.
...
You cannot set the ENUM_CESSETUPPROP_CACONFIG property if the target server is a standalone certification authority. The <a href="https://msdn.microsoft.com/en-us/library/Ff808378(v=VS.85).aspx">ErrorString</a> property will be set to "The Certificate Enrollment Web Service cannot be used with a standalone certification authority (CA). It can only be used with an enterprise CA."
