...
using a GUID generated by hashing the provider name using the ETW name-hashing
...
a hash of the provider name using the ETW name-hashing algorithm described
below. This provides several benefits: it's easier to remember just the name;
the ID and the name are automatically linked; tools such as tracelog, traceview,
EventSource, and WPR have special support for providers that use IDs generated
