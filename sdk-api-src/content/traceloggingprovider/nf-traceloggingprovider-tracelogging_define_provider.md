...
Most providers do not need to specify any additional parameters.
...
a hash of the provider name using the ETW name-hashing algorithm. This provides
...
using the ETW name-hashing algorithm:
...
The ETW name-hashing algorithm can be implemented in C# as follows:
