...
A pointer to an <a href="https://msdn.microsoft.com/library/ms682833(v=VS.85).aspx">IEventObjectCollection</a> interface pointer on an event object collection. This parameter cannot be <b>NULL</b>.
