...
A pointer to an <a href="/windows/desktop/api/eventsys/nn-eventsys-ieventobjectcollection.md">IEventObjectCollection</a> interface pointer on an event object collection. This parameter cannot be <b>NULL</b>.
