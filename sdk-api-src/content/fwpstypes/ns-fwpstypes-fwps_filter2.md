...
The [FWPS_FILTER0](/windows/desktop/api/fwpstypes/ns-fwpstypes-fwps_filter0) is available.</div>
<div> </div>
...
Flags that specify actions that a callout's 
     <a href="/windows-hardware/drivers/ddi/content/fwpsk/nc-fwpsk-fwps_callout_classify_fn2">classifyFn2</a> callout function should take when
...
This flag indicates to a callout's 
       <a href="/windows-hardware/drivers/ddi/content/fwpsk/nc-fwpsk-fwps_callout_classify_fn2">classifyFn2</a> callout function that it should
...
<td width="60%">
This flag indicates to a callout's 
       <a href="/windows-hardware/drivers/ddi/content/fwpsk/nc-fwpsk-fwps_callout_classify_fn2">classifyFn2</a> callout function that if the
...
A context value that is associated with the filter. A callout can set this member to point to a
     ...
     <a href="/windows-hardware/drivers/ddi/content/fwpsk/nc-fwpsk-fwps_callout_notify_fn2">notifyFn2</a> callout function when the filter is
     ...
     <a href="/windows-hardware/drivers/ddi/content/fwpsk/nc-fwpsk-fwps_callout_classify_fn2">classifyFn2</a> callout function to preserve any
...
A pointer to the provider context, which is formatted as a [FWPM_PROVIDER_CONTEXT2](/windows/desktop/api/fwpmtypes/ns-fwpmtypes-fwpm_provider_context2) structure. If the filter uses a callout, and the callout has the FWPM_CALLOUT_FLAG_USES_PROVIDER_CONTEXT flag set, this member will contain the provider context from the corresponding [FWPM_FILTER0](/windows/desktop/api/fwpmtypes/ns-fwpmtypes-fwpm_filter0) structure. Otherwise, this parameter is
     NULL.

## -remarks

The filter engine passes a pointer to an <b>FWPS_FILTER2</b> structure to a callout's 
    <a href="/windows-hardware/drivers/ddi/content/fwpsk/nc-fwpsk-fwps_callout_notify_fn2">notifyFn2</a> and 
    <a href="/windows-hardware/drivers/ddi/content/fwpsk/nc-fwpsk-fwps_callout_classify_fn2">classifyFn2</a> callout functions.
...
This structure is essentially identical to the previous version, 
    [FWPM_PROVIDER_CONTEXT2](/windows/desktop/api/fwpmtypes/ns-fwpmtypes-fwpm_provider_context2) structure at the <b>providerContext</b> member.
...
[FWPS_FILTER1](/windows/desktop/api/fwpstypes/ns-fwpstypes-fwps_filter1)
...
<a href="/windows-hardware/drivers/ddi/content/fwpsk/nc-fwpsk-fwps_callout_classify_fn2">classifyFn2</a>



<a href="/windows-hardware/drivers/ddi/content/fwpsk/nc-fwpsk-fwps_callout_notify_fn2">notifyFn2</a>