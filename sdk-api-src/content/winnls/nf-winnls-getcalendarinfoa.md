...
description: Retrieves information about a calendar for a locale specified by identifier. (ANSI)
helpviewer_keywords: ["GetCalendarInfoA", "winnls/GetCalendarInfoA"]
