...
Pointer to the value of the dialog request from the operation that generated the <b>OpenMMI</b> request, for example, a call to <a href="https://msdn.microsoft.com/en-us/library/Dd693263(v=VS.85).aspx">IBDA::CheckEntitlementToken</a>. 
