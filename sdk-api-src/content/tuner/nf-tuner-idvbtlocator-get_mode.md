...
ms.topic: method
f1_keywords: ["tuner/IDVBTLocator.get_Mode"]
req.header: tuner.h
req.include-header: 
...
Receives a member of the <a href="https://docs.microsoft.com/previous-versions/windows/desktop/mstv/transmissionmode">TransmissionMode</a> enumeration.
