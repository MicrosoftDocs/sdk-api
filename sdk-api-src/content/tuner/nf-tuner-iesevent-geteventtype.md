...
ms.topic: method
f1_keywords: ["tuner/IESEvent.GetEventType"]
req.header: tuner.h
req.include-header: 
...
<a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/tuner/nf-tuner-ieseventservice-fireesevent">IESEventService::FireESEvent</a>
 
