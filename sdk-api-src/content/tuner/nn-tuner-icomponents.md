...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IComponents</b> interface inherits from the <a href="/previous-versions/windows/desktop/api/oaidl/nn-oaidl-idispatch.md">IDispatch</a> interface. <b>IComponents</b> also has these types of members:
<ul>
