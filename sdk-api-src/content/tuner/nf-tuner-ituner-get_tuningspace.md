...
ms.topic: method
f1_keywords: ["tuner/ITuner.get_TuningSpace"]
req.header: tuner.h
req.include-header: 
...
Address of an <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/tuner/nn-tuner-ituningspace">ITuningSpace</a> interface pointer that will be set to the current tuning space.
