...
<td width="60%">
Access is denied. You must own the job, or have <a href="https://msdn.microsoft.com/library/ms692302(v=VS.85).aspx">FAX_JOB_MANAGE</a> access.
...
An application typically calls the <b>FaxAbort</b> function to terminate a fax transmission that is in progress. To manage a queued fax job, an application typically calls the <a href="https://msdn.microsoft.com/library/ms691844(v=VS.85).aspx">FaxSetJob</a> function. <b>FaxSetJob</b> can cancel an active job; the function can also pause, resume, cancel, or restart a queued fax job.

Call the <a href="https://msdn.microsoft.com/library/ms691958(v=VS.85).aspx">FaxEnumJobs</a> function to retrieve a valid value to use in the <i>JobId</i> parameter.
