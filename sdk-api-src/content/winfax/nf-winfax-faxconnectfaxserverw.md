...
This function can only be used only with a local server. Use of a remote server is enabled in the <a href="https://msdn.microsoft.com/library/ms684513(v=VS.85).aspx">Fax Service Extended COM API</a>. For more information see the <a href="https://msdn.microsoft.com/12e71c4c-c4b5-4e6d-a1fa-b833d6a00ff8">IFaxServer::Connect</a> method.
...
The fax client application must call the <a href="https://msdn.microsoft.com/library/ms691909(v=VS.85).aspx">FaxClose</a> function to disconnect from the fax server and deallocate the handle that the <b>FaxConnectFaxServer</b> function returns. For more information, see <a href="https://msdn.microsoft.com/library/ms692919(v=VS.85).aspx">Connecting to the Fax Server</a> and <a href="https://msdn.microsoft.com/library/ms690866(v=VS.85).aspx">Disconnecting from a Fax Server</a>.
...
<a href="https://msdn.microsoft.com/library/ms691909(v=VS.85).aspx">FaxClose</a>
 
