...
Pointer to a <b>DWORD</b> variable to receive the number of <a href="https://msdn.microsoft.com/library/ms690762(v=VS.85).aspx">FAX_JOB_ENTRY</a> structures the function returns in the <i>JobEntry</i> parameter.
