...
For a detailed description of these values, see <a href="https://msdn.microsoft.com/library/ms691834(v=VS.85).aspx">Generic Fax Access Rights</a> and <a href="https://msdn.microsoft.com/library/ms692302(v=VS.85).aspx">Specific Fax Access Rights</a>.
...
The fax service is a secure service. Users must have certain access privileges to successfully call fax service functions. Call the <b>FaxAccessCheck</b> function to programmatically check a user's fax access permissions. For more information, see <a href="https://msdn.microsoft.com/library/ms692808(v=VS.85).aspx">Checking the Access Rights of Users</a> and <a href="https://msdn.microsoft.com/library/ms692351(v=VS.85).aspx">Fax Client User Access Rights</a>.
