...
Specifies an unsigned integer that identifies the application's base window message. The application can use this number to determine whether to process the message as a fax server event. For more information, see the <a href="https://msdn.microsoft.com/library/ms692820(v=VS.85).aspx">FAX_EVENT</a> topic. 
...
<td width="60%">
The application called the <a href="https://msdn.microsoft.com/library/ms691325(v=VS.85).aspx">FaxInitializeEventQueue</a> function more than once during a fax service session in Windows 2000. More than one call is supported in Windows XP and Windows Server 2003.
...
<a href="https://msdn.microsoft.com/library/ms692820(v=VS.85).aspx">FAX_EVENT</a>
