...
A fax client application passes the <b>FAX_JOB_PARAM</b> structure in a call to the <a href="https://msdn.microsoft.com/library/ms692343(v=VS.85).aspx">FaxSendDocument</a> function to inform the fax server how and when to send the fax transmission. For more information, see <a href="https://msdn.microsoft.com/library/ms691919(v=VS.85).aspx">Sending a Fax to One Recipient (Win32 Environment)</a>.
...
<a href="https://msdn.microsoft.com/library/ms735988(v=VS.85).aspx">lineMakeCall</a>
 
