...
description: Sets specified security information in the security descriptor of a specified tree of objects. (ANSI)
helpviewer_keywords: ["TREE_SEC_INFO_RESET", "TREE_SEC_INFO_RESET_KEEP_EXPLICIT", "TREE_SEC_INFO_SET", "TreeSetNamedSecurityInfoA", "aclapi/TreeSetNamedSecurityInfoA"]
...
f1_keywords:
 ...
 - aclapi/TreeSetNamedSecurityInfoA
dev_langs:
 - c++
topic_type:
 - APIRef
...
This version of this function is not supported. The wide character version of this function, [TreeSetNamedSecurityInfoW](/windows/desktop/api/aclapi/nf-aclapi-treesetnamedsecurityinfow), is supported.
