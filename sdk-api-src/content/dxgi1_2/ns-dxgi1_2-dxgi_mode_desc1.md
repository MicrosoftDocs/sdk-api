...
A <a href="https://msdn.microsoft.com/library/Bb173059(v=VS.85).aspx">DXGI_FORMAT</a>-typed value that describes the display format.


### -field ScanlineOrdering

A <a href="https://msdn.microsoft.com/library/Bb173067(v=VS.85).aspx">DXGI_MODE_SCANLINE_ORDER</a>-typed value that describes the scan-line drawing mode.


### -field Scaling

A <a href="https://msdn.microsoft.com/library/Bb173066(v=VS.85).aspx">DXGI_MODE_SCALING</a>-typed value that describes the scaling mode.
...
<b>DXGI_MODE_DESC1</b> is identical to <a href="https://msdn.microsoft.com/library/Bb173064(v=VS.85).aspx">DXGI_MODE_DESC</a> except that <b>DXGI_MODE_DESC1</b> includes the <b>Stereo</b> member.
