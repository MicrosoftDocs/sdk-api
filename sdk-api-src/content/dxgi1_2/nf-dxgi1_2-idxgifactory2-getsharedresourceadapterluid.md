...
ms.topic: method
f1_keywords: ["dxgi1_2/IDXGIFactory2.GetSharedResourceAdapterLuid"]
...
<li><a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-error">DXGI_ERROR_INVALID_CALL</a> if <i>hResource</i> is invalid.</li>
