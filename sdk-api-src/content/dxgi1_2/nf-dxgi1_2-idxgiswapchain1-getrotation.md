...
A pointer to a variable that receives a <a href="https://msdn.microsoft.com/library/Bb173065(v=VS.85).aspx">DXGI_MODE_ROTATION</a>-typed value that specifies the rotation of the back buffers for the swap chain.
