...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IDXGIOutput1</b> interface inherits from <a href="https://msdn.microsoft.com/library/Bb174546(v=VS.85).aspx">IDXGIOutput</a>. <b>IDXGIOutput1</b> also has these types of members:
<ul>
...
To determine  the outputs that are available from the adapter, use <a href="https://msdn.microsoft.com/library/Bb174525(v=VS.85).aspx">IDXGIAdapter::EnumOutputs</a>. To determine the specific output that the swap chain will update, use <a href="https://msdn.microsoft.com/library/Bb174571(v=VS.85).aspx">IDXGISwapChain::GetContainingOutput</a>. You can then call <a href="https://msdn.microsoft.com/54d5ff80-18db-43f2-b636-f93ac053146d">QueryInterface</a> from any  <a href="https://msdn.microsoft.com/library/Bb174546(v=VS.85).aspx">IDXGIOutput</a> object to obtain an <b>IDXGIOutput1</b> object.
