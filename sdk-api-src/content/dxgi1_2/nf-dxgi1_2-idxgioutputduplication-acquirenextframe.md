...
A pointer to a variable that receives the <a href="https://msdn.microsoft.com/library/Bb174560(v=VS.85).aspx">IDXGIResource</a> interface of the surface that contains the desktop bitmap.
