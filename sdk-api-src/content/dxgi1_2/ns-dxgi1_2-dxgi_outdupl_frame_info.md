...
The time stamp of the last update of the desktop image.  The operating system calls the <a href="https://msdn.microsoft.com/library/ms644904(v=VS.85).aspx">QueryPerformanceCounter</a> 
...
The time stamp of the last update to the mouse.  The operating system calls the <a href="https://msdn.microsoft.com/library/ms644904(v=VS.85).aspx">QueryPerformanceCounter</a> 
