...
title: IStorageFolderHandleAccess::Create method
...
ms.date: 4/24/2018
ms.keywords: Create method [Windows Runtime], Create method [Windows Runtime], IStorageFolderHandleAccess interface, Create,IStorageFolderHandleAccess.Create, IStorageFolderHandleAccess, IStorageFolderHandleAccess interface [Windows Runtime], Create method, IStorageFolderHandleAccess::Create, windowsstoragecom/IStorageFolderHandleAccess::Create, winrt.istoragefolderhandleaccess_create
...
# IStorageFolderHandleAccess::Create method
