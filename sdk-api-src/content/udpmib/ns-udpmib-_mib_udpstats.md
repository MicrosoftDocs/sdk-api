...
The 
			<a href="https://msdn.microsoft.com/library/Aa366029(v=VS.85).aspx">GetUdpStatistics</a> function returns a pointer to a <b>MIB_UDPSTATS</b> structure. 
...
<a href="https://msdn.microsoft.com/library/Aa366029(v=VS.85).aspx">GetUdpStatistics</a>
