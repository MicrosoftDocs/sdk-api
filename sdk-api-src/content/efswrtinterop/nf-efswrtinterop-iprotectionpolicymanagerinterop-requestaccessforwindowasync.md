...
title: IProtectionPolicyManagerInterop::RequestAccessForWindowAsync method
...
ms.date: 2/15/2018
ms.keywords: EDP.iprotectionpolicymanager_requestaccessforwindowasync, IProtectionPolicyManager interface, RequestAccessForWindowAsync method, IProtectionPolicyManager::RequestAccessForWindowAsync, IProtectionPolicyManagerInterop, IProtectionPolicyManagerInterop::RequestAccessForWindowAsync, RequestAccessForWindowAsync method, RequestAccessForWindowAsync method, IProtectionPolicyManager interface, RequestAccessForWindowAsync,IProtectionPolicyManagerInterop.RequestAccessForWindowAsync, efswrtinterop/IProtectionPolicyManager::RequestAccessForWindowAsync
...
-	efswrt.dll
api_name:
-	IProtectionPolicyManager.RequestAccessForWindowAsync
product: Windows
targetos: Windows
req.lib: 
req.dll: Efswrt.dll
...
# IProtectionPolicyManagerInterop::RequestAccessForWindowAsync method
