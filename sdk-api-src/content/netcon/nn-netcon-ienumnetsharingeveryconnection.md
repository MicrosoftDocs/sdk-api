...
ms.topic: interface
f1_keywords: ["netcon/IEnumNetSharingEveryConnection"]
req.header: netcon.h
req.include-header: 
...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IEnumNetSharingEveryConnection</b> interface inherits from the <a href="https://docs.microsoft.com/windows/desktop/api/unknwn/nn-unknwn-iunknown">IUnknown</a> interface. <b>IEnumNetSharingEveryConnection</b> also has these types of members:
<ul>
...
<a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/netcon/nf-netcon-ienumnetsharingeveryconnection-clone">Clone</a>
</td>
...
<tr data="declared;">
<td align="left" width="37%">
<a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/netcon/nf-netcon-ienumnetsharingeveryconnection-next">Next</a>
</td>
<td align="left" width="63%">
...
<tr data="declared;">
<td align="left" width="37%">
<a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/netcon/nf-netcon-ienumnetsharingeveryconnection-reset">Reset</a>
</td>
<td align="left" width="63%">
...
<tr data="declared;">
<td align="left" width="37%">
<a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/netcon/nf-netcon-ienumnetsharingeveryconnection-skip">Skip</a>
</td>
<td align="left" width="63%">
