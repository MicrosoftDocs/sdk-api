...
An application can use the <a href="https://msdn.microsoft.com/library/ms648749(v=VS.85).aspx">DdeDisconnect</a> function to terminate individual conversations in the list. 
