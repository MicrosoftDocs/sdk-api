...
Type: <b><a href="https://msdn.microsoft.com/library/Bb205314(v=VS.85).aspx">D3D10_INFO_QUEUE_FILTER_DESC</a></b>

A <a href="https://msdn.microsoft.com/library/Bb205314(v=VS.85).aspx">D3D10_INFO_QUEUE_FILTER_DESC</a> structure describing the types of messages the info queue should allow.
...
A <a href="https://msdn.microsoft.com/library/Bb205314(v=VS.85).aspx">D3D10_INFO_QUEUE_FILTER_DESC</a> structure describing the types of messages the info queue should reject.
...
For use with an <a href="https://msdn.microsoft.com/library/Bb173779(v=VS.85).aspx">ID3D10InfoQueue Interface</a>.
