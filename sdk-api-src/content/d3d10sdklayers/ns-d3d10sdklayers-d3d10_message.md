...
The category of the message. See <a href="https://msdn.microsoft.com/library/Bb205323(v=VS.85).aspx">D3D10_MESSAGE_CATEGORY</a>.
...
The severity of the message. See <a href="https://msdn.microsoft.com/library/Bb205325(v=VS.85).aspx">D3D10_MESSAGE_SEVERITY</a>.
...
The ID of the message. See <a href="https://msdn.microsoft.com/library/Bb205324(v=VS.85).aspx">D3D10_MESSAGE_ID</a>.
...
This structure is returned from <a href="https://msdn.microsoft.com/library/Bb173790(v=VS.85).aspx">ID3D10InfoQueue::GetMessage</a> as part of the Information Queue feature (see <a href="https://msdn.microsoft.com/library/Bb173779(v=VS.85).aspx">ID3D10InfoQueue Interface</a>).
