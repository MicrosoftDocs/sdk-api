...
The <b>MsiJoinTransaction</b> function requests that the Windows Installer make the current process the owner of the <a href="https://www.bing.com/search?q=transaction">transaction</a> installing the multiple-package installation. 
