...
Values that indicate how the pipeline interprets vertex data that is bound to the <a href="https://msdn.microsoft.com/library/Bb205116(v=VS.85).aspx">input-assembler stage</a>. These <a href="https://msdn.microsoft.com/library/Bb205124(v=VS.85).aspx">primitive topology values</a> determine how the vertex data is rendered on screen.
