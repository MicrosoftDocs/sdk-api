...
description: These flags identify shader parameters that use system-value semantics.
old-location: direct3d10\d3d10_name.htm
old-project: direct3d10
ms.assetid: VS|directx_sdk|~\d3d10_name.htm
ms.author: windowssdkdev
ms.date: 07/23/2018
ms.keywords: D3D10_NAME, D3D10_NAME enumeration [Direct3D 10], D3D10_NAME_CLIP_DISTANCE, D3D10_NAME_COVERAGE, D3D10_NAME_CULL_DISTANCE, D3D10_NAME_DEPTH, D3D10_NAME_INSTANCE_ID, D3D10_NAME_IS_FRONT_FACE, D3D10_NAME_POSITION, D3D10_NAME_PRIMITIVE_ID, D3D10_NAME_RENDER_TARGET_ARRAY_INDEX, D3D10_NAME_SAMPLE_INDEX, D3D10_NAME_TARGET, D3D10_NAME_UNDEFINED, D3D10_NAME_VERTEX_ID, D3D10_NAME_VIEWPORT_ARRAY_INDEX, D3D11_NAME_DEPTH_GREATER_EQUAL, D3D11_NAME_DEPTH_LESS_EQUAL, D3D11_NAME_FINAL_LINE_DENSITY_TESSFACTOR, D3D11_NAME_FINAL_LINE_DETAIL_TESSFACTOR, D3D11_NAME_FINAL_QUAD_EDGE_TESSFACTOR, D3D11_NAME_FINAL_QUAD_INSIDE_TESSFACTOR, D3D11_NAME_FINAL_TRI_EDGE_TESSFACTOR, D3D11_NAME_FINAL_TRI_INSIDE_TESSFACTOR, D3D_NAME, d3d10shader/D3D10_NAME, d3d10shader/D3D10_NAME_CLIP_DISTANCE, d3d10shader/D3D10_NAME_COVERAGE, d3d10shader/D3D10_NAME_CULL_DISTANCE, d3d10shader/D3D10_NAME_DEPTH, d3d10shader/D3D10_NAME_INSTANCE_ID, d3d10shader/D3D10_NAME_IS_FRONT_FACE, d3d10shader/D3D10_NAME_POSITION, d3d10shader/D3D10_NAME_PRIMITIVE_ID, d3d10shader/D3D10_NAME_RENDER_TARGET_ARRAY_INDEX, d3d10shader/D3D10_NAME_SAMPLE_INDEX, d3d10shader/D3D10_NAME_TARGET, d3d10shader/D3D10_NAME_UNDEFINED, d3d10shader/D3D10_NAME_VERTEX_ID, d3d10shader/D3D10_NAME_VIEWPORT_ARRAY_INDEX, d3d10shader/D3D11_NAME_DEPTH_GREATER_EQUAL, d3d10shader/D3D11_NAME_DEPTH_LESS_EQUAL, d3d10shader/D3D11_NAME_FINAL_LINE_DENSITY_TESSFACTOR, d3d10shader/D3D11_NAME_FINAL_LINE_DETAIL_TESSFACTOR, d3d10shader/D3D11_NAME_FINAL_QUAD_EDGE_TESSFACTOR, d3d10shader/D3D11_NAME_FINAL_QUAD_INSIDE_TESSFACTOR, d3d10shader/D3D11_NAME_FINAL_TRI_EDGE_TESSFACTOR, d3d10shader/D3D11_NAME_FINAL_TRI_INSIDE_TESSFACTOR, d3dcommon/D3D10_NAME, d3dcommon/D3D10_NAME_CLIP_DISTANCE, d3dcommon/D3D10_NAME_COVERAGE, d3dcommon/D3D10_NAME_CULL_DISTANCE, d3dcommon/D3D10_NAME_DEPTH, d3dcommon/D3D10_NAME_INSTANCE_ID, d3dcommon/D3D10_NAME_IS_FRONT_FACE, d3dcommon/D3D10_NAME_POSITION, d3dcommon/D3D10_NAME_PRIMITIVE_ID, d3dcommon/D3D10_NAME_RENDER_TARGET_ARRAY_INDEX, d3dcommon/D3D10_NAME_SAMPLE_INDEX, d3dcommon/D3D10_NAME_TARGET, d3dcommon/D3D10_NAME_UNDEFINED, d3dcommon/D3D10_NAME_VERTEX_ID, d3dcommon/D3D10_NAME_VIEWPORT_ARRAY_INDEX, d3dcommon/D3D11_NAME_DEPTH_GREATER_EQUAL, d3dcommon/D3D11_NAME_DEPTH_LESS_EQUAL, d3dcommon/D3D11_NAME_FINAL_LINE_DENSITY_TESSFACTOR, d3dcommon/D3D11_NAME_FINAL_LINE_DETAIL_TESSFACTOR, d3dcommon/D3D11_NAME_FINAL_QUAD_EDGE_TESSFACTOR, d3dcommon/D3D11_NAME_FINAL_QUAD_INSIDE_TESSFACTOR, d3dcommon/D3D11_NAME_FINAL_TRI_EDGE_TESSFACTOR, d3dcommon/D3D11_NAME_FINAL_TRI_INSIDE_TESSFACTOR, direct3d10.d3d10_name, e1c3a7b1-d34b-e2a6-a5ba-c5501d81853c
ms.prod: windows
...
This parameter contains the tessellation factor that corresponds to the number of lines that are broken into within the patch. This flag is used to tessellate an isolines patch.
...
The   <b>D3D10_NAME</b> enumeration is type defined in the  D3D10Shader.h header file as a <a href="https://msdn.microsoft.com/16675331-36cf-4086-a753-6d80ee934ace">D3D_NAME</a> enumeration, which is fully defined in the  D3DCommon.h header file.
...
<td>
<pre>
typedef D3D_NAME D3D10_NAME;</pre>
</td>
</tr>
</table></span></div>
These flags identify shader parameters that have <a href="https://msdn.microsoft.com/library/Bb509647(v=VS.85).aspx">predefined system-value</a> semantics. These flags are used in a shader-signature description (see <a href="https://msdn.microsoft.com/4c789141-5381-4fe9-b54f-c1a2761a5a20">D3D10_SIGNATURE_PARAMETER_DESC</a>).
