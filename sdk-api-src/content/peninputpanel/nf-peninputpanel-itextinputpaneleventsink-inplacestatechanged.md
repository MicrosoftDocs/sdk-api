...
The new state that the Input Panel has changed to, as defined by the <a href="https://msdn.microsoft.com/en-us/library/ms701175(v=VS.85).aspx">InPlaceState Enumeration</a>.
