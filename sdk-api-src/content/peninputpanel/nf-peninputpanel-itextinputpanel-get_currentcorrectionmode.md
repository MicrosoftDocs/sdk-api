...
<div> </div>
When the Tablet PC Input Panel or the correction comb is not visible, the current mode is <a href="https://msdn.microsoft.com/en-us/library/ms695063(v=VS.85).aspx">CorrectionMode_NotVisible</a>.
