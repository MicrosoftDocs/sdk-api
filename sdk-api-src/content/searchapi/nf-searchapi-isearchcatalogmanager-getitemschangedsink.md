...
Type: <b><a href="https://msdn.microsoft.com/library/Bb231458(v=VS.85).aspx">ISearchNotifyInlineSite</a>*</b>

A pointer to your <a href="https://msdn.microsoft.com/library/Bb231458(v=VS.85).aspx">ISearchNotifyInlineSite</a> interface.
...
The UUID of the <a href="https://msdn.microsoft.com/library/Bb231461(v=VS.85).aspx">ISearchItemsChangedSink</a> interface.
...
Receives a pointer to the <a href="https://msdn.microsoft.com/library/Bb231461(v=VS.85).aspx">ISearchItemsChangedSink</a> interface.
