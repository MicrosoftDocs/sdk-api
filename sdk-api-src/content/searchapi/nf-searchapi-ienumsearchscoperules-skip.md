...
Moves the internal counter a specified number of elements forward so that a subsequent call to <a href="https://msdn.microsoft.com/library/Bb266500(v=VS.85).aspx">IEnumSearchScopeRules::Next</a> starts from that number.
