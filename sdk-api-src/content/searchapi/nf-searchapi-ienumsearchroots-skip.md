...
<b>IEnumSearchRoots::Skip</b> moves the internal counter forward a specified number of elements so that a subsequent call to <a href="https://msdn.microsoft.com/library/Bb266505(v=VS.85).aspx">IEnumSearchRoots::Next</a> starts from that point. 
