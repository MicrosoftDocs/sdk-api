...
Used by <a href="https://msdn.microsoft.com/en-us/library/Cc288278(v=VS.85).aspx">PrioritizeMatchingURLs</a> to specify how to process items the indexer has previously failed to index.
