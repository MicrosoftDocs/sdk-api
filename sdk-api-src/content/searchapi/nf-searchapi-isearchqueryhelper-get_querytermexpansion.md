...
Receives a pointer to a value from the <a href="https://msdn.microsoft.com/library/Aa965705(v=VS.85).aspx">SEARCH_TERM_EXPANSION</a> enumeration that specifies the query term expansion.
...
<a href="https://msdn.microsoft.com/library/Bb231321(v=VS.85).aspx">ISearchQueryHelper::put_QueryTermExpansion</a>
