...
Indicates wildcard options on search terms. Used by <a href="https://msdn.microsoft.com/library/Bb231311(v=VS.85).aspx">ISearchQueryHelper::get_QueryTermExpansion</a> and <a href="https://msdn.microsoft.com/library/Bb231321(v=VS.85).aspx">ISearchQueryHelper::put_QueryTermExpansion</a> methods.
...
While the <b>SEARCH_TERM_EXPANSION</b> enumerated type lets you specify stem expansion, Windows Search does not currently support its use with the <a href="https://msdn.microsoft.com/library/Bb231313(v=VS.85).aspx">ISearchQueryHelper</a> interface.
