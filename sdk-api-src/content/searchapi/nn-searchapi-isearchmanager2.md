...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">ISearchManager2</b> interface inherits from <a href="https://msdn.microsoft.com/library/Bb231485(v=VS.85).aspx">ISearchManager</a>. <b>ISearchManager2</b> also has these types of members:
<ul>
...
<a href="https://msdn.microsoft.com/library/Bb231485(v=VS.85).aspx">ISearchManager</a>
 
