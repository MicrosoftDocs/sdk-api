...
description: Enables a WDS client to configure which WDS transport components have event logging. (Put)
...
f1_keywords:
 ...
 - wdstptmgmt/IWdsTransportDiagnosticsPolicy::put_Components
dev_langs:
 - c++
topic_type:
 - APIRef
