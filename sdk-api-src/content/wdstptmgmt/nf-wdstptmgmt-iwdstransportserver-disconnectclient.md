...
A value of the <a href="https://msdn.microsoft.com/en-us/library/Bb736534(v=VS.85).aspx">WDSTRANSPORT_DISCONNECT_TYPE</a> enumeration that specifies what action the WDS client should take upon disconnection from the WDS server.
