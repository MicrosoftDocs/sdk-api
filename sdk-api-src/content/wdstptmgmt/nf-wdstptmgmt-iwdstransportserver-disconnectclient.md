...
ms.topic: method
f1_keywords: ["wdstptmgmt/IWdsTransportServer.DisconnectClient"]
...
A value of the <a href="https://docs.microsoft.com/windows/desktop/api/wdstptmgmt/ne-wdstptmgmt-__midl___midl_itf_wdstptmgmt_0000_0000_0004">WDSTRANSPORT_DISCONNECT_TYPE</a> enumeration that specifies what action the WDS client should take upon disconnection from the WDS server.
