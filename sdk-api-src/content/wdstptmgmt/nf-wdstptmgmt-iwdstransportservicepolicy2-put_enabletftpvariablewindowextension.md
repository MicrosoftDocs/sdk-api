...
description: Receives a WDSTRANSPORT_TFTP_CAPABILITY value that specifies whether variable-window extension is enabled on the TFTP server. The value enables a WDS client computer to configure the WDS TFTP server to use variable-window extensions. (Put)
...
f1_keywords:
 ...
 - wdstptmgmt/IWdsTransportServicePolicy2::put_EnableTftpVariableWindowExtension
dev_langs:
 - c++
topic_type:
 - APIRef
