...
description: Enables a WDS client computer to configure the end of a multicast IP address range for a specified type of IP address. (Get)
...
f1_keywords:
 ...
 - wdstptmgmt/IWdsTransportServicePolicy::get_EndIpAddress
dev_langs:
 - c++
topic_type:
 - APIRef
