...
A pointer to an 
<a href="https://msdn.microsoft.com/library/windows/hardware/ff557080">LUID</a> that contains the session ID of the logon session to which credentials are to be added.
