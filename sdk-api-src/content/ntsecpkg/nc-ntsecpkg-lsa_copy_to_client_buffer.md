...
ms.topic: callback
f1_keywords: ["ntsecpkg/CopyToClientBuffer"]
...
<a href="https://docs.microsoft.com/windows/desktop/SecAuthN/plsa-client-request">LSA_CLIENT_REQUEST</a> data type representing a client request.
