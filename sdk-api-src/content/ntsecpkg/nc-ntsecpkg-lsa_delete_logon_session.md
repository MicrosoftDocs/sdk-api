...
Pointer to an 
<a href="https://docs.microsoft.com/windows/desktop/api/winnt/ns-winnt-_luid">LUID</a> structure containing the session ID of logon session to delete.
