...
ms.topic: callback
f1_keywords: ["ntsecpkg/SpApplyControlToken"]
...
Pointer to a 
<a href="https://docs.microsoft.com/windows/desktop/api/sspi/ns-sspi-_secbufferdesc">SecBufferDesc</a> structure containing the token to apply to the context.
