...
Retrieves the <a href="https://www.bing.com/search?q=idle+wait+time">idle wait time</a> for the work item. 
...
The idle time returned here is used in conjunction with <a href="https://www.bing.com/search?q=idle+triggers">idle triggers</a> and <a href="https://www.bing.com/search?q=idle+conditions">idle conditions</a>. Idle triggers are event-based triggers that are not associated with a scheduled time. Idle conditions are associated with the scheduled start time for the task.
