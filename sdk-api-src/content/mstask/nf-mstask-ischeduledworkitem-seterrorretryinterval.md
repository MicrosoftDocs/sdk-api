...
Sets the time interval, in minutes, between Task Scheduler's attempts to run a <a href="/windows/desktop/api/mstask/ns-mstask-_monthlydow">work item</a> after an error occurs. This method is not implemented.
