...
A pointer to an array of pointers (<b>LPWSTR</b>) to <b>null</b>-terminated character strings containing the file names of the tasks returned from the enumeration sequence. These file names are taken from the <a href="https://www.bing.com/search?q=Scheduled+Tasks+folder">Scheduled Tasks folder</a> and have the ".job" extension.
