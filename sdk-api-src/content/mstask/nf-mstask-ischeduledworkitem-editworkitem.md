...
Displays the Task, Schedule, and settings property pages for the <a href="/windows/desktop/api/mstask/ns-mstask-_monthlydow">work item</a>, allowing a user set the properties on those pages.
