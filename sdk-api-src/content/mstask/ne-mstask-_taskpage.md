...
Each property page can be used to define the properties of a <a href="https://www.bing.com/search?q=task+object">task object</a>.
...
<li><b>Start in</b>: This field specifies the <a href="/windows/desktop/api/mstask/ns-mstask-_monthlydow">working directory</a> for the task.</li>
<li>This property can also be set programmatically by calling 
...
Specifies the Schedule page for the task. This page is used to manage the <a href="https://www.bing.com/search?q=triggers">triggers</a> for the task. The user can create triggers, edit triggers, and delete triggers from this page. 
...
Specifies the Settings page for the task. The user can specify what happens when the task is completed, <a href="https://www.bing.com/search?q=idle+conditions">idle conditions</a>, and power management properties for the task. 
