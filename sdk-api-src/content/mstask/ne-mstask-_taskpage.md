...
Each property page can be used to define the properties of a <a href="https://msdn.microsoft.com/library/Aa381052(v=VS.85).aspx">task object</a>.
...
<li><b>Start in</b>: This field specifies the <a href="https://msdn.microsoft.com/library/Aa381060(v=VS.85).aspx">working directory</a> for the task.</li>
<li>This property can also be set programmatically by calling 
...
Specifies the Schedule page for the task. This page is used to manage the <a href="https://msdn.microsoft.com/library/Aa381052(v=VS.85).aspx">triggers</a> for the task. The user can create triggers, edit triggers, and delete triggers from this page. 
...
Specifies the Settings page for the task. The user can specify what happens when the task is completed, <a href="https://msdn.microsoft.com/library/Aa381016(v=VS.85).aspx">idle conditions</a>, and power management properties for the task. 
