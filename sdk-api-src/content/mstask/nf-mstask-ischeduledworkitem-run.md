...
title: IScheduledWorkItem::Run method
...
ms.date: 2/15/2018
ms.keywords: IScheduledWorkItem, IScheduledWorkItem interface [Task Scheduler], Run method, IScheduledWorkItem::Run, Run method [Task Scheduler], Run method [Task Scheduler], IScheduledWorkItem interface, Run,IScheduledWorkItem.Run, _msb_ischeduledworkitem_run, mstask/IScheduledWorkItem::Run, taskschd.ischeduledworkitem_run
...
Sends a request to the Task Scheduler service to run the <a href="w.htm">work item</a>.
