...
Variable of type <b>ULONG</b> that specifes the number of <a href="https://msdn.microsoft.com/library/ms629454(v=VS.85).aspx">SSortOrder</a> structures that are included in the <b>aSort</b> member. 
...
Type: <b><a href="https://msdn.microsoft.com/library/ms629454(v=VS.85).aspx">SSortOrder</a>[MAPI_DIM]</b>

Array of variables of type <a href="https://msdn.microsoft.com/library/ms629454(v=VS.85).aspx">SSortOrder</a> that specifies the structures that define a sort order.
