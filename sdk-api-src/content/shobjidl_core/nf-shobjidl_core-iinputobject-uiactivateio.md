...
Type: <b><a href="https://msdn.microsoft.com/library/ms644958(v=VS.85).aspx">MSG</a>*</b>
          ...
          A pointer to an <a href="https://msdn.microsoft.com/library/ms644958(v=VS.85).aspx">MSG</a> structure that contains the message that caused the activation change. This value may be <b>NULL</b>.
