...
ms.topic: method
f1_keywords: ["shobjidl_core/IShellItem.GetParent"]
...
Gets the parent of an <a href="https://docs.microsoft.com/windows/desktop/api/shobjidl_core/nn-shobjidl_core-ishellitem">IShellItem</a> object.
