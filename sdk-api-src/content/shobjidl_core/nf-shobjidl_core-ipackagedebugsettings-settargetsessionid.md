...
ms.date: 09/26/2018
ms.keywords: IPackageDebugSettings interface [Windows Runtime],SetTargetSessionId method, IPackageDebugSettings.SetTargetSessionId, IPackageDebugSettings::SetTargetSessionId, SetTargetSessionId, SetTargetSessionId method [Windows Runtime], SetTargetSessionId method [Windows Runtime],IPackageDebugSettings interface, shobjidl_core/IPackageDebugSettings::SetTargetSessionId, winrt.ipackagedebugsettings_settargetsessionid
