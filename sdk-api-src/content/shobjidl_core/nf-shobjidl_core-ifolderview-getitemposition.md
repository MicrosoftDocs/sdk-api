...
ms.topic: method
f1_keywords: ["shobjidl_core/IFolderView.GetItemPosition"]
...
A pointer to an <a href="https://docs.microsoft.com/windows/desktop/api/shtypes/ns-shtypes-_itemidlist">ITEMIDLIST</a> interface.
