...
Exposes methods that retrieve and set the state of items in a tree-view control that have the <a href="https://msdn.microsoft.com/library/Bb760013(v=VS.85).aspx">Tree-View Control Window Styles</a> flag set.
