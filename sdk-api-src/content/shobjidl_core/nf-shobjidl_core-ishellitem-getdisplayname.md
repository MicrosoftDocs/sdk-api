...
ms.topic: method
f1_keywords: ["shobjidl_core/IShellItem.GetDisplayName"]
...
Gets the display name of the <a href="https://docs.microsoft.com/windows/desktop/api/shobjidl_core/nn-shobjidl_core-ishellitem">IShellItem</a> object.
...
One of the <a href="https://docs.microsoft.com/windows/desktop/api/shobjidl_core/ne-shobjidl_core-_sigdn">SIGDN</a> values that indicates how the name should look.
