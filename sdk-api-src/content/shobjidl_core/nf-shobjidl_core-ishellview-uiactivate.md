...
Before remerging menu items, the Shell view typically hooks the <a href="https://msdn.microsoft.com/library/ms646283(v=VS.85).aspx">WM_SETFOCUS</a> message and calls the <a href="https://msdn.microsoft.com/bd320262-f383-453b-9028-4e93f0b3761a">OnViewWindowActive</a> method. The Shell view should not hook the <a href="https://msdn.microsoft.com/library/Bb775540(v=VS.85).aspx">NM_KILLFOCUS</a> message to remerge menu items.
