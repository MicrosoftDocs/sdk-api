...
It is the responsibility of the calling application to free <i>hwndTab</i> through <a href="https://msdn.microsoft.com/library/ms632682(v=VS.85).aspx">DestroyWindow</a>. <b>UnregisterTab</b> must be called before the handle is freed.
