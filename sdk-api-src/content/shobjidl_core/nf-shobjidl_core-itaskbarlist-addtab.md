...
Any type of window can be added to the taskbar, but it is recommended that the window at least have the <a href="https://msdn.microsoft.com/library/ms632600(v=VS.85).aspx">WS_CAPTION</a> style.
