...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IExplorerCommandState</b> interface inherits from the <a href="/windows/desktop/api/unknwn/nn-unknwn-iunknown">IUnknown</a> interface. <b>IExplorerCommandState</b> also has these types of members:
<ul>
...
<a href="/windows/desktop/api/shobjidl_core/nf-shobjidl_core-iexplorercommandstate-getstate">GetState</a>
</td>
