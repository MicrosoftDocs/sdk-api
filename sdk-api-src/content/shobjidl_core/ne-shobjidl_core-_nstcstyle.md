...
Maps to the <a href="https://msdn.microsoft.com/library/Bb760013(v=VS.85).aspx">TVS_HASBUTTONS</a> tree view control style.
...
Maps to the <a href="https://msdn.microsoft.com/library/Bb760013(v=VS.85).aspx">TVS_HASLINES</a> tree view control style.
...
Maps to the <a href="https://msdn.microsoft.com/library/Bb760013(v=VS.85).aspx">TVS_SINGLEEXPAND</a> tree view control style.
...
Maps to the <a href="https://msdn.microsoft.com/library/Bb760013(v=VS.85).aspx">TVS_FULLROWSELECT</a> tree view control style.
...
This is the opposite of the <a href="https://msdn.microsoft.com/library/Bb759981(v=VS.85).aspx">TVS_EX_NOSINGLECOLLAPSE</a> tree view control style.
...
Maps to the <a href="https://msdn.microsoft.com/library/ms632600(v=VS.85).aspx">WS_HSCROLL</a> Windows style.
...
Maps to the <a href="https://msdn.microsoft.com/library/Bb760013(v=VS.85).aspx">TVS_LINESATROOT</a> tree view control style.
...
Maps to the <a href="https://msdn.microsoft.com/library/Bb760013(v=VS.85).aspx">TVS_SHOWSELALWAYS</a> tree view control style.
...
This is the opposite of the <a href="https://msdn.microsoft.com/library/Bb760013(v=VS.85).aspx">TVS_INFOTIP</a> tree view control style.
...
This is the opposite of the <a href="https://msdn.microsoft.com/library/Bb760013(v=VS.85).aspx">TVS_NONEVENHEIGHT</a> tree view control style.
...
Maps to the <a href="https://msdn.microsoft.com/library/Bb760013(v=VS.85).aspx">TVS_DISABLEDRAGDROP</a> tree view control style.
...
Maps to the <a href="https://msdn.microsoft.com/library/Bb759981(v=VS.85).aspx">TVS_EX_RICHTOOLTIP</a> tree view control style.

NSTCS_RICHTOOLTIP has no effect unless it is combined with NSTCS_NOINFOTIP and/or NSTCS_FAVORITESMODE. If NSTCS_NOINFOTIP is not specified, the tree view displays an infotip instead of a tooltip. If NSTCS_FAVORITESMODE is not specified, the namespace tree control always sets the <a href="https://msdn.microsoft.com/library/Bb759981(v=VS.85).aspx">TVS_EX_RICHTOOLTIP</a> style.


### -field NSTCS_BORDER

Draw a thin border around the control. Corresponds to <a href="https://msdn.microsoft.com/library/ms632600(v=VS.85).aspx">WS_BORDER</a>.
...
This is the opposite of the <a href="https://msdn.microsoft.com/library/Bb760013(v=VS.85).aspx">TVS_EDITLABELS</a> tree view control style.
...
Maps to the <a href="https://msdn.microsoft.com/library/Bb759981(v=VS.85).aspx">TVS_EX_AUTOHSCROLL</a> tree view control style.
...
Maps to the <a href="https://msdn.microsoft.com/library/Bb759981(v=VS.85).aspx">TVS_EX_FADEINOUTEXPANDOS</a> tree view control style.
...
Maps to the <a href="https://msdn.microsoft.com/library/Bb760013(v=VS.85).aspx">TVS_CHECKBOXES</a> tree view control style.
...
Maps to the <a href="https://msdn.microsoft.com/library/Bb759981(v=VS.85).aspx">TVS_EX_PARTIALCHECKBOXES</a> tree view control style.
...
Maps to the <a href="https://msdn.microsoft.com/library/Bb759981(v=VS.85).aspx">TVS_EX_EXCLUSIONCHECKBOXES</a> tree view control style.
...
Maps to the <a href="https://msdn.microsoft.com/library/Bb759981(v=VS.85).aspx">TVS_EX_DIMMEDCHECKBOXES</a> tree view control style.
...
Maps to the <a href="https://msdn.microsoft.com/library/Bb759981(v=VS.85).aspx">TVS_EX_NOINDENTSTATE</a> tree view control style.
