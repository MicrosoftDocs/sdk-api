...
A pointer to a <a href="https://msdn.microsoft.com/library/windows/hardware/dn915850">SIZE</a> structure with the desired width and height of the image. Must not be <b>NULL</b>.
