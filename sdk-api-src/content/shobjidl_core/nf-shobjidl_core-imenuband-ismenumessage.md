...
A pointer to an <a href="https://msdn.microsoft.com/library/ms644958(v=VS.85).aspx">MSG</a> structure.
...
If this method returns <b>S_OK</b>, the message loop should not call <a href="https://msdn.microsoft.com/library/ms644955(v=VS.85).aspx">TranslateMessage</a> or <a href="https://msdn.microsoft.com/library/ms644934(v=VS.85).aspx">DispatchMessage</a>.
