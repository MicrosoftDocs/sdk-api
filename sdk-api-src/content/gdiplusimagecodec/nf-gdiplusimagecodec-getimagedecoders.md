...
The <b>GetImageDecoders</b> function gets an array of <a href="https://msdn.microsoft.com/library/ms534466(v=VS.85).aspx">ImageCodecInfo</a> objects that contain information about the available image decoders.
...
Integer that specifies the number of available image decoders. Call <a href="https://msdn.microsoft.com/library/ms534079(v=VS.85).aspx">GetImageDecodersSize</a> to determine this number. 
...
Integer that specifies the size, in bytes, of the array of 
					<a href="https://msdn.microsoft.com/library/ms534466(v=VS.85).aspx">ImageCodecInfo</a> objects. Call <a href="https://msdn.microsoft.com/library/ms534079(v=VS.85).aspx">GetImageDecodersSize</a> to determine this number. 
...
Pointer to a buffer that receives the array of 
					<a href="https://msdn.microsoft.com/library/ms534466(v=VS.85).aspx">ImageCodecInfo</a> objects. You must allocate memory for this buffer. Call <a href="https://msdn.microsoft.com/library/ms534079(v=VS.85).aspx">GetImageDecodersSize</a> to determine the size of the required buffer. 
