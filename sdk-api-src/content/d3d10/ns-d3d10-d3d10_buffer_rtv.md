...
Specifies the elements from a <a href="https://msdn.microsoft.com/library/Bb205133(v=VS.85).aspx">buffer</a> resource to use in a render-target view.
...
A render-target view is a member of a render-target-view description (see <a href="https://msdn.microsoft.com/library/Bb172410(v=VS.85).aspx">D3D10_RENDER_TARGET_VIEW_DESC</a>). Create a render-target view by calling <a href="https://msdn.microsoft.com/library/Bb173556(v=VS.85).aspx">ID3D10Device::CreateRenderTargetView</a>.
