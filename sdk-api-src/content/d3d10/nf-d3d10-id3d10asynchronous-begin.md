...
Calling Begin starts the asynchronous collection of GPU data. Calling <a href="https://msdn.microsoft.com/library/Bb173502(v=VS.85).aspx">ID3D10Asynchronous::End</a> causes data collection to stop.  
  See <a href="https://msdn.microsoft.com/library/Bb173500(v=VS.85).aspx">ID3D10Asynchronous Interface</a> for additional information.
