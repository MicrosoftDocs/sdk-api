...
Describes a <a href="https://msdn.microsoft.com/library/Bb205133(v=VS.85).aspx">2D texture</a>.
...
Flags (see <a href="https://msdn.microsoft.com/library/Bb172412(v=VS.85).aspx">D3D10_RESOURCE_MISC_FLAG</a>) that identify other, less common resource options. Use 0 if none of these flags apply. These flags can be combined with a logical OR. For a texture cube-map, set the <a href="https://msdn.microsoft.com/library/Bb172412(v=VS.85).aspx">D3D10_RESOURCE_MISC_TEXTURECUBE</a> flag. Cube-map arrays (that is, <b>ArraySize</b> &gt; 6) require feature level <a href="https://msdn.microsoft.com/afbc1a02-1730-4502-af15-b668412d664c">D3D_FEATURE_LEVEL_10_1</a>.
...
This structure is used in a call to <a href="https://msdn.microsoft.com/library/Bb173560(v=VS.85).aspx">ID3D10Device::CreateTexture2D</a>. A helpful derived structure CD3D10_TEXTURE2D_DESC is declared in D3D10.h, to help create a texture description.

The device places some size restrictions (must be multiples of a minimum size) for a subsampled, <a href="https://msdn.microsoft.com/library/Bb694531(v=VS.85).aspx">block compressed</a>, or bit-format resource.
