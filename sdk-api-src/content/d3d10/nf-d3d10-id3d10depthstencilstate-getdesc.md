...
ms.topic: method
f1_keywords: ["d3d10/ID3D10DepthStencilState.GetDesc"]
req.header: d3d10.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/d3d10/nn-d3d10-id3d10depthstencilstate">ID3D10DepthStencilState Interface</a>
 
