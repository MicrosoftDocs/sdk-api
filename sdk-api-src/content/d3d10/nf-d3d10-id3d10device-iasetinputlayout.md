...
Input-layout objects describe how vertex buffer data is streamed into the IA pipeline stage. To create an input-layout object, call <a href="https://msdn.microsoft.com/library/Bb173550(v=VS.85).aspx">ID3D10Device::CreateInputLayout</a>.
