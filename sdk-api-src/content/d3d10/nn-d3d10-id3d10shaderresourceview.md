...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">ID3D10ShaderResourceView</b> interface inherits from <a href="https://msdn.microsoft.com/library/Bb173876(v=VS.85).aspx">ID3D10View</a>. <b>ID3D10ShaderResourceView</b> also has these types of members:
<ul>
...
<a href="https://msdn.microsoft.com/library/Bb173855(v=VS.85).aspx">GetDesc</a>
</td>
...
To create a shader-resource view, call <a href="https://msdn.microsoft.com/library/Bb173558(v=VS.85).aspx">ID3D10Device::CreateShaderResourceView</a>.
