...
ms.topic: method
f1_keywords: ["d3d10/ID3D10Device.PSGetConstantBuffers"]
req.header: d3d10.h
req.include-header: 
...
Get the <a href="https://docs.microsoft.com/windows/desktop/direct3d10/d3d10-graphics-programming-guide-resources-types">constant buffers</a> used by the <a href="https://docs.microsoft.com/previous-versions/bb205146(v=vs.85)">pixel shader</a> pipeline stage.
