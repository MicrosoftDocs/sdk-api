...
Get the <a href="https://msdn.microsoft.com/library/Bb205120(v=VS.85).aspx">blend state</a> of the output-merger stage.
...
Address of a pointer to a blend-state interface (see <a href="https://msdn.microsoft.com/library/Bb173505(v=VS.85).aspx">ID3D10BlendState</a>).
...
Pointer to a <a href="https://msdn.microsoft.com/library/Bb173595(v=VS.85).aspx">sample mask</a>.
