...
Address of a pointer to a vertex shader (see <a href="https://msdn.microsoft.com/library/Bb173875(v=VS.85).aspx">ID3D10VertexShader</a>) to be returned by the method.
