...
Integer that specifies the CPU's read and write permissions for a resource. For possible values, see <a href="https://msdn.microsoft.com/library/Bb205318(v=VS.85).aspx">D3D10_MAP</a>.
...
Type: <b><a href="https://msdn.microsoft.com/library/Bb205319(v=VS.85).aspx">D3D10_MAPPED_TEXTURE2D</a>*</b>

Pointer to a structure (<a href="https://msdn.microsoft.com/library/Bb205319(v=VS.85).aspx">D3D10_MAPPED_TEXTURE2D</a>) that is filled in by the function and contains a pointer to the resource data.
...
All of the Map methods have identical return values and operating restrictions. These are listed in the remarks section of <a href="https://msdn.microsoft.com/library/Bb173865(v=VS.85).aspx">ID3D10Texture1D::Map</a>.
