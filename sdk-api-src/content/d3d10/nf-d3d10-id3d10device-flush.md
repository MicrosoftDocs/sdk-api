...
<b>Flush</b> should be used when the CPU waits for an arbitrary amount of time (such as when calling <a href="http://msdn2.microsoft.com/en-us/library/ms686298.aspx">Sleep</a>, <a href="https://msdn.microsoft.com/library/Bb205618(v=VS.85).aspx">ID3DX10ThreadPump::WaitForAllItems</a>, or <a href="https://msdn.microsoft.com/library/Bb174559(v=VS.85).aspx">WaitForVBlank</a>.

For more information about how flushing works, see <a href="https://msdn.microsoft.com/library/Bb172234(v=VS.85).aspx">Accurately Profiling Direct3D API Calls (Direct3D 9)</a>.
