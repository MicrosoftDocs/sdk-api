...
Get a pointer to the <a href="https://msdn.microsoft.com/library/windows/hardware/jj124414">index buffer</a> that is bound to the <a href="https://msdn.microsoft.com/library/Bb205116(v=VS.85).aspx">input-assembler</a> stage.
...
A pointer to an index buffer returned by the method (see <a href="https://msdn.microsoft.com/library/Bb173510(v=VS.85).aspx">ID3D10Buffer</a>).
...
Specifies format of the data in the index buffer (see <a href="https://msdn.microsoft.com/library/Bb173059(v=VS.85).aspx">DXGI_FORMAT</a>). These formats provide the size and type of the data in the buffer. The only formats allowed for index buffer data are 16-bit (DXGI_FORMAT_R16_UINT) and 32-bit (DXGI_FORMAT_R32_UINT) integers.
