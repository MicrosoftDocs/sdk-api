...
description: Bind an array of shader resources to the geometry shader stage. (ID3D10Device.GSSetShaderResources)
...
Bind an array of shader resources to the <a href="/windows/desktop/direct3d11/geometry-shader-stage">geometry shader stage</a>.
