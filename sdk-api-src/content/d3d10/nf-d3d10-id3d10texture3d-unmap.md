...
Invalidate the pointer to the resource retrieved by <a href="https://msdn.microsoft.com/library/Bb173873(v=VS.85).aspx">ID3D10Texture3D::Map</a>, and re-enable the GPU's access to the resource.
