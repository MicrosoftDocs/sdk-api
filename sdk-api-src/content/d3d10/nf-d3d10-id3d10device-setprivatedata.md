...
The data stored in the device with this method can be retrieved with <a href="https://msdn.microsoft.com/library/Bb173574(v=VS.85).aspx">ID3D10DeviceChild::GetPrivateData</a>.
