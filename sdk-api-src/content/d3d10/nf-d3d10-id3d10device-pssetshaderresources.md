...
ms.topic: method
f1_keywords: ["d3d10/ID3D10Device.PSSetShaderResources"]
req.header: d3d10.h
req.include-header: 
...
Bind an array of shader resources to the <a href="https://docs.microsoft.com/windows/desktop/direct3d11/pixel-shader-stage">pixel shader stage</a>.
