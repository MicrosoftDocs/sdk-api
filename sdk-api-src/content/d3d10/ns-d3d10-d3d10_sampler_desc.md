...
Type: <b><a href="https://msdn.microsoft.com/library/Bb205060(v=VS.85).aspx">D3D10_FILTER</a></b>

Filtering method to use when sampling a texture (see <a href="https://msdn.microsoft.com/library/Bb205060(v=VS.85).aspx">D3D10_FILTER</a>).


### -field AddressU

Type: <b><a href="https://msdn.microsoft.com/library/Bb172483(v=VS.85).aspx">D3D10_TEXTURE_ADDRESS_MODE</a></b>

Method to use for resolving a u texture coordinate that is outside the 0 to 1 range (see <a href="https://msdn.microsoft.com/library/Bb172483(v=VS.85).aspx">D3D10_TEXTURE_ADDRESS_MODE</a>).
...
A function that compares sampled data against existing sampled data. The function options are listed in <a href="https://msdn.microsoft.com/library/Bb204902(v=VS.85).aspx">D3D10_COMPARISON_FUNC</a>.
