...
Type: <b>const <a href="https://msdn.microsoft.com/library/Bb204893(v=VS.85).aspx">D3D10_BLEND_DESC</a>*</b>

Pointer to a blend-state description (see <a href="https://msdn.microsoft.com/library/Bb204893(v=VS.85).aspx">D3D10_BLEND_DESC</a>).
...
Address of a pointer to the blend-state object created (see <a href="https://msdn.microsoft.com/library/Bb173505(v=VS.85).aspx">ID3D10BlendState Interface</a>).
