...
ms.topic: struct
f1_keywords: ["d3d10/D3D10_INPUT_ELEMENT_DESC"]
req.header: d3d10.h
req.include-header: 
...
A description of a single element for the <a href="https://docs.microsoft.com/windows/desktop/direct3d11/d3d10-graphics-programming-guide-input-assembler-stage">input-assembler stage</a>.
