...
Invalidate the pointer to the resource that was retrieved by <a href="https://msdn.microsoft.com/library/Bb173869(v=VS.85).aspx">ID3D10Texture2D::Map</a>, and re-enable GPU access to the resource.
...
<a href="https://msdn.microsoft.com/library/Bb205133(v=VS.85).aspx">Subresource</a> to be unmapped. See <a href="https://msdn.microsoft.com/library/Bb694525(v=VS.85).aspx">D3D10CalcSubresource</a> for more details.
...
<a href="https://msdn.microsoft.com/library/Bb173867(v=VS.85).aspx">ID3D10Texture2D Interface</a>
 
