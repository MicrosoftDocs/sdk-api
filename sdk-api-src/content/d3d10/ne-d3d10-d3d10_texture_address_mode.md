...
Texture coordinates outside the range [0.0, 1.0] are set to the border color specified in <a href="https://msdn.microsoft.com/library/Bb172415(v=VS.85).aspx">D3D10_SAMPLER_DESC</a> or HLSL code.
