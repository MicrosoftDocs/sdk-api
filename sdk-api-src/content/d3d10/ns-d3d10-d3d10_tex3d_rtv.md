...
Specifies the <a href="https://msdn.microsoft.com/library/Bb205133(v=VS.85).aspx">subresource(s)</a> from a <a href="https://msdn.microsoft.com/library/Bb205133(v=VS.85).aspx">3D texture</a> to use in a render-target view.
...
This structure is one member of a render target view. See <a href="https://msdn.microsoft.com/library/Bb172410(v=VS.85).aspx">D3D10_RENDER_TARGET_VIEW_DESC</a>.
