...
Bind an array of <a href="https://msdn.microsoft.com/library/Bb205133(v=VS.85).aspx">vertex buffers</a> to the <a href="https://msdn.microsoft.com/library/Bb205116(v=VS.85).aspx">input-assembler</a> stage.
...
A pointer to an array of vertex buffers (see <a href="https://msdn.microsoft.com/library/Bb173510(v=VS.85).aspx">ID3D10Buffer</a>). The vertex buffers must have been created with the <a href="https://msdn.microsoft.com/library/Bb204891(v=VS.85).aspx">D3D10_BIND_VERTEX_BUFFER</a> flag.
...
For information about creating vertex buffers, see <a href="https://msdn.microsoft.com/library/Bb205130(v=VS.85).aspx">Create a Vertex Buffer</a>.
