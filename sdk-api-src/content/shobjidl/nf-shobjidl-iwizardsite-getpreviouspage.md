...
A pointer to a variable handle of type <a href="https://msdn.microsoft.com/library/Bb774548(v=VS.85).aspx">PROPSHEETPAGE</a> that represents the wizard page that comes immediately before the wizard extension page.
