...
Called when the user cancels navigation through the wizard extension. Gets the handle of the <a href="https://msdn.microsoft.com/library/Bb774548(v=VS.85).aspx">PROPSHEETPAGE</a> that represents the wizard page to display when the user cancels navigation while in the wizard extension.
...
A pointer to a handle variable of type <a href="https://msdn.microsoft.com/library/Bb774548(v=VS.85).aspx">PROPSHEETPAGE</a> that receives the wizard page to display when the user cancels navigation while in the wizard extension.
