...
ms.topic: function
f1_keywords: ["mprapi/MprConfigServerBackup"]
req.header: mprapi.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/mprapi/nf-mprapi-mprconfigserverrestore">MprConfigServerRestore</a>
