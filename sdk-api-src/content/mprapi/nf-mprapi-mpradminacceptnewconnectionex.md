...
ms.date: 4/16/2018
ms.keywords: MprAdminAcceptNewConnectionEx, MprAdminAcceptNewConnectionEx callback function [RAS], mprapi/MprAdminAcceptNewConnectionEx, rras.mpradminacceptnewconnectionex
...
If 
<b>MprAdminAcceptNewConnectionEx</b> accepts the connection, the return value should be <b>TRUE</b>.

If 
<b>MprAdminAcceptNewConnectionEx</b> rejects the connection, the return value should be <b>FALSE</b>.
