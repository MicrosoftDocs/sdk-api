...
title: IDiscRecorder2::get_ExclusiveAccessOwner method
...
ms.date: 3/14/2018
ms.keywords: IDiscRecorder2, IDiscRecorder2 interface [IMAPI], get_ExclusiveAccessOwner method, IDiscRecorder2::get_ExclusiveAccessOwner, get_ExclusiveAccessOwner method [IMAPI], get_ExclusiveAccessOwner method [IMAPI], IDiscRecorder2 interface, get_ExclusiveAccessOwner,IDiscRecorder2.get_ExclusiveAccessOwner, imapi.idiscrecorder2_get_exclusiveaccessowner, imapi2/IDiscRecorder2::get_ExclusiveAccessOwner
