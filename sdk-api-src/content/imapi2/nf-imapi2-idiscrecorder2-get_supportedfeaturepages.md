...
f1_keywords:
 ...
 - imapi2/IDiscRecorder2::get_SupportedFeaturePages
dev_langs:
 - c++
topic_type:
 - APIRef
...
List of features that the device supports. Each element of the list is a <b>VARIANT</b> of type <b>VT_I4</b>. The <b>lVal</b> member of the variant contains the feature page type value. For possible values, see the <a href="/windows/desktop/api/imapi2/ne-imapi2-imapi_feature_page_type">IMAPI_FEATURE_PAGE_TYPE</a> enumeration type.
