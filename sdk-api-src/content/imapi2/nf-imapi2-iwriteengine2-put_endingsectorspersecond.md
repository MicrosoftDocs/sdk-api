...
title: IWriteEngine2::put_EndingSectorsPerSecond method
...
ms.date: 3/14/2018
ms.keywords: IWriteEngine2, IWriteEngine2 interface [IMAPI], put_EndingSectorsPerSecond method, IWriteEngine2::put_EndingSectorsPerSecond, imapi.iwriteengine2_put_endingsectorspersecond, imapi2/IWriteEngine2::put_EndingSectorsPerSecond, put_EndingSectorsPerSecond method [IMAPI], put_EndingSectorsPerSecond method [IMAPI], IWriteEngine2 interface, put_EndingSectorsPerSecond,IWriteEngine2.put_EndingSectorsPerSecond
...
# IWriteEngine2::put_EndingSectorsPerSecond method
...
Approximate number of sectors per second that the recording device can write to the media at the end of the writing process. The default is -1 for maximum speed.
