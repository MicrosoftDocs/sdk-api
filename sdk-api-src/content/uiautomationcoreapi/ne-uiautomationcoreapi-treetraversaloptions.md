...
description: TreeTraversalOptions (uiautomationcoreapi.h) defines values that can be used to customize tree navigation order.
...
### -field TreeTraversalOptions_Default:0x0
