...
description: AutomationElementMode (uiautomationcoreapi.h) contains values that specify the type of reference to use when returning UI Automation elements.
