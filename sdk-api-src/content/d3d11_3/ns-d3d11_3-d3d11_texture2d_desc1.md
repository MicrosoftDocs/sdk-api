...
A <a href="https://msdn.microsoft.com/en-us/library/Dn899168(v=VS.85).aspx">D3D11_TEXTURE_LAYOUT</a>-typed value that identifies the layout of the texture.
...
This structure is used in a call to <a href="https://msdn.microsoft.com/en-us/library/Dn899229(v=VS.85).aspx">ID3D11Device3::CreateTexture2D1</a>.
