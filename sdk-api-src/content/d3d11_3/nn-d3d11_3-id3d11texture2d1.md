...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">ID3D11Texture2D1</b> interface inherits from <a href="https://msdn.microsoft.com/en-us/library/Ff476635(v=VS.85).aspx">ID3D11Texture2D</a>. <b>ID3D11Texture2D1</b> also has these types of members:
<ul>
...
<a href="https://msdn.microsoft.com/en-us/library/Dn899245(v=VS.85).aspx">GetDesc1</a>
</td>
...
To create an empty Texture2D resource, call <a href="https://msdn.microsoft.com/en-us/library/Dn899229(v=VS.85).aspx">ID3D11Device3::CreateTexture2D1</a>. For info about how to create a 2D texture, see <a href="https://msdn.microsoft.com/en-us/library/Ff476903(v=VS.85).aspx">How to: Create a Texture</a>. 
...
<a href="https://msdn.microsoft.com/en-us/library/Ff476635(v=VS.85).aspx">ID3D11Texture2D</a>
