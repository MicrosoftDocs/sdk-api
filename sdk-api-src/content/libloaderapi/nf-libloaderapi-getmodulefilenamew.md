...
<b>Windows XP:  </b>If the buffer is too small to hold the module name, the function returns <i>nSize</i>. The last error code remains unmodified. If <i>nSize</i> is zero, the return value is zero and the last error code is not modified either.
