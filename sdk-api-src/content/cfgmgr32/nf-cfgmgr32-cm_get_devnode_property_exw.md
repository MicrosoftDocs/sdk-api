...
ms.topic: function
f1_keywords: ["cfgmgr32/CM_Get_DevNode_Property_ExW"]
...
<p class="CCE_Message">[Beginning with Windows 8 and Windows Server 2012, this function has been deprecated.  Please use <a href="https://docs.microsoft.com/windows/desktop/api/cfgmgr32/nf-cfgmgr32-cm_get_devnode_propertyw">CM_Get_DevNode_Property</a> instead.]
