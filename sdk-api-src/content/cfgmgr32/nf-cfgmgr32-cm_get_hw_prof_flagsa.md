...
Pointer to a NULL-terminated string that contains the <a href="https://www.bing.com/search?q=device+instance+ID">device instance ID</a> of the device for which to retrieve hardware profile-specific configuration flags.
