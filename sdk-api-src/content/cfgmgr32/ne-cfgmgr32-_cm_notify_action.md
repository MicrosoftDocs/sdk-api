...
For this value, set the <b>FilterType</b> member of the <a href="https://msdn.microsoft.com/en-us/library/Mt299055(v=VS.85).aspx">CM_NOTIFY_FILTER</a> structure
...
When a driver calls the <a href="https://msdn.microsoft.com/en-us/library/Hh780224(v=VS.85).aspx">CM_Register_Notification</a> function, the <i>pCallback</i> parameter contains a pointer to a routine to be called when a specified PnP event occurs.  The callback routine's <i>Action</i> parameter is a value from the <b>CM_NOTIFY_ACTION</b> enumeration.
...
<a href="https://msdn.microsoft.com/en-us/library/Mt299055(v=VS.85).aspx">CM_NOTIFY_FILTER</a>



<a href="https://msdn.microsoft.com/en-us/library/Hh780224(v=VS.85).aspx">CM_Register_Notification</a>
 
