...
A handle to a remote machine on which to set the specified <a href="https://www.bing.com/search?q=device+setup+class+property">device setup class property</a>. This parameter is optional. If set to <b>NULL</b>, the property is set on the local machine.
