...
Depending on the type of <a href="https://msdn.microsoft.com/library/ms682005(v=VS.85).aspx">cluster object</a> for 
...
To create the page, call the function 
       <a href="https://msdn.microsoft.com/library/Bb760807(v=VS.85).aspx">CreatePropertySheetPage</a>. To produce pages 
