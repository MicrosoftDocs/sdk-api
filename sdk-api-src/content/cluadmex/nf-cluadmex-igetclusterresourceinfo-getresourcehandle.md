...
ms.topic: method
f1_keywords: ["cluadmex/IGetClusterResourceInfo.GetResourceHandle"]
...
Returns a handle to a <a href="https://docs.microsoft.com/previous-versions/windows/desktop/mscs/resources">resource</a>.
