...
description: Gets or sets the factoid that a recognizer uses to constrain its search for the recognition result. (Put)
...
f1_keywords:
 ...
 - msinkaut/IInkRecognizerContext::put_Factoid
dev_langs:
 - c++
topic_type:
 - APIRef
