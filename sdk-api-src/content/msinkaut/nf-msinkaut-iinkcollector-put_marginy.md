...
description: Gets or sets the y-axis margin around the window rectangle, in screen coordinates.This margin provides a buffer around the edge of the ink window. (IInkCollector.put_MarginY)
...
f1_keywords:
 ...
 - msinkaut/IInkCollector::put_MarginY
dev_langs:
 - c++
topic_type:
 - APIRef
