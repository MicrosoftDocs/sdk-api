...
description: Gets or sets the element in the second row, first column of the affine transform matrix that is represented by an InkTransform object. (Put)
...
f1_keywords:
 ...
 - msinkaut/IInkTransform::put_eM21
dev_langs:
 - c++
topic_type:
 - APIRef
