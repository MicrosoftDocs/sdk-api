...
<div> </div>
To remove the pointer from the clipboard, the parameter for the <a href="https://msdn.microsoft.com/en-us/library/ms686623(v=VS.85).aspx">OleSetClipboard</a> should be <b>NULL</b>. For the <a href="frlrfSystemWindowsFormsClipboardClassSetDataObjectTopic">SetDataObject</a> method, the <i>data</i> parameter should be <b>NULL</b>, and the <i>copy</i> parameter should be <b>TRUE</b>.

The <a href="https://msdn.microsoft.com/en-us/library/ms686623(v=VS.85).aspx">OleSetClipboard</a> and <a href="frlrfSystemWindowsFormsClipboardClassSetDataObjectTopic">SetDataObject</a> methods replace the contents of the clipboard.
