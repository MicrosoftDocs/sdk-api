...
description: Gets or sets the collection mode that determines whether ink, gestures, or both are recognized as the user writes. (Get)
...
f1_keywords:
 ...
 - msinkaut/IInkPicture::get_CollectionMode
dev_langs:
 - c++
topic_type:
 - APIRef
