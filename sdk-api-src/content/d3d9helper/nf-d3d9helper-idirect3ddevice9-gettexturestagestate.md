...
title: IDirect3DDevice9::GetTextureStageState (d3d9helper.h)
description: Retrieves a state value for an assigned texture. (IDirect3DDevice9.GetTextureStageState)
...
f1_keywords:
 ...
 - d3d9helper/IDirect3DDevice9::GetTextureStageState
dev_langs:
 - c++
topic_type:
 - APIRef
