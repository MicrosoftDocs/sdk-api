...
title: IDirect3DDevice9::SetMaterial (d3d9helper.h)
description: The IDirect3DDevice9::SetMaterial method (d3d9helper.h) sets the material properties for the device.
...
f1_keywords:
 - IDirect3DDevice9::SetMaterial
 - d3d9helper/IDirect3DDevice9::SetMaterial
dev_langs:
 - c++
topic_type:
 - APIRef
