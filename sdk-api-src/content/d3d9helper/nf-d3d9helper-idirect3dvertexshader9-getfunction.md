...
title: IDirect3DVertexShader9::GetFunction (d3d9helper.h)
description: The IDirect3DVertexShader9::GetFunction method (d3d9.h) gets a pointer to the shader data. 
...
f1_keywords:
 - IDirect3DVertexShader9::GetFunction
 - d3d9helper/IDirect3DVertexShader9::GetFunction
dev_langs:
 - c++
topic_type:
 - APIRef
