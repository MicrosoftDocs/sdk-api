...
Type: <b>const <a href="https://msdn.microsoft.com/library/Bb147253(v=VS.85).aspx">PALETTEENTRY</a>*</b>

Pointer to a <a href="https://msdn.microsoft.com/library/Bb147253(v=VS.85).aspx">PALETTEENTRY</a> structure, representing the palette entries to set. The number of <b>PALETTEENTRY</b> structures pointed to by pEntries is assumed to be 256. See Remarks. 
...
<a href="https://msdn.microsoft.com/library/Bb174397(v=VS.85).aspx">IDirect3DDevice9::GetPaletteEntries</a>
