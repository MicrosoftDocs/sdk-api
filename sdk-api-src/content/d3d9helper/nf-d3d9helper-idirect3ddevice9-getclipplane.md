...
The plane equation used by this method exists in world space and is set by a previous call to the <a href="https://msdn.microsoft.com/library/Bb174426(v=VS.85).aspx">IDirect3DDevice9::SetClipPlane</a> method.
