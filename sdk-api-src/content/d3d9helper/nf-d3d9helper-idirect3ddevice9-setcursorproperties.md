...
<ul>
<li>The hardware has set D3DCURSORCAPS_COLOR (see <a href="https://msdn.microsoft.com/library/Bb172530(v=VS.85).aspx">D3DCURSORCAPS</a>), and the cursor size is 32x32 (which is the cursor size in the operating system).</li>
<li>The application is running in windowed mode.</li>
</ul>
Otherwise, DirectX uses an emulated cursor. An application uses <a href="https://msdn.microsoft.com/library/Bb174429(v=VS.85).aspx">IDirect3DDevice9::SetCursorPosition</a> to move an emulated cursor to follow mouse movement.
...
<a href="https://msdn.microsoft.com/library/Bb174470(v=VS.85).aspx">IDirect3DDevice9::ShowCursor</a>
 
