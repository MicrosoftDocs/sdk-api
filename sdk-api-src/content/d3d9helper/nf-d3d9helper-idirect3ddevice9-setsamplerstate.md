...
The sampler stage index. For more info about sampler stage, see <a href="https://msdn.microsoft.com/library/Bb206339(v=VS.85).aspx">Sampling Stage Registers in vs_3_0 (DirectX HLSL)</a>.
...
<a href="https://msdn.microsoft.com/library/Bb174406(v=VS.85).aspx">IDirect3DDevice9::GetSamplerState</a>
 
