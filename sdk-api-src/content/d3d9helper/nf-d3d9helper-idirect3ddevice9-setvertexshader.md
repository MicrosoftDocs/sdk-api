...
Vertex shader interface. For more information, see <a href="https://msdn.microsoft.com/library/Bb205922(v=VS.85).aspx">IDirect3DVertexShader9</a>.
...
To set a fixed-function vertex shader (after having set a programmable vertex shader), call <b>IDirect3DDevice9::SetVertexShader</b>(NULL) to release the programmable shader, and then call <a href="https://msdn.microsoft.com/library/Bb174433(v=VS.85).aspx">IDirect3DDevice9::SetFVF</a> with the fixed-function vertex format.
...
<a href="https://msdn.microsoft.com/library/Bb174416(v=VS.85).aspx">IDirect3DDevice9::GetVertexShader</a>
 
