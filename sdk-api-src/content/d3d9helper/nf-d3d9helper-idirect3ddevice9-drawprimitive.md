...
title: IDirect3DDevice9::DrawPrimitive (d3d9helper.h)
description: The IDirect3DDevice9::DrawPrimitive method (d3d9helper.h) renders a sequence of non-indexed, geometric primitives of the specified type from the current set of data input streams.
