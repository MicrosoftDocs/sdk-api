...
description: Returns information describing the raster of the monitor on which the swap chain is presented. (IDirect3DDevice9.GetRasterStatus)
...
f1_keywords:
 ...
 - d3d9helper/IDirect3DDevice9::GetRasterStatus
dev_langs:
 - c++
topic_type:
 - APIRef
