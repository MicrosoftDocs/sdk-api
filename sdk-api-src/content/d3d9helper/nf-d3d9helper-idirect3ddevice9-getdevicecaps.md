...
ms.topic: method
f1_keywords: ["d3d9helper/IDirect3DDevice9.GetDeviceCaps"]
...
Pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/d3d9caps/ns-d3d9caps-_d3dcaps9">D3DCAPS9</a> structure, describing the returned device. 
