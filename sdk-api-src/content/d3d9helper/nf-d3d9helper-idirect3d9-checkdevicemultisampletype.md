...
Member of the <a href="https://msdn.microsoft.com/library/Bb172558(v=VS.85).aspx">D3DFORMAT</a> enumerated type that specifies the format of the surface to be multisampled. For more information, see Remarks.
...
Type: <b><a href="https://msdn.microsoft.com/library/Bb172574(v=VS.85).aspx">D3DMULTISAMPLE_TYPE</a></b>

Member of the <a href="https://msdn.microsoft.com/library/Bb172574(v=VS.85).aspx">D3DMULTISAMPLE_TYPE</a> enumerated type, identifying the multisampling technique to test.
...
See the remarks in <a href="https://msdn.microsoft.com/library/Bb172574(v=VS.85).aspx">D3DMULTISAMPLE_TYPE</a> for additional information on working with and setting multisample types and quality levels.
