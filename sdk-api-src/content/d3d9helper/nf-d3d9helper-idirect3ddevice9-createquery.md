...
title: IDirect3DDevice9::CreateQuery (d3d9helper.h)
description: The IDirect3DDevice9::CreateQuery method (d3d9helper.h) creates a status query.
...
f1_keywords:
 ...
 - d3d9helper/IDirect3DDevice9::CreateQuery
dev_langs:
 - c++
topic_type:
 - APIRef
