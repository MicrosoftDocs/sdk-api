...
title: IWMPMedia::put_name method
...
ms.date: 4/2/2018
ms.keywords: IWMPMedia, IWMPMedia interface [Windows Media Player], put_name method, IWMPMedia2 interface [Windows Media Player], put_name method, IWMPMedia2::put_name, IWMPMedia3 interface [Windows Media Player], put_name method, IWMPMedia3::put_name, IWMPMedia::put_name, IWMPMediaput_name, put_name method [Windows Media Player], put_name method [Windows Media Player], IWMPMedia interface, put_name method [Windows Media Player], IWMPMedia2 interface, put_name method [Windows Media Player], IWMPMedia3 interface, put_name,IWMPMedia.put_name, wmp.iwmpmedia_put_name, wmp/IWMPMedia2::put_name, wmp/IWMPMedia3::put_name, wmp/IWMPMedia::put_name
