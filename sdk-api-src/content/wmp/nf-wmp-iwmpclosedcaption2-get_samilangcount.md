...
ms.topic: method
f1_keywords: ["wmp/IWMPClosedCaption2.get_SAMILangCount"]
req.header: wmp.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/wmp/nf-wmp-iwmpclosedcaption2-getsamilangname">IWMPClosedCaption2::getSAMILangName</a>
