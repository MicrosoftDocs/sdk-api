...
ms.topic: method
f1_keywords: ["wmp/IWMPMediaCollection.remove"]
req.header: wmp.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/wmp/nf-wmp-iwmpmediacollection-add">IWMPMediaCollection::add</a>
 
