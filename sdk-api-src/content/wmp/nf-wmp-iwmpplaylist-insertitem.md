...
ms.date: 4/2/2018
ms.keywords: IWMPPlaylist, IWMPPlaylist interface [Windows Media Player], insertItem method, IWMPPlaylist::insertItem, IWMPPlaylistinsertItem, insertItem method [Windows Media Player], insertItem method [Windows Media Player], IWMPPlaylist interface, insertItem,IWMPPlaylist.insertItem, wmp.iwmpplaylist_insertitem, wmp/IWMPPlaylist::insertItem
