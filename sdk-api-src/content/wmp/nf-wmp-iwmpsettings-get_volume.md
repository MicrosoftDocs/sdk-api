...
title: IWMPSettings::get_volume method
...
ms.date: 4/11/2018
ms.keywords: IWMPSetting2.get_volume, IWMPSetting2::get_volume, IWMPSettings, IWMPSettings interface [Windows Media Player], get_volume method, IWMPSettings::get_volume, IWMPSettingsget_volume, get_volume method [Windows Media Player], get_volume method [Windows Media Player], IWMPSettings interface, get_volume,IWMPSettings.get_volume, wmp.iwmpsettings_get_volume, wmp/IWMPSettings::get_volume
...
# IWMPSettings::get_volume method
