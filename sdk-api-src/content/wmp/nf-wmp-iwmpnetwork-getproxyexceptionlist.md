...
ms.topic: method
f1_keywords: ["wmp/IWMPNetwork.getProxyExceptionList"]
req.header: wmp.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/wmp/nf-wmp-iwmpnetwork-setproxyexceptionlist">IWMPNetwork::setProxyExceptionList</a>
 
