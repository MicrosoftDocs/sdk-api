...
ms.topic: method
f1_keywords: ["wmp/IWMPFolderMonitorServices.startScan"]
req.header: wmp.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/wmp/nf-wmp-iwmpfoldermonitorservices-stopscan">IWMPFolderMonitorServices::stopScan</a>
