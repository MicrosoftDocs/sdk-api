...
A DDEML application should use the <a href="https://msdn.microsoft.com/library/ms648756(v=VS.85).aspx">DdeImpersonateClient</a> function. 
...
<a href="https://msdn.microsoft.com/library/ms648756(v=VS.85).aspx">DdeImpersonateClient</a>
