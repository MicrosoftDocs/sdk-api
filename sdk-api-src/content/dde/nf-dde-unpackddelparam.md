...
The 
					...
					<i>lParam</i> parameter by calling the <a href="https://msdn.microsoft.com/library/ms649004(v=VS.85).aspx">FreeDDElParam</a> function. 
...
<a href="https://msdn.microsoft.com/library/ms649006(v=VS.85).aspx">PackDDElParam</a> eases the porting of 16-bit DDE applications to 32-bit DDE applications. 
