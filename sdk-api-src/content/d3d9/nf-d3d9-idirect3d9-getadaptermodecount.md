...
title: IDirect3D9::GetAdapterModeCount (d3d9.h)
description: The IDirect3D9::GetAdapterModeCount method (d3d9.h) returns the number of display modes available on this adapter.
...
f1_keywords:
 ...
 - d3d9/IDirect3D9::GetAdapterModeCount
dev_langs:
 - c++
topic_type:
 - APIRef
