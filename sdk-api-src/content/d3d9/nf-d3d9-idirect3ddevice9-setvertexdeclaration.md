...
Pointer to an <a href="https://msdn.microsoft.com/library/Bb205919(v=VS.85).aspx">IDirect3DVertexDeclaration9</a> object, which contains the vertex declaration.
...
A vertex declaration is an IDirect3DVertexDeclaration9 object that defines the data members of a vertex (i.e. texture coordinates, colors, normals, etc.). This data can be useful for implementing <a href="https://msdn.microsoft.com/library/Bb509635(v=VS.85).aspx">vertex shaders and pixel shaders</a>.
...
<a href="https://msdn.microsoft.com/library/Bb174415(v=VS.85).aspx">IDirect3DDevice9::GetVertexDeclaration</a>
 
