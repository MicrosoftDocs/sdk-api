...
description: The IDirect3DDevice9::GetFrontBufferData method (d3d9.h) copies the device's front buffer into a system memory buffer provided by the application.
...
f1_keywords:
 ...
 - d3d9/IDirect3DDevice9::GetFrontBufferData
dev_langs:
 - c++
topic_type:
 - APIRef
