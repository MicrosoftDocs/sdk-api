...
title: IDirect3DDevice9::GetRenderTargetData (d3d9.h)
...
Pointer to an <a href="https://msdn.microsoft.com/en-us/library/Bb205892(v=VS.85).aspx">IDirect3DSurface9</a> object, representing a render target. 
...
Pointer to an <a href="https://msdn.microsoft.com/en-us/library/Bb205892(v=VS.85).aspx">IDirect3DSurface9</a> object, representing a destination surface. 
