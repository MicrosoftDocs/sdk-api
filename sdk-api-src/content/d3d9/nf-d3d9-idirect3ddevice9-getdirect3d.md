...
Address of a pointer to an <a href="https://msdn.microsoft.com/library/Bb174300(v=VS.85).aspx">IDirect3D9</a> interface, representing the interface of the Direct3D object that created the device. 
