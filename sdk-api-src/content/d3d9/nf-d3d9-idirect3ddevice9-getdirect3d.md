...
title: IDirect3DDevice9::GetDirect3D (d3d9.h)
description: Returns an interface to the instance of the Direct3D object that created the device. (IDirect3DDevice9.GetDirect3D)
