...
Address of a pointer to an <a href="https://msdn.microsoft.com/library/Bb174322(v=VS.85).aspx">IDirect3DBaseTexture9</a> interface, representing the returned texture. 
...
<a href="https://msdn.microsoft.com/library/Bb174413(v=VS.85).aspx">IDirect3DDevice9::GetTextureStageState</a>
