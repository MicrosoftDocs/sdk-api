...
description: Evicts all managed resources, including both Direct3D and driver-managed resources. (IDirect3DDevice9.EvictManagedResources)
...
f1_keywords:
 ...
 - d3d9/IDirect3DDevice9::EvictManagedResources
dev_langs:
 - c++
topic_type:
 - APIRef
