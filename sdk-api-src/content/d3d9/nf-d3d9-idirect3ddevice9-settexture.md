...
Pointer to an <a href="https://msdn.microsoft.com/library/Bb174322(v=VS.85).aspx">IDirect3DBaseTexture9</a> interface, representing the texture being set. 
...
<ul>
<li>Programmable shaders reference textures using the sampler number. The number of samplers available to a programmable shader is dependent on the shader version. For vertex shaders, see <a href="https://msdn.microsoft.com/library/Bb172957(v=VS.85).aspx">Sampler (Direct3D 9 asm-vs)</a>. For pixel shaders see <a href="https://msdn.microsoft.com/library/Bb172922(v=VS.85).aspx">Sampler (Direct3D 9 asm-ps)</a>.</li>
<li>The fixed function pipeline on the other hand, references textures by texture stage number. The maximum number of samplers is determined from two caps: MaxSimultaneousTextures and MaxTextureBlendStages of the <a href="https://msdn.microsoft.com/library/Bb172513(v=VS.85).aspx">D3DCAPS9</a> structure.</li>
</ul>
There are two other special cases for stage/sampler numbers.

<ul>
<li>A special number called D3DDMAPSAMPLER is used for <a href="https://msdn.microsoft.com/library/Bb219748(v=VS.85).aspx">Displacement Mapping (Direct3D 9)</a>.</li>
<li>A programmable vertex shader uses a special number defined by a <a href="https://msdn.microsoft.com/library/Bb172631(v=VS.85).aspx">D3DVERTEXTEXTURESAMPLER</a> when accessing <a href="https://msdn.microsoft.com/library/Bb206339(v=VS.85).aspx">Vertex Textures in vs_3_0 (DirectX HLSL)</a>.</li>
</ul>
