...
Address of a pointer to an <a href="https://msdn.microsoft.com/library/Bb205892(v=VS.85).aspx">IDirect3DSurface9</a> interface, representing the returned render-target surface for this device. 
...
The device can now support multiple render targets. The number of render targets supported by a device is contained in the NumSimultaneousRTs member of <a href="https://msdn.microsoft.com/library/Bb172513(v=VS.85).aspx">D3DCAPS9</a>. See <a href="https://msdn.microsoft.com/library/Bb147221(v=VS.85).aspx">Multiple Render Targets (Direct3D 9)</a>.
...
<a href="https://msdn.microsoft.com/library/Bb174455(v=VS.85).aspx">IDirect3DDevice9::SetRenderTarget</a>
 
