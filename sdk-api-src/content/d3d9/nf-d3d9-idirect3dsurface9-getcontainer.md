...
description: The IDirect3DSurface9::GetContainer (d3d9.h) method provides access to the parent cube texture or texture (mipmap) object.
...
f1_keywords:
 ...
 - d3d9/IDirect3DSurface9::GetContainer
dev_langs:
 - c++
topic_type:
 - APIRef
