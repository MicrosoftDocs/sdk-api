...
Pointer to a UINT to be filled with the number of times the <a href="https://msdn.microsoft.com/library/Bb174343(v=VS.85).aspx">IDirect3DDevice9Ex::PresentEx</a> method has been called. The count will also be incremented by calling some other APIs such as <a href="https://msdn.microsoft.com/library/Bb174432(v=VS.85).aspx">IDirect3DDevice9::SetDialogBoxMode</a>.
...
<a href="https://msdn.microsoft.com/library/Bb172503(v=VS.85).aspx">IDirect3DSwapChain9Ex</a>
 
