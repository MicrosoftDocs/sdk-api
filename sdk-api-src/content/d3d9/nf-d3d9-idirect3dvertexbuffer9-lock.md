...
description: The IDirect3DVertexBuffer9::Lock (d3d9.h) method locks a range of vertex data and obtains a pointer to the vertex buffer memory.
...
f1_keywords:
 ...
 - d3d9/IDirect3DVertexBuffer9::Lock
dev_langs:
 - c++
topic_type:
 - APIRef
