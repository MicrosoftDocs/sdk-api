...
Setting a new render target will cause the viewport (see <a href="https://msdn.microsoft.com/library/Bb206341(v=VS.85).aspx">Viewports and Clipping (Direct3D 9)</a>) to be set to the full size of the new render target.
