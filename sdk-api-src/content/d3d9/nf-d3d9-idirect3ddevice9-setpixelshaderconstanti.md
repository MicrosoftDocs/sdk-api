...
title: IDirect3DDevice9::SetPixelShaderConstantI (d3d9.h)
...
ms.topic: method
f1_keywords: ["d3d9/IDirect3DDevice9.SetPixelShaderConstantI"]
req.header: d3d9.h
...
<a href="https://docs.microsoft.com/windows/desktop/api/d3d9helper/nf-d3d9helper-idirect3ddevice9-getpixelshaderconstanti">IDirect3DDevice9::GetPixelShaderConstantI</a>
 
