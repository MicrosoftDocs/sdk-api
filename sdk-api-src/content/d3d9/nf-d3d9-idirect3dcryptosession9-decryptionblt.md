...
ms.topic: method
f1_keywords: ["d3d9/IDirect3DCryptoSession9.DecryptionBlt"]
req.header: d3d9.h
req.include-header: 
...
A pointer to a <a href="https://docs.microsoft.com/windows/desktop/medfound/d3dencrypted-block-info">D3DENCRYPTED_BLOCK_INFO</a> structure, or <b>NULL</b>.
