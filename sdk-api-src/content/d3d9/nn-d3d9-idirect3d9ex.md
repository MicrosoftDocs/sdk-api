...
Applications use the methods of the <b>IDirect3D9Ex</b> interface (which inherits from <a href="https://msdn.microsoft.com/library/Bb174300(v=VS.85).aspx">IDirect3D9</a>) to create Microsoft Direct3D 9Ex objects and set up the environment. This interface includes methods for enumerating and retrieving capabilities of the device and is available when the underlying device implementation is compliant with Windows Vista.


## -inheritance

The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IDirect3D9Ex</b> interface inherits from <a href="https://msdn.microsoft.com/library/Bb174300(v=VS.85).aspx">IDirect3D9</a>. <b>IDirect3D9Ex</b> also has these types of members:
<ul>
...
<a href="https://msdn.microsoft.com/library/Bb174302(v=VS.85).aspx">CreateDeviceEx</a>
</td>
...
<tr data="declared;">
<td align="left" width="37%">
<a href="https://msdn.microsoft.com/library/Bb174303(v=VS.85).aspx">EnumAdapterModesEx</a>
</td>
<td align="left" width="63%">
...
<tr data="declared;">
<td align="left" width="37%">
<a href="https://msdn.microsoft.com/library/Bb174304(v=VS.85).aspx">GetAdapterDisplayModeEx</a>
</td>
<td align="left" width="63%">
...
<tr data="declared;">
<td align="left" width="37%">
<a href="https://msdn.microsoft.com/library/Bb174305(v=VS.85).aspx">GetAdapterLUID</a>
</td>
<td align="left" width="63%">
...
<tr data="declared;">
<td align="left" width="37%">
<a href="https://msdn.microsoft.com/library/Bb174306(v=VS.85).aspx">GetAdapterModeCountEx</a>
</td>
<td align="left" width="63%">
...
The <b>IDirect3D9Ex</b> interface is obtained by calling the <a href="https://msdn.microsoft.com/library/Bb219676(v=VS.85).aspx">Direct3DCreate9Ex</a> function.
