...
Pointer to a <a href="https://msdn.microsoft.com/library/Bb172611(v=VS.85).aspx">D3DSURFACE_DESC</a> structure, describing one face of the specified cube texture level.
...
The <a href="https://msdn.microsoft.com/library/Bb172611(v=VS.85).aspx">D3DSURFACE_DESC</a> structure contains Width and Height members, which describe the size of one face in the cube. To get the size of the entire cube, multiply six (the number of cube faces) by the product of Width and Height.
