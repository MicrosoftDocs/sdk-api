...
description: Creates a new state block that contains the values for all device states, vertex-related states, or pixel-related states. (IDirect3DDevice9.CreateStateBlock)
