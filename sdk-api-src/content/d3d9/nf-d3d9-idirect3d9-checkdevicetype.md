...
Back buffer format. For more information about formats, see <a href="https://msdn.microsoft.com/library/Bb172558(v=VS.85).aspx">D3DFORMAT</a>. This value must be one of the render-target formats. You can use <a href="https://msdn.microsoft.com/library/Bb174316(v=VS.85).aspx">GetAdapterDisplayMode</a> to obtain the current format.
...
Member of the <a href="https://msdn.microsoft.com/library/Bb172547(v=VS.85).aspx">D3DDEVTYPE</a> enumerated type, indicating the device type to check. 
...
Member of the <a href="https://msdn.microsoft.com/library/Bb172558(v=VS.85).aspx">D3DFORMAT</a> enumerated type, indicating the format of the adapter display mode for which the device type is to be checked. For example, some devices will operate only in 16-bits-per-pixel modes. 
