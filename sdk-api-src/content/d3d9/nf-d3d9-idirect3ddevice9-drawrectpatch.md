...
Pointer to an array of four floating-point values that identify the number of segments each edge of the rectangle patch should be divided into when tessellated. See <a href="https://msdn.microsoft.com/library/Bb172598(v=VS.85).aspx">D3DRECTPATCH_INFO</a>. 


### -param pRectPatchInfo [in]

Type: <b>const <a href="https://msdn.microsoft.com/library/Bb172598(v=VS.85).aspx">D3DRECTPATCH_INFO</a>*</b>

Pointer to a <a href="https://msdn.microsoft.com/library/Bb172598(v=VS.85).aspx">D3DRECTPATCH_INFO</a> structure, describing the rectangular patch to draw. 
...
Calling <b>IDirect3DDevice9::DrawRectPatch</b> with a handle invalidates the same handle cached by a previous <a href="https://msdn.microsoft.com/library/Bb174374(v=VS.85).aspx">IDirect3DDevice9::DrawTriPatch</a> call.
...
<a href="https://msdn.microsoft.com/library/Bb174368(v=VS.85).aspx">IDirect3DDevice9::DeletePatch</a>
