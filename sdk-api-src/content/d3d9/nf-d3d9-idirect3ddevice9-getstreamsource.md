...
Address of a pointer to an <a href="https://msdn.microsoft.com/library/Bb205915(v=VS.85).aspx">IDirect3DVertexBuffer9</a> interface, representing the returned vertex buffer bound to the specified data stream. 
