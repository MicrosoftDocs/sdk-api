...
Or users might want to call the <a href="https://msdn.microsoft.com/library/Bb174430(v=VS.85).aspx">IDirect3DDevice9::SetCursorProperties</a> method if they want to change the cursor. See the code in the DirectX Graphics C/C++ Samples for more detail.
...
<a href="https://msdn.microsoft.com/library/Bb174429(v=VS.85).aspx">IDirect3DDevice9::SetCursorPosition</a>



<a href="https://msdn.microsoft.com/library/Bb174430(v=VS.85).aspx">IDirect3DDevice9::SetCursorProperties</a>
 
