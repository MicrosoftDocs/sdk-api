...
description: The IDirect3DResource9::SetPrivateData (d3d9.h) method associates data with the resource that is intended for use by the application, not by Direct3D.
