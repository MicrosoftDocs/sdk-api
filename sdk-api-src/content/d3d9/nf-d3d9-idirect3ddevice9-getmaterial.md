...
Type: <b><a href="https://msdn.microsoft.com/library/Bb172571(v=VS.85).aspx">D3DMATERIAL9</a>*</b>

Pointer to a <a href="https://msdn.microsoft.com/library/Bb172571(v=VS.85).aspx">D3DMATERIAL9</a> structure to fill with the currently set material properties. 
