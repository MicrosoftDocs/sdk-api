...
Identifies the query type. For more information, see <a href="https://msdn.microsoft.com/library/Bb172594(v=VS.85).aspx">D3DQUERYTYPE</a>.


### -param ppQuery [out, retval]

Type: <b><a href="https://msdn.microsoft.com/library/Bb205872(v=VS.85).aspx">IDirect3DQuery9</a>**</b>

Returns a pointer to the query interface that manages the query object. See <a href="https://msdn.microsoft.com/library/Bb205872(v=VS.85).aspx">IDirect3DQuery9</a>. 
...
Synchronous and asynchronous queries are created with <b>IDirect3DDevice9::CreateQuery</b> with <a href="https://msdn.microsoft.com/library/Bb172594(v=VS.85).aspx">D3DQUERYTYPE</a>. When a query has been created and the API calls have been made that are being queried, use <a href="https://msdn.microsoft.com/library/Bb205877(v=VS.85).aspx">IDirect3DQuery9::Issue</a> to issue a query and  <a href="https://msdn.microsoft.com/library/Bb205873(v=VS.85).aspx">IDirect3DQuery9::GetData</a> to get the results of the query.
...
<a href="https://msdn.microsoft.com/library/Bb172276(v=VS.85).aspx">Asynchronous Notification (Direct3D 9)</a>
