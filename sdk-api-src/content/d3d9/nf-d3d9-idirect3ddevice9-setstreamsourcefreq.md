...
There are two constants defined in d3d9types.h that are designed to use with SetStreamSourceFreq: D3DSTREAMSOURCE_INDEXEDDATA and D3DSTREAMSOURCE_INSTANCEDATA. To see how to use the constants, see <a href="https://msdn.microsoft.com/library/Bb173349(v=VS.85).aspx">Efficiently Drawing Multiple Instances of Geometry (Direct3D 9)</a>.
...
<a href="https://msdn.microsoft.com/library/Bb174410(v=VS.85).aspx">IDirect3DDevice9::GetStreamSourceFreq</a>
 
