...
ms.date: 4/25/2018
ms.keywords: IOCTL_GENERICUSBFN_TRANSFER_OUT, IOCTL_GENERICUSBFN_TRANSFER_OUT control code [Buses], buses.ioctl_genericusbfn_transfer_out, genericusbfnioctl/IOCTL_GENERICUSBFN_TRANSFER_OUT
