...
description: The OPM_STANDARD_INFORMATION (ksopmapi.h) structure contains the result from an Output Protection Manager (OPM) status request.
...
f1_keywords:
 ...
 - ksopmapi/_OPM_STANDARD_INFORMATION
