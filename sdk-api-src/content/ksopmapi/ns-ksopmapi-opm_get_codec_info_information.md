...
description: The OPM_GET_CODEC_INFO_INFORMATION (ksopmapi.h) structure contains the result from an OPM_GET_CODEC_INFO query.
...
f1_keywords:
 ...
 - ksopmapi/_OPM_GET_CODEC_INFO_INFORMATION
 - OPM_GET_CODEC_INFO_INFORMATION
 - ksopmapi/OPM_GET_CODEC_INFO_INFORMATION
dev_langs:
 - c++
topic_type:
 - APIRef
