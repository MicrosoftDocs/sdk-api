...
<a href="https://msdn.microsoft.com/library/Aa384651(v=VS.85).aspx">Auto-recovery</a> is disabled for the shadow copy.
...
Indicates that the writer will need to 
      <a href="https://msdn.microsoft.com/library/Aa384651(v=VS.85).aspx">auto-recover</a> the component in 
