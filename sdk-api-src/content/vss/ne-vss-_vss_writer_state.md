...
The writer is waiting for the 
     <a href="https://msdn.microsoft.com/library/Aa384664(v=VS.85).aspx">PostSnapshot</a> state.
...
The writer vetoed the shadow copy creation process during the <a href="https://msdn.microsoft.com/library/Aa384664(v=VS.85).aspx">PrepareForSnapshot</a> state.
