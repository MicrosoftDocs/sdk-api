...
ms.topic: method
f1_keywords: ["mdhcp/IMcastLeaseInfo.get_LeaseStartTime"]
req.header: mdhcp.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/mdhcp/nf-mdhcp-imcastleaseinfo-put_leasestarttime">IMcastLeaseInfo::put_LeaseStartTime</a>
 
