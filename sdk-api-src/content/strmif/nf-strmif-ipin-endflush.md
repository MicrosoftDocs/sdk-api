...
ms.date: 4/2/2018
ms.keywords: EndFlush method [DirectShow], EndFlush method [DirectShow], IPin interface, EndFlush,IPin.EndFlush, IPin, IPin interface [DirectShow], EndFlush method, IPin::EndFlush, IPinEndFlush, dshow.ipin_endflush, strmif/IPin::EndFlush
