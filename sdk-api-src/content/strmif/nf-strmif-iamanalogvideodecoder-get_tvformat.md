...
ms.topic: method
f1_keywords: ["strmif/IAMAnalogVideoDecoder.get_TVFormat"]
req.header: strmif.h
...
Pointer to a variable that receives a member of the <a href="https://docs.microsoft.com/windows/desktop/api/strmif/ne-strmif-taganalogvideostandard">AnalogVideoStandard</a> enumeration, indicating the analog video format.
