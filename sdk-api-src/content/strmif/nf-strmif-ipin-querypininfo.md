...
ms.topic: method
f1_keywords: ["strmif/IPin.QueryPinInfo"]
req.header: strmif.h
...
Pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/strmif/ns-strmif-_pininfo">PIN_INFO</a> structure that receives the pin information.
