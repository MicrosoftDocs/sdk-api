...
ms.topic: method
f1_keywords: ["strmif/IDvdInfo.GetCurrentVolumeInfo"]
req.header: strmif.h
...
Pointer to the retrieved current disc side (<a href="https://docs.microsoft.com/windows/desktop/api/strmif/ne-strmif-tagdvd_disc_side">DVD_DISC_SIDE</a>).
