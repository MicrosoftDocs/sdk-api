...
ms.topic: method
f1_keywords: ["strmif/IDvdInfo2.GetTitleParentalLevels"]
req.header: strmif.h
...
Pointer to a variable of type ULONG that receives a bitwise OR combination of <a href="https://docs.microsoft.com/windows/desktop/api/strmif/ne-strmif-tagdvd_parental_level">DVD_PARENTAL_LEVEL</a> values defined for the title.
