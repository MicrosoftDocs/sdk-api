...
ms.topic: method
f1_keywords: ["strmif/IEnumMediaTypes.Next"]
req.header: strmif.h
...
The address of an array of <a href="https://docs.microsoft.com/windows/desktop/api/strmif/ns-strmif-_ammediatype">AM_MEDIA_TYPE</a> pointers. The number of elements in the array is given in the <i>cMediaTypes</i> parameter.
