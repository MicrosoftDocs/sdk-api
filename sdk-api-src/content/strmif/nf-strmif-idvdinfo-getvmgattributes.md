...
ms.topic: method
f1_keywords: ["strmif/IDvdInfo.GetVMGAttributes"]
req.header: strmif.h
...
The video manager contains a separate group of streams, such as the DVD_MENU_Title menus (see <a href="https://docs.microsoft.com/windows/desktop/api/strmif/ne-strmif-tagdvd_menu_id">DVD_MENU_ID</a>), and the streams are not associated with any particular title number.
