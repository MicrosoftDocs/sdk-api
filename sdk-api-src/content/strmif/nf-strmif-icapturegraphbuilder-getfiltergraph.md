...
ms.topic: method
f1_keywords: ["strmif/ICaptureGraphBuilder.GetFiltergraph"]
req.header: strmif.h
...
Address of a pointer to an <a href="https://docs.microsoft.com/windows/desktop/api/strmif/nn-strmif-igraphbuilder">IGraphBuilder</a> interface.
