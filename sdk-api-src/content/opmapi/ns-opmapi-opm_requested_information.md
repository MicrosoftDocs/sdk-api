...
description: Contains the result of an Output Protection Manager (OPM) status request. (OPM_REQUESTED_INFORMATION)
...
f1_keywords:
 ...
 - opmapi/_OPM_REQUESTED_INFORMATION
 - OPM_REQUESTED_INFORMATION
 - opmapi/OPM_REQUESTED_INFORMATION
dev_langs:
 - c++
topic_type:
 - APIRef
