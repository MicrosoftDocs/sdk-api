...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IDropTarget</b> interface inherits from the <a href="iunknown.htm">IUnknown</a> interface. <b>IDropTarget</b> also has these types of members:
<ul>
