...
ms.topic: method
f1_keywords: ["oleidl/IOleObject.EnumAdvise"]
req.header: oleidl.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/oleidl/nf-oleidl-ioleobject-enumadvise">IOleObject::EnumAdvise</a> is not implemented.
