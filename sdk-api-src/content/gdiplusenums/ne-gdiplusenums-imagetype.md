...
The <b>ImageType</b> enumeration indicates whether an image is a bitmap or a metafile. The 
			<a href="https://msdn.microsoft.com/library/ms535395(v=VS.85).aspx">Image::GetType</a> method returns an element of this enumeration.
...
<a href="https://msdn.microsoft.com/library/ms535395(v=VS.85).aspx">Image::GetType</a>
 
