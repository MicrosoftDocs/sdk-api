...
To determine whether the object type value of an EMF+ record is valid, call <a href="https://msdn.microsoft.com/library/ms534087(v=VS.85).aspx">ObjectTypeIsValid</a>.
