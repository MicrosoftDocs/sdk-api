...
The <b>HatchStyle</b> enumeration specifies the hatch pattern used by a brush of type 
			<a href="https://msdn.microsoft.com/library/ms534459(v=VS.85).aspx">HatchBrush</a>. The hatch pattern consists of a solid background color and lines drawn over the background. 
