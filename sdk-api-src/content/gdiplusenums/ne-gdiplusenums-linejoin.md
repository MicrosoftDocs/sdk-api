...
When using <b>LineJoinMiter</b> and the actual ratio exceeds the miter limit, the corner is clipped perpendicular to the miter at a distance from the inner corner that is the product of the miter limit and the pen width. 
...
When using <b>LineJoinMiterClipped</b> and the miter limit is exceeded, the join is drawn as if its type were <b>LineJoinBevel</b>; that is, when the line walls on the inside of the join meet, then a joining line is drawn between the line walls on the outside of the join.
