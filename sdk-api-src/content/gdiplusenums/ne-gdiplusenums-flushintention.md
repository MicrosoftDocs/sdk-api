...
When passed to the 
				<a href="https://msdn.microsoft.com/library/ms535692(v=VS.85).aspx">Graphics::Flush</a> method, specifies that pending rendering operations are executed as soon as possible. The 
