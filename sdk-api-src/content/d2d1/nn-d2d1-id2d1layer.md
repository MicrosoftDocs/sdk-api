...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">ID2D1Layer</b> interface inherits from <a href="/windows/win32/api/d2d1/nn-d2d1-id2d1resource">ID2D1Resource</a>. <b>ID2D1Layer</b> also has these types of members:
<ul>
