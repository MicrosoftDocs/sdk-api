...
# ID2D1RenderTarget::CreateCompatibleRenderTarget(const D2D1_SIZE_F,const D2D1_SIZE_U,const D2D1_PIXEL_FORMAT,D2D1_COMPATIBLE_RENDER_TARGET_OPTIONS,ID2D1BitmapRenderTarget)
