...
ms.topic: method
f1_keywords: ["d2d1/ID2D1Factory.CreateGeometryGroup"]
req.header: d2d1.h
req.include-header: 
...
Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d2d1/nn-d2d1-id2d1geometrygroup">ID2D1GeometryGroup</a>**</b>
