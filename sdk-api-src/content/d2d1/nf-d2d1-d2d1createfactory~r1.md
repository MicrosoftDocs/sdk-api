...
description: The D2D1CreateFactory(D2D1_FACTORY_TYPE,REFIID,void**) function creates a factory object that can be used to create Direct2D resources.
helpviewer_keywords: ["D2D1CreateFactory","D2D1CreateFactory function [Direct2D]","D2D1CreateFactory(D2D1_FACTORY_TYPE","REFIID","void**)","d2d1/D2D1CreateFactory","direct2d.d2d1createfactory"]
tech.root: Direct2D
ms.date: 08/10/2022
