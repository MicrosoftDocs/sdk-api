...
To create an elipse geometry, use the <a href="https://docs.microsoft.com/windows/win32/api/d2d1/nf-d2d1-id2d1factory-createellipsegeometry">ID2D1Factory::CreateEllipseGeometry</a> method.
