---
UID: NF:d2d1.ID2D1RenderTarget.Clear
title: ID2D1RenderTarget::Clear
...
ms.date: 08/06/2018
ms.keywords: Clear, Clear method [Direct2D], Clear method [Direct2D],ID2D1RenderTarget interface, ID2D1RenderTarget interface [Direct2D],Clear method, ID2D1RenderTarget.Clear, ID2D1RenderTarget::Clear, d2d1/ID2D1RenderTarget::Clear, direct2d.ID2D1RenderTarget_Clear_ptr_COLOR_F
ms.prod: windows
