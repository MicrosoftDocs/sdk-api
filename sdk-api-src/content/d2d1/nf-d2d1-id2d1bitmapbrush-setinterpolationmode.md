...
ms.topic: method
f1_keywords: ["d2d1/ID2D1BitmapBrush.SetInterpolationMode"]
req.header: d2d1.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/d2d1/nf-d2d1-id2d1bitmapbrush-getinterpolationmode">ID2D1BitmapBrush::GetInterpolationMode</a>
 
