...
title: ID2D1Geometry::CombineWithGeometry(ID2D1Geometry,D2D1_COMBINE_MODE,const D2D1_MATRIX_3X2_F,FLOAT,ID2D1SimplifiedGeometrySink)
...
# ID2D1Geometry::CombineWithGeometry(ID2D1Geometry,D2D1_COMBINE_MODE,const D2D1_MATRIX_3X2_F,FLOAT,ID2D1SimplifiedGeometrySink)
