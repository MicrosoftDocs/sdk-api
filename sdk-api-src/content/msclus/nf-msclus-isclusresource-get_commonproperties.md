---
UID: NF:msclus.ISClusResource.get_CommonProperties
title: ISClusResource::get_CommonProperties
...
api_name:
 ...
 - ISClusResource.get_CommonProperties
product: Windows
targetos: Windows
req.lib: 
req.dll: MsClus.dll
...
<p class="CCE_Message">[The 
    <b>CommonProperties</b> property is available 
    for use in the operating systems specified in the Requirements section. It may be altered or unavailable in 
    subsequent versions.]

Returns 
    the read/write <a href="https://msdn.microsoft.com/5341d390-69dd-4e84-a443-f35a4b6c0bab">common properties</a> of a 
...
<a href="https://msdn.microsoft.com/1ac3fc77-cfec-4f80-8f9f-7b1d8e9bc897">ClusResource.CommonROProperties</a>
 
