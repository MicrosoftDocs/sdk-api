...
ms.topic: enum
f1_keywords: ["vdslun/VDS_STORAGE_IDENTIFIER_CODE_SET"]
req.header: vdslun.h
...
The <a href="https://docs.microsoft.com/windows/desktop/api/vdslun/ns-vdslun-_vds_storage_identifier">VDS_STORAGE_IDENTIFIER</a> structure includes 
