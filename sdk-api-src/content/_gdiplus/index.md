...
| [DitherType enumeration](..\gdipluspixelformats\ne-gdipluspixelformats-dithertype.md) | The DitherType enumeration identifies the available algorithms for dithering when a bitmap is converted. |
...
| [Bitmap class](..\gdiplusheaders\nl-gdiplusheaders-bitmap.md) | The Bitmap class inherits from the Image class. |
| [Blur class](..\gdipluseffects\nl-gdipluseffects-blur.md) | The Blur class enables you to apply a Gaussian blur effect to a bitmap and specify the nature of the blur. |
...
| [Brush class](..\gdiplusbrush\nl-gdiplusbrush-brush.md) | The Brush class is an abstract base class that defines a Brush object. A Brush object is used to paint the interior of graphics shapes, such as rectangles, ellipses, pies, polygons, and paths. |
| [CachedBitmap class](..\gdiplusheaders\nl-gdiplusheaders-cachedbitmap.md) | A CachedBitmap object stores a bitmap in a format that is optimized for display on a particular device. To display a cached bitmap, call the Graphics |
...
| [Color class](..\gdipluscolor\nl-gdipluscolor-color.md) | A Color object stores a 32-bit value that represents a color. |
...
| [CustomLineCap class](..\gdiplusheaders\nl-gdiplusheaders-customlinecap.md) | The CustomLineCap class encapsulates a custom line cap. |
...
| [Font class](..\gdiplusheaders\nl-gdiplusheaders-font.md) | The Font class encapsulates the characteristics, such as family, height, size, and style (or combination of styles), of a specific font. A Font object is used when drawing strings. |
| [FontCollection class](..\gdiplusheaders\nl-gdiplusheaders-fontcollection.md) | The FontCollection class is an abstract base class. It contains methods for enumerating the font families in a collection of fonts. Objects built from this class include the InstalledFontCollection and PrivateFontCollection classes. |
| [FontFamily class](..\gdiplusheaders\nl-gdiplusheaders-fontfamily.md) | This FontFamily class encapsulates a set of fonts that make up a font family. A font family is a group of fonts that have the same typeface but different styles. |
| [GdiplusBase class](..\gdiplusbase\nl-gdiplusbase-gdiplusbase.md) | The GdiplusBase class provides memory allocation and deallocation for GDI+ objects. GdiplusBase serves as a base class for all other GDI+ classes, so you never need to create an instance of GdiplusBase. |
| [Graphics class](..\gdiplusgraphics\nl-gdiplusgraphics-graphics.md) | The Graphics class provides methods for drawing lines, curves, figures, images, and text. A Graphics object stores attributes of the display device and attributes of the items to be drawn. |
| [GraphicsPath class](..\gdipluspath\nl-gdipluspath-graphicspath.md) | A GraphicsPath object stores a sequence of lines, curves, and shapes. |
...
| [HatchBrush class](..\gdiplusbrush\nl-gdiplusbrush-hatchbrush.md) | This HatchBrush class defines a rectangular brush with a hatch style, a foreground color, and a background color. |
...
| [Image class](..\gdiplusheaders\nl-gdiplusheaders-image.md) | The Image class provides methods for loading and saving raster images (bitmaps) and vector images (metafiles). |
| [ImageAttributes class](..\gdiplusimageattributes\nl-gdiplusimageattributes-imageattributes.md) | An ImageAttributes object contains information about how bitmap and metafile colors are manipulated during rendering. |
| [InstalledFontCollection class](..\gdiplusheaders\nl-gdiplusheaders-installedfontcollection.md) | The InstalledFontCollection class defines a class that represents the fonts installed on the system. |
| [Levels class](..\gdipluseffects\nl-gdipluseffects-levels.md) | The Levels class encompasses three bitmap adjustments |
| [LinearGradientBrush class](..\gdiplusbrush\nl-gdiplusbrush-lineargradientbrush.md) | The LinearGradientBrush class defines a brush that paints a color gradient in which the color changes evenly from the starting boundary line of the linear gradient brush to the ending boundary line of the linear gradient brush. |
| [Matrix class](..\gdiplusmatrix\nl-gdiplusmatrix-matrix.md) | A Matrix object represents a 3 &#215;3 matrix that, in turn, represents an affine transformation. |
| [Metafile class](..\gdiplusheaders\nl-gdiplusheaders-metafile.md) | The Metafile class defines a graphic metafile. A metafile contains records that describe a sequence of graphics API calls. Metafiles can be recorded (constructed) and played back (displayed). |
...
| [PathData class](..\gdiplustypes\nl-gdiplustypes-pathdata.md) | The PathData class is a helper class for the GraphicsPath and GraphicsPathIterator classes. |
| [PathGradientBrush class](..\gdipluspath\nl-gdipluspath-pathgradientbrush.md) | A PathGradientBrush object stores the attributes of a color gradient that you can use to fill the interior of a path with a gradually changing color. |
| [Pen class](..\gdipluspen\nl-gdipluspen-pen.md) | A Pen object is a Windows GDI+ object used to draw lines and curves. |
| [Point class](..\gdiplustypes\nl-gdiplustypes-point.md) | The Point class encapsulates a point in a 2-D coordinate system. |
| [PointF class](..\gdiplustypes\nl-gdiplustypes-pointf.md) | The PointF class encapsulates a point in a 2-D coordinate system. |
| [PrivateFontCollection class](..\gdiplusheaders\nl-gdiplusheaders-privatefontcollection.md) | The PrivateFontCollection is a collection class for fonts. This class keeps a collection of fonts specifically for an application. The fonts in the collection can include installed fonts as well as fonts that have not been installed on the system. |
| [Rect class](..\gdiplustypes\nl-gdiplustypes-rect.md) | A Rect object stores the upper-left corner, width, and height of a rectangle. |
| [RectF class](..\gdiplustypes\nl-gdiplustypes-rectf.md) | A RectF object stores the upper-left corner, width, and height of a rectangle. |
...
| [Region class](..\gdiplusheaders\nl-gdiplusheaders-region.md) | The Region class describes an area of the display surface. |
...
| [Size class](..\gdiplustypes\nl-gdiplustypes-size.md) | The Size class encapsulates a Width and Height dimension in a 2-D coordinate system. |
| [SizeF class](..\gdiplustypes\nl-gdiplustypes-sizef.md) | The SizeF class encapsulates a Width and Height dimension in a 2-D coordinate system. The SizeF class uses floating point coordinates. |
| [SolidBrush class](..\gdiplusbrush\nl-gdiplusbrush-solidbrush.md) | The SolidBrush class defines a solid color Brush object. A Brush object is used to fill in shapes similar to the way a paint brush can paint the inside of a shape. This class inherits from the Brush abstract base class. |
...
| [TextureBrush class](..\gdiplusbrush\nl-gdiplusbrush-texturebrush.md) | The TextureBrush class defines a Brush object that contains an Image object that is used for the fill. The fill image can be transformed by using the local Matrix object contained in the Brush object. |
...
| [Bitmap::ApplyEffect(IN Bitmap,IN INT,IN Effect,IN RECT,OUT RECT,OUT Bitmap)](..\gdiplusheaders\nf-gdiplusheaders-bitmap-applyeffect(in bitmap,in int,in effect,in rect,out rect,out bitmap).md) | This topic lists the ApplyEffect methods of the Bitmap class. For a complete list of methods for the Bitmap class, see Bitmap Methods. |
| [Bitmap::ApplyEffect](..\gdiplusheaders\nf-gdiplusheaders-bitmap-applyeffect.md) | This topic lists the ApplyEffect methods of the Bitmap class. For a complete list of methods for the Bitmap class, see Bitmap Methods. |
| [Bitmap::Bitmap(GpBitmap)](..\gdiplusheaders\nf-gdiplusheaders-bitmap-bitmap(gpbitmap).md) | This topic lists the constructors of the Bitmap class. For a complete class listing, see Bitmap Class. |
| [Bitmap::Bitmap(IN HBITMAP,IN HPALETTE)](..\gdiplusheaders\nf-gdiplusheaders-bitmap-bitmap(in hbitmap,in hpalette).md) | This topic lists the constructors of the Bitmap class. For a complete class listing, see Bitmap Class. |
| [Bitmap::Bitmap(IN HICON)](..\gdiplusheaders\nf-gdiplusheaders-bitmap-bitmap(in hicon).md) | This topic lists the constructors of the Bitmap class. For a complete class listing, see Bitmap Class. |
| [Bitmap::Bitmap(IN HINSTANCE,IN const WCHAR)](..\gdiplusheaders\nf-gdiplusheaders-bitmap-bitmap(in hinstance,in const wchar).md) | This topic lists the constructors of the Bitmap class. For a complete class listing, see Bitmap Class. |
| [Bitmap::Bitmap(IN IDirectDrawSurface7)](..\gdiplusheaders\nf-gdiplusheaders-bitmap-bitmap(in idirectdrawsurface7).md) | This topic lists the constructors of the Bitmap class. For a complete class listing, see Bitmap Class. |
| [Bitmap::Bitmap(IN INT,IN INT,IN Graphics)](..\gdiplusheaders\nf-gdiplusheaders-bitmap-bitmap(in int,in int,in graphics).md) | This topic lists the constructors of the Bitmap class. For a complete class listing, see Bitmap Class. |
| [Bitmap::Bitmap(IN INT,IN INT,IN PixelFormat)](..\gdiplusheaders\nf-gdiplusheaders-bitmap-bitmap(in int,in int,in pixelformat).md) | This topic lists the constructors of the Bitmap class. For a complete class listing, see Bitmap Class. |
| [Bitmap::Bitmap(IN IStream,IN BOOL)](..\gdiplusheaders\nf-gdiplusheaders-bitmap-bitmap(in istream,in bool).md) | This topic lists the constructors of the Bitmap class. For a complete class listing, see Bitmap Class. |
| [Bitmap::Bitmap(IN const BITMAPINFO,IN VOID)](..\gdiplusheaders\nf-gdiplusheaders-bitmap-bitmap(in const bitmapinfo,in void).md) | This topic lists the constructors of the Bitmap class. For a complete class listing, see Bitmap Class. |
| [Bitmap::Bitmap(IN const WCHAR,IN BOOL)](..\gdiplusheaders\nf-gdiplusheaders-bitmap-bitmap(in const wchar,in bool).md) | This topic lists the constructors of the Bitmap class. For a complete class listing, see Bitmap Class. |
| [Bitmap::Bitmap(INT,INT,INT,PixelFormat,BYTE)](..\gdiplusheaders\nf-gdiplusheaders-bitmap-bitmap(int,int,int,pixelformat,byte).md) | This topic lists the constructors of the Bitmap class. For a complete class listing, see Bitmap Class. |
| [Bitmap::Bitmap(const Bitmap &)](..\gdiplusheaders\nf-gdiplusheaders-bitmap-bitmap(const bitmap &).md) | This topic lists the constructors of the Bitmap class. For a complete class listing, see Bitmap Class. |
| [Bitmap::Clone(IN INT,IN INT,IN INT,IN INT,IN PixelFormat)](..\gdiplusheaders\nf-gdiplusheaders-bitmap-clone(in int,in int,in int,in int,in pixelformat).md) | This topic lists the Clone methods of the Bitmap class. For a complete list of methods for the Bitmap class, see Bitmap Methods. |
| [Bitmap::Clone(IN REAL,IN REAL,IN REAL,IN REAL,IN PixelFormat)](..\gdiplusheaders\nf-gdiplusheaders-bitmap-clone(in real,in real,in real,in real,in pixelformat).md) | This topic lists the Clone methods of the Bitmap class. For a complete list of methods for the Bitmap class, see Bitmap Methods. |
| [Bitmap::Clone(IN const RectF &,IN PixelFormat)](..\gdiplusheaders\nf-gdiplusheaders-bitmap-clone(in const rectf &,in pixelformat).md) | This topic lists the Clone methods of the Bitmap class. For a complete list of methods for the Bitmap class, see Bitmap Methods. |
| [Bitmap::Clone](..\gdiplusheaders\nf-gdiplusheaders-bitmap-clone.md) | This topic lists the Clone methods of the Bitmap class. For a complete list of methods for the Bitmap class, see Bitmap Methods. |
| [Bitmap::ConvertFormat](..\gdiplusheaders\nf-gdiplusheaders-bitmap-convertformat.md) | The Bitmap |
...
| [Bitmap::GetHistogramSize](..\gdiplusheaders\nf-gdiplusheaders-bitmap-gethistogramsize.md) | The Bitmap |
| [Bitmap::GetHistogram](..\gdiplusheaders\nf-gdiplusheaders-bitmap-gethistogram.md) | The Bitmap |
| [Bitmap::GetPixel](..\gdiplusheaders\nf-gdiplusheaders-bitmap-getpixel.md) | The Bitmap |
| [Bitmap::InitializePalette](..\gdiplusheaders\nf-gdiplusheaders-bitmap-initializepalette.md) | The Bitmap |
...
| [Font::Font(GpFont,Status)](..\gdiplusheaders\nf-gdiplusheaders-font-font(gpfont,status).md) | This topic lists the constructors of the Font class. For a complete class listing, see Font Class. |
| [Font::Font(IN HDC)](..\gdiplusheaders\nf-gdiplusheaders-font-font(in hdc).md) | This topic lists the constructors of the Font class. For a complete class listing, see Font Class. |
| [Font::Font(IN HDC,IN const HFONT)](..\gdiplusheaders\nf-gdiplusheaders-font-font(in hdc,in const hfont).md) | This topic lists the constructors of the Font class. For a complete class listing, see Font Class. |
| [Font::Font(IN HDC,IN const LOGFONTA)](..\gdiplusheaders\nf-gdiplusheaders-font-font(in hdc,in const logfonta).md) | This topic lists the constructors of the Font class. For a complete class listing, see Font Class. |
| [Font::Font(IN HDC,IN const LOGFONTW)](..\gdiplusheaders\nf-gdiplusheaders-font-font(in hdc,in const logfontw).md) | This topic lists the constructors of the Font class. For a complete class listing, see Font Class. |
| [Font::Font(IN const FontFamily,IN REAL,IN INT,IN Unit)](..\gdiplusheaders\nf-gdiplusheaders-font-font(in const fontfamily,in real,in int,in unit).md) | This topic lists the constructors of the Font class. For a complete class listing, see Font Class. |
| [Font::Font(IN const WCHAR,IN REAL,IN INT,IN Unit,IN const FontCollection)](..\gdiplusheaders\nf-gdiplusheaders-font-font(in const wchar,in real,in int,in unit,in const fontcollection).md) | This topic lists the constructors of the Font class. For a complete class listing, see Font Class. |
| [Font::Font(const Font &)](..\gdiplusheaders\nf-gdiplusheaders-font-font(const font &).md) | This topic lists the constructors of the Font class. For a complete class listing, see Font Class. |
| [Font::GetFamily](..\gdiplusheaders\nf-gdiplusheaders-font-getfamily.md) | The Font |
| [Font::GetHeight(IN REAL)](..\gdiplusheaders\nf-gdiplusheaders-font-getheight(in real).md) | This topic lists the GetHeight methods of the Font class. For a complete list of methods for the Font class, see Font Methods. |
| [Font::GetHeight](..\gdiplusheaders\nf-gdiplusheaders-font-getheight.md) | This topic lists the GetHeight methods of the Font class. For a complete list of methods for the Font class, see Font Methods. |
...
| [FontFamily::FontFamily(GpFontFamily,Status)](..\gdiplusheaders\nf-gdiplusheaders-fontfamily-fontfamily(gpfontfamily,status).md) | This topic lists the constructors of the FontFamily class. For a complete class listing, see FontFamilyClass. |
| [FontFamily::FontFamily(IN const WCHAR,IN const FontCollection)](..\gdiplusheaders\nf-gdiplusheaders-fontfamily-fontfamily(in const wchar,in const fontcollection).md) | This topic lists the constructors of the FontFamily class. For a complete class listing, see FontFamilyClass. |
| [FontFamily::FontFamily(const FontFamily &)](..\gdiplusheaders\nf-gdiplusheaders-fontfamily-fontfamily(const fontfamily &).md) | This topic lists the constructors of the FontFamily class. For a complete class listing, see FontFamilyClass. |
| [FontFamily::FontFamily](..\gdiplusheaders\nf-gdiplusheaders-fontfamily-fontfamily.md) | This topic lists the constructors of the FontFamily class. For a complete class listing, see FontFamilyClass. |
...
| [Graphics::DrawEllipse(IN const Pen,IN INT,IN INT,IN INT,IN INT)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawellipse(in const pen,in int,in int,in int,in int).md) | This topic lists the DrawEllipse methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawEllipse(IN const Pen,IN REAL,IN REAL,IN REAL,IN REAL)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawellipse(in const pen,in real,in real,in real,in real).md) | This topic lists the DrawEllipse methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawEllipse(IN const Pen,IN const Rect &)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawellipse(in const pen,in const rect &).md) | This topic lists the DrawEllipse methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawEllipse](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawellipse.md) | This topic lists the DrawEllipse methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawImage(IN Image,IN INT,IN INT)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawimage(in image,in int,in int).md) | This topic lists the DrawImage methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawImage(IN Image,IN INT,IN INT,IN INT,IN INT)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawimage(in image,in int,in int,in int,in int).md) | This topic lists the DrawImage methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawImage(IN Image,IN INT,IN INT,IN INT,IN INT,IN INT,IN INT,IN Unit)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawimage(in image,in int,in int,in int,in int,in int,in int,in unit).md) | This topic lists the DrawImage methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawImage(IN Image,IN REAL,IN REAL)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawimage(in image,in real,in real).md) | This topic lists the DrawImage methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawImage(IN Image,IN REAL,IN REAL,IN REAL,IN REAL)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawimage(in image,in real,in real,in real,in real).md) | This topic lists the DrawImage methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawImage(IN Image,IN REAL,IN REAL,IN REAL,IN REAL,IN REAL,IN REAL,IN Unit)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawimage(in image,in real,in real,in real,in real,in real,in real,in unit).md) | This topic lists the DrawImage methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawImage(IN Image,IN RectF,IN Matrix,IN Effect,IN ImageAttributes,IN Unit)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawimage(in image,in rectf,in matrix,in effect,in imageattributes,in unit).md) | This topic lists the DrawImage methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawImage(IN Image,IN const Point &)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawimage(in image,in const point &).md) | This topic lists the DrawImage methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawImage(IN Image,IN const Point,IN INT)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawimage(in image,in const point,in int).md) | This topic lists the DrawImage methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawImage(IN Image,IN const Point,IN INT,IN INT,IN INT,IN INT,IN INT,IN Unit,IN const ImageAttributes,IN DrawImageAbort,IN VOID)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawimage(in image,in const point,in int,in int,in int,in int,in int,in unit,in const imageattributes,in drawimageabort,in void).md) | This topic lists the DrawImage methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawImage(IN Image,IN const PointF,IN INT)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawimage(in image,in const pointf,in int).md) | This topic lists the DrawImage methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawImage(IN Image,IN const PointF,IN INT,IN REAL,IN REAL,IN REAL,IN REAL,IN Unit,IN const ImageAttributes,IN DrawImageAbort,IN VOID)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawimage(in image,in const pointf,in int,in real,in real,in real,in real,in unit,in const imageattributes,in drawimageabort,in void).md) | This topic lists the DrawImage methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawImage(IN Image,IN const Rect &)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawimage(in image,in const rect &).md) | This topic lists the DrawImage methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawImage(IN Image,IN const Rect &,IN INT,IN INT,IN INT,IN INT,IN Unit,IN const ImageAttributes,IN DrawImageAbort,IN VOID)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawimage(in image,in const rect &,in int,in int,in int,in int,in unit,in const imageattributes,in drawimageabort,in void).md) | This topic lists the DrawImage methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawImage(IN Image,IN const RectF &)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawimage(in image,in const rectf &).md) | This topic lists the DrawImage methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawImage(IN Image,IN const RectF &,IN REAL,IN REAL,IN REAL,IN REAL,IN Unit,IN const ImageAttributes,IN DrawImageAbort,IN VOID)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawimage(in image,in const rectf &,in real,in real,in real,in real,in unit,in const imageattributes,in drawimageabort,in void).md) | This topic lists the DrawImage methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawImage(IN Image,IN const RectF &,IN const RectF &,IN Unit,IN const ImageAttributes)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawimage(in image,in const rectf &,in const rectf &,in unit,in const imageattributes).md) | This topic lists the DrawImage methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawImage](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawimage.md) | This topic lists the DrawImage methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawLine(IN const Pen,IN INT,IN INT,IN INT,IN INT)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawline(in const pen,in int,in int,in int,in int).md) | This topic lists the DrawLine methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawLine(IN const Pen,IN const Point &,IN const Point &)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawline(in const pen,in const point &,in const point &).md) | This topic lists the DrawLine methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawLine(IN const Pen,IN const PointF &,IN const PointF &)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawline(in const pen,in const pointf &,in const pointf &).md) | This topic lists the DrawLine methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawLine](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawline.md) | This topic lists the DrawLine methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
...
| [Graphics::DrawRectangle(IN const Pen,IN INT,IN INT,IN INT,IN INT)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawrectangle(in const pen,in int,in int,in int,in int).md) | This topic lists the DrawRectangle methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawRectangle(IN const Pen,IN REAL,IN REAL,IN REAL,IN REAL)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawrectangle(in const pen,in real,in real,in real,in real).md) | This topic lists the DrawRectangle methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawRectangle(IN const Pen,IN const Rect &)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawrectangle(in const pen,in const rect &).md) | This topic lists the DrawRectangle methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::DrawRectangle](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-drawrectangle.md) | This topic lists the DrawRectangle methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
...
| [Graphics::FillEllipse(IN const Brush,IN INT,IN INT,IN INT,IN INT)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-fillellipse(in const brush,in int,in int,in int,in int).md) | This topic lists the FillEllipse methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::FillEllipse(IN const Brush,IN REAL,IN REAL,IN REAL,IN REAL)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-fillellipse(in const brush,in real,in real,in real,in real).md) | This topic lists the FillEllipse methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::FillEllipse(IN const Brush,IN const Rect &)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-fillellipse(in const brush,in const rect &).md) | This topic lists the FillEllipse methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::FillEllipse](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-fillellipse.md) | This topic lists the FillEllipse methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
...
| [Graphics::FillRectangle(IN const Brush,IN INT,IN INT,IN INT,IN INT)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-fillrectangle(in const brush,in int,in int,in int,in int).md) | This topic lists the FillRectangle methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::FillRectangle(IN const Brush,IN REAL,IN REAL,IN REAL,IN REAL)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-fillrectangle(in const brush,in real,in real,in real,in real).md) | This topic lists the FillRectangle methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::FillRectangle(IN const Brush,IN const Rect &)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-fillrectangle(in const brush,in const rect &).md) | This topic lists the FillRectangle methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::FillRectangle](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-fillrectangle.md) | This topic lists the FillRectangle methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
...
| [Graphics::Graphics(GpGraphics)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-graphics(gpgraphics).md) | This topic lists the constructors of the Graphics class. For a complete class listing, see Graphics Class. |
| [Graphics::Graphics(IN HDC,IN HANDLE)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-graphics(in hdc,in handle).md) | This topic lists the constructors of the Graphics class. For a complete class listing, see Graphics Class. |
| [Graphics::Graphics(IN HWND,IN BOOL)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-graphics(in hwnd,in bool).md) | This topic lists the constructors of the Graphics class. For a complete class listing, see Graphics Class. |
| [Graphics::Graphics(IN Image)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-graphics(in image).md) | This topic lists the constructors of the Graphics class. For a complete class listing, see Graphics Class. |
| [Graphics::Graphics(const Graphics &)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-graphics(const graphics &).md) | This topic lists the constructors of the Graphics class. For a complete class listing, see Graphics Class. |
| [Graphics::Graphics](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-graphics.md) | This topic lists the constructors of the Graphics class. For a complete class listing, see Graphics Class. |
...
| [Graphics::IsVisible(IN INT,IN INT,IN INT,IN INT)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-isvisible(in int,in int,in int,in int).md) | This topic lists the IsVisible methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::IsVisible(IN REAL,IN REAL)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-isvisible(in real,in real).md) | This topic lists the IsVisible methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::IsVisible(IN REAL,IN REAL,IN REAL,IN REAL)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-isvisible(in real,in real,in real,in real).md) | This topic lists the IsVisible methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::IsVisible(IN const Point &)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-isvisible(in const point &).md) | This topic lists the IsVisible methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::IsVisible(IN const PointF &)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-isvisible(in const pointf &).md) | This topic lists the IsVisible methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::IsVisible(IN const Rect &)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-isvisible(in const rect &).md) | This topic lists the IsVisible methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::IsVisible(IN const RectF &)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-isvisible(in const rectf &).md) | This topic lists the IsVisible methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::IsVisibleClipEmpty](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-isvisibleclipempty.md) | The Graphics |
| [Graphics::IsVisible](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-isvisible.md) | This topic lists the IsVisible methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
...
| [Graphics::MeasureString(IN const WCHAR,IN INT,IN const Font,IN const PointF &,IN const StringFormat,OUT RectF)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-measurestring(in const wchar,in int,in const font,in const pointf &,in const stringformat,out rectf).md) | This topic lists the MeasureString methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::MeasureString(IN const WCHAR,IN INT,IN const Font,IN const PointF &,OUT RectF)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-measurestring(in const wchar,in int,in const font,in const pointf &,out rectf).md) | This topic lists the MeasureString methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::MeasureString(IN const WCHAR,IN INT,IN const Font,IN const RectF &,OUT RectF)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-measurestring(in const wchar,in int,in const font,in const rectf &,out rectf).md) | This topic lists the MeasureString methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::MeasureString(IN const WCHAR,IN INT,IN const Font,IN const SizeF &,IN const StringFormat,OUT SizeF,OUT INT,OUT INT)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-measurestring(in const wchar,in int,in const font,in const sizef &,in const stringformat,out sizef,out int,out int).md) | This topic lists the MeasureString methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::MeasureString](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-measurestring.md) | This topic lists the MeasureString methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
...
| [Graphics::SetClip(IN HRGN,IN CombineMode)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-setclip(in hrgn,in combinemode).md) | This topic lists the SetClip methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::SetClip(IN const GraphicsPath,IN CombineMode)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-setclip(in const graphicspath,in combinemode).md) | This topic lists the SetClip methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::SetClip(IN const Rect &,IN CombineMode)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-setclip(in const rect &,in combinemode).md) | This topic lists the SetClip methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::SetClip(IN const RectF &,IN CombineMode)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-setclip(in const rectf &,in combinemode).md) | This topic lists the SetClip methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::SetClip(IN const Region,IN CombineMode)](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-setclip(in const region,in combinemode).md) | This topic lists the SetClip methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
| [Graphics::SetClip](..\gdiplusgraphics\nf-gdiplusgraphics-graphics-setclip.md) | This topic lists the SetClip methods of the Graphics class. For a complete list of methods for the Graphics class, see Graphics. |
...
| [GraphicsPath::AddArc(IN INT,IN INT,IN INT,IN INT,IN REAL,IN REAL)](..\gdipluspath\nf-gdipluspath-graphicspath-addarc(in int,in int,in int,in int,in real,in real).md) | This topic lists the AddArc methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
| [GraphicsPath::AddArc(IN REAL,IN REAL,IN REAL,IN REAL,IN REAL,IN REAL)](..\gdipluspath\nf-gdipluspath-graphicspath-addarc(in real,in real,in real,in real,in real,in real).md) | This topic lists the AddArc methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
| [GraphicsPath::AddArc(IN const Rect &,IN REAL,IN REAL)](..\gdipluspath\nf-gdipluspath-graphicspath-addarc(in const rect &,in real,in real).md) | This topic lists the AddArc methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
| [GraphicsPath::AddArc](..\gdipluspath\nf-gdipluspath-graphicspath-addarc.md) | This topic lists the AddArc methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
| [GraphicsPath::AddBezier(IN INT,IN INT,IN INT,IN INT,IN INT,IN INT,IN INT,IN INT)](..\gdipluspath\nf-gdipluspath-graphicspath-addbezier(in int,in int,in int,in int,in int,in int,in int,in int).md) | This topic lists the AddBezier methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
| [GraphicsPath::AddBezier(IN REAL,IN REAL,IN REAL,IN REAL,IN REAL,IN REAL,IN REAL,IN REAL)](..\gdipluspath\nf-gdipluspath-graphicspath-addbezier(in real,in real,in real,in real,in real,in real,in real,in real).md) | This topic lists the AddBezier methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
| [GraphicsPath::AddBezier(IN const Point &,IN const Point &,IN const Point &,IN const Point &)](..\gdipluspath\nf-gdipluspath-graphicspath-addbezier(in const point &,in const point &,in const point &,in const point &).md) | This topic lists the AddBezier methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
| [GraphicsPath::AddBezier](..\gdipluspath\nf-gdipluspath-graphicspath-addbezier.md) | This topic lists the AddBezier methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
| [GraphicsPath::AddBeziers(IN const Point,IN INT)](..\gdipluspath\nf-gdipluspath-graphicspath-addbeziers(in const point,in int).md) | This topic lists the AddBeziers methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
| [GraphicsPath::AddBeziers](..\gdipluspath\nf-gdipluspath-graphicspath-addbeziers.md) | This topic lists the AddBeziers methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
...
| [GraphicsPath::AddLines(IN const Point,IN INT)](..\gdipluspath\nf-gdipluspath-graphicspath-addlines(in const point,in int).md) | This topic lists the AddLines methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
| [GraphicsPath::AddLines](..\gdipluspath\nf-gdipluspath-graphicspath-addlines.md) | This topic lists the AddLines methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
...
| [GraphicsPath::AddString(IN const WCHAR,IN INT,IN const FontFamily,IN INT,IN REAL,IN const Point &,IN const StringFormat)](..\gdipluspath\nf-gdipluspath-graphicspath-addstring(in const wchar,in int,in const fontfamily,in int,in real,in const point &,in const stringformat).md) | This topic lists the AddString methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
| [GraphicsPath::AddString(IN const WCHAR,IN INT,IN const FontFamily,IN INT,IN REAL,IN const Rect &,IN const StringFormat)](..\gdipluspath\nf-gdipluspath-graphicspath-addstring(in const wchar,in int,in const fontfamily,in int,in real,in const rect &,in const stringformat).md) | This topic lists the AddString methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
| [GraphicsPath::AddString(IN const WCHAR,IN INT,IN const FontFamily,IN INT,IN REAL,IN const RectF &,IN const StringFormat)](..\gdipluspath\nf-gdipluspath-graphicspath-addstring(in const wchar,in int,in const fontfamily,in int,in real,in const rectf &,in const stringformat).md) | This topic lists the AddString methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
| [GraphicsPath::AddString](..\gdipluspath\nf-gdipluspath-graphicspath-addstring.md) | This topic lists the AddString methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
...
| [GraphicsPath::GetBounds(OUT Rect,IN const Matrix,IN const Pen)](..\gdipluspath\nf-gdipluspath-graphicspath-getbounds(out rect,in const matrix,in const pen).md) | This topic lists the GetBounds methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
| [GraphicsPath::GetBounds](..\gdipluspath\nf-gdipluspath-graphicspath-getbounds.md) | This topic lists the GetBounds methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
...
| [GraphicsPath::GraphicsPath(GpPath)](..\gdipluspath\nf-gdipluspath-graphicspath-graphicspath(gppath).md) | This topic lists the constructors of the GraphicsPath class. For a complete class listing, see GraphicsPath Class. |
| [GraphicsPath::GraphicsPath(IN FillMode)](..\gdipluspath\nf-gdipluspath-graphicspath-graphicspath(in fillmode).md) | This topic lists the constructors of the GraphicsPath class. For a complete class listing, see GraphicsPath Class. |
| [GraphicsPath::GraphicsPath(IN const Point,IN const BYTE,IN INT,IN FillMode)](..\gdipluspath\nf-gdipluspath-graphicspath-graphicspath(in const point,in const byte,in int,in fillmode).md) | This topic lists the constructors of the GraphicsPath class. For a complete class listing, see GraphicsPath Class. |
| [GraphicsPath::GraphicsPath(IN const PointF,IN const BYTE,IN INT,IN FillMode)](..\gdipluspath\nf-gdipluspath-graphicspath-graphicspath(in const pointf,in const byte,in int,in fillmode).md) | This topic lists the constructors of the GraphicsPath class. For a complete class listing, see GraphicsPath Class. |
| [GraphicsPath::GraphicsPath(const GraphicsPath &)](..\gdipluspath\nf-gdipluspath-graphicspath-graphicspath(const graphicspath &).md) | This topic lists the constructors of the GraphicsPath class. For a complete class listing, see GraphicsPath Class. |
| [GraphicsPath::IsOutlineVisible(IN INT,IN INT,IN const Pen,IN const Graphics)](..\gdipluspath\nf-gdipluspath-graphicspath-isoutlinevisible(in int,in int,in const pen,in const graphics).md) | This topic lists the IsOutlineVisible methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
| [GraphicsPath::IsOutlineVisible(IN REAL,IN REAL,IN const Pen,IN const Graphics)](..\gdipluspath\nf-gdipluspath-graphicspath-isoutlinevisible(in real,in real,in const pen,in const graphics).md) | This topic lists the IsOutlineVisible methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
| [GraphicsPath::IsOutlineVisible(IN const Point &,IN const Pen,IN const Graphics)](..\gdipluspath\nf-gdipluspath-graphicspath-isoutlinevisible(in const point &,in const pen,in const graphics).md) | This topic lists the IsOutlineVisible methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
| [GraphicsPath::IsOutlineVisible](..\gdipluspath\nf-gdipluspath-graphicspath-isoutlinevisible.md) | This topic lists the IsOutlineVisible methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
| [GraphicsPath::IsVisible(IN INT,IN INT,IN const Graphics)](..\gdipluspath\nf-gdipluspath-graphicspath-isvisible(in int,in int,in const graphics).md) | This topic lists the IsVisible methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
| [GraphicsPath::IsVisible(IN REAL,IN REAL,IN const Graphics)](..\gdipluspath\nf-gdipluspath-graphicspath-isvisible(in real,in real,in const graphics).md) | This topic lists the IsVisible methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
| [GraphicsPath::IsVisible(IN const Point &,IN const Graphics)](..\gdipluspath\nf-gdipluspath-graphicspath-isvisible(in const point &,in const graphics).md) | This topic lists the IsVisible methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
| [GraphicsPath::IsVisible](..\gdipluspath\nf-gdipluspath-graphicspath-isvisible.md) | This topic lists the IsVisible methods of the GraphicsPath class. For a complete list of methods for the GraphicsPath class, see GraphicsPath. |
...
| [Image::Image(GpImage,Status)](..\gdiplusheaders\nf-gdiplusheaders-image-image(gpimage,status).md) | This topic lists the constructors of the Image class. For a complete class listing, see Image Class. |
| [Image::Image(IN IStream,IN BOOL)](..\gdiplusheaders\nf-gdiplusheaders-image-image(in istream,in bool).md) | This topic lists the constructors of the Image class. For a complete class listing, see Image Class. |
| [Image::Image(IN const Image &)](..\gdiplusheaders\nf-gdiplusheaders-image-image(in const image &).md) | This topic lists the constructors of the Image class. For a complete class listing, see Image Class. |
| [Image::Image(IN const WCHAR,IN BOOL)](..\gdiplusheaders\nf-gdiplusheaders-image-image(in const wchar,in bool).md) | This topic lists the constructors of the Image class. For a complete class listing, see Image Class. |
| [Image::Image~r3](..\gdiplusheaders\nf-gdiplusheaders-image-image~r3.md) | This topic lists the constructors of the Image class. For a complete class listing, see Image Class. |
...
| [Image::Save(IN IStream,IN const CLSID,IN const EncoderParameters)](..\gdiplusheaders\nf-gdiplusheaders-image-save(in istream,in const clsid,in const encoderparameters).md) | This topic lists the Save methods of the Image class. For a complete list of methods for the Image class, see Image Methods. |
...
| [Image::Save](..\gdiplusheaders\nf-gdiplusheaders-image-save.md) | This topic lists the Save methods of the Image class. For a complete list of methods for the Image class, see Image Methods. |
...
| [LinearGradientBrush::GetRectangle(OUT Rect)](..\gdiplusbrush\nf-gdiplusbrush-lineargradientbrush-getrectangle(out rect).md) | This topic lists the GetRectangle methods of the LinearGradientBrush class. For a complete list of methods for the LinearGradientBrush class, see LinearGradientBrush Methods. |
| [LinearGradientBrush::GetRectangle](..\gdiplusbrush\nf-gdiplusbrush-lineargradientbrush-getrectangle.md) | This topic lists the GetRectangle methods of the LinearGradientBrush class. For a complete list of methods for the LinearGradientBrush class, see LinearGradientBrush Methods. |
...
| [LinearGradientBrush::LinearGradientBrush(IN const Point &,IN const Point &,IN const Color &,IN const Color &)](..\gdiplusbrush\nf-gdiplusbrush-lineargradientbrush-lineargradientbrush(in const point &,in const point &,in const color &,in const color &).md) | This topic lists the constructors of the LinearGradientBrush class. For a complete class listing, see LinearGradientBrush Class. |
| [LinearGradientBrush::LinearGradientBrush(IN const PointF &,IN const PointF &,IN const Color &,IN const Color &)](..\gdiplusbrush\nf-gdiplusbrush-lineargradientbrush-lineargradientbrush(in const pointf &,in const pointf &,in const color &,in const color &).md) | This topic lists the constructors of the LinearGradientBrush class. For a complete class listing, see LinearGradientBrush Class. |
| [LinearGradientBrush::LinearGradientBrush(IN const Rect &,IN const Color &,IN const Color &,IN LinearGradientMode)](..\gdiplusbrush\nf-gdiplusbrush-lineargradientbrush-lineargradientbrush(in const rect &,in const color &,in const color &,in lineargradientmode).md) | This topic lists the constructors of the LinearGradientBrush class. For a complete class listing, see LinearGradientBrush Class. |
| [LinearGradientBrush::LinearGradientBrush(IN const Rect &,IN const Color &,IN const Color &,IN REAL,IN BOOL)](..\gdiplusbrush\nf-gdiplusbrush-lineargradientbrush-lineargradientbrush(in const rect &,in const color &,in const color &,in real,in bool).md) | This topic lists the constructors of the LinearGradientBrush class. For a complete class listing, see LinearGradientBrush Class. |
| [LinearGradientBrush::LinearGradientBrush(IN const RectF &,IN const Color &,IN const Color &,IN LinearGradientMode)](..\gdiplusbrush\nf-gdiplusbrush-lineargradientbrush-lineargradientbrush(in const rectf &,in const color &,in const color &,in lineargradientmode).md) | This topic lists the constructors of the LinearGradientBrush class. For a complete class listing, see LinearGradientBrush Class. |
| [LinearGradientBrush::LinearGradientBrush(IN const RectF &,IN const Color &,IN const Color &,IN REAL,IN BOOL)](..\gdiplusbrush\nf-gdiplusbrush-lineargradientbrush-lineargradientbrush(in const rectf &,in const color &,in const color &,in real,in bool).md) | This topic lists the constructors of the LinearGradientBrush class. For a complete class listing, see LinearGradientBrush Class. |
| [LinearGradientBrush::LinearGradientBrush(const LinearGradientBrush &)](..\gdiplusbrush\nf-gdiplusbrush-lineargradientbrush-lineargradientbrush(const lineargradientbrush &).md) | This topic lists the constructors of the LinearGradientBrush class. For a complete class listing, see LinearGradientBrush Class. |
| [LinearGradientBrush::LinearGradientBrush~r8](..\gdiplusbrush\nf-gdiplusbrush-lineargradientbrush-lineargradientbrush~r8.md) | This topic lists the constructors of the LinearGradientBrush class. For a complete class listing, see LinearGradientBrush Class. |
...
| [Matrix::TransformPoints(IN OUT Point,IN INT)](..\gdiplusmatrix\nf-gdiplusmatrix-matrix-transformpoints(in out point,in int).md) | This topic lists the TransformPoints methods of the Matrix class. For a complete list of methods for the Matrix class, see Matrix Methods. |
| [Matrix::TransformPoints](..\gdiplusmatrix\nf-gdiplusmatrix-matrix-transformpoints.md) | This topic lists the TransformPoints methods of the Matrix class. For a complete list of methods for the Matrix class, see Matrix Methods. |
...
| [Metafile::ConvertToEmfPlus(IN const Graphics,IN IStream,IN OUT INT,IN EmfType,IN const WCHAR)](..\gdiplusheaders\nf-gdiplusheaders-metafile-converttoemfplus(in const graphics,in istream,in out int,in emftype,in const wchar).md) | The Metafile |
| [Metafile::ConvertToEmfPlus(IN const Graphics,IN const WCHAR,IN OUT INT,IN EmfType,IN const WCHAR)](..\gdiplusheaders\nf-gdiplusheaders-metafile-converttoemfplus(in const graphics,in const wchar,in out int,in emftype,in const wchar).md) | The Metafile |
| [Metafile::ConvertToEmfPlus](..\gdiplusheaders\nf-gdiplusheaders-metafile-converttoemfplus.md) | The Metafile |
| [Metafile::EmfToWmfBits](..\gdiplusheaders\nf-gdiplusheaders-metafile-emftowmfbits.md) | Converts an enhanced-format metafile to a Windows Metafile Format (WMF) metafile and stores the converted records in a specified buffer. |
| [Metafile::GetDownLevelRasterizationLimit](..\gdiplusheaders\nf-gdiplusheaders-metafile-getdownlevelrasterizationlimit.md) | Gets the rasterization limit currently set for this metafile. |
| [Metafile::GetHENHMETAFILE](..\gdiplusheaders\nf-gdiplusheaders-metafile-gethenhmetafile.md) | The Metafile |
| [Metafile::GetMetafileHeader(IN HENHMETAFILE,OUT MetafileHeader)](..\gdiplusheaders\nf-gdiplusheaders-metafile-getmetafileheader(in henhmetafile,out metafileheader).md) | This topic lists the GetMetafileHeader methods of the Metafile class. For a complete list of methods for the Metafile class, see Metafile Methods. |
| [Metafile::GetMetafileHeader(IN IStream,OUT MetafileHeader)](..\gdiplusheaders\nf-gdiplusheaders-metafile-getmetafileheader(in istream,out metafileheader).md) | This topic lists the GetMetafileHeader methods of the Metafile class. For a complete list of methods for the Metafile class, see Metafile Methods. |
| [Metafile::GetMetafileHeader(IN const WCHAR,OUT MetafileHeader)](..\gdiplusheaders\nf-gdiplusheaders-metafile-getmetafileheader(in const wchar,out metafileheader).md) | This topic lists the GetMetafileHeader methods of the Metafile class. For a complete list of methods for the Metafile class, see Metafile Methods. |
| [Metafile::GetMetafileHeader(OUT MetafileHeader)](..\gdiplusheaders\nf-gdiplusheaders-metafile-getmetafileheader(out metafileheader).md) | This topic lists the GetMetafileHeader methods of the Metafile class. For a complete list of methods for the Metafile class, see Metafile Methods. |
| [Metafile::GetMetafileHeader](..\gdiplusheaders\nf-gdiplusheaders-metafile-getmetafileheader.md) | This topic lists the GetMetafileHeader methods of the Metafile class. For a complete list of methods for the Metafile class, see Metafile Methods. |
| [Metafile::Metafile(IN HDC,IN EmfType,IN const WCHAR)](..\gdiplusheaders\nf-gdiplusheaders-metafile-metafile(in hdc,in emftype,in const wchar).md) | This topic lists the constructors of the Metafile class. For a complete class listing, see Metafile Class. |
| [Metafile::Metafile(IN HDC,IN const Rect &,IN MetafileFrameUnit,IN EmfType,IN const WCHAR)](..\gdiplusheaders\nf-gdiplusheaders-metafile-metafile(in hdc,in const rect &,in metafileframeunit,in emftype,in const wchar).md) | This topic lists the constructors of the Metafile class. For a complete class listing, see Metafile Class. |
| [Metafile::Metafile(IN HDC,IN const RectF &,IN MetafileFrameUnit,IN EmfType,IN const WCHAR)](..\gdiplusheaders\nf-gdiplusheaders-metafile-metafile(in hdc,in const rectf &,in metafileframeunit,in emftype,in const wchar).md) | This topic lists the constructors of the Metafile class. For a complete class listing, see Metafile Class. |
| [Metafile::Metafile(IN HENHMETAFILE,IN BOOL)](..\gdiplusheaders\nf-gdiplusheaders-metafile-metafile(in henhmetafile,in bool).md) | This topic lists the constructors of the Metafile class. For a complete class listing, see Metafile Class. |
| [Metafile::Metafile(IN HMETAFILE,IN const WmfPlaceableFileHeader,IN BOOL)](..\gdiplusheaders\nf-gdiplusheaders-metafile-metafile(in hmetafile,in const wmfplaceablefileheader,in bool).md) | This topic lists the constructors of the Metafile class. For a complete class listing, see Metafile Class. |
| [Metafile::Metafile(IN IStream)](..\gdiplusheaders\nf-gdiplusheaders-metafile-metafile(in istream).md) | This topic lists the constructors of the Metafile class. For a complete class listing, see Metafile Class. |
| [Metafile::Metafile(IN IStream,IN HDC,IN EmfType,IN const WCHAR)](..\gdiplusheaders\nf-gdiplusheaders-metafile-metafile(in istream,in hdc,in emftype,in const wchar).md) | This topic lists the constructors of the Metafile class. For a complete class listing, see Metafile Class. |
| [Metafile::Metafile(IN IStream,IN HDC,IN const Rect &,IN MetafileFrameUnit,IN EmfType,IN const WCHAR)](..\gdiplusheaders\nf-gdiplusheaders-metafile-metafile(in istream,in hdc,in const rect &,in metafileframeunit,in emftype,in const wchar).md) | This topic lists the constructors of the Metafile class. For a complete class listing, see Metafile Class. |
| [Metafile::Metafile(IN IStream,IN HDC,IN const RectF &,IN MetafileFrameUnit,IN EmfType,IN const WCHAR)](..\gdiplusheaders\nf-gdiplusheaders-metafile-metafile(in istream,in hdc,in const rectf &,in metafileframeunit,in emftype,in const wchar).md) | This topic lists the constructors of the Metafile class. For a complete class listing, see Metafile Class. |
| [Metafile::Metafile(IN const WCHAR)](..\gdiplusheaders\nf-gdiplusheaders-metafile-metafile(in const wchar).md) | This topic lists the constructors of the Metafile class. For a complete class listing, see Metafile Class. |
| [Metafile::Metafile(IN const WCHAR,IN HDC,IN EmfType,IN const WCHAR)](..\gdiplusheaders\nf-gdiplusheaders-metafile-metafile(in const wchar,in hdc,in emftype,in const wchar).md) | This topic lists the constructors of the Metafile class. For a complete class listing, see Metafile Class. |
| [Metafile::Metafile(IN const WCHAR,IN HDC,IN const Rect &,IN MetafileFrameUnit,IN EmfType,IN const WCHAR)](..\gdiplusheaders\nf-gdiplusheaders-metafile-metafile(in const wchar,in hdc,in const rect &,in metafileframeunit,in emftype,in const wchar).md) | This topic lists the constructors of the Metafile class. For a complete class listing, see Metafile Class. |
| [Metafile::Metafile(IN const WCHAR,IN HDC,IN const RectF &,IN MetafileFrameUnit,IN EmfType,IN const WCHAR)](..\gdiplusheaders\nf-gdiplusheaders-metafile-metafile(in const wchar,in hdc,in const rectf &,in metafileframeunit,in emftype,in const wchar).md) | This topic lists the constructors of the Metafile class. For a complete class listing, see Metafile Class. |
| [Metafile::Metafile(IN const WCHAR,IN const WmfPlaceableFileHeader)](..\gdiplusheaders\nf-gdiplusheaders-metafile-metafile(in const wchar,in const wmfplaceablefileheader).md) | This topic lists the constructors of the Metafile class. For a complete class listing, see Metafile Class. |
| [Metafile::Metafile(const Metafile &)](..\gdiplusheaders\nf-gdiplusheaders-metafile-metafile(const metafile &).md) | This topic lists the constructors of the Metafile class. For a complete class listing, see Metafile Class. |
| [Metafile::Metafile~r15](..\gdiplusheaders\nf-gdiplusheaders-metafile-metafile~r15.md) | This topic lists the constructors of the Metafile class. For a complete class listing, see Metafile Class. |
| [Metafile::PlayRecord](..\gdiplusheaders\nf-gdiplusheaders-metafile-playrecord.md) | The Metafile |
| [Metafile::SetDownLevelRasterizationLimit](..\gdiplusheaders\nf-gdiplusheaders-metafile-setdownlevelrasterizationlimit.md) | Sets the resolution for certain brush bitmaps that are stored in this metafile. |
...
| [PathGradientBrush::GetCenterPoint(OUT Point)](..\gdipluspath\nf-gdipluspath-pathgradientbrush-getcenterpoint(out point).md) | This topic lists the GetCenterPoint methods of the PathGradientBrush class. For a complete list of methods for the PathGradientBrush class, see PathGradientBrush Methods. |
| [PathGradientBrush::GetCenterPoint](..\gdipluspath\nf-gdipluspath-pathgradientbrush-getcenterpoint.md) | This topic lists the GetCenterPoint methods of the PathGradientBrush class. For a complete list of methods for the PathGradientBrush class, see PathGradientBrush Methods. |
...
| [PathGradientBrush::GetRectangle(OUT Rect)](..\gdipluspath\nf-gdipluspath-pathgradientbrush-getrectangle(out rect).md) | This topic lists the GetRectangle methods of the PathGradientBrush class. For a complete list of methods for the PathGradientBrush class, see PathGradientBrush Methods. |
| [PathGradientBrush::GetRectangle](..\gdipluspath\nf-gdipluspath-pathgradientbrush-getrectangle.md) | This topic lists the GetRectangle methods of the PathGradientBrush class. For a complete list of methods for the PathGradientBrush class, see PathGradientBrush Methods. |
...
| [PathGradientBrush::PathGradientBrush(IN const GraphicsPath)](..\gdipluspath\nf-gdipluspath-pathgradientbrush-pathgradientbrush(in const graphicspath).md) | This topic lists the constructors of the PathGradientBrush class. For a complete class listing, see PathGradientBrushXX Class. |
| [PathGradientBrush::PathGradientBrush(IN const Point,IN INT,IN WrapMode)](..\gdipluspath\nf-gdipluspath-pathgradientbrush-pathgradientbrush(in const point,in int,in wrapmode).md) | This topic lists the constructors of the PathGradientBrush class. For a complete class listing, see PathGradientBrushXX Class. |
| [PathGradientBrush::PathGradientBrush(IN const PointF,IN INT,IN WrapMode)](..\gdipluspath\nf-gdipluspath-pathgradientbrush-pathgradientbrush(in const pointf,in int,in wrapmode).md) | This topic lists the constructors of the PathGradientBrush class. For a complete class listing, see PathGradientBrushXX Class. |
| [PathGradientBrush::PathGradientBrush(const PathGradientBrush &)](..\gdipluspath\nf-gdipluspath-pathgradientbrush-pathgradientbrush(const pathgradientbrush &).md) | This topic lists the constructors of the PathGradientBrush class. For a complete class listing, see PathGradientBrushXX Class. |
| [PathGradientBrush::PathGradientBrush~r5](..\gdipluspath\nf-gdipluspath-pathgradientbrush-pathgradientbrush~r5.md) | This topic lists the constructors of the PathGradientBrush class. For a complete class listing, see PathGradientBrushXX Class. |
...
| [Pen::Pen(GpPen,Status)](..\gdipluspen\nf-gdipluspen-pen-pen(gppen,status).md) | This topic lists the constructors of the Pen class. For a complete class listing, see Pen Class. |
| [Pen::Pen(IN const Brush,IN REAL)](..\gdipluspen\nf-gdipluspen-pen-pen(in const brush,in real).md) | This topic lists the constructors of the Pen class. For a complete class listing, see Pen Class. |
| [Pen::Pen(IN const Color &,IN REAL)](..\gdipluspen\nf-gdipluspen-pen-pen(in const color &,in real).md) | This topic lists the constructors of the Pen class. For a complete class listing, see Pen Class. |
| [Pen::Pen(const Pen &)](..\gdipluspen\nf-gdipluspen-pen-pen(const pen &).md) | This topic lists the constructors of the Pen class. For a complete class listing, see Pen Class. |
...
| [Rect::Contains(IN Rect &)](..\gdiplustypes\nf-gdiplustypes-rect-contains(in rect &).md) | This topic lists the Contains methods of the Rect class. For a complete list of methods for the Rect class, see Rect Methods. |
| [Rect::Contains(IN const Point &)](..\gdiplustypes\nf-gdiplustypes-rect-contains(in const point &).md) | This topic lists the Contains methods of the Rect class. For a complete list of methods for the Rect class, see Rect Methods. |
| [Rect::Contains](..\gdiplustypes\nf-gdiplustypes-rect-contains.md) | This topic lists the Contains methods of the Rect class. For a complete list of methods for the Rect class, see Rect Methods. |
...
| [Rect::Intersect(OUT Rect &,IN const Rect &,IN const Rect &)](..\gdiplustypes\nf-gdiplustypes-rect-intersect(out rect &,in const rect &,in const rect &).md) | This topic lists the Intersect methods of the Rect class. For a complete list of methods for the Rect class, see Rect Methods. |
| [Rect::Intersect](..\gdiplustypes\nf-gdiplustypes-rect-intersect.md) | This topic lists the Intersect methods of the Rect class. For a complete list of methods for the Rect class, see Rect Methods. |
...
| [Rect::Offset(IN INT,IN INT)](..\gdiplustypes\nf-gdiplustypes-rect-offset(in int,in int).md) | This topic lists the Offset methods of the Rect class. For a complete list of methods for the Rect class, see Rect Methods. |
| [Rect::Offset](..\gdiplustypes\nf-gdiplustypes-rect-offset.md) | This topic lists the Offset methods of the Rect class. For a complete list of methods for the Rect class, see Rect Methods. |
...
| [RectF::Contains(IN const PointF &)](..\gdiplustypes\nf-gdiplustypes-rectf-contains(in const pointf &).md) | This topic lists the Contains methods of the RectF class. For a complete list of methods for the RectF class, see RectF Methods. |
| [RectF::Contains(IN const RectF &)](..\gdiplustypes\nf-gdiplustypes-rectf-contains(in const rectf &).md) | This topic lists the Contains methods of the RectF class. For a complete list of methods for the RectF class, see RectF Methods. |
| [RectF::Contains](..\gdiplustypes\nf-gdiplustypes-rectf-contains.md) | This topic lists the Contains methods of the RectF class. For a complete list of methods for the RectF class, see RectF Methods. |
...
| [RectF::Intersect(OUT RectF &,IN const RectF &,IN const RectF &)](..\gdiplustypes\nf-gdiplustypes-rectf-intersect(out rectf &,in const rectf &,in const rectf &).md) | This topic lists the Intersect methods of the RectF class. For a complete list of methods for the RectF class, see RectF Methods. |
| [RectF::Intersect](..\gdiplustypes\nf-gdiplustypes-rectf-intersect.md) | This topic lists the Intersect methods of the RectF class. For a complete list of methods for the RectF class, see RectF Methods. |
...
| [RectF::Offset(IN REAL,IN REAL)](..\gdiplustypes\nf-gdiplustypes-rectf-offset(in real,in real).md) | This topic lists the Offset methods of the RectF class. For a complete list of methods for the RectF class, see Rect Methods. |
| [RectF::Offset](..\gdiplustypes\nf-gdiplustypes-rectf-offset.md) | This topic lists the Offset methods of the RectF class. For a complete list of methods for the RectF class, see Rect Methods. |
...
| [Region::Complement(IN const GraphicsPath)](..\gdiplusheaders\nf-gdiplusheaders-region-complement(in const graphicspath).md) | This topic lists the Complement methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::Complement(IN const RectF &)](..\gdiplusheaders\nf-gdiplusheaders-region-complement(in const rectf &).md) | This topic lists the Complement methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::Complement(IN const Region)](..\gdiplusheaders\nf-gdiplusheaders-region-complement(in const region).md) | This topic lists the Complement methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::Complement](..\gdiplusheaders\nf-gdiplusheaders-region-complement.md) | This topic lists the Complement methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::Equals](..\gdiplusheaders\nf-gdiplusheaders-region-equals.md) | The Region |
| [Region::Exclude(IN const GraphicsPath)](..\gdiplusheaders\nf-gdiplusheaders-region-exclude(in const graphicspath).md) | This topic lists the Exclude methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::Exclude(IN const RectF &)](..\gdiplusheaders\nf-gdiplusheaders-region-exclude(in const rectf &).md) | This topic lists the Exclude methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::Exclude(IN const Region)](..\gdiplusheaders\nf-gdiplusheaders-region-exclude(in const region).md) | This topic lists the Exclude methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::Exclude](..\gdiplusheaders\nf-gdiplusheaders-region-exclude.md) | This topic lists the Exclude methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::FromHRGN](..\gdiplusheaders\nf-gdiplusheaders-region-fromhrgn.md) | The Region |
| [Region::GetBounds(OUT RectF,IN const Graphics)](..\gdiplusheaders\nf-gdiplusheaders-region-getbounds(out rectf,in const graphics).md) | This topic lists the GetBounds methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::GetBounds](..\gdiplusheaders\nf-gdiplusheaders-region-getbounds.md) | This topic lists the GetBounds methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
...
| [Region::GetRegionScans(IN const Matrix,OUT Rect,OUT INT)](..\gdiplusheaders\nf-gdiplusheaders-region-getregionscans(in const matrix,out rect,out int).md) | This topic lists the GetRegionScans methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::GetRegionScansCount](..\gdiplusheaders\nf-gdiplusheaders-region-getregionscanscount.md) | The Region |
| [Region::GetRegionScans](..\gdiplusheaders\nf-gdiplusheaders-region-getregionscans.md) | This topic lists the GetRegionScans methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::Intersect(IN const GraphicsPath)](..\gdiplusheaders\nf-gdiplusheaders-region-intersect(in const graphicspath).md) | This topic lists the Intersect methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::Intersect(IN const RectF &)](..\gdiplusheaders\nf-gdiplusheaders-region-intersect(in const rectf &).md) | This topic lists the Intersect methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::Intersect(IN const Region)](..\gdiplusheaders\nf-gdiplusheaders-region-intersect(in const region).md) | This topic lists the Intersect methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::Intersect](..\gdiplusheaders\nf-gdiplusheaders-region-intersect.md) | This topic lists the Intersect methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
...
| [Region::IsVisible(IN INT,IN INT,IN INT,IN INT,IN const Graphics)](..\gdiplusheaders\nf-gdiplusheaders-region-isvisible(in int,in int,in int,in int,in const graphics).md) | This topic lists the IsVisible methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::IsVisible(IN REAL,IN REAL,IN REAL,IN REAL,IN const Graphics)](..\gdiplusheaders\nf-gdiplusheaders-region-isvisible(in real,in real,in real,in real,in const graphics).md) | This topic lists the IsVisible methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::IsVisible(IN REAL,IN REAL,IN const Graphics)](..\gdiplusheaders\nf-gdiplusheaders-region-isvisible(in real,in real,in const graphics).md) | This topic lists the IsVisible methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::IsVisible(IN const Point &,IN const Graphics)](..\gdiplusheaders\nf-gdiplusheaders-region-isvisible(in const point &,in const graphics).md) | This topic lists the IsVisible methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::IsVisible(IN const PointF &,IN const Graphics)](..\gdiplusheaders\nf-gdiplusheaders-region-isvisible(in const pointf &,in const graphics).md) | This topic lists the IsVisible methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::IsVisible(IN const Rect &,IN const Graphics)](..\gdiplusheaders\nf-gdiplusheaders-region-isvisible(in const rect &,in const graphics).md) | This topic lists the IsVisible methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::IsVisible(IN const RectF &,IN const Graphics)](..\gdiplusheaders\nf-gdiplusheaders-region-isvisible(in const rectf &,in const graphics).md) | This topic lists the IsVisible methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::IsVisible](..\gdiplusheaders\nf-gdiplusheaders-region-isvisible.md) | This topic lists the IsVisible methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
...
| [Region::Translate(IN INT,IN INT)](..\gdiplusheaders\nf-gdiplusheaders-region-translate(in int,in int).md) | This topic lists the Translate methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::Translate](..\gdiplusheaders\nf-gdiplusheaders-region-translate.md) | This topic lists the Translate methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::Union(IN const GraphicsPath)](..\gdiplusheaders\nf-gdiplusheaders-region-union(in const graphicspath).md) | This topic lists the Union methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::Union(IN const RectF &)](..\gdiplusheaders\nf-gdiplusheaders-region-union(in const rectf &).md) | This topic lists the Union methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::Union(IN const Region)](..\gdiplusheaders\nf-gdiplusheaders-region-union(in const region).md) | This topic lists the Union methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::Union](..\gdiplusheaders\nf-gdiplusheaders-region-union.md) | This topic lists the Union methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::Xor(IN const GraphicsPath)](..\gdiplusheaders\nf-gdiplusheaders-region-xor(in const graphicspath).md) | This topic lists the Xor methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::Xor(IN const RectF &)](..\gdiplusheaders\nf-gdiplusheaders-region-xor(in const rectf &).md) | This topic lists the Xor methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::Xor(IN const Region)](..\gdiplusheaders\nf-gdiplusheaders-region-xor(in const region).md) | This topic lists the Xor methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
| [Region::Xor](..\gdiplusheaders\nf-gdiplusheaders-region-xor.md) | This topic lists the Xor methods of the Region class. For a complete list of methods for the Region class, see Region Methods. |
...
| [TextureBrush::TextureBrush(IN Image,IN WrapMode)](..\gdiplusbrush\nf-gdiplusbrush-texturebrush-texturebrush(in image,in wrapmode).md) | This topic lists the constructors of the TextureBrush class. For a complete class listing, see TextureBrush Class. |
| [TextureBrush::TextureBrush(IN Image,IN WrapMode,IN INT,IN INT,IN INT,IN INT)](..\gdiplusbrush\nf-gdiplusbrush-texturebrush-texturebrush(in image,in wrapmode,in int,in int,in int,in int).md) | This topic lists the constructors of the TextureBrush class. For a complete class listing, see TextureBrush Class. |
| [TextureBrush::TextureBrush(IN Image,IN WrapMode,IN REAL,IN REAL,IN REAL,IN REAL)](..\gdiplusbrush\nf-gdiplusbrush-texturebrush-texturebrush(in image,in wrapmode,in real,in real,in real,in real).md) | This topic lists the constructors of the TextureBrush class. For a complete class listing, see TextureBrush Class. |
| [TextureBrush::TextureBrush(IN Image,IN WrapMode,IN const RectF &)](..\gdiplusbrush\nf-gdiplusbrush-texturebrush-texturebrush(in image,in wrapmode,in const rectf &).md) | This topic lists the constructors of the TextureBrush class. For a complete class listing, see TextureBrush Class. |
| [TextureBrush::TextureBrush(IN Image,IN WrapMode,const IN Rect &)](..\gdiplusbrush\nf-gdiplusbrush-texturebrush-texturebrush(in image,in wrapmode,const in rect &).md) | This topic lists the constructors of the TextureBrush class. For a complete class listing, see TextureBrush Class. |
| [TextureBrush::TextureBrush(IN Image,IN const Rect &,IN const ImageAttributes)](..\gdiplusbrush\nf-gdiplusbrush-texturebrush-texturebrush(in image,in const rect &,in const imageattributes).md) | This topic lists the constructors of the TextureBrush class. For a complete class listing, see TextureBrush Class. |
| [TextureBrush::TextureBrush(IN Image,IN const RectF &,IN const ImageAttributes)](..\gdiplusbrush\nf-gdiplusbrush-texturebrush-texturebrush(in image,in const rectf &,in const imageattributes).md) | This topic lists the constructors of the TextureBrush class. For a complete class listing, see TextureBrush Class. |
| [TextureBrush::TextureBrush(const TextureBrush &)](..\gdiplusbrush\nf-gdiplusbrush-texturebrush-texturebrush(const texturebrush &).md) | This topic lists the constructors of the TextureBrush class. For a complete class listing, see TextureBrush Class. |
| [TextureBrush::TextureBrush~r9](..\gdiplusbrush\nf-gdiplusbrush-texturebrush-texturebrush~r9.md) | This topic lists the constructors of the TextureBrush class. For a complete class listing, see TextureBrush Class. |
