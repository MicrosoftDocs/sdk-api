...
The <b>DRMCreateIssuanceLicense</b> function 
    creates an <a href="https://msdn.microsoft.com/library/Ff951644(v=VS.85).aspx">issuance license</a> from scratch, from a template, or from a signed issuance license.
