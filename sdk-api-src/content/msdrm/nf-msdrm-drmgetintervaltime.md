...
ms.topic: function
f1_keywords: ["msdrm/DRMGetIntervalTime"]
req.header: msdrm.h
req.include-header: 
...
<a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/msdrm/nf-msdrm-drmsetintervaltime">DRMSetIntervalTime</a>
 
