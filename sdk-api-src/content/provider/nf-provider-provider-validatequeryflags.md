...
At present, the <a href="https://msdn.microsoft.com/en-us/library/Aa392762(v=VS.85).aspx">Provider</a> class does not support any query flags. Therefore, if <i>lFlags</i> is set to a value other than zero (0),  <b>Provider::ValidateQueryFlags</b> automatically returns <b>WBEM_E_UNSUPPORTED_PARAMETER</b>.
