...
At present, the <a href="https://docs.microsoft.com/windows/desktop/api/provider/nl-provider-provider">Provider</a> class does not support any enumeration flags. Therefore, if <i>lFlags</i> is set to a value other than zero,  <b>Provider::ValidateEnumerationFlags</b> automatically returns <b>WBEM_E_UNSUPPORTED_PARAMETER</b>.
