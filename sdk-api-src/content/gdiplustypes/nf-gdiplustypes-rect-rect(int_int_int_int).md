---
UID: NF:gdiplustypes.Rect.Rect(INT,INT,INT,INT)
...
Creates a <a href="/windows/desktop/api/gdiplustypes/nl-gdiplustypes-rect">Rect</a> object by using four integers to initialize the 
			<b>X</b>, 
			<b>Y</b>, 
			<b>Width</b>, and 
