...
The <b>SizeF::Empty</b> method determines whether a 
			<a href="https://msdn.microsoft.com/library/ms534506(v=VS.85).aspx">SizeF</a> object is empty.
...
A 
				<a href="https://msdn.microsoft.com/library/ms534506(v=VS.85).aspx">SizeF</a> object is defined as empty if the 
				<b>Width</b> and 
