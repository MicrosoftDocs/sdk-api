...
The <b>SizeF::Equals</b> method determines whether two 
			<a href="https://msdn.microsoft.com/library/ms534506(v=VS.85).aspx">SizeF</a> objects are equal.
...
Type: <b>const <a href="https://msdn.microsoft.com/library/ms534506(v=VS.85).aspx">SizeF</a></b>

Reference to a 
					<a href="https://msdn.microsoft.com/library/ms534506(v=VS.85).aspx">SizeF</a> object that is compared to this 
					<b>SizeF</b> object. 
...
If the 
						...
						<a href="https://msdn.microsoft.com/library/ms534506(v=VS.85).aspx">SizeF</a> objects are equal, this method returns <b>TRUE</b>; otherwise, it returns <b>FALSE</b>.
...
Two 
				<a href="https://msdn.microsoft.com/library/ms534506(v=VS.85).aspx">SizeF</a> objects are defined as equal if the 
				<b>Width</b> and 
