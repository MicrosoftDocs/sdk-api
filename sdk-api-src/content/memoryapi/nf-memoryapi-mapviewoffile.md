...
ms.date: 11/02/2018
ms.keywords: FILE_MAP_ALL_ACCESS, FILE_MAP_COPY, FILE_MAP_EXECUTE, FILE_MAP_READ, FILE_MAP_WRITE, MapViewOfFile, MapViewOfFile function, _win32_mapviewoffile, base.mapviewoffile, fs.mapviewoffile, winbase/MapViewOfFile
...
To specify a suggested base address for the view, use the 
    <a href="https://msdn.microsoft.com/2ac8a7d6-5c52-41de-acb9-d7f975fd2a94">MapViewOfFileEx</a> function. However, this practice is 
    not recommended.
...
To obtain the size of a view, use the <a href="https://msdn.microsoft.com/3b1f7d27-1f5d-452e-b58f-560cd9b9cbd3">VirtualQuery</a> 
    function.
...
Multiple views of a file (or a file mapping object and its mapped file) are <i>coherent</i> 
    ...
    process by using the <a href="https://msdn.microsoft.com/9c8da574-5bda-49f1-a6b6-c026639d6504">DuplicateHandle</a> function, or 
...
If a file mapping object is backed by the paging file 
     (<a href="https://msdn.microsoft.com/d3302183-76a0-47ec-874f-1173db353dfe">CreateFileMapping</a> is called with the 
...
When a file mapping object that is backed by the paging file is created, the caller can  specify whether 
     ...
     freed or decommitted by calling <a href="https://msdn.microsoft.com/d6f27be8-8929-4a4d-b52c-fa99044ca243">VirtualFree</a>. Reserved and 
     committed pages are released when the view is unmapped and the file mapping object is closed. For details, see 
     the <a href="https://msdn.microsoft.com/2e9c3174-af48-4fa3-9f6a-fb62b23ed994">UnmapViewOfFile</a> and 
     <a href="https://msdn.microsoft.com/9b84891d-62ca-4ddc-97b7-c4c79482abd9">CloseHandle</a> functions.
