...
Adds an item to a collection and calls the <a href="https://msdn.microsoft.com/library/Dd757100(v=VS.85).aspx">AddRef</a> 
...
<td align="left" width="63%">
Gets next item from the list and calls the <a href="https://msdn.microsoft.com/library/Dd757100(v=VS.85).aspx">AddRef</a> 
