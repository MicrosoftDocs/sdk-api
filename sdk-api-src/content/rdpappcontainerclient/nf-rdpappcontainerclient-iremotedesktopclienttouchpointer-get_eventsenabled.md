...
description: Whether touch pointer event notifications are enabled for the RDP app container client control. (Get)
...
f1_keywords:
 ...
 - rdpappcontainerclient/IRemoteDesktopClientTouchPointer::get_EventsEnabled
dev_langs:
 - c++
topic_type:
 - APIRef
