...
ms.topic: function
f1_keywords: ["d2d1_1helper/ConvertColorSpace"]
...
Convert a <a href="https://docs.microsoft.com/windows/desktop/Direct2D/d2d1-color-f">D2D1_COLOR_F</a> from one color space to another.
