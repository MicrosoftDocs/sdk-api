...
description: Converts an array of directory service object names from one format to another. (ANSI)
helpviewer_keywords: ["DsCrackNamesA", "ntdsapi/DsCrackNamesA"]
