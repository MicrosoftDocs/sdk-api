...
The <b>DS_REPSYNCALL_ERRINFO</b> structure is used with the <a href="https://msdn.microsoft.com/en-us/library/ms676282(v=VS.85).aspx">DS_REPSYNCALL_UPDATE</a> structure to contain errors generated by the 
...
Contains one of the <a href="https://msdn.microsoft.com/en-us/library/ms676279(v=VS.85).aspx">DS_REPSYNCALL_ERROR</a> values that indicates where in the replication process the error occurred.
...
<a href="https://msdn.microsoft.com/en-us/library/ms676279(v=VS.85).aspx">DS_REPSYNCALL_ERROR</a>
