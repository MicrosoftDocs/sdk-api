...
description: The DS_NAME_RESULT_ITEM structure contains a name converted by the DsCrackNames function, along with associated error and domain data. (Unicode)
...
f1_keywords:
 ...
 - ntdsapi/PDS_NAME_RESULT_ITEMW
 - DS_NAME_RESULT_ITEMW
 - ntdsapi/DS_NAME_RESULT_ITEMW
dev_langs:
 - c++
topic_type:
 - APIRef
