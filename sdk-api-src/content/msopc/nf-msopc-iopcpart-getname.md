...
ms.date: 3/14/2018
ms.keywords: GetName method [Open Packaging Conventions], GetName method [Open Packaging Conventions], IOpcPart interface, GetName,IOpcPart.GetName, IOpcPart, IOpcPart interface [Open Packaging Conventions], GetName method, IOpcPart::GetName, msopc/IOpcPart::GetName, opc.iopcpart_getname
