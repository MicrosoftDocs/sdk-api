...
ms.topic: method
f1_keywords: ["msopc/IOpcRelationshipEnumerator.GetCurrent"]
req.header: msopc.h
req.include-header: 
...
An <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcrelationship">IOpcRelationship</a> interface pointer.
