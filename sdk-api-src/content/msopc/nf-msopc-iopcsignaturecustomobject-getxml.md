...
In the buffer, XML markup is preceded by a <a href="https://www.bing.com/search?q=byte+order+mark">byte order mark</a> that corresponds to the encoding of the markup.

Supported encodings and <a href="https://www.bing.com/search?q=byte+order+mark">byte order mark</a> values.<table>
<tr>
<th>Encoding</th>
<th>Description</th>
...
For an example of a buffer with a <a href="https://www.bing.com/search?q=byte+order+mark">byte order mark</a>, see the Remarks section.
...
The following table shows a <a href="https://www.bing.com/search?q=byte+order+mark">byte order mark</a> at the beginning of an <i>xmlMarkup</i> buffer that contains "&lt;Object Id="id1"&gt;&lt;/Object&gt;":
