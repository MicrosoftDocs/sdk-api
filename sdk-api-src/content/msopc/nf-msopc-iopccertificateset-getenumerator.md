...
ms.topic: method
f1_keywords: ["msopc/IOpcCertificateSet.GetEnumerator"]
req.header: msopc.h
req.include-header: 
...
A pointer to an <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/msopc/nn-msopc-iopccertificateenumerator">IOpcCertificateEnumerator</a> interface of certificates in the set.
