...
If this function returns an icon handle in the <b>hIcon</b> member of the <a href="https://msdn.microsoft.com/4d32826a-bb40-4805-9826-801c142b8d28">SHSTOCKICONINFO</a>  structure pointed to by <i>psii</i>, you are responsible for freeing the icon with <a href="https://msdn.microsoft.com/library/ms648063(v=VS.85).aspx">DestroyIcon</a> when you no longer need it.
