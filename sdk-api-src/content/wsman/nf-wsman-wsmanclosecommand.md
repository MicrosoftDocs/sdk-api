...
ms.topic: function
f1_keywords: ["wsman/WSManCloseCommand"]
req.header: wsman.h
req.include-header: 
...
Specifies the command handle to be closed. This handle is returned by a <a href="https://docs.microsoft.com/windows/desktop/api/wsman/nf-wsman-wsmanrunshellcommand">WSManRunShellCommand</a> call.
