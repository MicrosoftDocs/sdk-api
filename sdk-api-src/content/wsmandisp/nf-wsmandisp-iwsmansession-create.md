...
Creates a new instance of a resource and returns the <a href="https://msdn.microsoft.com/library/Aa384465(v=VS.85).aspx">endpoint reference</a> (EPR) of the new object.
...
<ul>
<li>URI with one or more  <a href="https://msdn.microsoft.com/library/Aa384465(v=VS.85).aspx">selectors</a>. Be aware that the <a href="https://msdn.microsoft.com/library/Aa384465(v=VS.85).aspx">WMI plug-in</a> does not support creating any resource other than a WS-Management protocol listener.</li>
<li>
