...
description: Gets or sets the path for a resource fragment or property when ResourceLocator is used in IWSManSession object methods such as Get, Put, or Enumerate. (Get)
...
f1_keywords:
 ...
 - wsmandisp/IWSManResourceLocator::get_FragmentPath
dev_langs:
 - c++
topic_type:
 - APIRef
