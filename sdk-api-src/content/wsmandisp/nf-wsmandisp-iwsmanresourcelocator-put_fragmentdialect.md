...
description: Gets or sets the language dialect for a resource fragment dialect when IWSManResourceLocator is used in IWSManSession object methods such as Get, Put, or Enumerate. (Put)
...
f1_keywords:
 ...
 - wsmandisp/IWSManResourceLocator::put_FragmentDialect
dev_langs:
 - c++
topic_type:
 - APIRef
