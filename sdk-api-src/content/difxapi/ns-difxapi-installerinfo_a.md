---
UID: NS:difxapi.INSTALLERINFO_A
title: INSTALLERINFO_A
...
ms.date: 2/15/2018
ms.keywords: "*PINSTALLERINFO_A, INSTALLERINFO, INSTALLERINFO structure [Device and Driver Installation], INSTALLERINFO_A, PINSTALLERINFO, PINSTALLERINFO structure pointer [Device and Driver Installation], devinst.installerinfo, difxapi-ref_2dcae2de-7f56-47e6-bbba-5e9527d56311.xml, difxapi/INSTALLERINFO, difxapi/PINSTALLERINFO"
...
req.assembly: 
req.type-library: 
req.typenames: INSTALLERINFO_A, *PINSTALLERINFO_A
topic_type:
-	APIRef
-	kbSyntax
api_type:
