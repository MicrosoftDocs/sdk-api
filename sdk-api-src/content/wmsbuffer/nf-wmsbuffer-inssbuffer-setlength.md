...
title: INSSBuffer::SetLength method
...
ms.date: 3/23/2018
ms.keywords: INSSBuffer, INSSBuffer interface [windows Media Format], SetLength method, INSSBuffer::SetLength, INSSBufferSetLength, SetLength method [windows Media Format], SetLength method [windows Media Format], INSSBuffer interface, SetLength,INSSBuffer.SetLength, wmformat.inssbuffer_setlength, wmsbuffer/INSSBuffer::SetLength
