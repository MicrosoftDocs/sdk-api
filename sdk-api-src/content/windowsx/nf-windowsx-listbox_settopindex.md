...
Ensures that the specified item in a list box is visible. You can use this macro or send the <a href="https://msdn.microsoft.com/library/Bb761356(v=VS.85).aspx">LB_SETTOPINDEX</a> message explicitly.
