...
Sets the style of a button. You can use this macro or send the <a href="https://msdn.microsoft.com/library/Bb761824(v=VS.85).aspx">BM_SETSTYLE</a> message explicitly. 
...
The button style. This parameter can be a combination of button styles. For a table of button styles, see <a href="https://msdn.microsoft.com/library/Bb775951(v=VS.85).aspx">Button Styles</a>. 
