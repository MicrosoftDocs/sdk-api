...
Finds the first string in a combo box list that exactly matches the specified string, except that the search is not case sensitive. You can use this macro or send the <a href="https://msdn.microsoft.com/library/Bb775837(v=VS.85).aspx">CB_FINDSTRINGEXACT</a> message explicitly.
...
For more information, see <a href="https://msdn.microsoft.com/library/Bb775837(v=VS.85).aspx">CB_FINDSTRINGEXACT</a>.
