...
Sets or clears the modification flag for an edit control. The modification flag indicates whether the text within the edit control has been modified. You can use this macro or send the <a href="https://msdn.microsoft.com/library/Bb761651(v=VS.85).aspx">EM_SETMODIFY</a> message explicitly.
...
For more information, see <a href="https://msdn.microsoft.com/library/Bb761651(v=VS.85).aspx">EM_SETMODIFY</a>.
