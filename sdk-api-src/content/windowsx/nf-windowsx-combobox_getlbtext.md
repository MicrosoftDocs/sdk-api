...
Gets a string from a list in a combo box. You can use this macro or send the <a href="https://msdn.microsoft.com/library/Bb775862(v=VS.85).aspx">CB_GETLBTEXT</a> message explicitly.
...
A pointer to the buffer that will receive the string. The buffer must have sufficient space for the string and a terminating null character. Before allocating the buffer, you can call <a href="https://msdn.microsoft.com/library/Bb856478(v=VS.85).aspx">ComboBox_GetLBTextLen</a> to retrieve the length of the string. 
...
For more information, see <a href="https://msdn.microsoft.com/library/Bb775862(v=VS.85).aspx">CB_GETLBTEXT</a>.
