...
Adds names to the list displayed by a combo box. The macro adds the names of directories and files that match a specified string and set of file attributes. It can also add mapped drive letters to the list in a combo box. You can use this macro or send the <a href="https://msdn.microsoft.com/library/Bb775832(v=VS.85).aspx">CB_DIR</a> message explicitly.
...
The attributes of the files or directories to be added to the list in a combo box. For more information, see <a href="https://msdn.microsoft.com/library/Bb775832(v=VS.85).aspx">CB_DIR</a>.
...
For more information, see <a href="https://msdn.microsoft.com/library/Bb775832(v=VS.85).aspx">CB_DIR</a>.
