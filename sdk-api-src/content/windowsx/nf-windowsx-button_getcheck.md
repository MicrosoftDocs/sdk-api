...
Gets the check state of a radio button or check box. You can use this macro or send the <a href="https://msdn.microsoft.com/library/Bb775986(v=VS.85).aspx">BM_GETCHECK</a> message explicitly. 
