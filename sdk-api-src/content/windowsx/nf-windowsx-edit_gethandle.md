...
Gets a handle to the memory currently allocated for the text of a multiline edit control. You can use this macro or send the <a href="https://msdn.microsoft.com/library/Bb761576(v=VS.85).aspx">EM_GETHANDLE</a> message explicitly.
...
For more information, see <a href="https://msdn.microsoft.com/library/Bb761576(v=VS.85).aspx">EM_GETHANDLE</a>.
