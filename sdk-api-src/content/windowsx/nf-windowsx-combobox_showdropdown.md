...
Shows or hides the list in a combo box. You can use this macro or send the <a href="https://msdn.microsoft.com/library/Bb775919(v=VS.85).aspx">CB_SHOWDROPDOWN</a> message explicitly.
...
This macro has no effect on a combo box created with the <a href="https://msdn.microsoft.com/library/Bb775796(v=VS.85).aspx">CBS_SIMPLE</a> style.
