...
Finds the first string in a list box that begins with the specified string. You can use this macro or send the <a href="https://msdn.microsoft.com/library/Bb775187(v=VS.85).aspx">LB_FINDSTRING</a> message explicitly.
...
<a href="https://msdn.microsoft.com/library/Bb856432(v=VS.85).aspx">ListBox_FindStringExact</a>
 
