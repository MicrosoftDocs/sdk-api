...
Sets the height of list items or the selection field in a combo box. You can use this macro or send the <a href="https://msdn.microsoft.com/library/Bb775911(v=VS.85).aspx">CB_SETITEMHEIGHT</a> message explicitly.
...
For more information, see <a href="https://msdn.microsoft.com/library/Bb775911(v=VS.85).aspx">CB_SETITEMHEIGHT</a>.
