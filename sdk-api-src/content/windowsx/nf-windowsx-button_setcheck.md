...
Sets the check state of a radio button or check box. You can use this macro or send the <a href="https://msdn.microsoft.com/library/Bb775989(v=VS.85).aspx">BM_SETCHECK</a> message explicitly. 
