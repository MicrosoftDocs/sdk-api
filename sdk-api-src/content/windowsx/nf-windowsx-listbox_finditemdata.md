...
ms.topic: macro
f1_keywords: ["windowsx/ListBox_FindItemData"]
...
Finds the first item in a list box that has the specified item data. You can use this macro or send the <a href="https://docs.microsoft.com/windows/desktop/Controls/lb-findstring">LB_FINDSTRING</a> message explicitly.
