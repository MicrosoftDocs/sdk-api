...
ms.topic: function
f1_keywords: ["powrprof/PowerWriteFriendlyName"]
...
The size of the friendly name specified by the <i>Buffer</i> parameter, including the terminating <b>NULL</b> character.
