...
# PowerReadDCValueIndex function
...
The identifier of the subgroup of power settings. Use <b>NO_SUBGROUP_GUID</b> to refer to the 
...
### -param DcValueIndex [out]

A pointer to a variable that receives the DC value index.
