...
ms.date: 3/14/2018
ms.keywords: GPM object [GPMC], GetRSOP method, GetRSOP method [GPMC], GetRSOP method [GPMC], GPM object, GetRSOP method [GPMC], IGPM interface, GetRSOP,IGPM.GetRSOP, IGPM, IGPM interface [GPMC], GetRSOP method, IGPM::GetRSOP, _win32_igpm_getrsop, gpmc.igpm_getrsop, gpmgmt/IGPM::GetRSOP, rsopLogging, rsopPlanning, rsopUnknown
