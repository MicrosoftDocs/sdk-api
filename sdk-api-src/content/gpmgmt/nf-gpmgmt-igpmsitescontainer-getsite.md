...
title: IGPMSitesContainer::GetSite method
...
ms.date: 3/14/2018
ms.keywords: GPMSitesContainer class [GPMC], GetSite method, GetSite method [GPMC], GetSite method [GPMC], GPMSitesContainer class, GetSite method [GPMC], IGPMSitesContainer interface, GetSite,IGPMSitesContainer.GetSite, IGPMSitesContainer, IGPMSitesContainer interface [GPMC], GetSite method, IGPMSitesContainer::GetSite, _win32_igpmsitescontainer_getsite, gpmc.igpmsitescontainer_getsite, gpmgmt/IGPMSitesContainer::GetSite
...
# IGPMSitesContainer::GetSite method
