...
title: IGPMGPO::GetSecurityDescriptor method
...
ms.date: 3/14/2018
ms.keywords: DACL_SECURITY_INFORMATION, GPMGPO class [GPMC], GetSecurityDescriptor method, GROUP_SECURITY_INFORMATION, GetSecurityDescriptor method [GPMC], GetSecurityDescriptor method [GPMC], GPMGPO class, GetSecurityDescriptor method [GPMC], IGPMGPO interface, GetSecurityDescriptor,IGPMGPO.GetSecurityDescriptor, IGPMGPO, IGPMGPO interface [GPMC], GetSecurityDescriptor method, IGPMGPO::GetSecurityDescriptor, OWNER_SECURITY_INFORMATION, SACL_SECURITY_INFORMATION, _win32_igpmgpo_getsecuritydescriptor, gpmc.igpmgpo_getsecuritydescriptor, gpmgmt/IGPMGPO::GetSecurityDescriptor
