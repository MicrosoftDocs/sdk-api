...
ms.topic: function
f1_keywords: ["propvarutil/InitPropVariantFromInt16"]
...
Initializes a <a href="https://docs.microsoft.com/windows/desktop/api/propidl/ns-propidl-tagpropvariant">PROPVARIANT</a> structure based on a 16-bit integer value.
