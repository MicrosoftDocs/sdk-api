...
The following example, to be included as part of a larger program, demonstrates how to use <a href="https://msdn.microsoft.com/library/Bb776543(v=VS.85).aspx">PropVariantToFileTimeVector</a> to access a FILETIME vector value in a <a href="https://msdn.microsoft.com/e86cc279-826d-4767-8d96-fc8280060ea1">PROPVARIANT</a>.
...
<a href="https://msdn.microsoft.com/library/Bb776544(v=VS.85).aspx">PropVariantToFileTimeVectorAlloc</a>
 
