...
The following example, to be included as part of a larger program, demonstrates how to use <a href="https://msdn.microsoft.com/library/Bb776556(v=VS.85).aspx">PropVariantToInt64Vector</a> to access an Int64 vector value in a <a href="https://msdn.microsoft.com/e86cc279-826d-4767-8d96-fc8280060ea1">PROPVARIANT</a>.
...
<a href="https://msdn.microsoft.com/library/Bb776557(v=VS.85).aspx">PropVariantToInt64VectorAlloc</a>
