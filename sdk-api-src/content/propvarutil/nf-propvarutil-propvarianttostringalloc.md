...
ms.topic: function
f1_keywords: ["propvarutil/PropVariantToStringAlloc"]
...
Extracts a string property value from a <a href="https://docs.microsoft.com/windows/desktop/api/propidl/ns-propidl-tagpropvariant">PROPVARIANT</a> structure.
