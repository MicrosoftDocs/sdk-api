...
The following example, to be included as part of a larger program, demonstrates how to use <a href="https://msdn.microsoft.com/library/Bb762311(v=VS.85).aspx">InitPropVariantFromUInt32</a>.
...
<a href="https://msdn.microsoft.com/library/Bb776572(v=VS.85).aspx">PropVariantToUInt32WithDefault</a>
 
