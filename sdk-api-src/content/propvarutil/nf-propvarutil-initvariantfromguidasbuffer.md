...
The following example, to be included as part of a larger program, demonstrates how to use <a href="https://www.bing.com/search?q=InitVariantFromGUIDAsBuffer">InitVariantFromGUIDAsBuffer</a>.
