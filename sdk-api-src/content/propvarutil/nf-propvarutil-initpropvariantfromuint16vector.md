...
The following example, to be included as part of a larger program, demonstrates how to use <a href="https://msdn.microsoft.com/library/Bb762310(v=VS.85).aspx">InitPropVariantFromUInt16Vector</a>.
