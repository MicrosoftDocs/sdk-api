...
The following example, to be included as part of a larger program, demonstrates how to use <a href="https://msdn.microsoft.com/library/Bb762315(v=VS.85).aspx">InitPropVariantVectorFromPropVariant</a>.
...
<a href="https://msdn.microsoft.com/library/Bb776521(v=VS.85).aspx">PropVariantGetElem</a>



<a href="https://msdn.microsoft.com/library/Bb776522(v=VS.85).aspx">PropVariantGetElementCount</a>
 
