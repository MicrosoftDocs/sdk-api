...
title: IATSC_MGT::GetTableDescriptorByTag method
...
# IATSC_MGT::GetTableDescriptorByTag method
...
Receives an <a href="https://msdn.microsoft.com/efca0ecf-eb3e-4dcd-a674-b8fe1a66ff84">IGenericDescriptor</a> interface pointer. Use this interface to retrieve the information in the descriptor. The caller must release the interface.
