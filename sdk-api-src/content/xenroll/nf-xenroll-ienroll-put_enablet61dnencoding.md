...
title: IEnroll::put_EnableT61DNEncoding (xenroll.h)
description: Sets or retrieves a Boolean value that determines whether the distinguished name in the request is encoded as a T61 string instead of as a Unicode string. (Put)
