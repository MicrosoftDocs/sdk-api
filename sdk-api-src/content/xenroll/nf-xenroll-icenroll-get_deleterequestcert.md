...
description: Sets or retrieves a Boolean value that determines whether dummy certificates in the request store are deleted. (Get)
...
f1_keywords:
 ...
 - xenroll/ICEnroll::get_DeleteRequestCert
dev_langs:
 - c++
topic_type:
 - APIRef
