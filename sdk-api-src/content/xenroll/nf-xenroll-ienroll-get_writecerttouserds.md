...
title: IEnroll::get_WriteCertToUserDS method
...
ms.date: 4/18/2018
ms.keywords: IEnroll, IEnroll interface [Security], WriteCertToUserDS property, IEnroll.WriteCertToUserDS, IEnroll::get_WriteCertToUserDS, IEnroll::put_WriteCertToUserDS, WriteCertToUserDS property [Security], WriteCertToUserDS property [Security], IEnroll interface, get_WriteCertToUserDS,IEnroll.get_WriteCertToUserDS, security.ienroll4_writecerttouserds, xenroll/IEnroll::WriteCertToUserDS, xenroll/IEnroll::get_WriteCertToUserDS, xenroll/IEnroll::put_WriteCertToUserDS
