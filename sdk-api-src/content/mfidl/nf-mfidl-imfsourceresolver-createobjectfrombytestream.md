...
<ul>
<li>
            Specify the URL in the <i>pwszURL</i> parameter.
          </li>
<li>
            Specify the MIME type by setting the <a href="https://msdn.microsoft.com/bcf86ece-2673-4ed8-98fd-cd0e2154b4a8">MF_BYTESTREAM_CONTENT_TYPE</a> attribute on the byte stream. (This attribute might be set already when you create the byte stream, depending on how the byte stream was created.)
          </li>
</ul>
