...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IMFTopoLoader</b> interface inherits from the <a href="/windows/desktop/api/unknwn/nn-unknwn-iunknown">IUnknown</a> interface. <b>IMFTopoLoader</b> also has these types of members:
<ul>
...
<a href="/windows/desktop/api/mfidl/nf-mfidl-imftopoloader-load">Load</a>
</td>
