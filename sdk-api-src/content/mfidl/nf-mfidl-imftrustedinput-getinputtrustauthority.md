...
ms.topic: method
f1_keywords: ["mfidl/IMFTrustedInput.GetInputTrustAuthority"]
req.header: mfidl.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/mfidl/nn-mfidl-imftrustedinput">IMFTrustedInput</a>
 
