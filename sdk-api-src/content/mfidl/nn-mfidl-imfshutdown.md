...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IMFShutdown</b> interface inherits from the <a href="/windows/desktop/api/unknwn/nn-unknwn-iunknown">IUnknown</a> interface. <b>IMFShutdown</b> also has these types of members:
<ul>
...
<a href="/windows/desktop/api/mfidl/nf-mfidl-imfshutdown-getshutdownstatus">GetShutdownStatus</a>
</td>
<td align="left" width="63%">
Queries the status of a prior call to the <a href="/windows/desktop/api/mfidl/nf-mfidl-imfshutdown-shutdown">Shutdown</a> method.
...
<tr data="declared;">
<td align="left" width="37%">
<a href="/windows/desktop/api/mfidl/nf-mfidl-imfshutdown-shutdown">Shutdown</a>
</td>
<td align="left" width="63%">
