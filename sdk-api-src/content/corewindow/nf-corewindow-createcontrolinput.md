...
ms.topic: function
f1_keywords: ["corewindow/CreateControlInput"]
...
Creates a <a href="https://docs.microsoft.com/en-us/uwp/api/windows.ui.core.icoreinputsourcebase">ICoreInputSourceBase</a> object in the caller’s UI thread.
