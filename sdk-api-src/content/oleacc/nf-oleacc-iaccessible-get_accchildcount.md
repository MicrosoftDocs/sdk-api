...
The number of children in an object can change. An application tracks the changes to the child count by watching for <a href="https://msdn.microsoft.com/en-us/library/Dd318066(v=VS.85).aspx">EVENT_OBJECT_CREATE</a> and <a href="https://msdn.microsoft.com/en-us/library/Dd318066(v=VS.85).aspx">EVENT_OBJECT_DESTROY</a> events generated by this object.
