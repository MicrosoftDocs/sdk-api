---
UID: NF:wbemtime.WBEMTime.operator=(const time_t &)
title: WBEMTime::operator=(const time_t &)
...
ms.date: 08/28/2018
ms.keywords: "??4WBEMTime@@QAEABV0@QAG@Z, ??4WBEMTime@@QEAAAEBV0@QEAG@Z, WBEMTime interface [Windows Management Instrumentation],operator= method, WBEMTime.operator=, WBEMTime.operator=(const time_t &), WBEMTime::operator=, WBEMTime::operator=(const BSTR&), WBEMTime::operator=(const time_t &), _hmm_wbemtime_operator_equal, operator=, operator= method [Windows Management Instrumentation], operator= method [Windows Management Instrumentation],WBEMTime interface, wbemtime/WBEMTime::operator=, wmi.wbemtime_operator_equal, wmi.wbemtime_operator_equal_const_bstr_"
ms.prod: windows
...
# WBEMTime::operator=(const time_t &)
