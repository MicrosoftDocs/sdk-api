---
UID: NF:wbemtime.WBEMTime.operator-assign(const SYSTEMTIME &)
title: WBEMTime::operator-assign(const SYSTEMTIME &)
...
# WBEMTime::operator-assign(const SYSTEMTIME &)
