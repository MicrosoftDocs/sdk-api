---
UID: NF:wbemtime.WBEMTime.operator=(const SYSTEMTIME &)
title: WBEMTime::operator=(const SYSTEMTIME &)
...
ms.date: 07/29/2018
ms.keywords: "??4WBEMTime@@QAEABV0@QAG@Z, ??4WBEMTime@@QEAAAEBV0@QEAG@Z, WBEMTime interface [Windows Management Instrumentation],operator= method, WBEMTime.operator=, WBEMTime.operator=(const SYSTEMTIME &), WBEMTime::operator=, WBEMTime::operator=(const BSTR&), WBEMTime::operator=(const SYSTEMTIME &), _hmm_wbemtime_operator_equal, operator=, operator= method [Windows Management Instrumentation], operator= method [Windows Management Instrumentation],WBEMTime interface, wbemtime/WBEMTime::operator=, wmi.wbemtime_operator_equal, wmi.wbemtime_operator_equal_const_bstr_"
ms.prod: windows
