---
UID: NF:wbemtime.WBEMTime.operator=(const FILETIME &)
title: WBEMTime::operator=(const FILETIME &)
...
ms.date: 08/03/2018
ms.keywords: "??4WBEMTime@@QAEABV0@QAG@Z, ??4WBEMTime@@QEAAAEBV0@QEAG@Z, WBEMTime interface [Windows Management Instrumentation],operator= method, WBEMTime.operator=, WBEMTime.operator=(const FILETIME &), WBEMTime::operator=, WBEMTime::operator=(const BSTR&), WBEMTime::operator=(const FILETIME &), _hmm_wbemtime_operator_equal, operator=, operator= method [Windows Management Instrumentation], operator= method [Windows Management Instrumentation],WBEMTime interface, wbemtime/WBEMTime::operator=, wmi.wbemtime_operator_equal, wmi.wbemtime_operator_equal_const_bstr_"
ms.prod: windows
