...
If the value returned is not <b>NULL</b>, the calling function must call <a href="https://msdn.microsoft.com/en-us/library/ms221481(v=VS.85).aspx">SysFreeString</a> on the returned value. This method returns the same value as <a href="https://msdn.microsoft.com/en-us/library/Aa394019(v=VS.85).aspx">WBEMTime::GetDMTF</a>(false).
