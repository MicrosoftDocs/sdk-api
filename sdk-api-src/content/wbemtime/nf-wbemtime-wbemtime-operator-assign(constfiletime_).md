---
UID: NF:wbemtime.WBEMTime.operator-assign(constFILETIME&)
title: WBEMTime::operator-assign(const FILETIME &) (wbemtime.h)
description: The WBEMTime class assignment operator overload method takes a CIM date time format parameter. (overload 5/5)
