---
UID: NF:wbemtime.WBEMTime.operator-assign(constSYSTEMTIME&)
title: WBEMTime::operator-assign(const SYSTEMTIME &) (wbemtime.h)
description: The WBEMTime class assignment operator overload method takes a CIM date time format parameter. (overload 2/5)
