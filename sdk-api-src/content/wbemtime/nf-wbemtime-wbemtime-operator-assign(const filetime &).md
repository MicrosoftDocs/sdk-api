---
UID: NF:wbemtime.WBEMTime.operator-assign(const FILETIME &)
title: WBEMTime::operator-assign(const FILETIME &)
...
ms.date: 08/30/2018
ms.keywords: "??4WBEMTime@@QAEABV0@QAG@Z, ??4WBEMTime@@QEAAAEBV0@QEAG@Z, WBEMTime interface [Windows Management Instrumentation],operator= method, WBEMTime.operator-assign(const FILETIME &), WBEMTime.operator=, WBEMTime::operator-assign(const FILETIME &), WBEMTime::operator=, WBEMTime::operator=(const BSTR&), _hmm_wbemtime_operator_equal, operator=, operator= method [Windows Management Instrumentation], operator= method [Windows Management Instrumentation],WBEMTime interface, wbemtime/WBEMTime::operator=, wmi.wbemtime_operator_equal, wmi.wbemtime_operator_equal_const_bstr_"
...
# WBEMTime::operator-assign(const FILETIME &)
...
The <a href="https://msdn.microsoft.com/b633bc8c-9d02-4bcf-8528-10773fb5ae7a">WBEMTime</a> class assignment operator overload method takes a CIM date time format parameter.
