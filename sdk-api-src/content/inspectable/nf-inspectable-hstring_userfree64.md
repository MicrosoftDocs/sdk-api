...
description: The HSTRING_UserFree64 function (inspectable.h) frees resources on the server side when called by RPC stub files.
...
f1_keywords:
 - HSTRING_UserFree64
 - inspectable/HSTRING_UserFree64
dev_langs:
 - c++
topic_type:
 - APIRef
