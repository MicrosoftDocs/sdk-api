...
description: Learn how the MCI_DGV_SETAUDIO_PARMS (ANSI) structure contains parameters for the MCI_SETAUDIO command for digital-video devices.
...
f1_keywords:
 ...
 - digitalv/MCI_DGV_SETAUDIO_PARMSA
dev_langs:
 - c++
topic_type:
 - APIRef
