...
description: Learn how the MCI_DGV_RESTORE_PARMS (ANSI) structure contains information for the MCI_RESTORE command for digital-video devices.
...
f1_keywords:
 ...
 - digitalv/MCI_DGV_RESTORE_PARMSA
dev_langs:
 - c++
topic_type:
 - APIRef
