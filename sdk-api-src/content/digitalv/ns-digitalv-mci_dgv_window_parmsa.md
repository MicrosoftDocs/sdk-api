...
description: Learn how the MCI_DGV_WINDOW_PARMS (ANSI) structure contains parameters for MCI_WINDOW command for digital-video devices.
...
f1_keywords:
 ...
 - digitalv/MCI_DGV_WINDOW_PARMSA
dev_langs:
 - c++
topic_type:
 - APIRef
