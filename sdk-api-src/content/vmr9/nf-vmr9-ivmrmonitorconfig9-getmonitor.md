...
ms.topic: method
f1_keywords: ["vmr9/IVMRMonitorConfig9.GetMonitor"]
req.header: vmr9.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/vmr9/nf-vmr9-ivmrmonitorconfig9-setmonitor">IVMRMonitorConfig9::SetMonitor</a>
