...
ms.topic: method
f1_keywords: ["vmr9/IVMRDeinterlaceControl9.GetNumberOfDeinterlaceModes"]
req.header: vmr9.h
req.include-header: 
...
Pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/vmr9/ns-vmr9-_vmr9videodesc">VMR9VideoDesc</a> structure that describes the video.
