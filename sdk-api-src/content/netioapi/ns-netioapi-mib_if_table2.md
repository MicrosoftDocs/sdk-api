...
ms.topic: struct
f1_keywords: ["netioapi/MIB_IF_TABLE2"]
...
An array of 
<a href="https://docs.microsoft.com/windows/desktop/api/netioapi/ns-netioapi-_mib_if_row2">MIB_IF_ROW2</a> structures containing interface entries.
