...
The <a href="/windows/desktop/api/netioapi/nf-netioapi-convertinterfaceluidtonamew">ConvertInterfaceLuidToNameW</a> converts a network interface LUID to a Unicode interface name. 
