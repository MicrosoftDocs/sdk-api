---
UID: NF:wbemdisp.ISWbemDateTime.get_UTC
title: ISWbemDateTime::get_UTC
...
ms.date: 06/07/2018
ms.keywords: ISWbemDateTime interface [Windows Management Instrumentation],UTC property, ISWbemDateTime.get_UTC, ISWbemDateTime.put_UTC, ISWbemDateTime::get_UTC, SWbemDateTime object [Windows Management Instrumentation],UTC property, SWbemDateTime.UTC, UTC property [Windows Management Instrumentation], UTC property [Windows Management Instrumentation],ISWbemDateTime interface, UTC property [Windows Management Instrumentation],SWbemDateTime object, _hmm_swbemdatetime.utc, get_UTC, wmi.swbemdatetime_utc
ms.prod: windows
