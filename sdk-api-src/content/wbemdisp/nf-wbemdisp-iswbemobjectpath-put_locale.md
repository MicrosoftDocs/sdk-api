---
UID: NF:wbemdisp.ISWbemObjectPath.put_Locale
title: ISWbemObjectPath::put_Locale
...
ms.date: 06/07/2018
ms.keywords: ISWbemObjectPath interface [Windows Management Instrumentation],Locale property, ISWbemObjectPath.get_Locale, ISWbemObjectPath.put_Locale, ISWbemObjectPath::put_Locale, Locale property [Windows Management Instrumentation], Locale property [Windows Management Instrumentation],ISWbemObjectPath interface, Locale property [Windows Management Instrumentation],SWbemObjectPath object, SWbemObjectPath object [Windows Management Instrumentation],Locale property, SWbemObjectPath.Locale, _hmm_swbemobjectpath.locale, put_Locale, wmi.swbemobjectpath_locale
ms.prod: windows
