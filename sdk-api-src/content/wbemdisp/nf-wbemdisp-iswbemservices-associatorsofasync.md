---
UID: NF:wbemdisp.ISWbemServices.AssociatorsOfAsync
title: ISWbemServices::AssociatorsOfAsync
...
old-location: wmi\swbemservices_associatorsofasync.htm
old-project: WmiSdk
ms.assetid: 3969d90f-d39c-40f1-9328-fc1afbaa53b1
ms.author: windowssdkdev
ms.date: 08/03/2018
ms.keywords: AssociatorsOfAsync, AssociatorsOfAsync method [Windows Management Instrumentation], AssociatorsOfAsync method [Windows Management Instrumentation],ISWbemServices interface, AssociatorsOfAsync method [Windows Management Instrumentation],SWbemServices object, ISWbemServices interface [Windows Management Instrumentation],AssociatorsOfAsync method, ISWbemServices.AssociatorsOfAsync, ISWbemServices::AssociatorsOfAsync, SWbemServices object [Windows Management Instrumentation],AssociatorsOfAsync method, SWbemServices.AssociatorsOfAsync, _hmm_swbemservices.associatorsofasync, wbemFlagDontSendStatus, wbemFlagSendStatus, wbemFlagUseAmendedQualifiers, wmi.swbemservices_associatorsofasync
ms.prod: windows
...
The 
<b>AssociatorsOfAsync</b> method of the 
<a href="https://msdn.microsoft.com/7fcfa404-2fe6-42e5-85ac-64536f6d2a44">SWbemServices</a> object returns a collection of objects (classes or instances) called endpoints that are associated with a specified object.  The call to <b>AssociatorsOfAsync</b> returns immediately, and the results and status are returned to the caller through events delivered to the sink that is specified in <i>objWbemSink</i>. To handle each returned object, create an <i>objWbemSink</i>.<a href="https://msdn.microsoft.com/14110ee7-a808-4786-b695-2ce54189d826">OnObjectReady</a> event handler.

After all the objects arrive, processing is done in the <i>objWbemSink</i>.<a href="https://msdn.microsoft.com/2723185d-5b8b-4cc7-ada3-51c3275272a9">OnCompleted</a> event. This method performs the same function that the ASSOCIATORS OF WQL query performs. For more information about creating a sink, see 
...
Required. Object sink that receives the objects asynchronously. Create an <a href="https://msdn.microsoft.com/a90777ef-fa26-4bfb-b196-c083a0c92a29">SWbemSink</a> object to receive the objects.
...
Integer that specifies the additional flags to the operation. The default for this parameter is <b>wbemFlagDontSendStatus</b>. This parameter can accept the following values.
...
Use the <i>objWbemAsyncContext</i> parameter in scripts to verify the source of a call.
...
<a href="https://msdn.microsoft.com/44989726-3f68-453b-b9f5-e76fb0fbb152">SWbemObject.ReferencesAsync_</a>
