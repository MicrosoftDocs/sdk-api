...
The 
<b>Instances_</b> method only works for class objects. It is not an error for the returned collection to have zero elements. The default behavior for this method is <a href="https://www.bing.com/search?q=semisynchronous">semisynchronous</a> because of the default <i>IFlags</i> value <b>wbemFlagReturnImmediately</b>.
