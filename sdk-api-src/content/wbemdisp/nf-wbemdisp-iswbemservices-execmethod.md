...
Use <b>SWbemServices.ExecMethod</b> as an alternative to direct access for executing a <a href="https://www.bing.com/search?q=provider+method">provider method</a> in cases where it is not possible to execute a method directly. The 
