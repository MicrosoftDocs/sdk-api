...
title: ITfPropertyStore::GetData method
...
ms.date: 3/26/2018
ms.keywords: GetData method [Text Services Framework], GetData method [Text Services Framework], ITfPropertyStore interface, GetData,ITfPropertyStore.GetData, ITfPropertyStore, ITfPropertyStore interface [Text Services Framework], GetData method, ITfPropertyStore::GetData, _tsf_itfpropertystore_getdata_ref, msctf/ITfPropertyStore::GetData, tsf.itfpropertystore_getdata
