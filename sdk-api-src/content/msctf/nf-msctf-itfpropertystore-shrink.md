...
ms.topic: method
f1_keywords: ["msctf/ITfPropertyStore.Shrink"]
req.header: msctf.h
req.include-header: 
...
Pointer to an <a href="https://docs.microsoft.com/windows/desktop/api/msctf/nn-msctf-itfrange">ITfRange</a> interface that contains the truncated range.
