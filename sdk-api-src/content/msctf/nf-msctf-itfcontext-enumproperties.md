...
title: ITfContext::EnumProperties method
...
ms.date: 3/26/2018
ms.keywords: EnumProperties method [Text Services Framework], EnumProperties method [Text Services Framework], ITfContext interface, EnumProperties,ITfContext.EnumProperties, ITfContext, ITfContext interface [Text Services Framework], EnumProperties method, ITfContext::EnumProperties, _tsf_itfcontext_enumproperties_ref, msctf/ITfContext::EnumProperties, tsf.itfcontext_enumproperties
