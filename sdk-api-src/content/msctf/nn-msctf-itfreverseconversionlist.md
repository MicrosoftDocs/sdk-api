...
title: ITfReverseConversionList
...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">ITfReverseConversionList</b> interface inherits from the <a href="https://msdn.microsoft.com/33f1d79a-33fc-4ce5-a372-e08bda378332">IUnknown</a> interface. <b>ITfReverseConversionList</b> also has these types of members:
<ul>
...
<a href="https://msdn.microsoft.com/0cf59b02-486b-412b-a8c2-b8a6e8e50248">GetLength</a>
</td>
<td align="left" width="63%">
Retrieves the number of keystroke sequences in the list.

<div class="alert"><b>Note</b>  <a href="https://msdn.microsoft.com/0cf59b02-486b-412b-a8c2-b8a6e8e50248">GetLength</a> is available for use in the operating systems specified in the Requirements section. It may be altered or unavailable in subsequent versions. For internal use only.</div>
<div> </div>
</td>
</tr>
<tr data="declared;">
...
This interface is used to store the results of the <a href="https://msdn.microsoft.com/a2312cd4-316a-42a6-85a5-e5ef819faa79">ITfReverseConversionList::DoReverseConversion</a> method.
