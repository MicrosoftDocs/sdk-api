...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">ITfTextInputProcessorEx</b> interface inherits from the <a href="/windows/desktop/api/unknwn/nn-unknwn-iunknown">IUnknown</a> interface. <b>ITfTextInputProcessorEx</b> also has these types of members:
<ul>
...
<a href="/windows/desktop/api/msctf/nf-msctf-itftextinputprocessorex-activateex">ActivateEx</a>
</td>
