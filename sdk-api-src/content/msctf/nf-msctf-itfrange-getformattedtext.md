...
The <b>ITfRange::GetFormattedText</b> method obtains formatted content contained within a range of text. The content is packaged in an object that supports the <a href="/windows/desktop/api/objidl/nn-objidl-idataobject.md">IDataObject</a> interface.
