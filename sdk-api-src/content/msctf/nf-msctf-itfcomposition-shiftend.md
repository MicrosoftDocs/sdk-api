...
title: ITfComposition::ShiftEnd method
...
ms.date: 3/26/2018
ms.keywords: ITfComposition, ITfComposition interface [Text Services Framework], ShiftEnd method, ITfComposition::ShiftEnd, ShiftEnd method [Text Services Framework], ShiftEnd method [Text Services Framework], ITfComposition interface, ShiftEnd,ITfComposition.ShiftEnd, _tsf_itfcomposition_shiftend_ref, msctf/ITfComposition::ShiftEnd, tsf.itfcomposition_shiftend
...
Pointer to an <a href="https://msdn.microsoft.com/b8889f7d-3228-4ecc-8d24-c04234d3101e">ITfRange</a> object that contains the new end anchor position. The end anchor of the context will be moved to the end anchor of this range. This method fails if the end anchor of this range is positioned prior to the start anchor of the composition.
