...
<td width="60%">
Content should be obtained as an <a href="/windows/desktop/api/objidl/nn-objidl-idataobject.md">IDataObject</a> data transfer object, with <i>riid</i> being IID_IDataObject. Clients should specify this option when a copy of the content is required.
