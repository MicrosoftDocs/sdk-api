...
title: IBDA_FrequencyFilter::get_Range method
...
ms.date: 4/26/2018
ms.keywords: IBDA_FrequencyFilter, IBDA_FrequencyFilter interface [Microsoft TV Technologies], get_Range method, IBDA_FrequencyFilter::get_Range, IBDA_FrequencyFilterget_Range, bdaiface/IBDA_FrequencyFilter::get_Range, get_Range method [Microsoft TV Technologies], get_Range method [Microsoft TV Technologies], IBDA_FrequencyFilter interface, get_Range,IBDA_FrequencyFilter.get_Range, mstv.ibda_frequencyfilter_get_range
...
# IBDA_FrequencyFilter::get_Range method
