...
ms.topic: method
f1_keywords: ["bdaiface/IBDA_Topology.SetMediaType"]
...
Pointer to an <a href="https://docs.microsoft.com/windows/desktop/api/strmif/ns-strmif-_ammediatype">AM_MEDIA_TYPE</a> structure that contains the media type.
