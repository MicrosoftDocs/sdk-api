...
title: IBDA_AUX::EnumCapability method
...
ms.date: 3/26/2018
ms.keywords: EnumCapability method [Microsoft TV Technologies], EnumCapability method [Microsoft TV Technologies], IBDA_AUX interface, EnumCapability,IBDA_AUX.EnumCapability, IBDA_AUX, IBDA_AUX interface [Microsoft TV Technologies], EnumCapability method, IBDA_AUX::EnumCapability, PBDA_AUX_CONNECTOR_TYPE_Composite, PBDA_AUX_CONNECTOR_TYPE_SVideo, bdaiface/IBDA_AUX::EnumCapability, mstv.ibda_aux_enumcapability
