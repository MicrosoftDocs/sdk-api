...
description: Indicates whether a firewall is enabled locally (the effective result may differ due to group policy settings). (Get)
...
f1_keywords:
 ...
 - netfw/INetFwPolicy2::get_FirewallEnabled
dev_langs:
 - c++
topic_type:
 - APIRef
