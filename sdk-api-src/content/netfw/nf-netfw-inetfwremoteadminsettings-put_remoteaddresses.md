...
description: Specifies a set of remote addresses from which remote administration is allowed. (Put)
...
f1_keywords:
 ...
 - netfw/INetFwRemoteAdminSettings::put_RemoteAddresses
dev_langs:
 - c++
topic_type:
 - APIRef
...
For a predefined address range, use the <a href="/previous-versions/windows/desktop/api/netfw/nf-netfw-inetfwremoteadminsettings-get_scope">Scope</a> property.
