...
Element of the <a href="https://msdn.microsoft.com/library/ms534177(v=VS.85).aspx">StringAlignment</a> enumeration that specifies how a string is aligned in reference to the bounding rectangle. 
