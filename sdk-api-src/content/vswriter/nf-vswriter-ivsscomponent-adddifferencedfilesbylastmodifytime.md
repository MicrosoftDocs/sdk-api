...
This method was not called by a writer or, if called by a writer, it either was not called during a 
        ...
        <a href="https://msdn.microsoft.com/library/Aa384652(v=VS.85).aspx">BackupComplete</a> or 
        <a href="https://msdn.microsoft.com/library/Aa384652(v=VS.85).aspx">BackupShutdown</a> event.
...
A writer calls this method to specify that certain files in a component should be backed up only if they have been modified since a certain time. For more information, see <a href="https://msdn.microsoft.com/library/Aa385002(v=VS.85).aspx">Backup By Last Modify Time</a>.
