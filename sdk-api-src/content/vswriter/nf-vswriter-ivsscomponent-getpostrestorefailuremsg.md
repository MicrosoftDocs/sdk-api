...
The caller should free the memory held by the <i>pbstrPostRestoreFailureMsg</i> parameter by calling <a href="https://msdn.microsoft.com/library/ms221481(v=VS.85).aspx">SysFreeString</a>.
