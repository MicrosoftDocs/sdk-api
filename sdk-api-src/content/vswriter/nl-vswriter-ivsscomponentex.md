...
<td align="left" width="63%">
Sets a <a href="https://msdn.microsoft.com/library/Aa384664(v=VS.85).aspx">PostSnapshot</a> failure message string for a component.
...
<td align="left" width="63%">
Sets a <a href="https://msdn.microsoft.com/library/Aa384664(v=VS.85).aspx">PrepareForBackup</a> failure message string for a component.
