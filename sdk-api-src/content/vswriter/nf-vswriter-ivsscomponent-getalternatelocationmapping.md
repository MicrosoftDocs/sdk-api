...
The caller must call <a href="/windows/desktop/api/unknwn/nf-unknwn-iunknown-release.md">IUnknown::Release</a> to release the system resources held by the <i>ppMapping</i> parameter when it is done with the 
