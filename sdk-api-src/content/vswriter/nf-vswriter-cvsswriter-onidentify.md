...
title: CVssWriter::OnIdentify method
...
ms.date: 2/15/2018
ms.keywords: CVssWriter, CVssWriter interface [VSS], OnIdentify method, CVssWriter::OnIdentify, OnIdentify method [VSS], OnIdentify method [VSS], CVssWriter interface, OnIdentify,CVssWriter.OnIdentify, _win32_cvsswriter_onidentify, base.cvsswriter_onidentify, vswriter/CVssWriter::OnIdentify
...
The 
<b>OnIdentify</b> method is called by a writer following receipt of an <a href="vssgloss_i.htm">Identify</a> event.
...
See 
<a href="writers.htm">Writer Event Handling</a> for more information on writer interactions with events.
