...
The 
<b>OnIdentify</b> method is called by a writer following receipt of an <a href="https://msdn.microsoft.com/library/Aa384659(v=VS.85).aspx">Identify</a> event.
...
See 
<a href="https://msdn.microsoft.com/library/Aa384993(v=VS.85).aspx">Writer Event Handling</a> for more information on writer interactions with events.
