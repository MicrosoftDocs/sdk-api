...
Functions such as <a href="https://msdn.microsoft.com/library/Aa365467(v=VS.85).aspx">ReadFile</a> and <a href="https://msdn.microsoft.com/library/Aa365747(v=VS.85).aspx">WriteFile</a> set this handle to the nonsignaled state before they begin an I/O operation. When the operation has completed, the handle is set to the signaled state.
...
<a href="https://msdn.microsoft.com/library/Aa365747(v=VS.85).aspx">WriteFile</a> (and related) functions.  
...
You can use the 
<a href="https://msdn.microsoft.com/library/Aa363791(v=VS.85).aspx">CancelIo</a> function to cancel an asynchronous I/O operation.
