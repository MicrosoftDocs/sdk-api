...
ms.topic: struct
f1_keywords: ["fwpmtypes/FWPM_CALLOUT_CHANGE0"]
...
A <a href="https://docs.microsoft.com/windows/desktop/api/fwpmtypes/ne-fwpmtypes-fwpm_change_type_">FWPM_CHANGE_TYPE</a> value that specifies the type of change.
