...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IWICPersistStream</b> interface inherits from <a href="https://msdn.microsoft.com/library/ms690091(v=VS.85).aspx">IPersistStream</a>. <b>IWICPersistStream</b> also has these types of members:
<ul>
