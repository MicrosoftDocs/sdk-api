...
The <b>GetCAPropertyFlags</b> method retrieves the property flags for a <a href="https://msdn.microsoft.com/en-us/library/ms721572(v=VS.85).aspx">certification authority</a> (CA) property.
...
The <b>GetCAPropertyFlags</b> method's functionality is similar to that of the <a href="https://msdn.microsoft.com/en-us/library/Aa383240(v=VS.85).aspx">ICertAdmin2::GetCAPropertyFlags</a> method. 
