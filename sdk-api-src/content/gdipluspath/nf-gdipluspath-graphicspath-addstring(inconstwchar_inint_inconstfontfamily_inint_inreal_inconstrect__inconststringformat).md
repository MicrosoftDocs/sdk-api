...
Reference to a <a href="https://msdn.microsoft.com/en-us/library/ms534495(v=VS.85).aspx">Rect</a> object that specifies, in world units, the bounding rectangle for the string. 
