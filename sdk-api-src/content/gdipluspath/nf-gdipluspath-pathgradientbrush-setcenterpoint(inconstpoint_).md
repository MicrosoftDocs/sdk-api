---
UID: NF:gdipluspath.PathGradientBrush.SetCenterPoint(INconstPoint&)
...
Reference to a 
					<a href="https://docs.microsoft.com/windows/desktop/api/gdiplustypes/nl-gdiplustypes-point">Point</a> object that specifies the center point. 
