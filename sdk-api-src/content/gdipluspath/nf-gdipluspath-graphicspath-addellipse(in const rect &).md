...
ms.date: 07/29/2018
ms.keywords: AddEllipse, AddEllipse methods [GDI+], GraphicsPath.AddEllipse, GraphicsPath.AddEllipse(IN const Rect &), GraphicsPath::AddEllipse, GraphicsPath::AddEllipse(IN const Rect &), _gdiplus_CLASS_GraphicsPath_AddEllipse_Methods, gdiplus._gdiplus_CLASS_GraphicsPath_AddEllipse_Methods, gdipluspath/AddEllipse
