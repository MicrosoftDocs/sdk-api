...
title: GraphicsPath::AddClosedCurve(IN const PointF,IN INT)
...
ms.date: 09/12/2018
ms.keywords: AddClosedCurve, AddClosedCurve method [GDI+], AddClosedCurve method [GDI+],GraphicsPath class, GraphicsPath class [GDI+],AddClosedCurve method, GraphicsPath.AddClosedCurve, GraphicsPath.AddClosedCurve(IN const PointF,IN INT), GraphicsPath.AddClosedCurve(const PointF*,INT), GraphicsPath::AddClosedCurve, GraphicsPath::AddClosedCurve(IN const PointF,IN INT), _gdiplus_CLASS_GraphicsPath_AddClosedCurve_PointF_points_INT_count_, gdiplus._gdiplus_CLASS_GraphicsPath_AddClosedCurve_PointF_points_INT_count_
...
# GraphicsPath::AddClosedCurve(IN const PointF,IN INT)
