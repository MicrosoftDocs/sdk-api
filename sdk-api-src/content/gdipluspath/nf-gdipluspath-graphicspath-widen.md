...
Type: <b>const <a href="https://msdn.microsoft.com/library/ms534485(v=VS.85).aspx">Pen</a>*</b>

Pointer to a <a href="https://msdn.microsoft.com/library/ms534485(v=VS.85).aspx">Pen</a> object. The path is made as wide as it would be when drawn by this pen. 
...
Optional. Pointer to a <a href="https://msdn.microsoft.com/library/ms534475(v=VS.85).aspx">Matrix</a> object that specifies a transformation to be applied along with the widening. If this parameter is <b>NULL</b>, no transformation is applied. The default value is <b>NULL</b>. 
