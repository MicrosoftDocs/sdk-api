...
Markers divide a path into sections. You can use a <a href="https://msdn.microsoft.com/en-us/library/ms534458(v=VS.85).aspx">GraphicsPathIterator</a> object to draw selected sections of a path.
