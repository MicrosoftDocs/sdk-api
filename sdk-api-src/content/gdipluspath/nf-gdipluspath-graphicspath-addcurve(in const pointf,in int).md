...
title: GraphicsPath::AddCurve(IN const PointF,IN INT)
...
ms.date: 09/26/2018
ms.keywords: AddCurve, AddCurve methods [GDI+], GraphicsPath.AddCurve, GraphicsPath.AddCurve(IN const PointF,IN INT), GraphicsPath::AddCurve, GraphicsPath::AddCurve(IN const PointF,IN INT), _gdiplus_CLASS_GraphicsPath_AddCurve_Methods, gdiplus._gdiplus_CLASS_GraphicsPath_AddCurve_Methods, gdipluspath/AddCurve
...
# GraphicsPath::AddCurve(IN const PointF,IN INT)
