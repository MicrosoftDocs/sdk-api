---
UID: NF:gdipluspath.GraphicsPath.AddCurve(IN const PointF,IN INT,IN INT,IN INT,IN REAL)
title: GraphicsPath::AddCurve(IN const PointF,IN INT,IN INT,IN INT,IN REAL)
