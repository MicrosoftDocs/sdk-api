...
ms.topic: method
f1_keywords: ["gdipluspath/GraphicsPath.GetLastPoint"]
...
Pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/gdiplustypes/nl-gdiplustypes-pointf">PointF</a> object that receives the last point. 
