...
ms.topic: method
f1_keywords: ["gdipluspath/GraphicsPathIterator.CopyData"]
...
The <b>GraphicsPathIterator::CopyData</b> method copies a subset of the path's data points to a <a href="https://docs.microsoft.com/windows/desktop/api/gdiplustypes/nl-gdiplustypes-pointf">PointF</a> array and copies a subset of the path's point types to a <b>BYTE</b> array.
...
You can call the <a href="https://docs.microsoft.com/windows/desktop/api/gdipluspath/nf-gdipluspath-graphicspathiterator-getcount">GraphicsPathIterator::GetCount</a> method to determine the number of data points in the path.
