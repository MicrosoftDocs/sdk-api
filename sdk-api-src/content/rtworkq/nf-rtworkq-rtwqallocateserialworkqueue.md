...
<ul>
<li>The default work queue  (<b>RTWQ_STANDARD_WORKQUEUE</b>).  See <a href="https://msdn.microsoft.com/en-us/library/Dn448453(v=VS.85).aspx">RTWQ_WORKQUEUE_TYPE</a>.</li>
<li>The platform multithreaded queue (<b>RTWQ_MULTITHREADED_WORKQUEUE</b>). See <a href="https://msdn.microsoft.com/en-us/library/Dn448453(v=VS.85).aspx">RTWQ_WORKQUEUE_TYPE</a>.</li>
...
<a href="https://msdn.microsoft.com/en-us/library/Dn448453(v=VS.85).aspx">RTWQ_WORKQUEUE_TYPE</a>
 
