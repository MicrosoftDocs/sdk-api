...
The caller should use the <a href="/windows/desktop/api/propidl/nn-propidl-ipropertysetstorage.md">IPropertySetStorage</a> and <a href="/windows/desktop/api/propidl/nn-propidl-ipropertystorage.md">IPropertyStorage</a> interfaces to locate additional properties. When this flag is set, properties available through COM enumerators should not be returned from <a href="https://msdn.microsoft.com/5fb7219a-608c-43f8-a8e3-48bbf0218c6e">IFilter</a>.
...
<a href="/windows/desktop/api/propidl/nn-propidl-ipropertysetstorage.md">IPropertySetStorage</a>



<a href="/windows/desktop/api/propidl/nn-propidl-ipropertystorage.md">IPropertyStorage</a>
 
