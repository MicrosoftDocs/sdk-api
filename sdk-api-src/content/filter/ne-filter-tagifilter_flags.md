...
The caller should use the <a href="https://msdn.microsoft.com/library/Aa379840(v=VS.85).aspx">IPropertySetStorage</a> and <a href="https://msdn.microsoft.com/library/Aa379968(v=VS.85).aspx">IPropertyStorage</a> interfaces to locate additional properties. When this flag is set, properties available through COM enumerators should not be returned from <a href="https://msdn.microsoft.com/library/ms691105(v=VS.85).aspx">IFilter</a>.
...
The <i>pdwFlags</i> parameter in the <a href="https://msdn.microsoft.com/library/ms690965(v=VS.85).aspx">IFilter::Init</a> method allows the <a href="https://msdn.microsoft.com/library/ms691105(v=VS.85).aspx">IFilter</a> implementation to pass information back to the caller. For Indexing Service 3.0, the only valid flag is IFILTER_FLAGS_OLE_PROPERTIES. If OLE properties should not be enumerated, then pdwFlags should be set to zero.
...
<a href="https://msdn.microsoft.com/library/Aa379840(v=VS.85).aspx">IPropertySetStorage</a>



<a href="https://msdn.microsoft.com/library/Aa379968(v=VS.85).aspx">IPropertyStorage</a>
 
