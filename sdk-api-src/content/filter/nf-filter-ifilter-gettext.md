...
ms.date: 3/23/2018
ms.keywords: GetText method [Indexing Service], GetText method [Indexing Service], IFilter interface, GetText,IFilter.GetText, IFilter, IFilter interface [Indexing Service], GetText method, IFilter::GetText, _idxs_IFilter_GetText, filter/IFilter::GetText, indexsrv.ifilter_gettext
...
<td width="60%">
All the text in the current chunk has been returned. Additional calls to the <a href="https://msdn.microsoft.com/library/windows/hardware/dn926850">GetText</a> method should return this error until the <a href="https://msdn.microsoft.com/4d4f3150-deec-40b6-a945-b4cea241db8d">IFilter::GetChunk</a> method has been called successfully. 
