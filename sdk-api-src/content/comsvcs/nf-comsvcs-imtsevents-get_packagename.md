...
title: IMtsEvents::get_PackageName method
...
ms.date: 2/15/2018
ms.keywords: IMtsEvents, IMtsEvents interface [COM+], get_PackageName method, IMtsEvents::get_PackageName, _dtc_IMtsEvents_PackageName, comsvcs/IMtsEvents::get_PackageName, cos.imtsevents_get_packagename, get_PackageName method [COM+], get_PackageName method [COM+], IMtsEvents interface, get_PackageName,IMtsEvents.get_PackageName
...
# IMtsEvents::get_PackageName method
