...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IComObjectConstruction2Events</b> interface inherits from the <a href="https://msdn.microsoft.com/en-us/library/ms680509(v=VS.85).aspx">IUnknown</a> interface. <b>IComObjectConstruction2Events</b> also has these types of members:
<ul>
...
<a href="https://msdn.microsoft.com/en-us/library/ms686446(v=VS.85).aspx">OnObjectConstruct2</a>
</td>
