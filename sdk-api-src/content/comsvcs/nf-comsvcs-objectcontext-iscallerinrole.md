...
title: ObjectContext::IsCallerInRole method
...
ms.date: 4/3/2018
ms.keywords: IsCallerInRole method [COM+], IsCallerInRole method [COM+], ObjectContext interface, IsCallerInRole,ObjectContext.IsCallerInRole, ObjectContext, ObjectContext interface [COM+], IsCallerInRole method, ObjectContext::IsCallerInRole, _cos_ObjectContext_IsCallerInRole, comsvcs/ObjectContext::IsCallerInRole, cos.objectcontext_iscallerinrole
...
# ObjectContext::IsCallerInRole method
...
<td width="60%">
An unexpected error has occurred. This can happen if one object passes its <a href="https://msdn.microsoft.com/09a17e57-7224-43bc-93c7-16ab95ca2517">ObjectContext</a> pointer to another object and the other object calls <a href="https://msdn.microsoft.com/e1ef03e6-fcb2-463b-b2b3-a88e958a1d19">IsCallerInRole</a> using this pointer. An <b>ObjectContext</b> pointer is not valid outside the context of the object that originally obtained it.
