...
This interface is used to find out about a particular caller in a chain of callers that is part of the security call context. For more information about how security call context information is accessed, see <a href="https://msdn.microsoft.com/en-us/library/ms681779(v=VS.85).aspx">Programmatic Component Security</a>. 

COM+ applications that do not use role-based security and base COM applications cannot call methods of <b>ISecurityIdentityColl</b> because they cannot obtain the necessary pointer to <a href="https://msdn.microsoft.com/en-us/library/ms686495(v=VS.85).aspx">ISecurityCallContext</a>. For more information, see <a href="https://msdn.microsoft.com/en-us/library/ms691483(v=VS.85).aspx">CoGetCallContext</a>.


## -inheritance

The <b xmlns:loc="http://microsoft.com/wdcml/l10n">ISecurityIdentityColl</b> interface inherits from the <a href="https://msdn.microsoft.com/en-us/library/ms221608(v=VS.85).aspx">IDispatch</a> interface. <b>ISecurityIdentityColl</b> also has these types of members:
<ul>
...
<a href="https://msdn.microsoft.com/en-us/library/ms684180(v=VS.85).aspx">get__NewEnum</a>
</td>
...
<tr data="declared;">
<td align="left" width="37%">
<a href="https://msdn.microsoft.com/en-us/library/ms680631(v=VS.85).aspx">get_Count</a>
</td>
<td align="left" width="63%">
...
<tr data="declared;">
<td align="left" width="37%">
<a href="https://msdn.microsoft.com/en-us/library/ms678922(v=VS.85).aspx">get_Item</a>
</td>
<td align="left" width="63%">
