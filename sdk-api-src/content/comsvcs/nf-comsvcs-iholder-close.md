...
<ol>
<li>Obtain a reference to the Resource Dispenser (the object that exposes <a href="https://msdn.microsoft.com/en-us/library/ms686956(v=VS.85).aspx">IDispenserDriver</a>).
</li>
...
<li><b>IHolder::Close</b> releases its reference to Resource Dispenser's <a href="https://msdn.microsoft.com/en-us/library/ms686956(v=VS.85).aspx">IDispenserDriver</a> interface. This is the reason you need a reference in step 1; otherwise, the Resource Dispenser would delete itself prematurely before the subsequent steps can be completed.
</li>
