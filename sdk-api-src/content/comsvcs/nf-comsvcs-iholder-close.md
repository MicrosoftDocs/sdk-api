...
ms.date: 2/15/2018
ms.keywords: Close method [COM+], Close method [COM+], IHolder interface, Close,IHolder.Close, IHolder, IHolder interface [COM+], Close method, IHolder::Close, _dtc_IHolder_Close, comsvcs/IHolder::Close, cos.iholder_close
