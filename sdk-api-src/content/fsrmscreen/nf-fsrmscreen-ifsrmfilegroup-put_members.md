...
description: Retrieves or sets the filename patterns that determine the files that are included in the file group. (Put)
...
f1_keywords:
 ...
 - fsrmscreen/IFsrmFileGroup::put_Members
dev_langs:
 - c++
topic_type:
 - APIRef
