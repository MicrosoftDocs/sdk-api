...
If not NULL and the output format is not supported for the given input format, <i>ppSupportedOutputFormat</i> returns a pointer to the closest output format that is supported. Use <a href="https://msdn.microsoft.com/library/Ee419206(v=VS.85).aspx">XAPOFree</a> to free the returned structure. 
