...
title: XAPO_LOCKFORPROCESS_BUFFER_PARAMETERS
...
Maximum number of frames in the stream buffer that <a href="https://msdn.microsoft.com/library/Ee418456(v=VS.85).aspx">IXAPO::Process</a> would ever be required to handle, irrespective of dynamic parameter settings.
