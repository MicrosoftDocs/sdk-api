...
Converts an array of run <a href="https://msdn.microsoft.com/library/Dd374094(v=VS.85).aspx">embedding levels</a> to a map of visual-to-logical position and/or logical-to-visual position.
