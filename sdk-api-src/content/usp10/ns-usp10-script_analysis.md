...
ms.topic: struct
f1_keywords: ["usp10/SCRIPT_ANALYSIS"]
req.header: usp10.h
req.include-header: 
...
A <a href="https://docs.microsoft.com/windows/desktop/api/usp10/ns-usp10-tag_script_state">SCRIPT_STATE</a> structure containing a copy of the Unicode algorithm state.
...
<a href="https://docs.microsoft.com/windows/desktop/api/usp10/ns-usp10-tag_script_item">SCRIPT_ITEM</a>
