...
Array of characters in each <a href="https://msdn.microsoft.com/library/Dd374094(v=VS.85).aspx">range</a>. The number of array elements is indicated by <i>cRanges</i>. The values of the elements of this array add up to the value of <i>cChars</i>.
