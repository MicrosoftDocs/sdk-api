...
<a href="https://www.bing.com/search?q=WINHTTP_OPTION_PROXY">WINHTTP_OPTION_PROXY</a> flag.  The default proxy configuration can be overridden for a new session by specifying the configuration with the 
