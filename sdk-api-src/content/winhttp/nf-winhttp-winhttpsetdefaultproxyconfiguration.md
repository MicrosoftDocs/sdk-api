...
<a href="https://msdn.microsoft.com/library/Aa384066(v=VS.85).aspx">WINHTTP_OPTION_PROXY</a> flag.  The default proxy configuration can be overridden for a new session by specifying the configuration with the 
