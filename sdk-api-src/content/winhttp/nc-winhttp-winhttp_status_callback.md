...
A pointer to a buffer that specifies information pertinent to this call to the callback function. The format of this data depends on the value of the <i>dwInternetStatus</i> parameter. For more information, see <i>dwInternetStatus</i>.


If the <i>dwInternetStatus</i> parameter is WINHTTP_CALLBACK_STATUS_SECURE_FAILURE, this parameter can be a bitwise-OR combination of one or more of the following values:
