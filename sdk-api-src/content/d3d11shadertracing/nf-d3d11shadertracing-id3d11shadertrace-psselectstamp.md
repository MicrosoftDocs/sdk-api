...
After you call <b>PSSelectStamp</b> to set the pixel-shader stamp, you can call the <a href="https://msdn.microsoft.com/en-us/library/Hh446846(v=VS.85).aspx">ID3D11ShaderTrace::GetInitialRegisterContents</a>,  <a href="https://msdn.microsoft.com/en-us/library/Hh446850(v=VS.85).aspx">ID3D11ShaderTrace::GetStep</a>, <a href="https://msdn.microsoft.com/en-us/library/Hh446856(v=VS.85).aspx">ID3D11ShaderTrace::GetWrittenRegister</a>, and <a href="https://msdn.microsoft.com/en-us/library/Hh446848(v=VS.85).aspx">ID3D11ShaderTrace::GetReadRegister</a> methods to get trace data for that stamp.
