...
The index of the register within  the trace step. The range of the index is [0...NumRegistersRead-1], where <b>NumRegistersRead</b> is a member of the  <a href="https://msdn.microsoft.com/en-us/library/Hh404541(v=VS.85).aspx">D3D11_TRACE_STEP</a> structure.


### -param pRegister [out]

A pointer to a <a href="https://msdn.microsoft.com/en-us/library/Hh404532(v=VS.85).aspx">D3D11_TRACE_REGISTER</a> structure. <b>GetReadRegister</b> fills the members of this structure with information about the register that was read by the step in the trace.


### -param pValue [out]

A pointer to a  <a href="https://msdn.microsoft.com/en-us/library/Hh404544(v=VS.85).aspx">D3D11_TRACE_VALUE</a> structure. <b>GetReadRegister</b> fills the members of this structure with information about the value that was read from the register.
