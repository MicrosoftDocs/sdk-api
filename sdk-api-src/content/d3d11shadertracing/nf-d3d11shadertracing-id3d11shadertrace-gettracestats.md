...
A pointer to a <a href="https://msdn.microsoft.com/en-us/library/Hh404538(v=VS.85).aspx">D3D11_TRACE_STATS</a> structure. <b>GetTraceStats</b> fills the members of this structure with statistics about the trace.
...
<li>E_FAIL if no trace statistics are available yet; <a href="https://msdn.microsoft.com/en-us/library/Hh446865(v=VS.85).aspx">ID3D11ShaderTrace::TraceReady</a> must return S_OK before <b>GetTraceStats</b> can succeed.</li>
