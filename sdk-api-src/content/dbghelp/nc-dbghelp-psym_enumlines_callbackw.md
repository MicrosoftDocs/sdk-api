...
description: PSYM_ENUMLINES_CALLBACKW (Unicode) is an application-defined callback function used with the SymEnumLines and SymEnumSourceLines functions.
...
f1_keywords:
 ...
 - dbghelp/PSYM_ENUMLINES_CALLBACKW
dev_langs:
 - c++
topic_type:
 - APIRef
