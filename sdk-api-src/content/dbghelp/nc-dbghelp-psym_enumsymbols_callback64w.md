...
description: PSYM_ENUMSYMBOLS_CALLBACK64W (Unicode) is an application-defined callback function used with the SymEnumerateSymbols64 function.
...
f1_keywords:
 ...
 - dbghelp/PSYM_ENUMSYMBOLS_CALLBACK64W
dev_langs:
 - c++
topic_type:
 - APIRef
