...
description: PSYM_ENUMSOURCEFILES_CALLBACKW (Unicode) is an application-defined callback function used with the SymEnumSourceFiles function.
...
f1_keywords:
 ...
 - dbghelp/PSYM_ENUMSOURCEFILES_CALLBACKW
dev_langs:
 - c++
topic_type:
 - APIRef
