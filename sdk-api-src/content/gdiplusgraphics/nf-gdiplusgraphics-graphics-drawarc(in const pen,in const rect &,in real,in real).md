...
ms.date: 10/09/2018
ms.keywords: DrawArc, DrawArc methods [GDI+], Graphics.DrawArc, Graphics.DrawArc(IN const Pen,IN const Rect &,IN REAL,IN REAL), Graphics::DrawArc, Graphics::DrawArc(IN const Pen,IN const Rect &,IN REAL,IN REAL), _gdiplus_CLASS_Graphics_DrawArc_Methods, gdiplus._gdiplus_CLASS_Graphics_DrawArc_Methods, gdiplusgraphics/DrawArc
