...
Pointer to an array of <a href="https://msdn.microsoft.com/en-us/library/ms534495(v=VS.85).aspx">Rect</a> objects that specify the coordinates of the rectangles to be drawn. 
