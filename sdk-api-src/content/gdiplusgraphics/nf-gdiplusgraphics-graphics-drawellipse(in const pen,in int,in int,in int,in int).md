...
ms.date: 10/09/2018
ms.keywords: DrawEllipse, DrawEllipse methods [GDI+], Graphics.DrawEllipse, Graphics.DrawEllipse(IN const Pen,IN INT,IN INT,IN INT,IN INT), Graphics::DrawEllipse, Graphics::DrawEllipse(IN const Pen,IN INT,IN INT,IN INT,IN INT), _gdiplus_CLASS_Graphics_DrawEllipse_Methods, gdiplus._gdiplus_CLASS_Graphics_DrawEllipse_Methods, gdiplusgraphics/DrawEllipse
