...
The <b>Graphics::Save</b> method saves the current state (transformations, clipping region, and quality settings) of this <a href="https://msdn.microsoft.com/7e874710-3cd3-42c8-bd2f-8a779b19ba59">Graphics</a> object. You can restore the state later by calling the <a href="https://msdn.microsoft.com/en-us/library/ms535804(v=VS.85).aspx">Graphics::Restore</a> method.
