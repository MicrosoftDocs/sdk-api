...
ms.date: 09/26/2018
ms.keywords: GetClipBounds, GetClipBounds methods [GDI+], Graphics.GetClipBounds, Graphics.GetClipBounds(OUT RectF), Graphics::GetClipBounds, Graphics::GetClipBounds(OUT RectF), _gdiplus_CLASS_Graphics_GetClipBounds_Methods, gdiplus._gdiplus_CLASS_Graphics_GetClipBounds_Methods, gdiplusgraphics/GetClipBounds
