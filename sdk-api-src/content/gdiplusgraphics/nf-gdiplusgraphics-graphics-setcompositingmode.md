...
The <b>Graphics::SetCompositingMode</b> method sets the compositing mode of this <a href="https://msdn.microsoft.com/library/windows/hardware/mt131452">Graphics</a> object.
...
Type: <b><a href="https://msdn.microsoft.com/library/ms534093(v=VS.85).aspx">CompositingMode</a></b>

Element of the <a href="https://msdn.microsoft.com/library/ms534093(v=VS.85).aspx">CompositingMode</a> enumeration that specifies the compositing mode. 
