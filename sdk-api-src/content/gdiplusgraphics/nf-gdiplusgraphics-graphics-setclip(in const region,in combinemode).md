...
ms.date: 07/29/2018
ms.keywords: Graphics.SetClip, Graphics.SetClip(IN const Region,IN CombineMode), Graphics::SetClip, Graphics::SetClip(IN const Region,IN CombineMode), SetClip, SetClip methods [GDI+], _gdiplus_CLASS_Graphics_SetClip_Methods, gdiplus._gdiplus_CLASS_Graphics_SetClip_Methods, gdiplusgraphics/SetClip
ms.prod: windows
