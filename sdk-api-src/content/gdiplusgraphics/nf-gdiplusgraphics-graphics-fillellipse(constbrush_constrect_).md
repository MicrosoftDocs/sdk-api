---
UID: NF:gdiplusgraphics.Graphics.FillEllipse(constBrush,constRect&)
...
Pointer to a 
					<a href="/windows/desktop/api/gdiplusbrush/nl-gdiplusbrush-brush">Brush</a> object that is used to paint the interior of the ellipse.
