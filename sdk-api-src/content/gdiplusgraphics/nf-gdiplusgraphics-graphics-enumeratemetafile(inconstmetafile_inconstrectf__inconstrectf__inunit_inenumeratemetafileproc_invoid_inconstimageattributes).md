...
Reference to a 
					<a href="https://msdn.microsoft.com/en-us/library/ms534497(v=VS.85).aspx">RectF</a> object that specifies the rectangle in which the metafile is displayed. 
...
Reference to a 
					<a href="https://msdn.microsoft.com/en-us/library/ms534497(v=VS.85).aspx">RectF</a> object that specifies the portion of the metafile that is displayed. 
