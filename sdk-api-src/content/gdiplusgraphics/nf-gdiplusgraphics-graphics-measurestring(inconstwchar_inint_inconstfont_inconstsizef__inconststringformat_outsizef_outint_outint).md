...
Reference to a <a href="https://msdn.microsoft.com/en-us/library/ms534506(v=VS.85).aspx">SizeF</a> object that specifies the width and height of a rectangle that bounds the string. 
...
Pointer to a <a href="https://msdn.microsoft.com/en-us/library/ms534506(v=VS.85).aspx">SizeF</a> object that receives the width and height of the rectangle that bounds the string. 
