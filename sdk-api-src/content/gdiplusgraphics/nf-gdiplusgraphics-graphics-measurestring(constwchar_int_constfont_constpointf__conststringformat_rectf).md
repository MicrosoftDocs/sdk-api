---
UID: NF:gdiplusgraphics.Graphics.MeasureString(constWCHAR,INT,constFont,constPointF&,constStringFormat,RectF)
...
description: The Graphics::MeasureString method measures the extent of the string in the specified font, format, and layout rectangle. (overload 2/3)
