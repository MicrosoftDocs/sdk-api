...
ms.date: 07/29/2018
ms.keywords: Graphics.IsVisible, Graphics.IsVisible(IN REAL,IN REAL), Graphics::IsVisible, Graphics::IsVisible(IN REAL,IN REAL), IsVisible, IsVisible methods [GDI+], _gdiplus_CLASS_Graphics_IsVisible_Methods, gdiplus._gdiplus_CLASS_Graphics_IsVisible_Methods, gdiplusgraphics/IsVisible
ms.prod: windows
