---
UID: NF:gdiplusgraphics.Graphics.DrawCurve(IN const Pen,IN const PointF,IN INT,IN REAL)
title: Graphics::DrawCurve(IN const Pen,IN const PointF,IN INT,IN REAL)
...
Pointer to an array of <a href="https://msdn.microsoft.com/2d357844-19a8-4ada-ba1e-685fea2e65ce">PointF</a> objects that specify the coordinates that the cardinal spline passes through. 
...
<tr>
<td>
<pre>VOID Example_DrawCurve6(HDC hdc)
{
