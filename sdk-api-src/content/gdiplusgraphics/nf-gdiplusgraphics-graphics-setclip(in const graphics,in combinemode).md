...
ms.date: 10/09/2018
ms.keywords: Graphics.SetClip, Graphics.SetClip(IN const Graphics,IN CombineMode), Graphics::SetClip, Graphics::SetClip(IN const Graphics,IN CombineMode), SetClip, SetClip methods [GDI+], _gdiplus_CLASS_Graphics_SetClip_Methods, gdiplus._gdiplus_CLASS_Graphics_SetClip_Methods, gdiplusgraphics/SetClip
