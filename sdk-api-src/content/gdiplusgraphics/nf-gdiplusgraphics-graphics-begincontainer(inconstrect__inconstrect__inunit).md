...
The following example calls the <b>Graphics::BeginContainer</b> method to create a graphics container. The code specifies a transformation for the container by passing two rectangles to the <b>Graphics::BeginContainer</b> method. The code calls 
						<a href="https://msdn.microsoft.com/en-us/library/ms535966(v=VS.85).aspx">Graphics::FillEllipse</a> twice: once inside the container and once outside the container (after the call to <a href="https://msdn.microsoft.com/en-us/library/ms535686(v=VS.85).aspx">Graphics::EndContainer</a>).
