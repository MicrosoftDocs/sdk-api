---
UID: NF:gdiplusgraphics.Graphics.TransformPoints(CoordinateSpace,CoordinateSpace,Point,INT)
title: Graphics::TransformPoints(IN CoordinateSpace,IN CoordinateSpace,IN OUT Point,IN INT) (gdiplusgraphics.h)
description: The Graphics::TransformPoints method converts an array of points from one coordinate space to another. The conversion is based on the current world and page transformations of this Graphics object. (overload 1/2)
