...
This function is useful when a copy of a variant is needed, and to guarantee that it is not VT_BYREF, such as when handling arguments in an implementation of <a href="/previous-versions/windows/desktop/api/oaidl/nf-oaidl-idispatch-invoke.md">IDispatch::Invoke</a>.
