...
ms.topic: function
f1_keywords: ["winbase/CreateFileMapping"]
...
For an example, see 
     ...
     <a href="https://docs.microsoft.com/windows/desktop/Memory/creating-a-file-mapping-using-large-pages">Creating a File Mapping Using Large Pages</a>.
