...
Alternatively, you can use an integer atom that has been converted using the <a href="https://msdn.microsoft.com/library/ms649055(v=VS.85).aspx">MAKEINTATOM</a> macro. See Remarks for more information. 
