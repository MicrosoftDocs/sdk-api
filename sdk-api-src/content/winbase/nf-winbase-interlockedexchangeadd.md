---
UID: NF:winbase.InterlockedExchangeAdd
...
ms.date: 05/17/2018
ms.keywords: InterlockedExchangeAdd, InterlockedExchangeAdd function, _win32_interlockedexchangeadd, base.interlockedexchangeadd, winbase/InterlockedExchangeAdd
ms.prod: windows
...
To operate  on 64-bit values, use the <a href="https://msdn.microsoft.com/f8cab5f8-8054-4c02-9a6d-80fd9d98cf74">InterlockedExchangeAdd64</a> function.
...
This function is implemented using a compiler intrinsic where possible. For more information, see the WinBase.h header file and <a href="https://msdn.microsoft.com/library/windows/desktop/25809e1f-9c60-4492-9f7c-0fb59c8d13d2">_InterlockedExchangeAdd</a>


This function  generates a full memory barrier (or fence) to ensure that memory operations are completed in order.

<b>Itanium-based systems:  </b>For performance-critical applications, use <a href="https://msdn.microsoft.com/920daad7-7c47-4e55-8aba-db63cf285d12">InterlockedExchangeAddAcquire</a> instead.
