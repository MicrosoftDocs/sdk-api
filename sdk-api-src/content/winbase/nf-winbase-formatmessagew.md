...
Floating-point format specifiers—e, E, f, and g—are not supported. 
        The workaround is to use the <a href="https://www.bing.com/search?q=StringCchPrintf">StringCchPrintf</a> 
...
Inserts that use the I64 prefix are treated as two 32-bit arguments. They must be used before subsequent 
        ...
        <a href="https://www.bing.com/search?q=StringCchPrintf">StringCchPrintf</a> instead of this prefix.
