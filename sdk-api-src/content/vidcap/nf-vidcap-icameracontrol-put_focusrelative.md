...
Specifies the relative focus. The size of the value represents the speed at which the focal point changes; a higher value represents a higher speed. To get the possible range of values, call <a href="https://msdn.microsoft.com/en-us/library/Dd376302(v=VS.85).aspx">ICameraControl::getRange_FocusRelative</a>.
