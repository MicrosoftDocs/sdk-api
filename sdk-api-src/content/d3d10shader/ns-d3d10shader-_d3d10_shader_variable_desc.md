...
Flags, which identify shader-variable properties (see <a href="https://msdn.microsoft.com/library/Bb172442(v=VS.85).aspx">D3D10_SHADER_VARIABLE_FLAGS</a>).
...
Get a shader-variable description using reflection, by calling <a href="https://msdn.microsoft.com/library/Bb173846(v=VS.85).aspx">ID3D10ShaderReflectionVariable::GetDesc</a>.
