...
Get the geometry <a href="https://msdn.microsoft.com/library/Bb509626(v=VS.85).aspx">shader profile</a> best suited to a given device.
...
Pointer to the device (see <a href="https://msdn.microsoft.com/library/Bb173528(v=VS.85).aspx">ID3D10Device Interface</a>).
