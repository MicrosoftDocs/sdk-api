---
UID: NS:wtsapi32._WTS_PRODUCT_INFOA
title: "_WTS_PRODUCT_INFOA"
...
ms.date: 10/25/2018
ms.keywords: PRODUCT_INFO, PRODUCT_INFO structure [Remote Desktop Services], PRODUCT_INFOA, WTS_PRODUCT_INFO, WTS_PRODUCT_INFO structure [Remote Desktop Services], WTS_PRODUCT_INFOA, WTS_PRODUCT_INFOW, _WTS_PRODUCT_INFOA, _WTS_PRODUCT_INFOW, termserv.wts_product_info, wtsapi32/WTS_PRODUCT_INFO, wtsapi32/WTS_PRODUCT_INFOA, wtsapi32/WTS_PRODUCT_INFOW
ms.prod: windows
...
product: Windows
targetos: Windows
req.typenames: PRODUCT_INFOA
req.redist: 
---

# _WTS_PRODUCT_INFOA structure
