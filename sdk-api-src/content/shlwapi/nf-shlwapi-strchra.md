...
description: Searches a string for the first occurrence of a character that matches the specified character. The comparison is case-sensitive. (ANSI)
helpviewer_keywords: ["StrChrA", "shlwapi/StrChrA"]
