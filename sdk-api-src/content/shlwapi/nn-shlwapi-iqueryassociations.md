...
You can also retrieve an application's name using this interface. Use method <a href="https://msdn.microsoft.com/72463664-783b-4375-a6ba-43633a82ec7e">IQueryAssociations::GetString</a>. Set the <i>str</i> parameter to <a href="https://msdn.microsoft.com/en-us/library/Bb762475(v=VS.85).aspx">ASSOCSTR_FRIENDLYAPPNAME</a>.
