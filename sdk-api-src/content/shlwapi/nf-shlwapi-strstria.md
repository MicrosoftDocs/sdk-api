...
description: Finds the first occurrence of a substring within a string. The comparison is not case-sensitive. (ANSI)
helpviewer_keywords: ["StrStrIA", "shlwapi/StrStrIA"]
