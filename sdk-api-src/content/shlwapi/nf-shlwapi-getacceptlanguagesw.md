...
description: Retrieves a string used with websites when specifying language preferences. (Unicode)
helpviewer_keywords: ["GetAcceptLanguages", "GetAcceptLanguages function [Windows Shell]", "GetAcceptLanguagesW", "_shell_GetAcceptLanguages", "shell.GetAcceptLanguages", "shlwapi/GetAcceptLanguages", "shlwapi/GetAcceptLanguagesW"]
