...
The global counter for use with the <a href="https://msdn.microsoft.com/library/Bb231485(v=VS.85).aspx">ISearchManager</a>.


### -field GLOBALCOUNTER_SEARCHOPTIONS

The global counter for use with <a href="https://msdn.microsoft.com/library/Bb231313(v=VS.85).aspx">ISearchQueryHelper</a> to identify whether a query parser's settings have changed.
