...
description: Sends a message to all top-level windows in the system. (ANSI)
helpviewer_keywords: ["SHSendMessageBroadcastA", "shlwapi/SHSendMessageBroadcastA"]
...
f1_keywords:
 ...
 - shlwapi/SHSendMessageBroadcastA
dev_langs:
 - c++
topic_type:
 - APIRef
