...
description: Converts a string representing a decimal or hexadecimal number to an integer. (ANSI)
helpviewer_keywords: ["STIF_DEFAULT", "STIF_SUPPORT_HEX", "StrToIntExA", "shlwapi/StrToIntExA"]
