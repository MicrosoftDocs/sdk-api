...
description: Retrieves or sets a value that indicates whether the data manager should check imposed limits, such as the minimum available free disk space, before collecting data. (Put)
...
f1_keywords:
 ...
 - pla/IDataManager::put_CheckBeforeRunning
dev_langs:
 - c++
topic_type:
 - APIRef
...
<a href="/previous-versions/windows/desktop/api/pla/nf-pla-idatamanager-get_maxfoldercount">IDataManager::MaxFolderCount</a>
