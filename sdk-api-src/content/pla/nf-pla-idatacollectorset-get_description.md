...
description: Retrieves or sets the description of the data collector set. The description will be added to all output files as metadata and inserted into Performance Data Helper logs as a comment. (Get)
...
f1_keywords:
 ...
 - pla/IDataCollectorSet::get_Description
dev_langs:
 - c++
topic_type:
 - APIRef
