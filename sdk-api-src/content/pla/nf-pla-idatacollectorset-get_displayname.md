...
title: IDataCollectorSet::get_DisplayName method
...
ms.date: 2/15/2018
ms.keywords: DisplayName property [PLA], DisplayName property [PLA], IDataCollectorSet interface, IDataCollectorSet, IDataCollectorSet interface [PLA], DisplayName property, IDataCollectorSet.DisplayName, IDataCollectorSet::get_DisplayName, IDataCollectorSet::put_DisplayName, get_DisplayName,IDataCollectorSet.get_DisplayName, pla.idatacollectorset_displayname, pla/IDataCollectorSet::DisplayName, pla/IDataCollectorSet::get_DisplayName, pla/IDataCollectorSet::put_DisplayName
...
# IDataCollectorSet::get_DisplayName method
