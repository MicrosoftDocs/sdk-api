...
description: Retrieves or sets the maximum number of subkeys from which to recursively collect registry values. (Put)
...
f1_keywords:
 ...
 - pla/IConfigurationDataCollector::put_RegistryMaxRecursiveDepth
dev_langs:
 - c++
topic_type:
 - APIRef
