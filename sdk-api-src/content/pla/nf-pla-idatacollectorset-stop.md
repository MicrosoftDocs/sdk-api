...
ms.topic: method
f1_keywords: ["pla/IDataCollectorSet.Stop"]
req.header: pla.h
req.include-header: 
...
<a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/pla/nf-pla-idatacollectorset-start">IDataCollectorSet::Start</a>
 
