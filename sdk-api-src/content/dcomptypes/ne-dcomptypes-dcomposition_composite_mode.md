...
If you want a visual to be drawn with antialiasing, use <a href="https://msdn.microsoft.com/library/Hh437364(v=VS.85).aspx">DCOMPOSITION_BITMAP_INTERPOLATION_MODE_LINEAR</a> for the content of the visual, and <a href="https://msdn.microsoft.com/library/Hh437365(v=VS.85).aspx">DCOMPOSITION_BORDER_MODE_SOFT</a> for the edges.
