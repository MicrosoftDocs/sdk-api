...
A <a href="https://docs.microsoft.com/windows/desktop/api/wlanapi/ne-wlanapi-_dot11_radio_state">DOT11_RADIO_STATE</a> value that indicates the software radio state.


### -field dot11HardwareRadioState

A <a href="https://docs.microsoft.com/windows/desktop/api/wlanapi/ne-wlanapi-_dot11_radio_state">DOT11_RADIO_STATE</a> value that indicates the hardware radio state.
