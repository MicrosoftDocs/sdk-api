...
ms.topic: struct
f1_keywords: ["wlanapi/WLAN_CONNECTION_ATTRIBUTES"]
...
A <a href="https://docs.microsoft.com/windows/desktop/api/wlanapi/ne-wlanapi-_wlan_interface_state">WLAN_INTERFACE_STATE</a> value that indicates the state of the interface.
