...
A <a href="https://msdn.microsoft.com/en-us/library/Dd433865(v=VS.85).aspx">CRYPT_XML_SIGNED_INFO</a> structure that contains the canonicalization algorithm, 
...
Optional. A pointer to a <a href="https://msdn.microsoft.com/en-us/library/Dd433855(v=VS.85).aspx">CRYPT_XML_KEY_INFO</a> structure that contains information that is encoded in the <b>KeyInfo</b> element.
...
Optional. A pointer to an array of  pointers to <a href="https://msdn.microsoft.com/en-us/library/Dd433859(v=VS.85).aspx">CRYPT_XML_OBJECT</a> structures that  contain information that is encoded in <b>Object</b> elements.
