...
description: MIB_TCPROW_LH (tcpmib.h) contains information that describes an IPv4 TCP connection.
...
f1_keywords:
 - _MIB_TCPROW_LH
 - tcpmib/_MIB_TCPROW_LH
 - PMIB_TCPROW_LH
 - tcpmib/PMIB_TCPROW_LH
 - MIB_TCPROW_LH
 - tcpmib/MIB_TCPROW_LH
dev_langs:
 - c++
topic_type:
 - APIRef
