...
ms.topic: method
f1_keywords: ["d3d12shader/ID3D12ShaderReflectionType.IsEqual"]
...
Indicates whether two <a href="https://docs.microsoft.com/windows/desktop/api/d3d12shader/nn-d3d12shader-id3d12shaderreflectiontype">ID3D12ShaderReflectionType Interface</a> pointers have the same underlying type.
