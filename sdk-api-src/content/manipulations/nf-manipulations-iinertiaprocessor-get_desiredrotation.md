...
description: The DesiredRotation property specifies how far the current inertia processor object should manipulate the target object in radians. (Get)
...
f1_keywords:
 ...
 - manipulations/IInertiaProcessor::get_DesiredRotation
dev_langs:
 - c++
topic_type:
 - APIRef
