...
description: The DesiredDisplacement property specifies the desired distance that the object will travel. (Get)
...
f1_keywords:
 ...
 - manipulations/IInertiaProcessor::get_DesiredDisplacement
dev_langs:
 - c++
topic_type:
 - APIRef
