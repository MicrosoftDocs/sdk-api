...
description: The InitialRadius property specifies the distance from the edge of the target to its center before the object was changed. (Put)
...
f1_keywords:
 ...
 - manipulations/IInertiaProcessor::put_InitialRadius
dev_langs:
 - c++
topic_type:
 - APIRef
