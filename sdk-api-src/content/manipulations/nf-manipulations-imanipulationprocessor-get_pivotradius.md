...
description: The PivotRadius property is used to determine how much rotation is used in single finger manipulation. (Get)
...
f1_keywords:
 ...
 - manipulations/IManipulationProcessor::get_PivotRadius
dev_langs:
 - c++
topic_type:
 - APIRef
