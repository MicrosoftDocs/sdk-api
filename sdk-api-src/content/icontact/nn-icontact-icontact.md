...
<ul>
<li>
<a href="/windows/desktop/api/objidl/nn-objidl-ipersistfile.md">IPersistFile</a>: Enables the contact 
...
<li>
<a href="/windows/desktop/api/objidl/nn-objidl-ipersiststream.md">IPersistStream</a>: Provides methods for saving and 
			loading objects that use a simple serial stream for their storage needs.</li>
<li>
<a href="/windows/desktop/api/ocidl/nn-ocidl-ipersiststreaminit.md">IPersistStreamInit</a>: Enables the contact to be saved 
			or loaded from a stream. Use <a href="/windows/desktop/api/ocidl/nf-ocidl-ipersiststreaminit-initnew.md">IPersistStreamInit::InitNew</a> to create a 
			new <b>IContact</b>. 
			Note: loading a contact with <a href="/windows/desktop/api/objidl/nn-objidl-ipersiststream.md">IPersistStream</a> does 
			not give you the locking and conflict detection that <a href="/windows/desktop/api/objidl/nf-objidl-ipersistfile-load.md">IPersistFile::Load</a> 
