...
The address of a pointer to a render-target-view interface. See <a href="https://msdn.microsoft.com/library/Bb173827(v=VS.85).aspx">ID3D10RenderTargetView Interface</a>.
