...
Type: <b><a href="https://msdn.microsoft.com/library/Bb173672(v=VS.85).aspx">ID3D10EffectRenderTargetViewVariable</a>*</b>

A pointer to a render-target-view variable. See <a href="https://msdn.microsoft.com/library/Bb173672(v=VS.85).aspx">ID3D10EffectRenderTargetViewVariable Interface</a>.
