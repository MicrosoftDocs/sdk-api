...
A pointer to effect data; either ASCII <a href="https://msdn.microsoft.com/library/Bb509638(v=VS.85).aspx">HLSL</a> code or a compiled effect.
...
Optional. An array of NULL-terminated macro definitions (see <a href="https://msdn.microsoft.com/library/Bb172436(v=VS.85).aspx">D3D10_SHADER_MACRO</a>).


### -param pInclude [in]

Type: <b><a href="https://msdn.microsoft.com/library/Bb173775(v=VS.85).aspx">ID3D10Include</a>*</b>

Optional. A pointer to an <a href="https://msdn.microsoft.com/library/Bb173775(v=VS.85).aspx">ID3D10Include Interface</a> for handling include files. Setting this to <b>NULL</b> will cause a compile error if a shader contains a #include.
...
The address of a <a href="https://msdn.microsoft.com/library/Bb173507(v=VS.85).aspx">ID3D10Blob Interface</a> that contains the compiled effect.
...
Optional. A pointer to an <a href="https://msdn.microsoft.com/library/Bb173507(v=VS.85).aspx">ID3D10Blob Interface</a> that contains compiler error messages, or <b>NULL</b> if there were no errors.
...
For an example, see <a href="https://msdn.microsoft.com/library/Bb205078(v=VS.85).aspx">Compile an Effect (Direct3D 10)</a>.
