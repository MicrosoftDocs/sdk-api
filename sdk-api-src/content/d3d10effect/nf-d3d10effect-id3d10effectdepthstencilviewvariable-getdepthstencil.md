...
The address of a pointer to a depth-stencil-view interface. See <a href="https://msdn.microsoft.com/library/Bb173526(v=VS.85).aspx">ID3D10DepthStencilView Interface</a>.
