...
title: ID3D10Effect::GetTechniqueByName
...
A pointer to an <a href="https://msdn.microsoft.com/library/Bb173708(v=VS.85).aspx">ID3D10EffectTechnique Interface</a>, or <b>NULL</b> if the technique is not found.
...
An effect contains one or more techniques; each technique contains one or more passes. You can access a technique using its name or with an index. For more about techniques, see <a href="https://msdn.microsoft.com/library/Bb205112(v=VS.85).aspx">techniques and passes</a>.
