...
<a href="https://msdn.microsoft.com/library/Bb173668(v=VS.85).aspx">AsEffect</a>
</td>
...
To create an effect pool, call a function like <a href="https://msdn.microsoft.com/library/Bb172661(v=VS.85).aspx">D3DX10CreateEffectPoolFromFile</a>. Effect pools can improve performance by reducing the number of API calls required to make state changes (see <a href="https://msdn.microsoft.com/library/Bb205113(v=VS.85).aspx">Using Effect Pools</a>).
