...
title: ID3D10EffectRasterizerVariable::GetBackingStore
...
A pointer to a rasteriser-state description (see <a href="https://msdn.microsoft.com/library/Bb172408(v=VS.85).aspx">D3D10_RASTERIZER_DESC</a>).
