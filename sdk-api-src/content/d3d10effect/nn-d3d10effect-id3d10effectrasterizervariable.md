...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">ID3D10EffectRasterizerVariable</b> interface inherits from <a href="https://msdn.microsoft.com/library/Bb173724(v=VS.85).aspx">ID3D10EffectVariable</a>. <b>ID3D10EffectRasterizerVariable</b> also has these types of members:
<ul>
...
<a href="https://msdn.microsoft.com/library/Bb173670(v=VS.85).aspx">GetBackingStore</a>
</td>
...
<tr data="declared;">
<td align="left" width="37%">
<a href="https://msdn.microsoft.com/library/Bb173671(v=VS.85).aspx">GetRasterizerState</a>
</td>
<td align="left" width="63%">
