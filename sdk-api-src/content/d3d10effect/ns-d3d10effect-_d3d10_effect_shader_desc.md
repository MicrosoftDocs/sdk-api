...
Passed into CreateInputLayout. Only valid on a vertex shader or geometry shader. See <a href="https://msdn.microsoft.com/library/Bb173550(v=VS.85).aspx">ID3D10Device_CreateInputLayout</a>.
...
A string that constains a declaration of the <a href="https://msdn.microsoft.com/library/Bb205123(v=VS.85).aspx">stream output </a> from a geometry shader.
...
To get an effect-shader description, call <a href="https://msdn.microsoft.com/library/Bb173703(v=VS.85).aspx">ID3D10EffectShaderVariable::GetShaderDesc</a>.
