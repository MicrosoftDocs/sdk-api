...
ms.topic: method
f1_keywords: ["gdipluspen/Pen.RotateTransform"]
...
The <b>Pen::RotateTransform</b> method updates the world transformation matrix of this 
			<a href="https://docs.microsoft.com/windows/desktop/api/gdipluspen/nl-gdipluspen-pen">Pen</a> object with the product of itself and a rotation matrix.
