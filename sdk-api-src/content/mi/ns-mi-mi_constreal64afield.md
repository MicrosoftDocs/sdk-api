...
ms.topic: struct
f1_keywords: ["mi/MI_ConstReal64AField"]
req.header: mi.h
req.include-header: 
...
A field of type <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/mi/ns-mi-_mi_constreal64a">MI_ConstReal64A</a>.
