...
ms.topic: struct
f1_keywords: ["mi/MI_ConstUint8AField"]
req.header: mi.h
req.include-header: 
...
A field of type <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/mi/ns-mi-_mi_constuint8a">MI_ConstUint8A</a>.
