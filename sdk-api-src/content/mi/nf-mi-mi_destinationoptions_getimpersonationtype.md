...
ms.topic: function
f1_keywords: ["mi/MI_DestinationOptions_GetImpersonationType"]
req.header: mi.h
req.include-header: 
...
Returned <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/mi/ne-mi-_mi_destinationoptions_impersonationtype">MI_DestinationOptions_ImpersonationType</a> enumeration.
