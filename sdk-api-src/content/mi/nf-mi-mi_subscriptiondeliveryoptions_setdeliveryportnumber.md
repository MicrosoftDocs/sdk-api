...
ms.topic: function
f1_keywords: ["mi/MI_SubscriptionDeliveryOptions_SetDeliveryPortNumber"]
req.header: mi.h
req.include-header: 
...
This function is only valid when using <a href="https://docs.microsoft.com/windows/desktop/WinRM/portal">Windows Remote Management</a> (WinRM). It is relevant only for push delivery.
...
<a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/mi/nf-mi-mi_subscriptiondeliveryoptions_setdeliveryretryinterval">MI_SubscriptionDeliveryOptions_SetDeliveryRetryInterval</a>
 
