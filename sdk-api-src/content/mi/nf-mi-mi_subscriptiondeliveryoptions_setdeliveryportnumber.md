...
This function is only valid when using <a href="https://msdn.microsoft.com/6429e748-e0bf-431a-8989-db5b211665d5">Windows Remote Management</a> (WinRM). It is relevant only for push delivery.
