...
ms.topic: function
f1_keywords: ["mi/MI_Session_QueryInstances"]
req.header: mi.h
req.include-header: 
...
Runtime type information (RTTI) and polymorphic <a href="https://docs.microsoft.com/previous-versions/windows/desktop/wmi_v2/mi-flags">flags</a>.
