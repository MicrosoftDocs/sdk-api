...
description: Represents a property inside an MI_Instance structure. (MI_ConstSint16AField)
...
req.irql: 
targetos: Windows
req.typenames: MI_ConstSint16AField
req.redist: Windows Management Framework 3.0 on Windows Server 2008 R2 with SP1, Windows 7 with SP1, and Windows Server 2008 with SP2
ms.custom: 19H1
f1_keywords:
 - _MI_ConstSint16AField
 - mi/_MI_ConstSint16AField
 - MI_ConstSint16AField
 - mi/MI_ConstSint16AField
dev_langs:
 - c++
topic_type:
 - APIRef
...
# MI_ConstSint16AField structure
...
A field of type <a href="/windows/desktop/api/mi/ns-mi-mi_sint16a">MI_Sint16A</a>.
