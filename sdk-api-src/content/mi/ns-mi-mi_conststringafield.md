...
ms.topic: struct
f1_keywords: ["mi/MI_ConstStringAField"]
req.header: mi.h
req.include-header: 
...
A field of type <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/mi/ns-mi-_mi_conststringa">MI_ConstStringA</a>.
