...
ms.topic: function
f1_keywords: ["mi/MI_Instance_Clone"]
req.header: mi.h
req.include-header: 
...
Returned instance. This should be deleted via <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/mi/nf-mi-mi_instance_delete">MI_Instance_Delete</a>.
