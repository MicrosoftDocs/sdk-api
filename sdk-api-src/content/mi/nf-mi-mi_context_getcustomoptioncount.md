...
ms.topic: function
f1_keywords: ["mi/MI_Context_GetCustomOptionCount"]
req.header: mi.h
req.include-header: 
...
These options are passed by the client, possibly through the <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/mi/ns-mi-_mi_operationoptions">MI_OperationOptions</a> structure.
