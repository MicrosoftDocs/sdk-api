...
ms.topic: function
f1_keywords: ["mi/MI_Session_EnumerateInstances"]
req.header: mi.h
req.include-header: 
...
Polymorphic and runtime type information (RTTI) <a href="https://docs.microsoft.com/previous-versions/windows/desktop/wmi_v2/mi-flags">flags</a>.
