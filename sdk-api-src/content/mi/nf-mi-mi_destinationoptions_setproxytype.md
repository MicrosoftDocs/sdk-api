...
ms.topic: function
f1_keywords: ["mi/MI_DestinationOptions_SetProxyType"]
req.header: mi.h
req.include-header: 
...
<a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/mi/nf-mi-mi_destinationoptions_getproxytype">MI_DestinationOptions_GetProxyType</a>
 
