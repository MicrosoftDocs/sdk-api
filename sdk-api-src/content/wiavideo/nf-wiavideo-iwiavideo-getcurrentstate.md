...
The <b>IWiaVideo::GetCurrentState</b> method specifies the state of the video stream as a member of the <a href="https://msdn.microsoft.com/library/ms630181(v=VS.85).aspx">WIAVIDEO_STATE</a> enumeration.
...
Type: <b><a href="https://msdn.microsoft.com/library/ms630181(v=VS.85).aspx">WIAVIDEO_STATE</a>*</b>

A member of the <a href="https://msdn.microsoft.com/library/ms630181(v=VS.85).aspx">WIAVIDEO_STATE</a> enumeration that specifies the current state of the video stream.
