...
The path and directory where the image file is saved are specified by the <a href="https://msdn.microsoft.com/library/ms629895(v=VS.85).aspx">IWiaVideo::ImagesDirectory</a> property.
