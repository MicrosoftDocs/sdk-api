...
title: ITaskSettings3::put_Volatile (taskschd.h)
description: Gets or sets a boolean value that indicates whether the task is automatically disabled every time Windows starts. (Put)
...
f1_keywords:
 ...
 - taskschd/ITaskSettings3::put_Volatile
dev_langs:
 - c++
topic_type:
 - APIRef
