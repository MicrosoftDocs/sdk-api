...
title: IMaintenanceSettings::get_Period method
...
ms.date: 2/15/2018
ms.keywords: IMaintenanceSettings, IMaintenanceSettings interface [Task Scheduler], Period property, IMaintenanceSettings.Period, IMaintenanceSettings::get_Period, IMaintenanceSettings::put_Period, Period property [Task Scheduler], Period property [Task Scheduler], IMaintenanceSettings interface, get_Period,IMaintenanceSettings.get_Period, taskschd.imaintenancesettings_period, taskschd/IMaintenanceSettings::Period, taskschd/IMaintenanceSettings::get_Period, taskschd/IMaintenanceSettings::put_Period
...
# IMaintenanceSettings::get_Period method
