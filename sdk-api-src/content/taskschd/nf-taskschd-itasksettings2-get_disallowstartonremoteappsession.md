...
description: Gets or sets a Boolean value that specifies that the task will not be started if triggered to run in a Remote Applications Integrated Locally (RAIL) session. (Get)
...
f1_keywords:
 ...
 - taskschd/ITaskSettings2::get_DisallowStartOnRemoteAppSession
dev_langs:
 - c++
topic_type:
 - APIRef
