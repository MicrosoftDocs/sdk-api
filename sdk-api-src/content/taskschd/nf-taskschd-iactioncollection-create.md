...
title: IActionCollection::Create method
...
ms.date: 2/15/2018
ms.keywords: Create method [Task Scheduler], Create method [Task Scheduler], IActionCollection interface, Create,IActionCollection.Create, IActionCollection, IActionCollection interface [Task Scheduler], Create method, IActionCollection::Create, TASK_ACTION_COM_HANDLER, TASK_ACTION_EXEC, TASK_ACTION_SEND_EMAIL, TASK_ACTION_SHOW_MESSAGE, actions [Task Scheduler], creating, taskschd.iactioncollection_create, taskschd/IActionCollection::Create
...
An <a href="https://msdn.microsoft.com/library/windows/hardware/ff538787">IAction</a> interface that represents the new action. 

Pass in a reference to a <b>NULL</b> <a href="https://msdn.microsoft.com/library/windows/hardware/ff538787">IAction</a> interface pointer.  Referencing a non-<b>NULL</b> pointer can cause a memory leak because the pointer will be overwritten.
