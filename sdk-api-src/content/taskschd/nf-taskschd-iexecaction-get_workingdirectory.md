...
description: Gets or sets the directory that contains either the executable file or the files that are used by the executable file. (Get)
...
f1_keywords:
 ...
 - taskschd/IExecAction::get_WorkingDirectory
dev_langs:
 - c++
topic_type:
 - APIRef
