...
description: Gets or sets a delay time that is randomly added to the start time of the trigger. (IDailyTrigger.get_RandomDelay)
...
f1_keywords:
 ...
 - taskschd/IDailyTrigger::get_RandomDelay
dev_langs:
 - c++
topic_type:
 - APIRef
