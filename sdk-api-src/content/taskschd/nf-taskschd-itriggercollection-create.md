...
title: ITriggerCollection::Create method
...
ms.date: 2/15/2018
ms.keywords: Create method [Task Scheduler], Create method [Task Scheduler], ITriggerCollection interface, Create,ITriggerCollection.Create, ITriggerCollection, ITriggerCollection interface [Task Scheduler], Create method, ITriggerCollection::Create, TASK_TRIGGER_BOOT, TASK_TRIGGER_DAILY, TASK_TRIGGER_EVENT, TASK_TRIGGER_IDLE, TASK_TRIGGER_LOGON, TASK_TRIGGER_MONTHLY, TASK_TRIGGER_MONTHLYDOW, TASK_TRIGGER_REGISTRATION, TASK_TRIGGER_SESSION_STATE_CHANGE, TASK_TRIGGER_TIME, TASK_TRIGGER_WEEKLY, taskschd.itriggercollection_create, taskschd/ITriggerCollection::Create, triggers [Task Scheduler], creating
