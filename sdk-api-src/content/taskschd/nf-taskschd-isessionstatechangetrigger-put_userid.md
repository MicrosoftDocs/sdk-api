...
description: Gets or sets the user for the Terminal Server session. When a session state change is detected for this user, a task is started. (Put)
...
f1_keywords:
 ...
 - taskschd/ISessionStateChangeTrigger::put_UserId
dev_langs:
 - c++
topic_type:
 - APIRef
