...
title: ITaskSettings::get_MultipleInstances (taskschd.h)
description: Gets or sets the policy that defines how the Task Scheduler deals with multiple instances of the task. (Get)
