...
title: ITaskSettings::get_RestartInterval method
...
ms.date: 2/15/2018
ms.keywords: ITaskSettings, ITaskSettings interface [Task Scheduler], RestartInterval property, ITaskSettings.RestartInterval, ITaskSettings::get_RestartInterval, ITaskSettings::put_RestartInterval, RestartInterval property [Task Scheduler], RestartInterval property [Task Scheduler], ITaskSettings interface, get_RestartInterval,ITaskSettings.get_RestartInterval, taskschd.itasksettings_restartinterval, taskschd/ITaskSettings::RestartInterval, taskschd/ITaskSettings::get_RestartInterval, taskschd/ITaskSettings::put_RestartInterval
...
# ITaskSettings::get_RestartInterval method
