...
description: Gets or sets a Boolean value that indicates that the task will be stopped if the computer is going onto batteries. (Get)
...
f1_keywords:
 ...
 - taskschd/ITaskSettings::get_StopIfGoingOnBatteries
dev_langs:
 - c++
topic_type:
 - APIRef
