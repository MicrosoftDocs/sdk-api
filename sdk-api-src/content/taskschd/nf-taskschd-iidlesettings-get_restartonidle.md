...
description: Gets or sets a Boolean value that indicates whether the task is restarted when the computer cycles into an idle condition more than once. (Get)
...
f1_keywords:
 ...
 - taskschd/IIdleSettings::get_RestartOnIdle
dev_langs:
 - c++
topic_type:
 - APIRef
