...
title: ISessionStateChangeTrigger::get_StateChange (taskschd.h)
description: Gets or sets the kind of Terminal Server session change that would trigger a task launch. (Get)
...
f1_keywords:
 ...
 - taskschd/ISessionStateChangeTrigger::get_StateChange
dev_langs:
 - c++
topic_type:
 - APIRef
