...
description: Gets or sets the security logon method that is required to run the tasks that are associated with the principal. (Put)
...
f1_keywords:
 - IPrincipal::put_LogonType
 - taskschd/IPrincipal::put_LogonType
dev_langs:
 - c++
topic_type:
 - APIRef
