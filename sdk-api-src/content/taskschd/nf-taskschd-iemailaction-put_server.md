...
title: IEmailAction::put_Server method
...
ms.date: 2/15/2018
ms.keywords: IEmailAction, IEmailAction interface [Task Scheduler], Server property, IEmailAction.Server, IEmailAction::get_Server, IEmailAction::put_Server, Server property [Task Scheduler], Server property [Task Scheduler], IEmailAction interface, put_Server,IEmailAction.put_Server, taskschd.iemailaction_server, taskschd/IEmailAction::Server, taskschd/IEmailAction::get_Server, taskschd/IEmailAction::put_Server
...
# IEmailAction::put_Server method
