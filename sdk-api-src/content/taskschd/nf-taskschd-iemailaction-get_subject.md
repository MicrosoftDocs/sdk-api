...
title: IEmailAction::get_Subject method
...
ms.date: 2/15/2018
ms.keywords: IEmailAction, IEmailAction interface [Task Scheduler], Subject property, IEmailAction.Subject, IEmailAction::get_Subject, IEmailAction::put_Subject, Subject property [Task Scheduler], Subject property [Task Scheduler], IEmailAction interface, get_Subject,IEmailAction.get_Subject, taskschd.iemailaction_subject, taskschd/IEmailAction::Subject, taskschd/IEmailAction::get_Subject, taskschd/IEmailAction::put_Subject
...
# IEmailAction::get_Subject method
