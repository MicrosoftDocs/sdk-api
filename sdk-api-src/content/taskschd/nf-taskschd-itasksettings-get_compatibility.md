...
description: Gets or sets an integer value that indicates which version of Task Scheduler a task is compatible with. (Get)
...
f1_keywords:
 ...
 - taskschd/ITaskSettings::get_Compatibility
dev_langs:
 - c++
topic_type:
 - APIRef
