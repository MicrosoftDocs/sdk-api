...
A value that was passed in the <i>pData</i> parameter to function <a href="https://msdn.microsoft.com/library/Bb775657(v=VS.85).aspx">DSA_EnumCallback</a> or function <a href="https://msdn.microsoft.com/library/Bb775615(v=VS.85).aspx">DPA_EnumCallback</a>.
