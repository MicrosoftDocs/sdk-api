...
Address of a pointer to an <a href="https://msdn.microsoft.com/library/Bb694546(v=VS.85).aspx">ID3D10Device1 Interface</a> that will receive the newly created device.
...
To create a device without creating a swap chain, see <a href="https://msdn.microsoft.com/library/Bb694526(v=VS.85).aspx">D3D10CreateDevice1</a>.
