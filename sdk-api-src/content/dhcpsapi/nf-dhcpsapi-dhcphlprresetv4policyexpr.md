...
ms.topic: function
f1_keywords: ["dhcpsapi/DhcpHlprResetV4PolicyExpr"]
...
Pointer to <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/dhcpsapi/ns-dhcpsapi-_dhcp_policy">DHCP_POLICY</a> structure that contains the policy to reset.
