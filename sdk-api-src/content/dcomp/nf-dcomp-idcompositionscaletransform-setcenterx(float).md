...
title: IDCompositionScaleTransform::SetCenterX(float)
...
ms.date: 07/24/2018
ms.keywords: IDCompositionScaleTransform interface [DirectComposition],SetCenterX method, IDCompositionScaleTransform.SetCenterX, IDCompositionScaleTransform.SetCenterX(float), IDCompositionScaleTransform::SetCenterX, IDCompositionScaleTransform::SetCenterX(float), SetCenterX, SetCenterX method [DirectComposition], SetCenterX method [DirectComposition],IDCompositionScaleTransform interface, dcomp/IDCompositionScaleTransform::SetCenterX, directcomp.idcompositionscaletransform_setcenterx_float
...
# IDCompositionScaleTransform::SetCenterX(float)
