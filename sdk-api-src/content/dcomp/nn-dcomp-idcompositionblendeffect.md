...
ms.topic: interface
f1_keywords: ["dcomp/IDCompositionBlendEffect"]
req.header: dcomp.h
req.include-header: 
...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IDCompositionBlendEffect</b> interface inherits from <a href="https://docs.microsoft.com/windows/desktop/api/dcomp/nn-dcomp-idcompositionfiltereffect">IDCompositionFilterEffect</a>. <b>IDCompositionBlendEffect</b> also has these types of members:
<ul>
...
The <b>IDCompositionBlendEffect</b> interface has these methods.
...
<a href="https://docs.microsoft.com/windows/desktop/api/dcomp/nf-dcomp-idcompositionblendeffect-setmode">SetMode</a>
</td>
