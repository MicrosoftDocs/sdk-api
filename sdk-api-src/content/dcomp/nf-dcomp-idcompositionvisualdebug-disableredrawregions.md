...
- Dcomp.dll
api_name:
- IDCompositionVisualDebug.DisableRedrawRegions
targetos: Windows
req.typenames: 
req.redist: 
ms.custom: 19H1
...
<a href="https://docs.microsoft.com/windows/desktop/api/dcomp/nf-dcomp-idcompositionvisualdebug-enableredrawregions">IDCompositionVisualDebug::EnableRedrawRegions</a>
 
