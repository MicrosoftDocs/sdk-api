...
ms.topic: method
f1_keywords: ["dcomp/IDCompositionVirtualSurface.Trim"]
req.header: dcomp.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/dcomp/nf-dcomp-idcompositionvirtualsurface-resize">IDCompositionVirtualSurface::Resize</a>
 
