...
ms.topic: method
f1_keywords: ["dcomp/IDCompositionDevice3.CreateTurbulenceEffect"]
req.header: dcomp.h
req.include-header: 
...
Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/dcomp/nn-dcomp-idcompositionturbulenceeffect">IDCompositionTurbulenceEffect</a>**</b>
