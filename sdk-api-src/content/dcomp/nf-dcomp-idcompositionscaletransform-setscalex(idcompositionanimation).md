...
ms.topic: method
f1_keywords: ["dcomp/IDCompositionScaleTransform.SetScaleX"]
req.header: dcomp.h
req.include-header: 
...
<a href="https://docs.microsoft.com/previous-versions/windows/desktop/legacy/hh449055(v=vs.85)">IDCompositionScaleTransform::SetScaleY</a>
 
