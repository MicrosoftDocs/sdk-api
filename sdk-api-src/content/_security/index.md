...
description: Overview of the Security and Identity technology.
...
- [Authentication](/windows/win32/secauthn)
- [Authorization](/windows/win32/secauthz)
- [Best Practices for the Security APIs](/windows/win32/secbp)
- [Certificate Enrollment API](/windows/win32/seccertenroll)
- [Cryptography API: Next Generation](/windows/win32/seccng)
- [Cryptography](/windows/win32/seccrypto)
- [Security Glossary](/windows/win32/secgloss)
- [Security Management](/windows/win32/secmgmt)
- [Security WMI Providers](/windows/win32/secprov)
- [Software Licensing API](/previous-versions/windows/desktop/secslapi)
