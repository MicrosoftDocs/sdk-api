---
UID: NF:winsock.FD_ZERO
title: FD_ZERO macro (winsock.h)
description: The FD_ZERO macro (winsock.h) is used to clear all sockets in a descriptor set
...
The **FD_ZERO** macro clears all sockets in an [fd_set](/windows/win32/api/winsock/ns-winsock-fd_set) structure by setting the *fd_count* to 0.
