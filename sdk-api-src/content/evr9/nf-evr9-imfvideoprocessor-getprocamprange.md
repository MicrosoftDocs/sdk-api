...
ms.topic: method
f1_keywords: ["evr9/IMFVideoProcessor.GetProcAmpRange"]
req.header: evr9.h
req.include-header: 
...
The ProcAmp setting to query. For a list of possible values, see <a href="https://docs.microsoft.com/windows/desktop/medfound/procamp-settings">ProcAmp Settings</a>.


### -param pPropRange [out]

Pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/dxva2api/ns-dxva2api-_dxva2_valuerange">DXVA2_ValueRange</a> structure that receives range of values for the specified ProcAmp setting.
