...
ms.topic: macro
f1_keywords: ["rtmv2/RTM_IPV4_GET_ADDR_AND_MASK"]
req.header: rtmv2.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/rtmv2/ns-rtmv2-_rtm_net_address">RTM_NET_ADDRESS</a> structure and length to an IPv4 address and mask.
