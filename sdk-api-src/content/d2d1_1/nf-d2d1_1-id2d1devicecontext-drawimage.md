---
UID: NF:d2d1_1.ID2D1DeviceContext.DrawImage
title: ID2D1DeviceContext::DrawImage
...
ms.date: 08/06/2018
ms.keywords: DrawImage, DrawImage method [Direct2D], DrawImage method [Direct2D],ID2D1DeviceContext interface, ID2D1DeviceContext interface [Direct2D],DrawImage method, ID2D1DeviceContext.DrawImage, ID2D1DeviceContext::DrawImage, d2d1_1/ID2D1DeviceContext::DrawImage, direct2d.id2d1devicecontext_drawimage
ms.prod: windows
