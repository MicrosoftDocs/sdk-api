---
UID: NF:d2d1_1.ID2D1DeviceContext.DrawImage(ID2D1Effect,constD2D1_POINT_2F,constD2D1_RECT_F,D2D1_INTERPOLATION_MODE,D2D1_COMPOSITE_MODE)
...
description: Draws an image to the device context. (overload 8/8)
