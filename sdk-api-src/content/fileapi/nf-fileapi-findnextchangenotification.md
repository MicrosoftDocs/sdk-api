...
ms.topic: function
f1_keywords: ["fileapi/FindNextChangeNotification"]
...
For an example, see 
<a href="https://docs.microsoft.com/windows/desktop/FileIO/obtaining-directory-change-notifications">Obtaining Directory Change Notifications</a>. 
