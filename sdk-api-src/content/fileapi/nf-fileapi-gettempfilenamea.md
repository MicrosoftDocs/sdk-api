...
Temporary files whose names have been created by this function are not automatically deleted. To delete these files call [DeleteFile](nf-fileapi-deletefilea.md).

To avoid problems resulting when converting an ANSI string, an application should call the [CreateFile](nf-fileapi-createfilea.md) function to create a temporary file.
...
[DeleteFile](nf-fileapi-deletefilea.md)

[File Management Functions](/windows/win32/FileIO/file-management-functions)

[GetTempPath2](nf-fileapi-gettemppath2a.md)
