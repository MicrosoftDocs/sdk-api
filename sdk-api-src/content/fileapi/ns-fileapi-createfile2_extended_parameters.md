...
<tr>
<td width="40%"><a id="FILE_FLAG_DISALLOW_PATH_REDIRECTS"></a><a id="file_flag_disallow_path_redirects"></a><dl>
<dt><b>FILE_FLAG_DISALLOW_PATH_REDIRECTS</b></dt>
<dt>0x00010000</dt>
</dl>
</td>
<td width="60%">
If this flag is set and the specified path contains any redirections (for example, a <a href="/windows/desktop/FileIO/reparse-points">reparse point</a> such as a symbolic link, mount point, or junction), the open operation fails. Use this flag to ensure that the file or directory being opened is at the exact path specified, without following any path redirections.
</td>
</tr>
<tr>
