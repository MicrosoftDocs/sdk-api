...
ms.topic: macro
f1_keywords: ["vfw/ICDecompressBegin"]
req.header: vfw.h
req.include-header: 
...
Pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/wingdi/ns-wingdi-tagbitmapinfo">BITMAPINFO</a> structure containing the output format. 
