...
If the text range is a selection, you can set the attributes of the selection by using the <a href="https://msdn.microsoft.com/library/Bb774143(v=VS.85).aspx">ITextSelection::SetFlags</a> method. 
