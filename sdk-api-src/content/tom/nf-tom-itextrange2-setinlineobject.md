...
The closing bracket (<a href="https://msdn.microsoft.com/library/Hh768758(v=VS.85).aspx">tomBrackets</a>) character. See <a href="http://go.microsoft.com/fwlink/p/?linkid=124972">Unicode Technical Note 28</a> for a list of characters.
...
The separator character for <a href="https://msdn.microsoft.com/library/Hh768758(v=VS.85).aspx">tomBracketsWithSeps</a>, which can be one of the following values.
...
The number of columns in the inline object. For  <a href="https://msdn.microsoft.com/library/Hh768758(v=VS.85).aspx">tomMatrix</a> only.
