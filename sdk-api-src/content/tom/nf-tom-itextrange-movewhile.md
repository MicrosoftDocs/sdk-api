...
The motion described by <a href="https://msdn.microsoft.com/library/Bb774084(v=VS.85).aspx">ITextRange::MoveUntil</a> is logical rather than geometric. That is, motion is toward the end or toward the start of a story. Depending on the language, moving to the end of the story could be moving left or moving right. 
...
The <b>ITextRange::MoveWhile</b> method is similar to <a href="https://msdn.microsoft.com/library/Bb774084(v=VS.85).aspx">ITextRange::MoveUntil</a>, but <b>MoveWhile</b> searches as long as it finds members of the set specified by <i>Cset</i>, and there is no additional increment to the value <i>pDelta</i>.

The <a href="https://msdn.microsoft.com/library/Bb774082(v=VS.85).aspx">ITextRange::MoveStartWhile</a> and <a href="https://msdn.microsoft.com/library/Bb774072(v=VS.85).aspx">ITextRange::MoveEndWhile</a> methods move the start and end, respectively, just past all contiguous characters that are found in set of characters specified by the <i>Cset</i> parameter.
