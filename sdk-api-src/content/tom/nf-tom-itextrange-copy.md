...
The <a href="https://msdn.microsoft.com/library/Bb787744(v=VS.85).aspx">ITextRange::Cut</a>, 
				<b>ITextRange::Copy</b>, and <a href="https://msdn.microsoft.com/library/Bb774095(v=VS.85).aspx">ITextRange::Paste</a> methods let you perform the usual 
...
To copy and replace plain text, you can use the <a href="https://msdn.microsoft.com/library/Bb774036(v=VS.85).aspx">ITextRange::GetText</a> 
				<b></b>and <a href="https://msdn.microsoft.com/library/Bb787831(v=VS.85).aspx">ITextRange::SetText</a> 
				<b></b>methods. To copy formatted text from range r1 to range r2 without using the clipboard, you can use <b>Copy</b> and 
				<b>Paste</b> and also the <a href="https://msdn.microsoft.com/library/Bb773958(v=VS.85).aspx">ITextRange::GetFormattedText</a> and <a href="https://msdn.microsoft.com/library/Bb774149(v=VS.85).aspx">ITextRange::SetFormattedText</a> methods, as shown in the following Microsoft Visual Basic example:
...
<a href="https://msdn.microsoft.com/library/Bb787744(v=VS.85).aspx">Cut</a>



<a href="https://msdn.microsoft.com/library/Bb773958(v=VS.85).aspx">GetFormattedText</a>
...
<a href="https://msdn.microsoft.com/library/Bb774149(v=VS.85).aspx">SetFormattedText</a>
