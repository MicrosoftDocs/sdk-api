...
Unit that is indexed. For a list of possible <i>Unit</i> values, see the discussion under <a href="https://msdn.microsoft.com/library/Bb774058(v=VS.85).aspx">ITextRange</a>. 
