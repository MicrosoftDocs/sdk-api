...
The <a href="https://msdn.microsoft.com/library/Bb774058(v=VS.85).aspx">ITextRange</a> object that is compared to this range. 
...
The 
				<b>ITextRange::IsEqual</b> method returns <b>tomTrue</b> only if the range points at the same text as <i>pRange</i>. See <a href="https://msdn.microsoft.com/library/Bb787724(v=VS.85).aspx">Finding Rich Text</a> for code that compares two different pieces of text to see if they contain the same plain text and the same character formatting.
