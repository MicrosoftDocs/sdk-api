...
If <b>ITextPara::GetKeepWithNext</b> succeeds, it returns <b>S_OK</b>. If the method fails, it returns one of the following COM error codes.  For more information about COM error codes, see <a href="/windows/desktop/com/error-handling-in-com">Error Handling in COM</a>.
...
<a href="/windows/desktop/api/tom/nf-tom-itextpara-setkeepwithnext">SetKeepWithNext</a>
