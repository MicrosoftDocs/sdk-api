...
To set the first line indentation amount, call the <a href="https://msdn.microsoft.com/library/Bb774155(v=VS.85).aspx">ITextPara::SetIndents</a> method.

To get and set the indent for all other lines of the paragraph (that is, the left
				indent), use <a href="https://msdn.microsoft.com/library/Bb773977(v=VS.85).aspx">ITextPara::GetLeftIndent</a> and <a href="https://msdn.microsoft.com/library/Bb774155(v=VS.85).aspx">ITextPara::SetIndents</a>.
