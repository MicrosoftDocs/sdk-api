...
The <b>ITextRange2</b> interface is derived from <a href="https://msdn.microsoft.com/library/Bb774058(v=VS.85).aspx">ITextRange</a>, and its objects are powerful editing and data-binding tools that enable a program to select text in a story and then examine or change that text.
