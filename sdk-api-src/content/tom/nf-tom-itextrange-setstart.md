...
<a href="https://msdn.microsoft.com/library/Bb774139(v=VS.85).aspx">ITextRange::SetEnd</a> sets the range's end position, and <a href="https://msdn.microsoft.com/library/Bb787805(v=VS.85).aspx">ITextRange::SetRange</a> sets both range ends simultaneously. The following example shows how to convert a nondegenerate range into a degenerate one (insertion point).
