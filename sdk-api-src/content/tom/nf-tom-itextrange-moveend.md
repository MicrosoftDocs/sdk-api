...
The units by which to move the end of the range. The default value is <b>tomCharacter</b>. For a list of the other unit values, see <a href="https://msdn.microsoft.com/library/Bb774058(v=VS.85).aspx">ITextRange</a>. 
