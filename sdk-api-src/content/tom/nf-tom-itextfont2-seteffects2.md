...
title: ITextFont2::SetEffects2 method
...
ms.date: 3/31/2018
ms.keywords: ITextFont2, ITextFont2 interface [Windows Controls], SetEffects2 method, ITextFont2::SetEffects2, SetEffects2 method [Windows Controls], SetEffects2 method [Windows Controls], ITextFont2 interface, SetEffects2,ITextFont2.SetEffects2, controls.itextfont2_seteffects2, tom/ITextFont2::SetEffects2, tomAutoSpaceAlpha, tomAutoSpaceNumeric, tomAutoSpaceParens, tomDoublestrike, tomEmbeddedFont, tomModWidthPairs, tomModWidthSpace, tomOverlapping
