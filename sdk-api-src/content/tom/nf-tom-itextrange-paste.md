...
The clipboard format to use in the paste operation. Zero is best format, which usually is RTF, but <b>CF_UNICODETEXT</b> and other formats are also possible. The default value is zero. For more information, see <a href="https://msdn.microsoft.com/library/ms649013(v=VS.85).aspx">Clipboard Formats</a>.
...
For more information, see<a href="https://msdn.microsoft.com/library/Bb787742(v=VS.85).aspx">ITextRange::Copy</a>.
...
<a href="https://msdn.microsoft.com/library/ms649013(v=VS.85).aspx">Clipboard Formats</a>
