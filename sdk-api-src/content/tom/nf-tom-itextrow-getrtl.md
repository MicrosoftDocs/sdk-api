...
ms.date: 3/31/2018
ms.keywords: GetRTL method [Windows Controls], GetRTL method [Windows Controls], ITextRow interface, GetRTL,ITextRow.GetRTL, ITextRow, ITextRow interface [Windows Controls], GetRTL method, ITextRow::GetRTL, controls.itextrow_getrtl, tom/ITextRow::GetRTL
