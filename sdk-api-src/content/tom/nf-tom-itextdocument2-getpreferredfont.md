...
If the high-order word of <i>Options</i> is <a href="https://msdn.microsoft.com/library/Hh768766(v=VS.85).aspx">tomUseTwips</a>, the font heights are given in twips.
