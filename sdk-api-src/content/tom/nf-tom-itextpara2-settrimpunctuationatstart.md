...
ms.topic: method
f1_keywords: ["tom/ITextPara2.SetTrimPunctuationAtStart"]
req.header: tom.h
req.include-header: 
...
A <a href="https://docs.microsoft.com/windows/desktop/Controls/about-text-object-model">tomBool</a> that indicates whether to trim the leading space of a punctuation symbol. It can be one of the following values.
...
<a href="https://docs.microsoft.com/windows/desktop/api/tom/nf-tom-itextpara2-gettrimpunctuationatstart">ITextPara2::GetTrimPunctuationAtStart</a>
 
