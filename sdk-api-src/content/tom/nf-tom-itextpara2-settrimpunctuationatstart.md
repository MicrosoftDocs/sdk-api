...
A <a href="https://msdn.microsoft.com/library/Bb787724(v=VS.85).aspx">tomBool</a> that indicates whether to trim the leading space of a punctuation symbol. It can be one of the following values.
