...
If a document is created with the <a href="https://msdn.microsoft.com/library/Bb774091(v=VS.85).aspx">ITextDocument::New</a> method and the zero values are used, then the Text Object Model (TOM) engine has to choose which flags and code page to use. UTF-8 Rich Text Format (RTF) (defined below) is an attractive default.
