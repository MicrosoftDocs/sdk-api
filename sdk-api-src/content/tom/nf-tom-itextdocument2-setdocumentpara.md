...
You can also set the default paragraph formatting by calling <a href="https://msdn.microsoft.com/library/Bb787849(v=VS.85).aspx">ITextPara::Reset(tomDefault)</a>.
