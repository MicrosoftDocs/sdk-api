...
This method is similar to <a href="https://msdn.microsoft.com/library/Bb787831(v=VS.85).aspx">ITextRange:: SetText</a>, but lets the client specify flags that control various insertion options, including the special flag <b>tomLanguageTag</b> to get the BCP-47 language tag for the range. This is an industry standard language tag that may be preferable to <a href="https://msdn.microsoft.com/library/Bb774167(v=VS.85).aspx">ITextFont::SetLanguageID</a>, which uses a language code identifier (LCID).
