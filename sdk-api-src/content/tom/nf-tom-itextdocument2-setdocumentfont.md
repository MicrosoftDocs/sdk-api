...
You can also set the default character formatting by calling <a href="https://msdn.microsoft.com/library/Bb787865(v=VS.85).aspx">ITextFont::Reset(tomDefault)</a>.
...
<a href="https://msdn.microsoft.com/library/Bb787865(v=VS.85).aspx">ITextFont::Reset</a>
 
