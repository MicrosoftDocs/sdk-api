...
Call this method only if the <a href="https://msdn.microsoft.com/library/Bb774027(v=VS.85).aspx">ITextDocument::GetStoryCount</a> method returns a value that is greater than one.
