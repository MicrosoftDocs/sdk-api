...
title: ITAgentEvent::get_Event method
...
ms.date: 4/16/2018
ms.keywords: ITAgentEvent, ITAgentEvent interface [TAPI 2.2], get_Event method, ITAgentEvent::get_Event, _tapi3_itagentevent_get_event, get_Event method [TAPI 2.2], get_Event method [TAPI 2.2], ITAgentEvent interface, get_Event,ITAgentEvent.get_Event, tapi3.itagentevent_get_event, tapi3cc/ITAgentEvent::get_Event
