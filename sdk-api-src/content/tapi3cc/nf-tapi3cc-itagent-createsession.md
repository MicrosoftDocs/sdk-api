...
title: ITAgent::CreateSession (tapi3cc.h)
description: The CreateSession method creates a new agent session for the input ACD group and address. (ITAgent.CreateSession)
