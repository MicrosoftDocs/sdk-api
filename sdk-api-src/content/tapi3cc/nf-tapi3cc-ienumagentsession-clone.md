...
description: The IEnumAgentSession::Clone method (tapi3cc.h) creates another enumerator that contains the same enumeration state as the current one.  
...
f1_keywords:
 ...
 - tapi3cc/IEnumAgentSession::Clone
dev_langs:
 - c++
topic_type:
 - APIRef
