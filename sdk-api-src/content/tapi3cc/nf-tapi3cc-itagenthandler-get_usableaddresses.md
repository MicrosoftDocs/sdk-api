...
description: The get_UsableAddresses method creates a collection of addresses available for receiving ACD calls on this agent handler. (ITAgentHandler.get_UsableAddresses)
