...
description: The get_CurrentLongestWaitTime method gets the longest time a current call (still in the queue) has been waiting (in seconds) during the current measurement period. (ITQueue.get_CurrentLongestWaitTime)
