...
description: The get_TotalWrapUpTime method gets the number of seconds spent on ACD call wrap-up (after-call work) during this agent session (by this agent). (ITAgentSession.get_TotalWrapUpTime)
