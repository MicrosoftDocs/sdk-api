...
title: ITAgent::get_TotalWrapUpTime method
...
ms.date: 4/16/2018
ms.keywords: ITAgent, ITAgent interface [TAPI 2.2], get_TotalWrapUpTime method, ITAgent::get_TotalWrapUpTime, _tapi3_itagent_get_totalwrapuptime, get_TotalWrapUpTime method [TAPI 2.2], get_TotalWrapUpTime method [TAPI 2.2], ITAgent interface, get_TotalWrapUpTime,ITAgent.get_TotalWrapUpTime, tapi3.itagent_get_totalwrapuptime, tapi3cc/ITAgent::get_TotalWrapUpTime
...
# ITAgent::get_TotalWrapUpTime method
