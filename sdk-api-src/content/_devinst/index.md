...
| [CM_Open_Device_Interface_KeyA function](..\cfgmgr32\nf-cfgmgr32-cm_open_device_interface_keya.md) | The CM_Open_Device_Interface_Key_ExA function opens the registry subkey that is used by applications and drivers to store information that is specific to a device interface. |
| [CM_Open_Device_Interface_KeyW function](..\cfgmgr32\nf-cfgmgr32-cm_open_device_interface_keyw.md) | The CM_Open_Device_Interface_Key_ExA function opens the registry subkey that is used by applications and drivers to store information that is specific to a device interface. |
