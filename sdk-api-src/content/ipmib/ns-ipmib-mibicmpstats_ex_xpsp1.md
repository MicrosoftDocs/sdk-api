...
ms.topic: struct
f1_keywords: ["ipmib/MIBICMPSTATS_EX"]
req.header: ipmib.h
...
<a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/ipmib/ns-ipmib-_mib_icmp_ex_xpsp1">MIB_ICMP_EX</a> structure contains two 
