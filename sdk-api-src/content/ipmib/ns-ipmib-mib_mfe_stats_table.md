...
ms.topic: struct
f1_keywords: ["ipmib/MIB_MFE_STATS_TABLE"]
req.header: ipmib.h
...
<a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/ipmib/ns-ipmib-_mib_ipmcast_mfe_stats">MIB_IPMCAST_MFE_STATS</a> structures.
