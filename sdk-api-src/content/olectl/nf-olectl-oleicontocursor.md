...
The function returns a handle to the new cursor object. The caller is responsible for deleting this cursor with the <a href="https://www.bing.com/search?q=DestroyCursor">DestroyCursor</a> function. If the conversion could not be completed, the return value is <b>NULL</b>.
...
This function calls the <a href="https://www.bing.com/search?q=CopyCursor">CopyCursor</a> function.
