...
Forces the pager control to recalculate the size of the contained window. Using this macro will result in a <a href="https://msdn.microsoft.com/library/Bb760864(v=VS.85).aspx">PGN_CALCSIZE</a> notification being sent. You can use this macro or send the <a href="https://msdn.microsoft.com/library/Bb760876(v=VS.85).aspx">PGM_RECALCSIZE</a> message explicitly. 
