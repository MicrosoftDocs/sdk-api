...
Gets the handle to an image list used for drawing list-view items. You can use this macro or send the <a href="https://msdn.microsoft.com/library/Bb774943(v=VS.85).aspx">LVM_GETIMAGELIST</a> message explicitly. 
