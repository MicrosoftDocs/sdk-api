...
Type: <b>const <a href="https://msdn.microsoft.com/library/Bb787473(v=VS.85).aspx">TASKDIALOGCONFIG</a>*</b>

Pointer to a <a href="https://msdn.microsoft.com/library/Bb787473(v=VS.85).aspx">TASKDIALOGCONFIG</a> structure that contains information used to display the task dialog.
