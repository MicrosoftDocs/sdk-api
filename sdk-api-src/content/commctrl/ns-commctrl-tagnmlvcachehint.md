...
Contains information used to update the cached item information for use with a <a href="https://msdn.microsoft.com/library/Bb774735(v=VS.85).aspx">virtual list view</a>. 
