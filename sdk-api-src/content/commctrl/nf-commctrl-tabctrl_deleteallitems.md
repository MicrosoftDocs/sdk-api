...
Removes all items from a tab control. You can use this macro or send the <a href="https://msdn.microsoft.com/library/Bb760575(v=VS.85).aspx">TCM_DELETEALLITEMS</a> message explicitly. 
