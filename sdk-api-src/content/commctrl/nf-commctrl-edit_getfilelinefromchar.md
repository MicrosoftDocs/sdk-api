...
Gets the index of the file (or logical) line of text that includes the specified character index  (text wrap delimiters are ignored). You can use this macro or send the <a href="controls.em_filelinefromchar">EM_FILELINEFROMCHAR</a> message explicitly.
