...
<td width="60%">
The insertion mark is on the background of the toolbar. This flag is only used with the <a href="https://msdn.microsoft.com/library/Bb787367(v=VS.85).aspx">TB_INSERTMARKHITTEST</a> message. 
