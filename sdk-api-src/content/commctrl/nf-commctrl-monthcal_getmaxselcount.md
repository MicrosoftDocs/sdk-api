...
Retrieves the maximum date range that can be selected in a month calendar control. You can use this macro or send the <a href="https://msdn.microsoft.com/library/Bb760960(v=VS.85).aspx">MCM_GETMAXSELCOUNT</a> message explicitly. 
...
You can change the maximum date range that can be selected by using the <a href="https://msdn.microsoft.com/library/Bb761008(v=VS.85).aspx">MCM_SETMAXSELCOUNT</a> message. 
