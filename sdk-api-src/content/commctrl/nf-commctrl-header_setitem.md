...
Sets the attributes of the specified item in a header control. You can use this macro or send the <a href="https://msdn.microsoft.com/library/Bb775367(v=VS.85).aspx">HDM_SETITEM</a> message explicitly. 
...
A pointer to an <a href="https://msdn.microsoft.com/library/Bb775247(v=VS.85).aspx">HDITEM</a> structure that contains item information. When this message is sent, the 
...
The <a href="https://msdn.microsoft.com/library/Bb775247(v=VS.85).aspx">HDITEM</a> structure that supports this macro supports item order and image list information. By using these members, you can control the order in which items are displayed and specify images to appear with items. 
