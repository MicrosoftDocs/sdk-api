...
Sorts the child items of the specified parent item in a tree-view control. You can use this macro or send the <a href="https://msdn.microsoft.com/library/Bb773782(v=VS.85).aspx">TVM_SORTCHILDREN</a> message explicitly. 
...
## -remarks
		...
		This message alphabetizes the tree items using <a href="https://msdn.microsoft.com/library/ms647489(v=VS.85).aspx">lstrcmpi</a> on the item name. You can use the <a href="https://msdn.microsoft.com/library/Bb773785(v=VS.85).aspx">TVM_SORTCHILDRENCB</a> message to customize the ordering behavior.
