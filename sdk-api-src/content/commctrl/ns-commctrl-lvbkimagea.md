...
description: Contains information about the background image of a list-view control. This structure is used for both setting and retrieving background image information. (ANSI)
helpviewer_keywords: ["*LPLVBKIMAGEA","LPLVBKIMAGE","LPLVBKIMAGE structure pointer [Windows Controls]","LVBKIF_FLAG_ALPHABLEND","LVBKIF_FLAG_TILEOFFSET","LVBKIF_SOURCE_HBITMAP","LVBKIF_SOURCE_NONE","LVBKIF_SOURCE_URL","LVBKIF_STYLE_NORMAL","LVBKIF_STYLE_TILE","LVBKIF_TYPE_WATERMARK","LVBKIMAGE","LVBKIMAGE structure [Windows Controls]","LVBKIMAGEA","LVBKIMAGEW","_win32_LVBKIMAGE","_win32_LVBKIMAGE_cpp","commctrl/LPLVBKIMAGE","commctrl/LVBKIMAGE","commctrl/LVBKIMAGEA","commctrl/LVBKIMAGEW","controls.LVBKIMAGE","controls._win32_LVBKIMAGE"]
