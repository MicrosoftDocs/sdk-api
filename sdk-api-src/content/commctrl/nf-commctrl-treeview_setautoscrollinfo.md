...
Sets information used to determine auto-scroll characteristics. Use this macro or send the <a href="https://msdn.microsoft.com/library/Bb773738(v=VS.85).aspx">TVM_SETAUTOSCROLLINFO</a> message explicitly.
...
Autoscroll information is used to scroll a nonvisible item into view. The control must have the <a href="https://msdn.microsoft.com/library/Bb759981(v=VS.85).aspx">TVS_EX_AUTOHSCROLL</a> extended style. For information on extended styles, see Tree-View Control Extended Styles.
