...
Gets the text meant for display when the list-view control appears empty. Use this macro or send the <a href="https://msdn.microsoft.com/library/Bb774921(v=VS.85).aspx">LVM_GETEMPTYTEXT</a> message explicitly.
