...
ms.topic: macro
f1_keywords: ["commctrl/ListView_GetTextBkColor"]
...
Gets the text background color of a list-view control. You can use this macro or send the <a href="https://docs.microsoft.com/windows/desktop/Controls/lvm-gettextbkcolor">LVM_GETTEXTBKCOLOR</a> message explicitly. 
