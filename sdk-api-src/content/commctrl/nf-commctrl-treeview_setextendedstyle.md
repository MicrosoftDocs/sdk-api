...
Sets the extended style for a specified TreeView control. Use this macro or send the <a href="https://msdn.microsoft.com/library/Bb773744(v=VS.85).aspx">TVM_SETEXTENDEDSTYLE</a> message explicitly.
...
Value that indicates the extended style. For more information on styles, see <a href="https://msdn.microsoft.com/library/Bb759981(v=VS.85).aspx">Tree-View Control Extended Styles</a>.
