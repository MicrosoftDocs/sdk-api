...
Determines the width of a specified string using the specified list-view control's current font. You can use this macro or send the <a href="https://msdn.microsoft.com/library/Bb761073(v=VS.85).aspx">LVM_GETSTRINGWIDTH</a> message explicitly. 
