...
Shows the infotip for a specified item in a tree-view control. Use this macro or send the <a href="https://msdn.microsoft.com/library/Bb773779(v=VS.85).aspx">TVM_SHOWINFOTIP</a> message explicitly.
...
Most applications do not use this macro. Infotips are shown automatically. For more information, see Using Tree-view Infotips in the <a href="https://msdn.microsoft.com/library/Bb760017(v=VS.85).aspx">About Tree-View Controls</a> overview.
