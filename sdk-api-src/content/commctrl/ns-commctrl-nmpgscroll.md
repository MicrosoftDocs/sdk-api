...
Contains and receives information that the pager control uses when scrolling the contained window. It is used with the <a href="https://msdn.microsoft.com/library/Bb760866(v=VS.85).aspx">PGN_SCROLL</a> notification. 
