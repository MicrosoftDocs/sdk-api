...
ms.topic: struct
f1_keywords: ["commctrl/NMSELCHANGE"]
...
Carries information required to process the <a href="https://docs.microsoft.com/windows/desktop/Controls/mcn-selchange">MCN_SELCHANGE</a> notification code. 
