...
Gets the text color of a list-view control. You can use this macro or send the <a href="https://docs.microsoft.com/windows/desktop/Controls/lvm-gettextcolor">LVM_GETTEXTCOLOR</a> message explicitly. 
