...
Contains information specific to an <a href="https://msdn.microsoft.com/library/Bb773470(v=VS.85).aspx">NM_CUSTOMDRAW (tree view)</a> notification code sent by a tree-view control. 
...
<a href="https://msdn.microsoft.com/library/Bb775483(v=VS.85).aspx">NMCUSTOMDRAW</a> structure that contains general custom draw information. 
