...
Indicates whether an item in the list-view control is visible. Use this macro or send the <a href="https://msdn.microsoft.com/library/Bb761135(v=VS.85).aspx">LVM_ISITEMVISIBLE</a> message explicitly.
