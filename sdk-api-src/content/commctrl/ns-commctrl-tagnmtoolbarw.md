...
<a href="https://msdn.microsoft.com/library/Bb760476(v=VS.85).aspx">TBBUTTON</a> structure that contains information about the toolbar button associated with the notification code. This member only contains valid information with the <a href="https://msdn.microsoft.com/library/Bb787280(v=VS.85).aspx">TBN_QUERYINSERT</a> and <a href="https://msdn.microsoft.com/library/Bb787278(v=VS.85).aspx">TBN_QUERYDELETE</a> notification codes. 
