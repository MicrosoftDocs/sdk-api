...
Gets the index of the topmost visible item when in list or report view. You can use this macro or send the <a href="https://msdn.microsoft.com/library/Bb761087(v=VS.85).aspx">LVM_GETTOPINDEX</a> message explicitly. 
