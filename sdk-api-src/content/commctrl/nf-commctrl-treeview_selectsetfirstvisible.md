...
ms.topic: macro
f1_keywords: ["commctrl/TreeView_SelectSetFirstVisible"]
...
Using the <b>TreeView_SelectSetFirstVisible</b> macro is equivalent to sending the <a href="https://docs.microsoft.com/windows/desktop/Controls/tvm-selectitem">TVM_SELECTITEM</a> message with its <i>flag</i> parameter set to the TVGN_FIRSTVISIBLE value. 
