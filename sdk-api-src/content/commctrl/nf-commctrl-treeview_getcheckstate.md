...
Gets the check state of the specified item. You can also use the <a href="https://msdn.microsoft.com/library/Bb773614(v=VS.85).aspx">TVM_GETITEMSTATE</a> message directly. 
