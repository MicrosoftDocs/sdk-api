...
Gets the check state of the specified item. You can also use the <a href="https://docs.microsoft.com/windows/desktop/Controls/tvm-getitemstate">TVM_GETITEMSTATE</a> message directly.
