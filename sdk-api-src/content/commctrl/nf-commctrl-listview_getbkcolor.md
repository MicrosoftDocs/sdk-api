...
Gets the background color of a list-view control. You can use this macro or send the <a href="https://msdn.microsoft.com/en-us/library/Bb774905(v=VS.85).aspx">LVM_GETBKCOLOR</a> message explicitly. 
