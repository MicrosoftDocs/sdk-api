...
Carries information required to process the <a href="https://msdn.microsoft.com/library/Bb760935(v=VS.85).aspx">MCN_GETDAYSTATE</a> notification code. All members of this structure are for input, except 
...
Address of an array of <a href="https://msdn.microsoft.com/library/Bb760915(v=VS.85).aspx">MONTHDAYSTATE</a> values. The buffer at this address must be large enough to contain at least 
