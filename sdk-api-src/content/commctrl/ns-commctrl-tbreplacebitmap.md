...
Used with the <a href="https://msdn.microsoft.com/library/Bb787391(v=VS.85).aspx">TB_REPLACEBITMAP</a> message to replace one toolbar bitmap with another.
...
If 
				<b>nIDNew</b> holds a bitmap handle, rather than a resource ID, do not destroy the bitmap until it has been replaced with <a href="https://msdn.microsoft.com/library/Bb787391(v=VS.85).aspx">TB_REPLACEBITMAP</a>, or the toolbar is destroyed.
