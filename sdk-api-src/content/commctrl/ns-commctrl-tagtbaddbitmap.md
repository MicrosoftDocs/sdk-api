...
If 
				<b>nID</b> holds a bitmap handle, rather than a resource ID, do not destroy the bitmap until it has been replaced with <a href="https://msdn.microsoft.com/library/Bb787391(v=VS.85).aspx">TB_REPLACEBITMAP</a>. Otherwise, the toolbar is destroyed.

Defined values can be used as indexes to the standard bitmaps. For more information, see <a href="https://msdn.microsoft.com/library/Bb760433(v=VS.85).aspx">Toolbar Standard Button Image Index Values</a>.

The <b>TBADDBITMAP</b> structure is used with the <a href="https://msdn.microsoft.com/library/Bb787289(v=VS.85).aspx">TB_ADDBITMAP</a> message.
