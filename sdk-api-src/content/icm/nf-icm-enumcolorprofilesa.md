...
title: EnumColorProfilesA function
...
Do not attempt to use <b>EnumColorProfiles</b> to determine the default profile for a device. Instead, create a device context for the device and then invoke the <a href="https://msdn.microsoft.com/1e16771a-80c5-47bb-9c98-14169d4dd773">GetICMProfile</a> function. On Windows Vista and Windows 7, the <a href="https://msdn.microsoft.com/library/windows/hardware/ff563726">WcsGetDefaultColorProfile</a> function can also be used to determine a device's default color profile.
