...
The <b>IMILBitmapEffectRenderContextImpl</b> interface inherits from the <a href="/windows/desktop/api/unknwn/nn-unknwn-iunknown">IUnknown</a> interface. <b>IMILBitmapEffectRenderContextImpl</b> also has these types of members:
