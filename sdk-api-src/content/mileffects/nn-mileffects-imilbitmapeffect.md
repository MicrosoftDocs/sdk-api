...
<a href="https://msdn.microsoft.com/library/ms735315(v=VS.85).aspx">GetOutput</a>
</td>
...
<tr data="declared;">
<td align="left" width="37%">
<a href="https://msdn.microsoft.com/library/ms735316(v=VS.85).aspx">GetParentEffect</a>
</td>
<td align="left" width="63%">
...
<tr data="declared;">
<td align="left" width="37%">
<a href="https://msdn.microsoft.com/library/ms735318(v=VS.85).aspx">SetInputSource</a>
</td>
<td align="left" width="63%">
...
<b>IMILBitmapEffect</b> is a wrapper for a <a href="https://msdn.microsoft.com/library/ms735258(v=VS.85).aspx">IMILBitmapEffectPrimitive</a>. A <b>IMILBitmapEffectPrimitive</b> is wrapped by a <b>IMILBitmapEffect</b> through Component Object Model (COM) aggregation.
            Therefore, independent software vendor (ISV) effect writers do not need to implement the <b>IMILBitmapEffect</b>, <a href="https://msdn.microsoft.com/library/ms735279(v=VS.85).aspx">IMILBitmapEffectImpl</a>, and <a href="https://msdn.microsoft.com/library/ms735314(v=VS.85).aspx">IMILBitmapEffectConnections</a> interfaces.
