...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IMILBitmapEffectOutputConnectorImpl</b> interface inherits from the <a href="https://msdn.microsoft.com/33f1d79a-33fc-4ce5-a372-e08bda378332">IUnknown</a> interface. <b>IMILBitmapEffectOutputConnectorImpl</b> also has these types of members:
<ul>
...
<a href="https://msdn.microsoft.com/library/ms735261(v=VS.85).aspx">AddBackLink</a>
</td>
<td align="left" width="63%"></td>
</tr>
<tr data="declared;">
<td align="left" width="37%">
<a href="https://msdn.microsoft.com/library/ms735264(v=VS.85).aspx">RemoveBackLink</a>
</td>
<td align="left" width="63%"></td>
</tr>
</table> 
...
This interface must be implemented if an effect also implements <a href="https://msdn.microsoft.com/library/ms735267(v=VS.85).aspx">IMILBitmapEffectOutputConnector</a>.
