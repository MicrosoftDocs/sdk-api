...
ms.topic: struct
f1_keywords: ["mfplay/MFP_PAUSE_EVENT"]
req.header: mfplay.h
req.include-header: 
...
Event structure for the <b>MFP_EVENT_TYPE_PAUSE</b> event. This event is sent when the <a href="https://docs.microsoft.com/windows/desktop/api/mfplay/nf-mfplay-imfpmediaplayer-pause">IMFPMediaPlayer::Pause</a> method completes.
