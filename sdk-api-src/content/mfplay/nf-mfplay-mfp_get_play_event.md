...
```cpp
MFP_PLAY_EVENT MFP_GET_PLAY_EVENT(
...
Type: **<a href="/windows/desktop/api/mfplay/ns-mfplay-mfp_play_event">MFP_PLAY_EVENT</a>**

Returns a pointer to an **MFP_PLAY_EVENT** structure.
...
Casts an <a href="/windows/desktop/api/mfplay/ns-mfplay-mfp_event_header">MFP_EVENT_HEADER</a> pointer to an <a href="/windows/desktop/api/mfplay/ns-mfplay-mfp_play_event">MFP_PLAY_EVENT</a> pointer.
