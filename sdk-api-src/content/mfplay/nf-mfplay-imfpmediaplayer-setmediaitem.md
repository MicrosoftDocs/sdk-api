...
ms.topic: method
f1_keywords: ["mfplay/IMFPMediaPlayer.SetMediaItem"]
req.header: mfplay.h
req.include-header: 
...
Pointer to the <a href="https://docs.microsoft.com/windows/desktop/api/mfplay/nn-mfplay-imfpmediaitem">IMFPMediaItem</a> interface of the media item.
