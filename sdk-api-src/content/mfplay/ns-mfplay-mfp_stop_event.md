...
ms.topic: struct
f1_keywords: ["mfplay/MFP_STOP_EVENT"]
req.header: mfplay.h
req.include-header: 
...
Event structure for the <b>MFP_EVENT_TYPE_STOP</b> event. This event is sent when the <a href="https://docs.microsoft.com/windows/desktop/api/mfplay/nf-mfplay-imfpmediaplayer-stop">IMFPMediaPlayer::Stop</a> method completes.
