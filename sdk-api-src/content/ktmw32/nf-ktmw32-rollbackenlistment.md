...
ms.topic: function
f1_keywords: ["ktmw32/RollbackEnlistment"]
req.header: ktmw32.h
req.include-header: 
...
The latest virtual clock value received for this enlistment. See <a href="https://docs.microsoft.com/windows/desktop/api/winnt/ns-winnt-_large_integer">LARGE_INTEGER</a>.
