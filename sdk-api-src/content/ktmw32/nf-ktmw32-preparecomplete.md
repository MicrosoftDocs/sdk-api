...
ms.topic: function
f1_keywords: ["ktmw32/PrepareComplete"]
req.header: ktmw32.h
req.include-header: 
...
The latest virtual clock value received for this prepare complete notification. If you specify <b>NULL</b>, the virtual clock value is not changed. See <a href="https://docs.microsoft.com/windows/desktop/api/winnt/ns-winnt-_large_integer">LARGE_INTEGER</a>.
