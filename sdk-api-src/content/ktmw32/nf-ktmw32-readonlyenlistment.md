...
ms.topic: function
f1_keywords: ["ktmw32/ReadOnlyEnlistment"]
req.header: ktmw32.h
req.include-header: 
...
The latest virtual clock value received for this enlistment. If you specify <b>NULL</b>, the virtual clock value is not changed. See <a href="https://docs.microsoft.com/windows/desktop/api/winnt/ns-winnt-_large_integer">LARGE_INTEGER</a>.
