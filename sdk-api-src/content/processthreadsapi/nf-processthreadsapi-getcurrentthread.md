...
ms.topic: function
f1_keywords: ["processthreadsapi/GetCurrentThread"]
...
For an example, see 
<a href="https://docs.microsoft.com/windows/desktop/SecAuthZ/verifying-client-access-with-acls-in-c--">Checking Client Access</a>.
