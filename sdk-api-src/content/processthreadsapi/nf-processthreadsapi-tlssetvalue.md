...
ms.topic: function
f1_keywords: ["processthreadsapi/TlsSetValue"]
...
The TLS index that was allocated by the <a href="https://docs.microsoft.com/windows/desktop/api/processthreadsapi/nf-processthreadsapi-tlsalloc">TlsAlloc</a> 
      function.
