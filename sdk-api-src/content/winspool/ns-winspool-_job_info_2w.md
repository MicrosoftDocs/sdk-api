...
description: The JOB_INFO_2 structure describes a full set of values associated with a job.
old-location: gdi\job_info_2.htm
old-project: printdocs
ms.assetid: 0cc61e35-4ac9-47bd-bb0d-ff43854bdee5
ms.author: windowsdriverdev
ms.date: 3/27/2018
ms.keywords: "*LPJOB_INFO_2W, *PJOB_INFO_2W, JOB_INFO_2, JOB_INFO_2 structure [Windows GDI], JOB_INFO_2W, PJOB_INFO_2, PJOB_INFO_2 structure pointer [Windows GDI], _JOB_INFO_2A, _JOB_INFO_2W, _win32_JOB_INFO_2_str, gdi.job_info_2, winspool/JOB_INFO_2, winspool/PJOB_INFO_2, winspool/_JOB_INFO_2A, winspool/_JOB_INFO_2W"
...
req.umdf-ver: 
req.ddi-compliance: 
req.unicode-ansi: "_JOB_INFO_2W (Unicode) and _JOB_INFO_2A (ANSI)"
req.idl: 
req.max-support: 
req.namespace: 
req.assembly: 
req.type-library: 
req.typenames: JOB_INFO_2W, *PJOB_INFO_2W, *LPJOB_INFO_2W
topic_type:
-	APIRef
-	kbSyntax
api_type:
...
The <b>JOB_INFO_2</b> structure describes a full set of values associated with a job.
