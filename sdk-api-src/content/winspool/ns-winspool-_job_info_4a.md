...
ms.date: 3/27/2018
ms.keywords: "*LPJOB_INFO_4A, *PJOB_INFO_4A, JOB_INFO_4, JOB_INFO_4 structure [Windows GDI], JOB_INFO_4A, PJOB_INFO_4, PJOB_INFO_4 structure pointer [Windows GDI], _JOB_INFO_4A, _JOB_INFO_4W, _win32_JOB_INFO_4_str, gdi.job_info_4, winspool/JOB_INFO_4, winspool/PJOB_INFO_4, winspool/_JOB_INFO_4A, winspool/_JOB_INFO_4W"
...
req.assembly: 
req.type-library: 
req.typenames: JOB_INFO_4A, *PJOB_INFO_4A, *LPJOB_INFO_4A
topic_type:
-	APIRef
-	kbSyntax
api_type:
