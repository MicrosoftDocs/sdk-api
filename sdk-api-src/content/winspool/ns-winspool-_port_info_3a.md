...
ms.date: 3/27/2018
ms.keywords: "*LPPORT_INFO_3A, *PPORT_INFO_3A, PORT_INFO_3, PORT_INFO_3 structure [Windows GDI], PORT_INFO_3A, PPORT_INFO_3, PPORT_INFO_3 structure pointer [Windows GDI], _PORT_INFO_3A, _PORT_INFO_3W, _win32_PORT_INFO_3_str, gdi.port_info_3, winspool/PORT_INFO_3, winspool/PPORT_INFO_3, winspool/_PORT_INFO_3A, winspool/_PORT_INFO_3W"
...
req.assembly: 
req.type-library: 
req.typenames: PORT_INFO_3A, *PPORT_INFO_3A, *LPPORT_INFO_3A
topic_type:
-	APIRef
-	kbSyntax
api_type:
