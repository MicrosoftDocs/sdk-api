...
ms.date: 3/27/2018
ms.keywords: "*LPFORM_INFO_1A, *PFORM_INFO_1A, FORM_INFO_1, FORM_INFO_1 structure [Windows GDI], FORM_INFO_1A, PFORM_INFO_1, PFORM_INFO_1 structure pointer [Windows GDI], _FORM_INFO_1A, _FORM_INFO_1W, _win32_FORM_INFO_1_str, gdi.form_info_1, winspool/FORM_INFO_1, winspool/PFORM_INFO_1, winspool/_FORM_INFO_1A, winspool/_FORM_INFO_1W"
...
req.assembly: 
req.type-library: 
req.typenames: FORM_INFO_1A, *PFORM_INFO_1A, *LPFORM_INFO_1A
topic_type:
-	APIRef
-	kbSyntax
api_type:
