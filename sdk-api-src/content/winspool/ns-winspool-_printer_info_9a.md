---
UID: NS:winspool._PRINTER_INFO_9A
title: "_PRINTER_INFO_9A"
...
ms.date: 3/27/2018
ms.keywords: "*LPPRINTER_INFO_9A, *PPRINTER_INFO_9A, PPRINTER_INFO_9, PPRINTER_INFO_9 structure pointer [Windows GDI], PRINTER_INFO_9, PRINTER_INFO_9 structure [Windows GDI], PRINTER_INFO_9A, _PRINTER_INFO_9A, _PRINTER_INFO_9W, _win32_PRINTER_INFO_9_str, gdi.printer_info_9, winspool/PPRINTER_INFO_9, winspool/PRINTER_INFO_9, winspool/_PRINTER_INFO_9A, winspool/_PRINTER_INFO_9W"
...
req.assembly: 
req.type-library: 
req.typenames: PRINTER_INFO_9A, *PPRINTER_INFO_9A, *LPPRINTER_INFO_9A
topic_type:
-	APIRef
-	kbSyntax
api_type:
