...
old-location: gdi\abortprinter.htm
old-project: printdocs
ms.assetid: b361fba5-e4e7-4c9e-ab32-b8ab88dcb1dc
ms.author: windowsdriverdev
ms.date: 3/27/2018
ms.keywords: AbortPrinter, AbortPrinter function [Windows GDI], _win32_AbortPrinter, gdi.abortprinter, winspool/AbortPrinter
...
The <b>AbortPrinter</b> function deletes a printer's spool file if the printer is configured for spooling.
...
Handle to the printer from which the spool file is deleted. Use the <a href="https://msdn.microsoft.com/96763220-d851-46f0-8be8-403f3356edb9">OpenPrinter</a> or <a href="https://msdn.microsoft.com/ffc4fee8-46c6-47ad-803d-623bf8efdefd">AddPrinter</a> function to retrieve a printer handle.
...
<div> </div>
If the printer is not configured for spooling, the <b>AbortPrinter</b> function has no effect.
