---
UID: NS:winspool._PRINTER_OPTIONSW
title: "_PRINTER_OPTIONSW"
...
ms.date: 3/27/2018
ms.keywords: "*LPPRINTER_OPTIONSW, *PPRINTER_OPTIONSW, PPRINTER_OPTIONS, PPRINTER_OPTIONS structure pointer [Windows GDI], PRINTER_OPTIONS, PRINTER_OPTIONS structure [Windows GDI], PRINTER_OPTIONSW, _PRINTER_OPTIONSA, _PRINTER_OPTIONSW, _win32_PRINTER_OPTIONS_str, gdi.printer_options, winspool/PPRINTER_OPTIONS, winspool/PRINTER_OPTIONS"
...
req.assembly: 
req.type-library: 
req.typenames: PRINTER_OPTIONSW, *PPRINTER_OPTIONSW, *LPPRINTER_OPTIONSW
topic_type:
-	APIRef
-	kbSyntax
api_type:
