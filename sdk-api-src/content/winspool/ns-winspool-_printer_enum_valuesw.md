---
UID: NS:winspool._PRINTER_ENUM_VALUESW
title: "_PRINTER_ENUM_VALUESW"
...
ms.date: 3/27/2018
ms.keywords: "*LPPRINTER_ENUM_VALUESW, *PPRINTER_ENUM_VALUESW, PPRINTER_ENUM_VALUES, PPRINTER_ENUM_VALUES structure pointer [Windows GDI], PRINTER_ENUM_VALUES, PRINTER_ENUM_VALUES structure [Windows GDI], PRINTER_ENUM_VALUESW, _PRINTER_ENUM_VALUESA, _PRINTER_ENUM_VALUESW, _win32_PRINTER_ENUM_VALUES_str, gdi.printer_enum_values, winspool/PPRINTER_ENUM_VALUES, winspool/PRINTER_ENUM_VALUES, winspool/_PRINTER_ENUM_VALUESA, winspool/_PRINTER_ENUM_VALUESW"
...
req.assembly: 
req.type-library: 
req.typenames: PRINTER_ENUM_VALUESW, *PPRINTER_ENUM_VALUESW, *LPPRINTER_ENUM_VALUESW
topic_type:
-	APIRef
-	kbSyntax
api_type:
...
# _PRINTER_ENUM_VALUESW structure
