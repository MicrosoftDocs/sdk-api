---
UID: NS:winspool._DRIVER_INFO_3A
title: "_DRIVER_INFO_3A"
...
ms.date: 3/27/2018
ms.keywords: "*LPDRIVER_INFO_3A, *PDRIVER_INFO_3A, DRIVER_INFO_3, DRIVER_INFO_3 structure [Windows GDI], DRIVER_INFO_3A, PDRIVER_INFO_3, PDRIVER_INFO_3 structure pointer [Windows GDI], _DRIVER_INFO_3A, _DRIVER_INFO_3W, _win32_DRIVER_INFO_3_str, gdi.driver_info_3, winspool/DRIVER_INFO_3, winspool/PDRIVER_INFO_3, winspool/_DRIVER_INFO_3A, winspool/_DRIVER_INFO_3W"
...
req.assembly: 
req.type-library: 
req.typenames: DRIVER_INFO_3A, *PDRIVER_INFO_3A, *LPDRIVER_INFO_3A
topic_type:
-	APIRef
-	kbSyntax
api_type:
