...
ms.date: 3/27/2018
ms.keywords: "*LPDOC_INFO_1A, *PDOC_INFO_1A, DOC_INFO_1, DOC_INFO_1 structure [Windows GDI], DOC_INFO_1A, _DOC_INFO_1A, _DOC_INFO_1W, _win32_DOC_INFO_1_str, gdi.doc_info_1, winspool/DOC_INFO_1, winspool/_DOC_INFO_1A, winspool/_DOC_INFO_1W"
...
req.assembly: 
req.type-library: 
req.typenames: DOC_INFO_1A, *PDOC_INFO_1A, *LPDOC_INFO_1A
topic_type:
-	APIRef
-	kbSyntax
api_type:
