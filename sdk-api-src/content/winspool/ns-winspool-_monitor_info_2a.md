---
UID: NS:winspool._MONITOR_INFO_2A
title: "_MONITOR_INFO_2A"
...
ms.date: 3/27/2018
ms.keywords: "*LPMONITOR_INFO_2A, *PMONITOR_INFO_2A, MONITOR_INFO_2, MONITOR_INFO_2 structure [Windows GDI], MONITOR_INFO_2A, PMONITOR_INFO_2, PMONITOR_INFO_2 structure pointer [Windows GDI], _MONITOR_INFO_2A, _MONITOR_INFO_2W, _win32_MONITOR_INFO_2_str, gdi.monitor_info_2, winspool/MONITOR_INFO_2, winspool/PMONITOR_INFO_2, winspool/_MONITOR_INFO_2A, winspool/_MONITOR_INFO_2W"
...
req.assembly: 
req.type-library: 
req.typenames: MONITOR_INFO_2A, *PMONITOR_INFO_2A, *LPMONITOR_INFO_2A
topic_type:
-	APIRef
-	kbSyntax
api_type:
