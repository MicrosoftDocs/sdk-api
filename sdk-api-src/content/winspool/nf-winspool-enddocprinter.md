---
UID: NF:winspool.EndDocPrinter
title: EndDocPrinter function
author: windows-driver-content
description: The EndDocPrinter function ends a print job for the specified printer.
old-location: gdi\enddocprinter.htm
old-project: printdocs
ms.assetid: 13c713e8-cc24-4191-8b1e-967b9e20e541
ms.author: windowsdriverdev
ms.date: 3/27/2018
ms.keywords: EndDocPrinter, EndDocPrinter function [Windows GDI], _win32_EndDocPrinter, gdi.enddocprinter, winspool/EndDocPrinter
...
The <b>EndDocPrinter</b> function ends a print job for the specified printer.
...
Handle to a printer for which the print job should be ended. Use the <a href="https://msdn.microsoft.com/96763220-d851-46f0-8be8-403f3356edb9">OpenPrinter</a> or <a href="https://msdn.microsoft.com/ffc4fee8-46c6-47ad-803d-623bf8efdefd">AddPrinter</a> function to retrieve a printer handle.
...
<div> </div>
The <b>EndDocPrinter</b> function returns an error if the print job was not started by calling the <a href="https://msdn.microsoft.com/caa2bd80-4af3-4968-a5b9-d12f16cac6fc">StartDocPrinter</a> function.
...
<li>To end the print job, call <b>EndDocPrinter</b>.</li>
</ol>
