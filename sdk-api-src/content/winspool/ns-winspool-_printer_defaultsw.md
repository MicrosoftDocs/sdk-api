---
UID: NS:winspool._PRINTER_DEFAULTSW
title: "_PRINTER_DEFAULTSW"
...
ms.date: 3/27/2018
ms.keywords: "*LPPRINTER_DEFAULTSW, *PPRINTER_DEFAULTSW, PPRINTER_DEFAULTS, PPRINTER_DEFAULTS structure pointer [Windows GDI], PRINTER_DEFAULTS, PRINTER_DEFAULTS structure [Windows GDI], PRINTER_DEFAULTSW, _PRINTER_DEFAULTSA, _PRINTER_DEFAULTSW, _win32_PRINTER_DEFAULTS_str, gdi.printer_defaults, winspool/PPRINTER_DEFAULTS, winspool/PRINTER_DEFAULTS, winspool/_PRINTER_DEFAULTSA, winspool/_PRINTER_DEFAULTSW"
...
req.assembly: 
req.type-library: 
req.typenames: PRINTER_DEFAULTSW, *PPRINTER_DEFAULTSW, *LPPRINTER_DEFAULTSW
topic_type:
-	APIRef
-	kbSyntax
api_type:
