---
UID: NS:winspool._PROVIDOR_INFO_2A
title: "_PROVIDOR_INFO_2A"
...
ms.date: 3/27/2018
ms.keywords: "*LPPROVIDOR_INFO_2A, *PPROVIDOR_INFO_2A, PPROVIDOR_INFO_2, PPROVIDOR_INFO_2 structure pointer [Windows GDI], PROVIDOR_INFO_2, PROVIDOR_INFO_2 structure [Windows GDI], PROVIDOR_INFO_2A, _PROVIDOR_INFO_2A, _PROVIDOR_INFO_2W, _win32_PROVIDOR_INFO_2_str, gdi.providor_info_2, winspool/PPROVIDOR_INFO_2, winspool/PROVIDOR_INFO_2, winspool/_PROVIDOR_INFO_2A, winspool/_PROVIDOR_INFO_2W"
...
req.assembly: 
req.type-library: 
req.typenames: PROVIDOR_INFO_2A, *PPROVIDOR_INFO_2A, *LPPROVIDOR_INFO_2A
topic_type:
-	APIRef
-	kbSyntax
api_type:
