...
Implements the  <a href="https://msdn.microsoft.com/library/ms678495(v=VS.85).aspx">IRpcStubBuffer::Connect</a> method and connects the server object to the stub.
