...
The <b>NdrProxyGetBuffer</b> function obtains a network buffer from COM through the use of an <a href="https://msdn.microsoft.com/library/ms686644(v=VS.85).aspx">IRpcChannelBuffer::GetBuffer</a> method call.
