...
Contains one of the list view column formatting values that indicates how the column is displayed. The possible values are defined for the <b>fmt</b> member of the <a href="https://www.bing.com/search?q=LVCOLUMN">LVCOLUMN</a> structure.
...
<a href="https://www.bing.com/search?q=LVCOLUMN">LVCOLUMN</a>
