...
title: IAMMultiMediaStream::Initialize method
...
ms.date: 4/26/2018
ms.keywords: IAMMultiMediaStream, IAMMultiMediaStream interface [DirectShow], Initialize method, IAMMultiMediaStream::Initialize, IAMMultiMediaStreamInitialize, Initialize method [DirectShow], Initialize method [DirectShow], IAMMultiMediaStream interface, Initialize,IAMMultiMediaStream.Initialize, amstream/IAMMultiMediaStream::Initialize, dshow.iammultimediastream_initialize
...
# IAMMultiMediaStream::Initialize method
