...
ms.topic: method
f1_keywords: ["amstream/IAMMediaTypeSample.GetMediaType"]
...
Address of a pointer that receives an <a href="https://docs.microsoft.com/windows/desktop/api/strmif/ns-strmif-_ammediatype">AM_MEDIA_TYPE</a> structure.
