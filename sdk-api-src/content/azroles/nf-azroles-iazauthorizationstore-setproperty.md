...
title: IAzAuthorizationStore::SetProperty method
...
ms.date: 4/13/2018
ms.keywords: AZ_PROP_APPLICATION_DATA, AZ_PROP_APPLY_STORE_SACL, AZ_PROP_AZSTORE_DOMAIN_TIMEOUT, AZ_PROP_AZSTORE_MAX_SCRIPT_ENGINES, AZ_PROP_AZSTORE_SCRIPT_ENGINE_TIMEOUT, AZ_PROP_DESCRIPTION, AZ_PROP_GENERATE_AUDITS, AzAuthorizationStore object [Security], SetProperty method, IAzAuthorizationStore, IAzAuthorizationStore interface [Security], SetProperty method, IAzAuthorizationStore::SetProperty, SetProperty method [Security], SetProperty method [Security], AzAuthorizationStore object, SetProperty method [Security], IAzAuthorizationStore interface, SetProperty,IAzAuthorizationStore.SetProperty, azroles/IAzAuthorizationStore::SetProperty, security.azauthorizationstore_setproperty
