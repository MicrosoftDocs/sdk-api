...
description: The ApplicationData property of IAzScope sets or retrieves an opaque field that can be used by the application to store information. (Get)
...
f1_keywords:
 ...
 - azroles/IAzScope::get_ApplicationData
dev_langs:
 - c++
topic_type:
 - APIRef
