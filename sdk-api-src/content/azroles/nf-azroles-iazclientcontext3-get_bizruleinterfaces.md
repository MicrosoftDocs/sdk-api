...
The <b>IAzClientContext3::BizRuleInterfaces</b> method gets the collection of <a href="https://msdn.microsoft.com/library/ms221608(v=VS.85).aspx">IDispatch</a> interfaces that can be called by the business rule (BizRule) script associated with this client context.
