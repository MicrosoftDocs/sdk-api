...
ms.topic: method
f1_keywords: ["azroles/IAzTask.DeleteTask"]
...
The <b>DeleteTask</b> method removes the <a href="https://docs.microsoft.com/windows/desktop/api/azroles/nn-azroles-iaztask">IAzTask</a> object with the specified name from the task.
...
Name of the <a href="https://docs.microsoft.com/windows/desktop/api/azroles/nn-azroles-iaztask">IAzTask</a> object to remove from the task.
