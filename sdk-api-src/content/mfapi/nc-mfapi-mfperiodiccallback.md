...
ms.topic: callback
f1_keywords: ["mfapi/MFPERIODICCALLBACK"]
req.header: mfapi.h
req.include-header: 
...
Callback function for the <a href="https://docs.microsoft.com/windows/desktop/api/mfapi/nf-mfapi-mfaddperiodiccallback">MFAddPeriodicCallback</a> function.
