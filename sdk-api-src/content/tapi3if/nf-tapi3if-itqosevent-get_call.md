...
ms.topic: method
f1_keywords: ["tapi3if/ITQOSEvent.get_Call"]
...
<a href="https://docs.microsoft.com/windows/desktop/api/tapi3if/nn-tapi3if-itcallinfo">ITCallInfo</a> interface for the call on which the QOS event occurred.
