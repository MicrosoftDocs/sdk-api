...
ms.topic: method
f1_keywords: ["tapi3if/ITAddress2.DeviceSpecificVariant"]
...
<a href="https://docs.microsoft.com/windows/desktop/api/tapi3if/nf-tapi3if-itaddress2-devicespecific">DeviceSpecific</a> method.
