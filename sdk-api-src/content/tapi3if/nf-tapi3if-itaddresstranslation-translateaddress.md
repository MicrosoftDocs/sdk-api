...
<b>TranslateAddress</b> method is to obtain the <i>pDestAddress</i> string (<a href="https://msdn.microsoft.com/library/ms726017(v=VS.85).aspx">dialable address</a>) needed as a parameter for 
...
<a href="https://msdn.microsoft.com/library/ms221458(v=VS.85).aspx">SysAllocString</a> to allocate memory for <i>pAddressToTranslate</i> and use 
