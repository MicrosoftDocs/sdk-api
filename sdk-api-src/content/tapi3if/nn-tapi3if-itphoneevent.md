...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">ITPhoneEvent</b> interface inherits from the <a href="/previous-versions/windows/desktop/api/oaidl/nn-oaidl-idispatch">IDispatch</a> interface. <b>ITPhoneEvent</b> also has these types of members:
<ul>
...
<a href="/windows/desktop/api/tapi3if/nf-tapi3if-itphoneevent-get_buttonlampid">get_ButtonLampId</a>
</td>
...
<tr data="declared;">
<td align="left" width="37%">
<a href="/windows/desktop/api/tapi3if/nf-tapi3if-itphoneevent-get_buttonstate">get_ButtonState</a>
</td>
<td align="left" width="63%">
Gets a 
<a href="/windows/desktop/api/tapi3if/ne-tapi3if-phone_button_state">PHONE_BUTTON_STATE</a> value specifying the state to which the button has transitioned.

</td>
</tr>
<tr data="declared;">
<td align="left" width="37%">
<a href="/windows/desktop/api/tapi3if/nf-tapi3if-itphoneevent-get_call">get_Call</a>
</td>
<td align="left" width="63%">
Gets pointer to the 
...
<tr data="declared;">
<td align="left" width="37%">
<a href="/windows/desktop/api/tapi3if/nf-tapi3if-itphoneevent-get_event">get_Event</a>
</td>
<td align="left" width="63%">
Gets a 
...
<tr data="declared;">
<td align="left" width="37%">
<a href="/windows/desktop/api/tapi3if/nf-tapi3if-itphoneevent-get_hookswitchdevice">get_HookSwitchDevice</a>
</td>
<td align="left" width="63%">
Gets a 
<a href="/windows/desktop/api/tapi3if/ne-tapi3if-phone_hook_switch_device">PHONE_HOOK_SWITCH_DEVICE</a> value specifying the hookswitch device that changed state.

</td>
</tr>
<tr data="declared;">
<td align="left" width="37%">
<a href="/windows/desktop/api/tapi3if/nf-tapi3if-itphoneevent-get_hookswitchstate">get_HookSwitchState</a>
</td>
<td align="left" width="63%">
Gets a 
<a href="/windows/desktop/api/tapi3if/ne-tapi3if-phone_hook_switch_state">PHONE_HOOK_SWITCH_STATE</a> value specifying the state to which the hookswitch has transitioned.

</td>
</tr>
<tr data="declared;">
<td align="left" width="37%">
<a href="/windows/desktop/api/tapi3if/nf-tapi3if-itphoneevent-get_numbergathered">get_NumberGathered</a>
</td>
<td align="left" width="63%">
...
<tr data="declared;">
<td align="left" width="37%">
<a href="/windows/desktop/api/tapi3if/nf-tapi3if-itphoneevent-get_phone">get_Phone</a>
</td>
<td align="left" width="63%">
...
<tr data="declared;">
<td align="left" width="37%">
<a href="/windows/desktop/api/tapi3if/nf-tapi3if-itphoneevent-get_ringmode">get_RingMode</a>
</td>
<td align="left" width="63%">
