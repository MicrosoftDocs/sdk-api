...
ms.topic: method
f1_keywords: ["tapi3if/ITTerminal.get_TerminalType"]
...
<a href="https://docs.microsoft.com/windows/desktop/api/tapi3if/ne-tapi3if-terminal_type">TERMINAL_TYPE</a> of the terminal.
