...
ms.topic: method
f1_keywords: ["tapi3if/ITTAPI2.EnumeratePhones"]
...
<a href="https://docs.microsoft.com/windows/desktop/api/tapi3if/nf-tapi3if-ittapi2-get_phones">get_Phones</a> method.
