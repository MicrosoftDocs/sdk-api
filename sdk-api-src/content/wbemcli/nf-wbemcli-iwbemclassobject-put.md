...
The pointer is treated as read-only. The caller must call <a href="https://msdn.microsoft.com/library/ms221165(v=VS.85).aspx">VariantClear</a> after this call is complete.
