...
Receives a pointer to a substitute object to be used in asynchronous 
      ...
      <a href="https://msdn.microsoft.com/library/ms680509(v=VS.85).aspx">IUnknown</a> pointer and must call 
      <a href="https://msdn.microsoft.com/library/ms682521(v=VS.85).aspx">QueryInterface</a> for 
...
This method returns standard COM error codes for 
       <a href="https://msdn.microsoft.com/library/ms682521(v=VS.85).aspx">QueryInterface</a>. It returns 
