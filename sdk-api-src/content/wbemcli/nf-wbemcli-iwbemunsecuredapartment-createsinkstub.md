...
Receives a pointer to a substitute object to be used in asynchronous 
      ...
      <a href="https://msdn.microsoft.com/library/Dd757101(v=VS.85).aspx">QueryInterface</a> for 
...
This method returns standard COM error codes for 
       <a href="https://msdn.microsoft.com/library/Dd757101(v=VS.85).aspx">QueryInterface</a>. It returns 
