...
WMI only calls <a href="https://msdn.microsoft.com/library/Dd757100(v=VS.85).aspx">AddRef</a> to the pointer when <b>WBEM_S_NO_ERROR</b> returns. When an error code returns, the reference count is the same as on entry. For a detailed explanation of asynchronous calling methods, see 
