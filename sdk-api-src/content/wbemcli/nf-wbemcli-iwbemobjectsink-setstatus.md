...
<b>SetStatus</b>, and in many cases, <a href="https://msdn.microsoft.com/library/ms682317(v=VS.85).aspx">Release</a>.
...
<b>SetStatus</b> returns, the called object must use the <a href="https://msdn.microsoft.com/library/ms691379(v=VS.85).aspx">AddRef</a> method on the pointer before the called object returns.
