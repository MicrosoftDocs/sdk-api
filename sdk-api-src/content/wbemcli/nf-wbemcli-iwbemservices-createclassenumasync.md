...
When a call succeeds, WMI calls <a href="https://msdn.microsoft.com/library/ms691379(v=VS.85).aspx">AddRef</a> on the pointer <i>pResponseHandler</i>, returns immediately, and  then asynchronously calls <i>pResponseHandler</i>– &gt;
