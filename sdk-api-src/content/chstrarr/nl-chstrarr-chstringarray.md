...
The <b>CHStringArray</b> class has these methods.
<table class="members" id="memberListMethods">
<tr>
<th align="left" width="37%">Method</th>
<th align="left" width="63%">Description</th>
...
</table>Adds an element to the end of the array; the array grows if necessary.
...
Inserts an element (or all of the elements in another array) at a specified index.
