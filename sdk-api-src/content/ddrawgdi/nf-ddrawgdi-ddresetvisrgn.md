...
Wrapper for the <a href="https://msdn.microsoft.com/library/ms648698(v=VS.85).aspx">NtGdiDdResetVisrgn</a> function and enables timely user-mode information on the clipping region for windows on the desktop.
