...
Once the object has been re-enabled, the capabilities for the device can be re-queried using a call to <a href="https://msdn.microsoft.com/library/ms648441(v=VS.85).aspx">DdQueryDirectDrawObject</a> or GdiEntry2.
