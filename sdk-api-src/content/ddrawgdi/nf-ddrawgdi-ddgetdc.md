...
Wrapper for the <a href="https://msdn.microsoft.com/library/ms648682(v=VS.85).aspx">NtGdiDdGetDC</a> function and returns a Windows Graphics Device Interface (GDI) 
...
The returned DC must be freed by a call to <a href="https://msdn.microsoft.com/library/ms648696(v=VS.85).aspx">NtGdiDdReleaseDC</a> or <b>GdiEntry8</b>.
