...
ms.date: 4/24/2018
ms.keywords: GetUserString method [Windows Runtime], GetUserString method [Windows Runtime], IMetaDataTables interface, GetUserString,IMetaDataTables.GetUserString, IMetaDataTables, IMetaDataTables interface [Windows Runtime], GetUserString method, IMetaDataTables::GetUserString, rometadataapi/IMetaDataTables::GetUserString, winrt.imetadatatables_getuserstring
