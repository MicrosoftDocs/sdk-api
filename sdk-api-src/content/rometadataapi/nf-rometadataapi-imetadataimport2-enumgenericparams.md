...
ms.date: 4/24/2018
ms.keywords: EnumGenericParams method [Windows Runtime], EnumGenericParams method [Windows Runtime], IMetaDataImport2 interface, EnumGenericParams,IMetaDataImport2.EnumGenericParams, IMetaDataImport2, IMetaDataImport2 interface [Windows Runtime], EnumGenericParams method, IMetaDataImport2::EnumGenericParams, rometadataapi/IMetaDataImport2::EnumGenericParams, winrt.imetadataimport2_enumgenericparams
