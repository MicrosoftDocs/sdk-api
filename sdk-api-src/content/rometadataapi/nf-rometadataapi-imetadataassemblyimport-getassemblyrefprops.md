...
ms.date: 4/24/2018
ms.keywords: GetAssemblyRefProps method [Windows Runtime], GetAssemblyRefProps method [Windows Runtime], IMetaDataAssemblyImport interface, GetAssemblyRefProps,IMetaDataAssemblyImport.GetAssemblyRefProps, IMetaDataAssemblyImport, IMetaDataAssemblyImport interface [Windows Runtime], GetAssemblyRefProps method, IMetaDataAssemblyImport::GetAssemblyRefProps, rometadataapi/IMetaDataAssemblyImport::GetAssemblyRefProps, winrt.imetadataassemblyimport_getassemblyrefprops
