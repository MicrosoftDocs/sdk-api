...
ms.date: 4/24/2018
ms.keywords: GetNextString method [Windows Runtime], GetNextString method [Windows Runtime], IMetaDataTables interface, GetNextString,IMetaDataTables.GetNextString, IMetaDataTables, IMetaDataTables interface [Windows Runtime], GetNextString method, IMetaDataTables::GetNextString, rometadataapi/IMetaDataTables::GetNextString, winrt.imetadatatables_getnextstring
