...
ms.topic: method
f1_keywords: ["videoacc/IAMVideoAccelerator.Execute"]
...
Pointer to an array of <a href="https://docs.microsoft.com/windows/desktop/api/amva/ns-amva-_tag_amvabufferinfo">AMVABUFFERINFO</a> structures.
