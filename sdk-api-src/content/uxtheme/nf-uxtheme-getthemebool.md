...
Value of type <b>int</b> that specifies the part containing the BOOL property. See <a href="https://msdn.microsoft.com/library/Bb773210(v=VS.85).aspx">Parts and States</a>.
...
<td width="60%">
<b>TRUE</b> if the image associated with the part and state have transparent areas. See <a href="https://msdn.microsoft.com/library/Bb773397(v=VS.85).aspx">GetThemeColor</a> for the definition of the TMT_TRANSPARENTCOLOR value that defines the transparent color.
...
<td width="60%">
<b>TRUE</b> if the glyph associated with this part and state have transparent areas. See <a href="https://msdn.microsoft.com/library/Bb773397(v=VS.85).aspx">GetThemeColor</a> for the definition of the TMT_GLYPHCOLOR value that defines the transparent color.
