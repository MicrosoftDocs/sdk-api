...
Value of type <a href="https://msdn.microsoft.com/library/Bb759870(v=VS.85).aspx">WINDOWTHEMEATTRIBUTETYPE</a> that specifies the type of attribute to set. The value of this parameter determines the type of data that should be passed in the <i>pvAttribute</i> parameter. Can be the following value.
...
<td width="60%">
Specifies non-client related attributes. <i>pvAttribute</i> must be a pointer of type <a href="https://msdn.microsoft.com/library/Bb773248(v=VS.85).aspx">WTA_OPTIONS</a>.
...
<a href="https://msdn.microsoft.com/library/Bb759870(v=VS.85).aspx">WINDOWTHEMEATTRIBUTETYPE</a>
 
