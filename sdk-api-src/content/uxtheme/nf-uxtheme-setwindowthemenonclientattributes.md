...
A bitmask that describes which values are to be modified. Can be a combination of the <a href="https://msdn.microsoft.com/library/Bb759875(v=VS.85).aspx">WTNCA</a> constants.
...
A combination of flags that modify window visual style attributes based on <i>dwMask</i>. Can be a combination of the <a href="https://msdn.microsoft.com/library/Bb759875(v=VS.85).aspx">WTNCA</a> constants.
