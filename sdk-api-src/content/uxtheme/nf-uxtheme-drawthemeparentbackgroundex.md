...
Used by partially-transparent or alpha-blended child controls to draw the part of their parent in front of which they appear. Sends a <a href="https://msdn.microsoft.com/library/ms648055(v=VS.85).aspx">WM_ERASEBKGND</a> message followed by a <a href="https://msdn.microsoft.com/8703ee74-812a-4ca2-8ee3-a3b8779739e7">WM_PRINTCLIENT</a>.
...
<td width="60%">
If set, this function sends a <a href="https://msdn.microsoft.com/library/Bb787524(v=VS.85).aspx">WM_CTLCOLORSTATIC</a> message to the parent and uses the brush if one is provided. Otherwise, it uses COLOR_BTNFACE.
...
<td width="60%">
If set, this function returns S_OK without sending a <a href="https://msdn.microsoft.com/library/Bb787524(v=VS.85).aspx">WM_CTLCOLORSTATIC</a> message if the parent actually painted on <a href="https://msdn.microsoft.com/library/ms648055(v=VS.85).aspx">WM_ERASEBKGND</a>.
