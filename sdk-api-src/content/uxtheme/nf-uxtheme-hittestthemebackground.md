...
<b>DWORD</b> that specifies the hit test options. See <a href="https://msdn.microsoft.com/library/Bb773203(v=VS.85).aspx">Hit Test Options</a> for a list of options.
...
<b>WORD</b> that receives the hit test code that indicates whether the point in <i>ptTest</i> is in the background area bounded by <i>pRect</i> or <i>hrgn</i>. See <a href="https://msdn.microsoft.com/library/Bb773206(v=VS.85).aspx">Hit Test Return Values</a> for a list of values returned.
