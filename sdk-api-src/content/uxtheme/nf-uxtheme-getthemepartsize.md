...
Value of type <b>int</b> that specifies the part to calculate the size of. See <a href="https://msdn.microsoft.com/library/Bb773210(v=VS.85).aspx">Parts and States</a>.
...
Enumerated type that specifies the type of size to retrieve. See <a href="https://msdn.microsoft.com/library/Bb759839(v=VS.85).aspx">THEMESIZE</a> for a list of type values.
