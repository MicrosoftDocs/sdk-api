...
This function must be called before either the <a href="https://msdn.microsoft.com/library/Dd373385(v=VS.85).aspx">UpdatePanningFeedback</a> or <a href="https://msdn.microsoft.com/library/Dd373384(v=VS.85).aspx">EndPanningFeedback</a> functions can be called.
