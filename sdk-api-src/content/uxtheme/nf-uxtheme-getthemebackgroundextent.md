...
Pointer to a <a href="https://msdn.microsoft.com/library/windows/hardware/ff569234">RECT</a> structure that contains the content background rectangle, in logical coordinates. This rectangle is returned from <a href="https://msdn.microsoft.com/en-us/library/Bb773375(v=VS.85).aspx">GetThemeBackgroundContentRect</a>.
