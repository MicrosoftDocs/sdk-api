...
Value of type <b>int</b> that specifies the part that contains the content. See <a href="https://msdn.microsoft.com/library/Bb773210(v=VS.85).aspx">Parts and States</a>.
...
Value of type <b>int</b> that specifies the state of the part that contains the content. See <a href="https://msdn.microsoft.com/library/Bb773210(v=VS.85).aspx">Parts and States</a>.
...
Pointer to a <a href="https://msdn.microsoft.com/library/windows/hardware/ff569234">RECT</a> structure that contains the content background rectangle, in logical coordinates. This rectangle is returned from <a href="https://msdn.microsoft.com/library/Bb773375(v=VS.85).aspx">GetThemeBackgroundContentRect</a>.
...
<a href="https://msdn.microsoft.com/library/Bb773375(v=VS.85).aspx">GetThemeBackgroundContentRect</a>
