...
Specifies credential information that has been serialized by using the <a href="https://msdn.microsoft.com/library/Bb776043(v=VS.85).aspx">ICredentialProvider::SetSerialization</a> method.
