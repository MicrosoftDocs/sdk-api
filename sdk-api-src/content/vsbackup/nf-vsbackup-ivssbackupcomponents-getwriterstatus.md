...
title: IVssBackupComponents::GetWriterStatus method
...
ms.date: 4/17/2018
ms.keywords: GetWriterStatus method [VSS], GetWriterStatus method [VSS], IVssBackupComponents interface, GetWriterStatus,IVssBackupComponents.GetWriterStatus, IVssBackupComponents, IVssBackupComponents interface [VSS], GetWriterStatus method, IVssBackupComponents::GetWriterStatus, S_OK, VSS_E_WRITERERROR_INCONSISTENTSNAPSHOT, VSS_E_WRITERERROR_NONRETRYABLE, VSS_E_WRITERERROR_OUTOFRESOURCES, VSS_E_WRITERERROR_RETRYABLE, VSS_E_WRITERERROR_TIMEOUT, VSS_E_WRITER_NOT_RESPONDING, VSS_E_WRITER_STATUS_NOT_AVAILABLE, _win32_ivssbackupcomponents_getwriterstatus, base.ivssbackupcomponents_getwriterstatus, vsbackup/IVssBackupComponents::GetWriterStatus
...
# IVssBackupComponents::GetWriterStatus method
