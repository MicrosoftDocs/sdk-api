...
description: The CreateVssBackupComponents function creates an IVssBackupComponents interface object and returns a pointer to it. (CreateVssBackupComponentsInternal)
