---
UID: NS:d3d12video.D3D12_VIDEO_ENCODER_CODEC_PICTURE_CONTROL_SUPPORT_HEVC
tech.root: mf
title: D3D12_VIDEO_ENCODER_CODEC_PICTURE_CONTROL_SUPPORT_HEVC
ms.date: 06/09/2021
targetos: Windows
description: Represents picture control support settings for HEVC video encoding.
prerelease: false
...
req.target-type: 
req.typenames: D3D12_VIDEO_ENCODER_CODEC_PICTURE_CONTROL_SUPPORT_HEVC
req.umdf-ver: 
req.unicode-ansi: 
topic_type:
 - apiref
...
f1_keywords:
 - D3D12_VIDEO_ENCODER_CODEC_PICTURE_CONTROL_SUPPORT_HEVC
 - d3d12video/D3D12_VIDEO_ENCODER_CODEC_PICTURE_CONTROL_SUPPORT_HEVC
dev_langs:
 - c++
---
