---
UID: NF:d3d12video.ID3D12VideoDecodeCommandList3.Barrier
title: ID3D12VideoDecodeCommandList3::Barrier
description: Adds a collection of barriers into a video decode command list recording.
tech.root: mf
ms.date: 11/01/2022
targetos: Windows
req.assembly: 
...
f1_keywords:
 - ID3D12VideoDecodeCommandList3::Barrier
 - d3d12video/ID3D12VideoDecodeCommandList3::Barrier
dev_langs:
 - c++
helpviewer_keywords:
 - Barrier
