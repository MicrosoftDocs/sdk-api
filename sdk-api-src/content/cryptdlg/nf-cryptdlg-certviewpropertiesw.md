...
A pointer to a <a href="https://msdn.microsoft.com/en-us/library/Aa377595(v=VS.85).aspx">CERT_VIEWPROPERTIES_STRUCT</a> structure that contains the information about the certificate to view.
