...
ms.topic: method
f1_keywords: ["sdoias/ISdo.PutProperty"]
req.header: sdoias.h
req.include-header: 
...
Pointer to a 
<a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/oaidl/ns-oaidl-tagvariant">VARIANT</a> that contains the value for that property.
