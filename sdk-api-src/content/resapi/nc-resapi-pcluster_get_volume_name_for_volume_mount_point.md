...
# PCLUSTER_GET_VOLUME_NAME_FOR_VOLUME_MOUNT_POINT callback function


## -description


<p class="CCE_Message">[<i>ClusterGetVolumeNameForVolumeMountPoint</i> is available for use in the operating systems specified in the Requirements section. It may be altered or unavailable in subsequent versions. Instead, use <a href="https://msdn.microsoft.com/3f749042-bdc9-4087-bb8a-d833713472eb">GetVolumeNameForVolumeMountPoint</a>.]
...
<b>Windows Server 2008 R2:  </b>The initial release of ResApi.h containing the 
      <i>ClusterGetVolumeNameForVolumeMountPoint</i> 
