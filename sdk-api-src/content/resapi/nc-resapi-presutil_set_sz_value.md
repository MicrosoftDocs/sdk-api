---
UID: NC:resapi.PRESUTIL_SET_SZ_VALUE
title: PRESUTIL_SET_SZ_VALUE
...
# PRESUTIL_SET_SZ_VALUE callback function


## -description


Sets a string value in the  <a href="https://msdn.microsoft.com/d2c1a9c0-7e87-4a3c-9a1a-7f1756f97804">cluster database</a>. The <b>PRESUTIL_SET_SZ_VALUE</b> type defines a pointer to this function.
...
The  <i>ResUtilSetSzValue</i> utility function allocates memory for the new value and calls the  <a href="https://msdn.microsoft.com/865ac74e-5e37-4a2d-a4a4-b23eb45824ce">Cluster API</a> function  <a href="https://msdn.microsoft.com/6e4fee56-1c18-4f6d-81ae-c305aae59572">ClusterRegSetValue</a>. If necessary, a previous value is deallocated. The new value is copied to the content of <i>ppszOutValue</i>.
...
Do not call  <i>ResUtilSetSzValue</i> from the following resource DLL entry point functions:
...
<i>ResUtilSetSzValue</i> can be safely called from any other resource DLL entry point function or from a worker thread. For more information, see  <a href="https://msdn.microsoft.com/0eaa4aea-8d9a-4552-b43a-fafa23a3e736">Function Calls to Avoid in Resource DLLs</a>.
