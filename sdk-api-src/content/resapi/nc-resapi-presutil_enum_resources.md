...
ms.date: 3/27/2018
ms.keywords: PRESUTIL_ENUM_RESOURCES, PRESUTIL_ENUM_RESOURCES callback function [Failover Cluster], _wolf_resutilenumresources, mscs.resutilenumresources, resapi/PRESUTIL_ENUM_RESOURCES
...
# PRESUTIL_ENUM_RESOURCES callback
...
A generic buffer that allows you to pass any kind of data to the callback function. 
       <i>ResUtilEnumResources</i> does not use this 
...
<i>ResUtilEnumResources</i> is a convenient and 
...
<i>ResUtilEnumResources</i> must be run on a cluster 
...
The following example uses 
      <i>ResUtilEnumResources</i> to list the names and 
