---
UID: NC:resapi.PCLUSTER_GET_VOLUME_PATH_NAME
title: PCLUSTER_GET_VOLUME_PATH_NAME
...
# PCLUSTER_GET_VOLUME_PATH_NAME callback function


## -description


<p class="CCE_Message">[<i>ClusterGetVolumePathName</i> is available for use in the operating systems specified in the Requirements section. It may be altered or unavailable in subsequent versions. Instead, use <a href="https://msdn.microsoft.com/fa34786c-af82-4b59-bf36-e9a95a2f913e">GetVolumePathName</a>.]
...
If you specify a relative directory or file name without a volume qualifier, 
       <i>ClusterGetVolumePathName</i> returns the drive letter of the 
       current volume.
...
<b>Windows Server 2008 R2:  </b>The initial release of ResApi.h containing the 
      <i>ClusterGetVolumePathName</i> function used 
