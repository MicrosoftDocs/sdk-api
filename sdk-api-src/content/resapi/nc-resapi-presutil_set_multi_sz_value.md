---
UID: NC:resapi.PRESUTIL_SET_MULTI_SZ_VALUE
title: PRESUTIL_SET_MULTI_SZ_VALUE
...
ms.date: 06/07/2018
ms.keywords: PRESUTIL_SET_MULTI_SZ_VALUE, PRESUTIL_SET_MULTI_SZ_VALUE callback, PRESUTIL_SET_MULTI_SZ_VALUE callback function [Failover Cluster], _wolf_resutilsetmultiszvalue, mscs.resutilsetmultiszvalue, resapi/PRESUTIL_SET_MULTI_SZ_VALUE
ms.prod: windows
...
# PRESUTIL_SET_MULTI_SZ_VALUE callback function
...
The  <i>ResUtilSetMultiSzValue</i> utility function allocates memory for the new value and calls the  <a href="https://msdn.microsoft.com/865ac74e-5e37-4a2d-a4a4-b23eb45824ce">Cluster API</a> function  <a href="https://msdn.microsoft.com/6e4fee56-1c18-4f6d-81ae-c305aae59572">ClusterRegSetValue</a>.
...
Do not call  <i>ResUtilSetMultiSzValue</i> from the following resource DLL entry point functions:
...
<i>ResUtilSetMultiSzValue</i> can be safely called from any other resource DLL entry point function or from a worker thread. For more information, see  <a href="https://msdn.microsoft.com/0eaa4aea-8d9a-4552-b43a-fafa23a3e736">Function Calls to Avoid in Resource DLLs</a>.
