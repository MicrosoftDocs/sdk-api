...
title: CreateDirect3D11DeviceFromDXGIDevice function (windows.graphics.directx.direct3d11.interop.h)
...
While we recommend [C++/WinRT](/windows/uwp/cpp-and-winrt-apis/index), if you're using C++/CX then you should call [CreateDirect3DDevice](https://msdn.microsoft.com/en-us/library/windows/apps/dn895089.aspx) instead of **CreateDirect3D11DeviceFromDXGIDevice**. If you're using WRL then **CreateDirect3D11DeviceFromDXGIDevice** can be used as shown in this code example.
