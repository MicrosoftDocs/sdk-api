...
helpviewer_keywords: ["Use DirectX..XMVector2GreaterR","XMVector2GreaterR","XMVector2GreaterR method [DirectX Math Support APIs]","dxmath.xmvector2greaterr"]
...
Tests whether one 2D vector is greater than another 2D vector and returns a comparison value that can be examined using functions such as <a href="https://docs.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmcomparisonalltrue">XMComparisonAllTrue</a>.
...
<a href="https://docs.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmvector2greater">XMVector2Greater</a>
 
