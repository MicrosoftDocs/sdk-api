...
description: Retrieve the x component of an XMVECTOR Data Type. (XMVectorGetX)
helpviewer_keywords: ["Use DirectX..XMVectorGetX","XMVectorGetX","XMVectorGetX method [DirectX Math Support APIs]","dxmath.xmvectorgetx"]
...
# XMVectorGetX function


## -description

Retrieve the <code>x</code> component of an <a href="/windows/desktop/dxmath/xmvector-data-type">XMVECTOR Data Type</a>.
...
The value in the <code>x</code> component of the 4D vector storing floating-point data <i>V</i>
