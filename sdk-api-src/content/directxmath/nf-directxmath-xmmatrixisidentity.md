...
helpviewer_keywords: ["Use DirectX..XMMatrixIsIdentity","XMMatrixIsIdentity","XMMatrixIsIdentity method [DirectX Math Support APIs]","dxmath.xmmatrixisidentity"]
...
Returns true if <i>M</i> is the identity matrix, and false otherwise.
