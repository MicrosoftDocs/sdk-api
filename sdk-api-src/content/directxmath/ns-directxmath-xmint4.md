...
For a list of more functionality such as constructors and operators that are available 
  ...
  are programming in C++, see <a href="/windows/desktop/dxmath/ovw-xmint4-extensions">XMINT4 Extensions</a>.
...
You can use <a href="/windows/desktop/api/directxmath/nf-directxmath-xmloadsint4">XMLoadSInt4</a> to load <code>XMINT4</code> into instances 
   of <a href="/windows/desktop/dxmath/xmvector-data-type">XMVECTOR</a>.

You can use <a href="/windows/desktop/api/directxmath/nf-directxmath-xmstoresint4">XMStoreSInt4</a> to store instances of <code>XMVECTOR</code> 
...
<a href="/windows/desktop/dxmath/ovw-xmint4-extensions">XMINT4 Extensions</a>