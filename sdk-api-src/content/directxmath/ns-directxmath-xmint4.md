...
For a list of more functionality such as constructors and operators that are available 
  ...
  are programming in C++, see <a href="https://msdn.microsoft.com/en-us/library/Hh449518(v=VS.85).aspx">XMINT4 Extensions</a>.
...
You can use <a href="https://msdn.microsoft.com/en-us/library/Hh404677(v=VS.85).aspx">XMLoadSInt4</a> to load <code>XMINT4</code> into instances 
   of <a href="https://msdn.microsoft.com/1a044094-444d-e787-fa6a-76e88531aef1">XMVECTOR</a>.

You can use <a href="https://msdn.microsoft.com/en-us/library/Hh404703(v=VS.85).aspx">XMStoreSInt4</a> to store instances of <code>XMVECTOR</code> 
...
<a href="https://msdn.microsoft.com/en-us/library/Hh449518(v=VS.85).aspx">XMINT4 Extensions</a>
 
