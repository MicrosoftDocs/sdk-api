...
helpviewer_keywords: ["Use DirectX..XMVectorGetW","XMVectorGetW","XMVectorGetW method [DirectX Math Support APIs]","dxmath.xmvectorgetw"]
...
The value in the <code>w</code> component of the 4D floating point vector <i>V</i>
