...
ms.topic: function
f1_keywords: ["directxmath/XMVectorTanH"]
...
Computes the hyperbolic tangent of each component of an <a href="https://docs.microsoft.com/windows/desktop/dxmath/xmvector-data-type">XMVECTOR</a>.
