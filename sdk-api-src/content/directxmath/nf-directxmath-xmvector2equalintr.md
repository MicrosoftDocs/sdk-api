...
helpviewer_keywords: ["Use DirectX..XMVector2EqualIntR","XMVector2EqualIntR","XMVector2EqualIntR method [DirectX Math Support APIs]","dxmath.xmvector2equalintr"]
...
Tests whether two 2D vectors are equal, treating each component as an unsigned integer. In addition, this function returns a comparison value that can be examined using functions such as <a href="/windows/desktop/api/directxmath/nf-directxmath-xmcomparisonalltrue">XMComparisonAllTrue</a>.
...
<a href="/windows/desktop/api/directxmath/nf-directxmath-xmvector2equalint">XMVector2EqualInt</a>