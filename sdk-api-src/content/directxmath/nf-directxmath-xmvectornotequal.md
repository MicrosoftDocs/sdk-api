...
ms.date: 12/05/2018
ms.keywords: Use DirectX..XMVectorNotEqual, XMVectorNotEqual, XMVectorNotEqual method [DirectX Math Support APIs], dxmath.xmvectornotequal
ms.topic: function
f1_keywords: ["directxmath/XMVectorNotEqual"]
