...
helpviewer_keywords: ["Use DirectX..XMVector3GreaterR","XMVector3GreaterR","XMVector3GreaterR method [DirectX Math Support APIs]","dxmath.xmvector3greaterr"]
...
Tests whether one 3D vector is greater than another 3D vector and returns a comparison value that can be examined using functions such as <a href="/windows/desktop/api/directxmath/nf-directxmath-xmcomparisonalltrue">XMComparisonAllTrue</a>.
...
<a href="/windows/desktop/api/directxmath/nf-directxmath-xmvector3greater">XMVector3Greater</a>