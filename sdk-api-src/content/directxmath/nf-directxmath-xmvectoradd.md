...
ms.date: 12/05/2018
ms.keywords: Use DirectX..XMVectorAdd, XMVectorAdd, XMVectorAdd method [DirectX Math Support APIs], dxmath.xmvectoradd
ms.topic: function
f1_keywords: ["directxmath/XMVectorAdd"]
...
Returns a vector that is the sum of <i>V1</i> and <i>V2</i>.
