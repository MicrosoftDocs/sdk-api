...
For a list of additional functionality such as constructors and operators that are available using <code>XMUINT4</code> when you
  are programming in C++, see <a href="https://msdn.microsoft.com/en-us/library/Hh449571(v=VS.85).aspx">XMUINT4 Extensions</a>.
...
You can use <a href="https://msdn.microsoft.com/en-us/library/Hh404682(v=VS.85).aspx">XMLoadUInt4</a> to load <code>XMUINT4</code> into instances 
   of <a href="https://msdn.microsoft.com/1a044094-444d-e787-fa6a-76e88531aef1">XMVECTOR</a>.

You can use <a href="https://msdn.microsoft.com/en-us/library/Hh404708(v=VS.85).aspx">XMStoreUInt4</a> to store instances of <code>XMVECTOR</code> 
...
<a href="https://msdn.microsoft.com/en-us/library/Hh449571(v=VS.85).aspx">XMUINT4 Extensions</a>
 
