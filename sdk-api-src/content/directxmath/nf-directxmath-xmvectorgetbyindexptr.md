...
ms.topic: function
f1_keywords: ["directxmath/XMVectorGetByIndexPtr"]
...
Retrieve, into an instance of a floating-point referenced by pointer, the value of one of the four components of an
  <a href="https://docs.microsoft.com/windows/desktop/dxmath/xmvector-data-type">XMVECTOR Data Type</a> containing floating-point data, referenced by index.
