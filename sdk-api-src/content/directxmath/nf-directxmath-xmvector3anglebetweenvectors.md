...
If V1 and V2 are normalized 3D vectors, it is faster to use <a href="/windows/desktop/api/directxmath/nf-directxmath-xmvector3anglebetweennormals">XMVector3AngleBetweenNormals</a>.
