...
description: Computes the radian angle between two 3D vectors.helpviewer_keywords: ["Use DirectX..XMVector3AngleBetweenVectors","XMVector3AngleBetweenVectors","XMVector3AngleBetweenVectors method [DirectX Math Support APIs]","dxmath.xmvector3anglebetweenvectors"]
...
f1_keywords:
- directxmath/XMVector3AngleBetweenVectors
dev_langs:
- c++
...
If V1 and V2 are normalized 3D vectors, it is faster to use <a href="https://docs.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmvector3anglebetweennormals">XMVector3AngleBetweenNormals</a>.
