...
helpviewer_keywords: ["Use DirectX..XMVectorGetYPtr","XMVectorGetYPtr","XMVectorGetYPtr method [DirectX Math Support APIs]","dxmath.xmvectorgetyptr"]
...
Retrieve the <code>y</code> component of an <a href="/windows/desktop/dxmath/xmvector-data-type">XMVECTOR Data Type</a> containing floating-point data, and storing that
...
Pointer to a float that will receive the value of the <code>y</code> element of the <a href="/windows/desktop/dxmath/xmvector-data-type">XMVECTOR Data Type</a> object
        <code>V</code>.
