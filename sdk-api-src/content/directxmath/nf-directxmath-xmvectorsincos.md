...
Computes the sine and cosine of each component of an <a href="/windows/desktop/dxmath/xmvector-data-type">XMVECTOR</a>.
...
<a href="/windows/desktop/api/directxmath/nf-directxmath-xmvectorsincosest">XMVectorSinCosEst</a>