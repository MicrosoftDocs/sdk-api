...
title: XMFLOAT4X3::XMFLOAT4X3(float,float,float,float,float,float,float,float,float,float,float,float)
...
Initializes a new instance of the <a href="https://msdn.microsoft.com/en-us/library/Ee419611(v=VS.85).aspx">XMFLOAT4X3</a> structure from twelve
