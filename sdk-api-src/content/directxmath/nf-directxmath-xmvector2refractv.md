...
ms.topic: function
f1_keywords: ["directxmath/XMVector2RefractV"]
...
This function is identical to <a href="https://docs.microsoft.com/en-us/windows/desktop/api/directxmath/nf-directxmath-xmvector2refract">XMVector2Refract</a> except that the <i>RefractionIndex</i> is supplied using a 2D vector instead of a <b>float</b> value.
