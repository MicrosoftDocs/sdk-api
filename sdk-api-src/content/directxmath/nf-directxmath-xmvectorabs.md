...
description: Computes the absolute value of each component of an XMVECTOR.helpviewer_keywords: ["Use DirectX..XMVectorAbs","XMVectorAbs","XMVectorAbs method [DirectX Math Support APIs]","dxmath.xmvectorabs"]
...
# XMVectorAbs function


## -description


Computes the absolute value of each component of an <a href="https://docs.microsoft.com/windows/desktop/dxmath/xmvector-data-type">XMVECTOR</a>.
...
Returns a vector whose components are the absolute value of the corresponding components of <i>V</i>.
