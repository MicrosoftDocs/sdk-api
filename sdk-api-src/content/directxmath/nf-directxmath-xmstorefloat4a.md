...
ms.topic: function
f1_keywords: ["directxmath/XMStoreFloat4A"]
...
Stores an <a href="https://docs.microsoft.com/windows/desktop/dxmath/xmvector-data-type">XMVECTOR</a> in an <a href="https://docs.microsoft.com/previous-versions/windows/desktop/legacy/ee419609(v=vs.85)">XMFLOAT4A</a>.
