...
Loads unsigned integer  data into the x, y, and z components 
  of an <a href="/windows/desktop/dxmath/xmvector-data-type">XMVECTOR</a>, without type checking.

## -parameters

### -param pSource [in]

Address of an <a href="/windows/desktop/api/directxmath/ns-directxmath-xmuint3">XMUINT3</a> structure containing the data to load.
...
For 16-byte aligned memory, it may be faster to use <a href="/windows/desktop/api/directxmath/nf-directxmath-xmloadint3a">XMLoadInt3A</a> with a casting operator.
