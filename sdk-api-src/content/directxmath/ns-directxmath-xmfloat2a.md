...
f1_keywords: ["directxmath/XMFLOAT2A"]
targetos: Windows
product: Windows
...
<code>XMFLOAT2A</code> can be loaded into instances of <a href="https://docs.microsoft.com/windows/desktop/dxmath/xmvector-data-type">XMVECTOR</a> by using <a href="https://docs.microsoft.com/en-us/windows/desktop/api/directxmath/nf-directxmath-xmloadfloat2a">XMLoadFloat2A</a>.
