...
description: Converts RGB color values to HSV color values.helpviewer_keywords: ["Use DirectX..XMColorRGBToHSV","XMColorRGBToHSV","XMColorRGBToHSV method [DirectX Math Support APIs]","dxmath.xmcolorrgbtohsv"]
...
## -returns
 ...
 Returns the converted color value. The X element is Hue (H), the Y element is Saturation (S), the Z element is Value (V), and the W element is Alpha (a copy of rgb.w). Each has a range of 0.0 to 1.0.
...
<div class="alert"><b>Note</b>  <code>XMColorRGBToHSV</code> is new for DirectXMath and is not available for XNAMath 2.x.</div>
<div> </div>
...
<a href="https://docs.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmcolorhsvtorgb">XMColorHSVToRGB</a>
 
