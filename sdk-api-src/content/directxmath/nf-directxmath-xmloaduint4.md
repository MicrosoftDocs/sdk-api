...
Loads unsigned integer  data into an <a href="/windows/desktop/dxmath/xmvector-data-type">XMVECTOR</a>.

## -parameters

### -param pSource [in]

Address of an <a href="/windows/desktop/api/directxmath/ns-directxmath-xmuint4">XMUINT4</a> structure containing the data to load.
