...
f1_keywords:
 ...
 - directxmath/XMComparisonAllInBounds
dev_langs:
 - c++
topic_type:
 - APIRef
...
Comparison value to test. The comparison value is typically retrieved using a recording version of an DirectXMath
        function such as <a href="https://docs.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmvectorinboundsr">XMVectorInBoundsR</a>. The names of the recording functions end
        with an "R".
