...
helpviewer_keywords: ["Use DirectX..XMStoreUInt2","XMStoreUInt2","XMStoreUInt2 method [DirectX Math Support APIs]","dxmath.xmstoreuint2"]
...
Stores unsigned integer data from an <a href="/windows/desktop/dxmath/xmvector-data-type">XMVECTOR</a> 
...
Address of an  <a href="/windows/desktop/direct3dhlsl/xmuint2">XMUINT2</a> structure in which to store the data.
