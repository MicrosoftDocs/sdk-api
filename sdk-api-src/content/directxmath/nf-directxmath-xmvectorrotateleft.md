...
In the case of a constant rotate value, it is more efficient to use the template form of <a href="/windows/desktop/dxmath/xmvectorrotateleft-template">XMVectorRotateLeft</a>:
