...
helpviewer_keywords: ["Use DirectX..XMVector3GreaterOrEqualR","XMVector3GreaterOrEqualR","XMVector3GreaterOrEqualR method [DirectX Math Support APIs]","dxmath.xmvector3greaterorequalr"]
...
Tests whether one 3D vector is greater-than-or-equal-to another 3D vector and returns a comparison value that can be examined using functions such as <a href="/windows/desktop/api/directxmath/nf-directxmath-xmcomparisonalltrue">XMComparisonAllTrue</a>.
...
<a href="/windows/desktop/api/directxmath/nf-directxmath-xmvector3greaterorequal">XMVector3GreaterOrEqual</a>