...
description: Retrieve the x component of an XMVECTOR Data Type. (XMVectorGetIntX)
...
The value in the <code>x</code> component of the 4D vector storing integer data<i>V</i>.
