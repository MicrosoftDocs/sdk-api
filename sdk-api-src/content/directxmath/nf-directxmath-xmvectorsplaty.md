...
ms.topic: function
f1_keywords: ["directxmath/XMVectorSplatY"]
...
Vector from which to select the y component.
...
Returns a vector, all of whose components are equal to the y component of <i>V</i>.
