...
helpviewer_keywords: ["Use DirectX..XMVector4EqualR","XMVector4EqualR","XMVector4EqualR method [DirectX Math Support APIs]","dxmath.xmvector4equalr"]
...
Tests whether two 4D vectors are equal. In addition, this function returns a comparison value that can be examined using functions such as <a href="/windows/desktop/api/directxmath/nf-directxmath-xmcomparisonalltrue">XMComparisonAllTrue</a>.
...
<a href="/windows/desktop/api/directxmath/nf-directxmath-xmvector4equal">XMVector4Equal</a>