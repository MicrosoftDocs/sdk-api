...
title: IWMSecureChannel::WMSC_AddSignature method
...
ms.date: 4/13/2018
ms.keywords: IWMSecureChannel, IWMSecureChannel interface [windows Media Format], WMSC_AddSignature method, IWMSecureChannel::WMSC_AddSignature, WMSC_AddSignature method [windows Media Format], WMSC_AddSignature method [windows Media Format], IWMSecureChannel interface, WMSC_AddSignature,IWMSecureChannel.WMSC_AddSignature, wmformat.iwmsecurechannel_wmsc_addsignature, wmsecure/IWMSecureChannel::WMSC_AddSignature
...
# IWMSecureChannel::WMSC_AddSignature method
