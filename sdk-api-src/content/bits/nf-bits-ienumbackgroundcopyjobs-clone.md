...
Creates another 
<a href="https://msdn.microsoft.com/en-us/library/Aa363109(v=VS.85).aspx">IEnumBackgroundCopyJobs</a> enumerator that contains the same enumeration state as the current one.
