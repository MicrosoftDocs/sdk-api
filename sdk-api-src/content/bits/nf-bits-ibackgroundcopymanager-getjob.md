...
ms.date: 4/10/2018
ms.keywords: GetJob method [BITS], GetJob method [BITS], IBackgroundCopyManager interface, GetJob,IBackgroundCopyManager.GetJob, IBackgroundCopyManager, IBackgroundCopyManager interface [BITS], GetJob method, IBackgroundCopyManager::GetJob, _drz_ibackgroundcopymanager_getjob, bits.ibackgroundcopymanager_getjob, bits/IBackgroundCopyManager::GetJob
