...
To start the job before the minimum retry period expires, call the <a href="https://msdn.microsoft.com/en-us/library/Aa363039(v=VS.85).aspx">IBackgroundCopyJob::Resume</a>  method.
