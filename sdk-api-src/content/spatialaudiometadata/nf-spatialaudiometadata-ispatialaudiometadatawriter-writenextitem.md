...
ms.topic: method
f1_keywords: ["spatialaudiometadata/ISpatialAudioMetadataWriter.WriteNextItem"]
...
The frame offset of the item within the range specified with the <i>frameCount</i> parameter to <a href="https://docs.microsoft.com/windows/desktop/api/spatialaudiometadata/nf-spatialaudiometadata-ispatialaudiometadataclient-activatespatialaudiometadataitems">ActivateSpatialAudioMetadataItems</a>.
