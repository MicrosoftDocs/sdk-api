---
UID: NF:d2d1_3.ID2D1DeviceContext2.DrawGdiMetafile
title: ID2D1DeviceContext2::DrawGdiMetafile
...
ms.date: 08/06/2018
ms.keywords: DrawGdiMetafile, DrawGdiMetafile method [Direct2D], DrawGdiMetafile method [Direct2D],ID2D1DeviceContext2 interface, ID2D1DeviceContext2 interface [Direct2D],DrawGdiMetafile method, ID2D1DeviceContext2.DrawGdiMetafile, ID2D1DeviceContext2::DrawGdiMetafile, d2d1_3/ID2D1DeviceContext2::DrawGdiMetafile, direct2d.id2d1devicecontext2_drawgdimetafile
ms.prod: windows
