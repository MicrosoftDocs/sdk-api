---
UID: NF:d2d1_3.ID2D1Ink.StreamAsGeometry
title: ID2D1Ink::StreamAsGeometry
...
ms.date: 08/06/2018
ms.keywords: ID2D1Ink interface [Direct2D],StreamAsGeometry method, ID2D1Ink.StreamAsGeometry, ID2D1Ink::StreamAsGeometry, StreamAsGeometry, StreamAsGeometry method [Direct2D], StreamAsGeometry method [Direct2D],ID2D1Ink interface, d2d1_3/ID2D1Ink::StreamAsGeometry, direct2d.id2d1ink_streamasgeometry
ms.prod: windows
