...
ms.topic: enum
f1_keywords: ["d2d1_3/D2D1_IMAGE_SOURCE_LOADING_OPTIONS"]
req.header: d2d1_3.h
req.include-header: 
...
Indicates the image source should only populate subregions of the image cache on-demand. You can control this behavior using 
        the <a href="https://docs.microsoft.com/windows/desktop/api/d2d1_3/nf-d2d1_3-ensurecached">EnsureCached</a> 
          and <a href="https://docs.microsoft.com/windows/desktop/api/d2d1_3/nf-d2d1_3-trimcache">TrimCache</a> methods. 
