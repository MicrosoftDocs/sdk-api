...
ms.topic: method
f1_keywords: ["d2d1_3/ID2D1CommandSink5.BlendImage"]
req.header: d2d1_3.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1commandsink5">ID2D1CommandSink5</a>
 
