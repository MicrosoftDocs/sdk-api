...
ms.topic: struct
f1_keywords: ["bcrypt/CRYPT_IMAGE_REG"]
req.header: bcrypt.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/bcrypt/ns-bcrypt-_crypt_provider_reg">CRYPT_PROVIDER_REG</a>
 
