...
ms.topic: function
f1_keywords: ["bcrypt/BCryptEnumContextFunctionProviders"]
req.header: bcrypt.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/bcrypt/ns-bcrypt-_crypt_context_function_providers">CRYPT_CONTEXT_FUNCTION_PROVIDERS</a>
 
