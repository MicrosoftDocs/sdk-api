...
ms.topic: function
f1_keywords: ["bcrypt/BCryptEnumContextFunctions"]
req.header: bcrypt.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/bcrypt/ns-bcrypt-_crypt_context_functions">CRYPT_CONTEXT_FUNCTIONS</a>
 
