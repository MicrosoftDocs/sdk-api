...
<b>servent</b> structure. To avoid the <a href="https://www.bing.com/search?q=WSAENOBUFS">WSAENOBUFS</a> error, the application should provide a buffer of at least MAXGETHOSTSTRUCT bytes (as defined in Winsock2.h).
