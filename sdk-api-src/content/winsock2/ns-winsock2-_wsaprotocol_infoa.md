...
<div class="alert"><b>Note</b>  Only one of XP1_UNI_SEND or XP1_UNI_RECV values may be set. If a protocol can be unidirectional in either direction, two <a href="https://msdn.microsoft.com/be5f3e81-1442-43c7-9e4e-9eb2b2a05132">WSAPROTOCOL_INFOW</a> structures should be used. When neither bit is set, the protocol is considered to be bidirectional.</div>
<div> </div>
...
<a href="https://msdn.microsoft.com/928b6937-41a3-4268-a3bc-14c9e04870e4">WSAEnumProtocols</a>. Obviously, a Windows Sockets 2 application should never see an entry with this bit set.
...
<a href="https://msdn.microsoft.com/dcf2e543-de54-43d9-9e45-4cb935da3548">WSASocket</a> matches this protocol entry.
...
<a href="https://msdn.microsoft.com/6bf6e6c4-6268-479c-86a6-52e90cf317db">socket</a>  or <a href="https://msdn.microsoft.com/dcf2e543-de54-43d9-9e45-4cb935da3548">WSASocket</a> function in order to open a socket for this protocol. Possible values for the socket type are defined in the <i>Winsock2.h</i> header file.
...
<a href="https://msdn.microsoft.com/6bf6e6c4-6268-479c-86a6-52e90cf317db">socket</a> or <a href="https://msdn.microsoft.com/dcf2e543-de54-43d9-9e45-4cb935da3548">WSASocket</a> function. Not all protocols allow a range of values. When this is the case <b>iProtocolMaxOffset</b> is zero.
...
<a href="https://msdn.microsoft.com/25bc511d-7a9f-41c1-8983-1af1e3f8bf2d">getsockopt</a> to retrieve the value of SO_MAX_MSG_SIZE after the socket has been bound to a local address.
...
<a href="https://msdn.microsoft.com/7777a2ff-2ece-4f28-88af-87fc96fdda9f">WSCUpdateProvider</a>



<a href="https://msdn.microsoft.com/803ef58a-853b-491c-bed1-e02275fef258">WSCUpdateProvider32</a>
