...
call to the <a href="/windows/desktop/api/winsock/nf-winsock-wsastartup">WSAStartup</a> function. For use with the AF_INET OR AF_INET6 address family, the <a href="/windows/desktop/api/winsock/nf-winsock-ntohs">ntohs</a> function does not require that the Winsock DLL be loaded. 
