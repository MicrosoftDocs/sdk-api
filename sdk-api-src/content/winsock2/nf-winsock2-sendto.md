...
<a href="https://msdn.microsoft.com/library/ms740668(v=VS.85).aspx">WSAEACCES</a>. For TCP/IP, an application can send to any multicast address (without becoming a group member).
