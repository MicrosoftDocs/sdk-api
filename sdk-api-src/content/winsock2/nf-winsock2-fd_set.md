...
The <b>FD_SET</b> macro add a file descriptor to a <a href="/windows/desktop/api/winsock2/ns-winsock2-fd_set">fd_set</a>. If the file descriptor already exist within the set, a duplicate will not be added.
