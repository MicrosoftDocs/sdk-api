...
<a href="https://www.bing.com/search?q=WSA_IO_PENDING">WSA_IO_PENDING</a> indicates that the overlapped operation has been successfully initiated and that completion will be indicated at a later time. Any other error code indicates that the overlapped operation was not successfully initiated and no completion indication will occur.
...
<td width="40%">
<dl>
<dt><b><a href="https://www.bing.com/search?q=WSAEDISCON">WSAEDISCON</a></b></dt>
</dl>
</td>
<td width="60%">
...
<a href="https://msdn.microsoft.com/library/windows/hardware/dn926950">shutdown</a> has been invoked with <i>how</i> set to <b>SD_RECEIVE</b> or <b>SD_BOTH</b>.
...
<a href="https://www.bing.com/search?q=WSAEDISCON">WSAEDISCON</a> is used to indicate graceful closure. In any case a return error code of 
<a href="https://www.bing.com/search?q=WSAECONNRESET">WSAECONNRESET</a> indicates an abortive close has occurred.
...
<a href="https://www.bing.com/search?q=WSA_IO_PENDING">WSA_IO_PENDING</a>. In this case, <i>lpNumberOfBytesRecvd</i> and <i>lpFlags</i> are not updated. When the overlapped operation completes, the amount of data transferred is indicated either through the <i>cbTransferred</i> parameter in the completion routine (if specified), or through the <i>lpcbTransfer</i> parameter in 
