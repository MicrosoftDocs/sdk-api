...
title: WSAStringToAddressW function (winsock2.h)
description: The WSAStringToAddress function converts a network address in its standard text presentation form into its numeric binary form in a sockaddr structure, suitable for passing to Windows Sockets routines that take such a structure. (Unicode)
helpviewer_keywords: ["WSAStringToAddress", "WSAStringToAddress function [Winsock]", "WSAStringToAddressW", "_win32_wsastringtoaddress_2", "winsock.wsastringtoaddress_2", "winsock2/WSAStringToAddress", "winsock2/WSAStringToAddressW"]
