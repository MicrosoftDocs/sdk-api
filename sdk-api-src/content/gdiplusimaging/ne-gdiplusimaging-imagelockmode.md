...
The <b>ImageLockMode</b> enumeration specifies flags that are passed to the 
			...
			<a href="https://msdn.microsoft.com/library/ms536298(v=VS.85).aspx">Bitmap::LockBits</a> method. The <b>Bitmap::LockBits</b> method locks a portion of an image so that you can read or write the pixel data.
...
Specifies that the buffer used for reading or writing pixel data is allocated by the user. If this flag is set, then the 
				...
				<a href="https://msdn.microsoft.com/library/ms536298(v=VS.85).aspx">Bitmap::LockBits</a> method serves as an input parameter (and possibly as an output parameter). If this flag is cleared, then the 
