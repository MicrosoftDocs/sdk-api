...
The <b>ImageFlags</b> enumeration specifies the attributes of the pixel data contained in an 
			...
			<a href="https://msdn.microsoft.com/library/ms535376(v=VS.85).aspx">Image::GetFlags</a> method returns an element of this enumeration.
...
<a href="https://msdn.microsoft.com/library/ms535376(v=VS.85).aspx">Image::GetFlags</a>
 
