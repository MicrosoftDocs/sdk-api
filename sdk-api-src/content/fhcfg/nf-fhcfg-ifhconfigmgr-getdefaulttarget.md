...
title: IFhConfigMgr::GetDefaultTarget method
...
ms.date: 4/13/2018
ms.keywords: FhConfigMgr class [Windows API], GetDefaultTarget method, GetDefaultTarget method [Windows API], GetDefaultTarget method [Windows API], FhConfigMgr class, GetDefaultTarget method [Windows API], IFhConfigMgr interface, GetDefaultTarget,IFhConfigMgr.GetDefaultTarget, IFhConfigMgr, IFhConfigMgr interface [Windows API], GetDefaultTarget method, IFhConfigMgr::GetDefaultTarget, fhcfg/IFhConfigMgr::GetDefaultTarget, winprog.ifhconfigmgr_getdefaulttarget
...
# IFhConfigMgr::GetDefaultTarget method
