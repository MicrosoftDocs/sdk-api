...
ms.date: 4/20/2018
ms.keywords: ILockBytes, ILockBytes interface [Structured Storage], Stat method, ILockBytes::Stat, Stat method [Structured Storage], Stat method [Structured Storage], ILockBytes interface, Stat,ILockBytes.Stat, _stg_ilockbytes_stat, objidl/ILockBytes::Stat, stg.ilockbytes_stat
