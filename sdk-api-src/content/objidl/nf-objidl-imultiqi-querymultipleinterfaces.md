...
ms.topic: method
f1_keywords: ["objidl/IMultiQI.QueryMultipleInterfaces"]
req.header: objidl.h
...
An array of <a href="https://docs.microsoft.com/windows/desktop/api/objidl/ns-objidl-tagmulti_qi">MULTI_QI</a> structures. For more information, see Remarks.
...
The <b>QueryMultipleInterfaces</b> method takes as input an array of <a href="https://docs.microsoft.com/windows/desktop/api/objidl/ns-objidl-tagmulti_qi">MULTI_QI</a> structures. Each structure specifies an interface IID and contains two additional members for receiving an interface pointer and return value.
...
On return, the caller should check the <b>hr</b> member of each <a href="https://docs.microsoft.com/windows/desktop/api/objidl/ns-objidl-tagmulti_qi">MULTI_QI</a> structure to determine which interface pointers were and were not returned.
