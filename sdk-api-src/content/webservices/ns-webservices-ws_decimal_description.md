...
ms.topic: struct
f1_keywords: ["webservices/WS_DECIMAL_DESCRIPTION"]
...
An optional type description used with <a href="https://docs.microsoft.com/windows/desktop/api/webservices/ne-webservices-ws_type">WS_DECIMAL_TYPE</a>.
