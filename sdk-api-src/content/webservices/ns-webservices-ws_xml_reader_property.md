...
ms.topic: struct
f1_keywords: ["webservices/WS_XML_READER_PROPERTY"]
...
Identifies the <a href="https://docs.microsoft.com/windows/desktop/api/webservices/ne-webservices-ws_xml_reader_property_id">WS_XML_READER_PROPERTY_ID</a>.
