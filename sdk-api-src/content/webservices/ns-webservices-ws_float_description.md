...
req.irql: 
targetos: Windows
req.typenames: WS_FLOAT_DESCRIPTION
req.redist: 
ms.custom: 19H1
f1_keywords:
 - _WS_FLOAT_DESCRIPTION
 - webservices/_WS_FLOAT_DESCRIPTION
...
# WS_FLOAT_DESCRIPTION structure


## -description

An optional type description used with <a href="https://docs.microsoft.com/windows/desktop/api/webservices/ne-webservices-ws_type">WS_FLOAT_TYPE</a> to specify constraints on the set of values
