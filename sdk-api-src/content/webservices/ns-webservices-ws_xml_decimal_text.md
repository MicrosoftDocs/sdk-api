...
helpviewer_keywords: ["WS_XML_DECIMAL_TEXT","WS_XML_DECIMAL_TEXT structure [Web Services for Windows]","webservices/WS_XML_DECIMAL_TEXT","wsw.ws_xml_decimal_text"]
...
req.irql: 
targetos: Windows
req.typenames: WS_XML_DECIMAL_TEXT
req.redist: 
ms.custom: 19H1
f1_keywords:
 - _WS_XML_DECIMAL_TEXT
 - webservices/_WS_XML_DECIMAL_TEXT
 - WS_XML_DECIMAL_TEXT
 - webservices/WS_XML_DECIMAL_TEXT
dev_langs:
 - c++
topic_type:
 - APIRef
