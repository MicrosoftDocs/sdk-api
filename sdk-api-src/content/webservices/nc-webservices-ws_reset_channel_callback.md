...
ms.topic: callback
f1_keywords: ["webservices/WS_RESET_CHANNEL_CALLBACK"]
...
Handles the <a href="https://docs.microsoft.com/windows/desktop/api/webservices/nf-webservices-wsresetchannel">WsResetChannel</a> call
