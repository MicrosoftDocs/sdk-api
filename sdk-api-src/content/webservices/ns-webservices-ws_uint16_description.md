...
ms.date: 12/05/2018
ms.keywords: WS_UINT16_DESCRIPTION, WS_UINT16_DESCRIPTION structure [Web Services for Windows], webservices/WS_UINT16_DESCRIPTION, wsw.ws_uint16_description
...
ms.custom: 19H1
f1_keywords:
 - _WS_UINT16_DESCRIPTION
 - webservices/_WS_UINT16_DESCRIPTION
 - WS_UINT16_DESCRIPTION
 - webservices/WS_UINT16_DESCRIPTION
dev_langs:
 - c++
topic_type:
 - APIRef
...
An optional type description used with <a href="https://docs.microsoft.com/windows/desktop/api/webservices/ne-webservices-ws_type">WS_UINT16_TYPE</a> to specify constraints on the set of values
