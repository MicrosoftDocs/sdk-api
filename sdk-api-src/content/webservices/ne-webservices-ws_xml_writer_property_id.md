...
Each xml writer property is identified by an ID and has an associated value.
      This enumeration is used within the <a href="/windows/desktop/api/webservices/ns-webservices-ws_xml_writer_property">WS_XML_WRITER_PROPERTY</a> structure, which is used as a parameter to <a href="/windows/desktop/api/webservices/nf-webservices-wscreatewriter">WsCreateWriter</a>, <a href="/windows/desktop/api/webservices/nf-webservices-wssetoutput">WsSetOutput</a>, <a href="/windows/desktop/api/webservices/nf-webservices-wssetoutputtobuffer">WsSetOutputToBuffer</a>, and <a href="/windows/desktop/api/webservices/nf-webservices-wswritexmlbuffertobytes">WsWriteXmlBufferToBytes</a>. It is also used directly as a parameter to <a href="/windows/desktop/api/webservices/nf-webservices-wsgetwriterproperty">WsGetWriterProperty</a>.
...
If the writer is using <a href="/windows/win32/api/webservices/ns-webservices-ws_xml_writer_buffer_output">WS_XML_WRITER_BUFFER_OUTPUT</a>, then this property is the maximum number of bytes
          the writer will retain across calls to <a href="/windows/desktop/api/webservices/nf-webservices-wssetoutput">WsSetOutput</a> for purposes of buffering output.
...
If the writer is using <a href="/windows/win32/api/webservices/ns-webservices-ws_xml_writer_stream_output">WS_XML_WRITER_STREAM_OUTPUT</a>, then this property is the maximum number of bytes
          the writer will retain across calls to <a href="/windows/desktop/api/webservices/nf-webservices-wssetoutput">WsSetOutput</a>  and <a href="/windows/desktop/api/webservices/nf-webservices-wsflushwriter">WsFlushWriter</a> for
          purposes of buffering output.
        

This property has no effect when specified with <a href="/windows/desktop/api/webservices/nf-webservices-wssetoutputtobuffer">WsSetOutputToBuffer</a>.
...
A <a href="/windows/desktop/api/webservices/ne-webservices-ws_charset">WS_CHARSET</a> value that
...
A <a href="/windows/desktop/api/webservices/ns-webservices-ws_buffers">WS_BUFFERS</a> structure
...
If the writer is using <a href="/windows/win32/api/webservices/ns-webservices-ws_xml_writer_buffer_output">WS_XML_WRITER_BUFFER_OUTPUT</a>, then the all the generated bytes are returned, and
          the buffers are valid until <a href="/windows/desktop/api/webservices/nf-webservices-wssetoutput">WsSetOutput</a>  or <a href="/windows/desktop/api/webservices/nf-webservices-wsfreewriter">WsFreeWriter</a> is called.
...
This may be less convenient but more efficient than using <a href="/windows/desktop/api/webservices/ne-webservices-ws_xml_writer_property_id">WS_XML_WRITER_PROPERTY_BYTES</a> because the
...
If the writer is using <a href="/windows/win32/api/webservices/ns-webservices-ws_xml_writer_buffer_output">WS_XML_WRITER_BUFFER_OUTPUT</a>, then this is the maximum number of
          bytes that will buffered for the entire document.  Calls to <a href="/windows/desktop/api/webservices/nf-webservices-wsflushwriter">WsFlushWriter</a> have no effect.
...
If the writer is using <a href="/windows/win32/api/webservices/ns-webservices-ws_xml_writer_stream_output">WS_XML_WRITER_STREAM_OUTPUT</a>, then this is the maxmimum amount of
          data that will be buffered between <a href="/windows/desktop/api/webservices/nf-webservices-wsflushwriter">WsFlushWriter</a> calls.
...
If the writer is using <a href="/windows/win32/api/webservices/ns-webservices-ws_xml_writer_buffer_output">WS_XML_WRITER_BUFFER_OUTPUT</a>, then all the generated bytes are returned, and
          the buffer is valid until <a href="/windows/desktop/api/webservices/nf-webservices-wssetoutput">WsSetOutput</a>  or <a href="/windows/desktop/api/webservices/nf-webservices-wsfreewriter">WsFreeWriter</a> is called.
...
This may be more convenient but less efficient than using <a href="/windows/desktop/api/webservices/ne-webservices-ws_xml_writer_property_id">WS_XML_WRITER_PROPERTY_BUFFERS</a> because the
...
A <b>BOOL</b> that
          indicates that <a href="/windows/desktop/api/webservices/nf-webservices-wswritestartattribute">WsWriteStartAttribute</a> has been called and the writer is
...
A <b>ULONG</b> used with <a href="/windows/win32/api/webservices/ns-webservices-ws_xml_writer_mtom_encoding">WS_XML_WRITER_MTOM_ENCODING</a>. This specifies the maximum amount of data that
          will be buffered for purposes of writing the MIME parts.  <a href="/windows/desktop/api/webservices/nf-webservices-wswritebytes">WsWriteBytes</a> and
          <a href="/windows/desktop/api/webservices/nf-webservices-wspullbytes">WsPullBytes</a> need to buffer data in order to emit the data as a separate MIME part that
...
A <a href="/windows/desktop/api/webservices/ns-webservices-ws_bytes">WS_BYTES</a> structure that contains a buffer that the writer may use for encoding the xml document.  This is
...
If the size specified is greater than or equal to <a href="/windows/desktop/api/webservices/ne-webservices-ws_xml_writer_property_id">WS_XML_WRITER_PROPERTY_BUFFER_MAX_SIZE</a>, then the 
...
If the writer is using <a href="/windows/win32/api/webservices/ns-webservices-ws_xml_writer_stream_output">WS_XML_WRITER_STREAM_OUTPUT</a>, then this property
          ...
          <a href="/windows/desktop/api/webservices/nf-webservices-wsflushwriter">WsFlushWriter</a>.
...
This property is not available on a writer that was set using <a href="/windows/desktop/api/webservices/nf-webservices-wssetoutputtobuffer">WsSetOutputToBuffer</a>.
...
An application can use <a href="/windows/desktop/api/webservices/ne-webservices-ws_xml_writer_property_id">WS_XML_WRITER_PROPERTY_BYTES_WRITTEN</a> and 
...
The binary encoding does not support empty elements.  When using <a href="/windows/desktop/api/webservices/nf-webservices-wscopynode">WsCopyNode</a> with
