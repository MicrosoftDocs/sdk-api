...
ms.topic: enum
f1_keywords: ["webservices/WS_XML_TEXT_TYPE"]
...
The type of <a href="https://docs.microsoft.com/windows/desktop/api/webservices/ns-webservices-_ws_xml_text">WS_XML_TEXT</a> structure.
