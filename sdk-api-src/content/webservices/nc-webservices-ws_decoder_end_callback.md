...
ms.date: 3/27/2018
ms.keywords: WS_DECODER_END_CALLBACK, WS_DECODER_END_CALLBACK callback function [Web Services for Windows], webservices/WS_DECODER_END_CALLBACK, wsw.ws_decoder_end_callback
...
# WS_DECODER_END_CALLBACK callback
