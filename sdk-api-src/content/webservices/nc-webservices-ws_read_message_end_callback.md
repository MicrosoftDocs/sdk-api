...
ms.topic: callback
f1_keywords: ["webservices/WS_READ_MESSAGE_END_CALLBACK"]
...
Handles the <a href="https://docs.microsoft.com/windows/desktop/api/webservices/nf-webservices-wsreadmessageend">WsReadMessageEnd</a> call
