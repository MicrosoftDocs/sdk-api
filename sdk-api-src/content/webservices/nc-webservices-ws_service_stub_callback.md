...
ms.topic: callback
f1_keywords: ["webservices/WS_SERVICE_STUB_CALLBACK"]
...
Invoked by service model to delegate to the service 
                ...
                for every service operation. It is defined on the <a href="https://docs.microsoft.com/windows/desktop/api/webservices/ns-webservices-_ws_operation_description">WS_OPERATION_DESCRIPTION</a> for each 
                service operation. 
