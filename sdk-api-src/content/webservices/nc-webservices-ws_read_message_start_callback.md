...
ms.topic: callback
f1_keywords: ["webservices/WS_READ_MESSAGE_START_CALLBACK"]
...
Handles the <a href="https://docs.microsoft.com/windows/desktop/api/webservices/nf-webservices-wsreadmessagestart">WsReadMessageStart</a> call
