...
description: Specifies constraints on the set of values which can be deserialized. (WS_CHAR_ARRAY_DESCRIPTION)
...
ms.custom: 19H1
f1_keywords:
 - _WS_CHAR_ARRAY_DESCRIPTION
 - webservices/_WS_CHAR_ARRAY_DESCRIPTION
...
# WS_CHAR_ARRAY_DESCRIPTION structure


## -description

Specifies constraints on the set of values
                which can be deserialized.This type description is used with <a href="/windows/desktop/api/webservices/ne-webservices-ws_type">WS_CHAR_ARRAY_TYPE</a> and is optional.
