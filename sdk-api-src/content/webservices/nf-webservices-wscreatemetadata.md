...
ms.topic: function
f1_keywords: ["webservices/WsCreateMetadata"]
...
On   success, a pointer that receives the address of the  <a href="https://docs.microsoft.com/windows/desktop/wsw/ws-metadata">WS_METADATA</a> structure representing the new message.
