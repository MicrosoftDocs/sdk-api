...
helpviewer_keywords: ["WS_INT16_DESCRIPTION","WS_INT16_DESCRIPTION structure [Web Services for Windows]","webservices/WS_INT16_DESCRIPTION","wsw.ws_int16_description"]
...
ms.custom: 19H1
f1_keywords:
 - _WS_INT16_DESCRIPTION
 - webservices/_WS_INT16_DESCRIPTION
...
# WS_INT16_DESCRIPTION structure


## -description

An optional type description used with <a href="https://docs.microsoft.com/windows/desktop/api/webservices/ne-webservices-ws_type">WS_INT16_TYPE</a> to specify constraints on the set of values
