...
ms.topic: callback
f1_keywords: ["webservices/WS_SET_LISTENER_PROPERTY_CALLBACK"]
...
Handles the <a href="https://docs.microsoft.com/windows/desktop/api/webservices/nf-webservices-wssetlistenerproperty">WsSetListenerProperty</a> call
