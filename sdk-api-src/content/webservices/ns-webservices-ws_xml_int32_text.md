...
ms.date: 12/05/2018
ms.keywords: WS_XML_INT32_TEXT, WS_XML_INT32_TEXT structure [Web Services for Windows], webservices/WS_XML_INT32_TEXT, wsw.ws_xml_int32_text
...
req.irql: 
targetos: Windows
req.typenames: WS_XML_INT32_TEXT
req.redist: 
ms.custom: 19H1
f1_keywords:
 - _WS_XML_INT32_TEXT
 - webservices/_WS_XML_INT32_TEXT
 - WS_XML_INT32_TEXT
 - webservices/WS_XML_INT32_TEXT
dev_langs:
 - c++
topic_type:
 - APIRef
