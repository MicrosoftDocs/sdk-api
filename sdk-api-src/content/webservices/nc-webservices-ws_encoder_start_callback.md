...
ms.date: 3/27/2018
ms.keywords: WS_ENCODER_START_CALLBACK, WS_ENCODER_START_CALLBACK callback function [Web Services for Windows], webservices/WS_ENCODER_START_CALLBACK, wsw.ws_encoder_start_callback
...
# WS_ENCODER_START_CALLBACK callback
