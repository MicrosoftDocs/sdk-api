...
The accompanying <b>value</b> member of the <a href="https://msdn.microsoft.com/52e4a5d3-e584-40d1-b71f-b4ef61104883">WS_LISTENER_PROPERTY</a> structure is a <a href="https://msdn.microsoft.com/en-us/library/Dd401803(v=VS.85).aspx">WS_CUSTOM_LISTENER_CALLBACKS</a> structure.
...
The accompanying <b>value</b> member of the <a href="https://msdn.microsoft.com/52e4a5d3-e584-40d1-b71f-b4ef61104883">WS_LISTENER_PROPERTY</a> structure is a pointer to <a href="https://msdn.microsoft.com/en-us/library/Dd401815(v=VS.85).aspx">WS_DISALLOWED_USER_AGENT_SUBSTRINGS</a> which specifies the list of disallowed user
                    agents sub-strings.
                    <ul>
