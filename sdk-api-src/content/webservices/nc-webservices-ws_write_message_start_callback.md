...
ms.topic: callback
f1_keywords: ["webservices/WS_WRITE_MESSAGE_START_CALLBACK"]
...
Handles the <a href="https://docs.microsoft.com/windows/desktop/api/webservices/nf-webservices-wswritemessagestart">WsWriteMessageStart</a> call
