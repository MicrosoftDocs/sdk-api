...
ms.topic: method
f1_keywords: ["dwrite/IDWriteFactory.CreateTextAnalyzer"]
req.header: dwrite.h
req.include-header: 
...
Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/dwrite/nn-dwrite-idwritetextanalyzer">IDWriteTextAnalyzer</a>**</b>
