...
ms.topic: method
f1_keywords: ["dwrite/IDWriteGdiInterop.CreateFontFromLOGFONT"]
req.header: dwrite.h
req.include-header: 
...
When this method returns, contains an address of a  pointer to a newly created <a href="https://docs.microsoft.com/windows/desktop/api/dwrite/nn-dwrite-idwritefont">IDWriteFont</a>  object if successful; otherwise, <b>NULL</b>.
