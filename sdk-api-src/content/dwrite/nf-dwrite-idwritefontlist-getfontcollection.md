...
ms.topic: method
f1_keywords: ["dwrite/IDWriteFontList.GetFontCollection"]
req.header: dwrite.h
req.include-header: 
...
When this method returns, contains the address of a pointer to the current <a href="https://docs.microsoft.com/windows/desktop/api/dwrite/nn-dwrite-idwritefontcollection">IDWriteFontCollection</a> object.
