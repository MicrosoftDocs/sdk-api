...
The <b>IWMPacketSize2</b> interface provides methods to set and retrieve the minimum <a href="https://msdn.microsoft.com/library/Dd757828(v=VS.85).aspx">packet</a> size for a profile.
