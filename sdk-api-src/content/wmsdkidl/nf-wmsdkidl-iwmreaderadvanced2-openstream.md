...
ms.topic: method
f1_keywords: ["wmsdkidl/IWMReaderAdvanced2.OpenStream"]
...
Pointer to an <a href="https://docs.microsoft.com/windows/desktop/api/wmsdkidl/nn-wmsdkidl-iwmreadercallback">IWMReaderCallback</a> interface.
