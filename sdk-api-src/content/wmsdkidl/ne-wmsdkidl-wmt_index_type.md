...
The index will associate indexes with the nearest <a href="https://msdn.microsoft.com/en-us/library/Dd757828(v=VS.85).aspx">cleanpoint</a>, or video key frame, in the Windows Media file. This is the default index type.
