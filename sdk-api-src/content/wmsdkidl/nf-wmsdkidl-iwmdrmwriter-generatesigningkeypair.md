...
Do not confuse the signature that is applied to the ASF header object, using these keys, with the signature that is applied to the DRM header object by using the <a href="https://msdn.microsoft.com/en-us/library/Dd757094(v=VS.85).aspx">DRM_LASignaturePrivKey</a> and other properties that make up the digital signature object in the file.
