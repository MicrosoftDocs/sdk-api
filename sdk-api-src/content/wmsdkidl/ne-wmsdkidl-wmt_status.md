...
### -field WMT_BUFFERING_START:2

The reader object is beginning to buffer content.

### -field WMT_BUFFERING_STOP:3
...
### -field WMT_STARTED:11

A reporting object has begun operations.

### -field WMT_STOPPED:12
...
### -field WMT_CLIENT_DISCONNECT:33
...
### -field WMT_NATIVE_OUTPUT_PROPS_CHANGED:34

Change in output properties.

### -field WMT_RECONNECT_START:35

Start of automatic reconnection to a server.

### -field WMT_RECONNECT_END:36

End of automatic reconnection to a server.

### -field WMT_CLIENT_CONNECT_EX:37
...
### -field WMT_CLIENT_DISCONNECT_EX:38
...
### -field WMT_LICENSEURL_SIGNATURE_STATE:43
...
### -field WMT_INIT_PLAYLIST_BURN:44
