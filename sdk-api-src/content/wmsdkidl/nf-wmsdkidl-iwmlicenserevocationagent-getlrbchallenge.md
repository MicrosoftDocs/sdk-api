...
After the challenge and response have been processed, the license server sends a signed license revocation blob, which includes instructions about the licenses to remove. You can perform the license revocation by calling the <a href="https://msdn.microsoft.com/en-us/library/Dd757227(v=VS.85).aspx">ProcessLRB</a> method.
