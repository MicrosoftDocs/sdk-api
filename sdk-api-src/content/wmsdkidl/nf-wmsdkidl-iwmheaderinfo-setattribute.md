...
Before you can use this method through the <b>IWMHeaderInfo</b> interface of a writer object to set <a href="https://msdn.microsoft.com/library/Dd757828(v=VS.85).aspx">DRM</a> attributes, you must set a profile for the writer to use.
