...
The <b>AddMarker</b> method adds a <a href="https://msdn.microsoft.com/library/Dd757828(v=VS.85).aspx">marker</a>, consisting of a name and a specific time, to the header section of the ASF file.
