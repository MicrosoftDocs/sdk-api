...
Generates a DRM <a href="https://msdn.microsoft.com/library/Dd757828(v=VS.85).aspx">key ID</a> that will be used in conjunction with a key seed to encrypt and decrypt files.
