---
UID: NF:winnetwk.WNetAddConnection4W
tech.root: WNet
title: WNetAddConnection4W function (winnetwk.h)
ms.date: 06/04/2025
targetos: Windows
description: The WNetAddConnection4 function makes a connection to a network resource. The function can redirect a local device to the network resource. (Unicode)
prerelease: false
req.assembly: 
...
The **WNetAddConnection4** function is similar to the [WNetAddConnection3](nf-winnetwk-wnetaddconnection3w.md) function. The main difference is that **WNetAddConnection4** has an additional parameter that allows the caller to specify an extendable property bag of parameters. The [WNetAddConnection2](nf-winnetwk-wnetaddconnection2w.md), **WNetAddConnection3**, and **WNetAddConnection4** functions supersede the [WNetAddConnection](nf-winnetwk-wnetaddconnectionw.md) function.
...
The *hwndOwner* parameter can be **NULL**. If it is, a call to **WNetAddConnection4** is equivalent to calling the [WNetAddConnection2](nf-winnetwk-wnetaddconnection2w.md) function.
...
- [WNetAddConnection](nf-winnetwk-wnetaddconnectionw.md)
- [WNetAddConnection2](nf-winnetwk-wnetaddconnection2w.md)
- [WNetAddConnection3](nf-winnetwk-wnetaddconnection3w.md)
