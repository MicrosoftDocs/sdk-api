...
title: IEnumCERTVIEWCOLUMN::GetName method
...
ms.date: 3/27/2018
ms.keywords: GetName method [Security], GetName method [Security], IEnumCERTVIEWCOLUMN interface, GetName,IEnumCERTVIEWCOLUMN.GetName, IEnumCERTVIEWCOLUMN, IEnumCERTVIEWCOLUMN interface [Security], GetName method, IEnumCERTVIEWCOLUMN::GetName, _certsrv_ienumcertviewcolumn_getname, certview/IEnumCERTVIEWCOLUMN::GetName, security.ienumcertviewcolumn_getname
