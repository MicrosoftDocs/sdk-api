...
ms.date: 01/07/2026
targetos: Windows
description: Asynchronously called when a UI Automation client disconnects from the provider.
prerelease: false
req.assembly: 
...
Asynchronously called when a UI Automation client disconnects from the provider.
