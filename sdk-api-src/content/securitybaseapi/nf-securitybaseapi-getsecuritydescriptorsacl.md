...
ms.topic: function
f1_keywords: ["securitybaseapi/GetSecurityDescriptorSacl"]
...
A pointer to the 
<a href="https://docs.microsoft.com/windows/desktop/api/winnt/ns-winnt-_security_descriptor">SECURITY_DESCRIPTOR</a> structure that contains the SACL to which the function retrieves a pointer.
