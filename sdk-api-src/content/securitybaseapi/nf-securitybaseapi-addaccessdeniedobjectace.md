...
ms.topic: function
f1_keywords: ["securitybaseapi/AddAccessDeniedObjectAce"]
...
<a href="https://docs.microsoft.com/windows/desktop/api/winnt/ns-winnt-_access_denied_ace">ACCESS_DENIED_ACE</a> is smaller and more efficient than an 
