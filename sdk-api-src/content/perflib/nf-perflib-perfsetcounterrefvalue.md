...
To indicate that the counter data is accessed by reference, the counter declaration in the manifest must include a <a href="https://msdn.microsoft.com/library/Aa371909(v=VS.85).aspx">counterAttribute</a> element whose <b>name</b> attribute is set to "reference". 
