...
A pointer to a <a href="https://msdn.microsoft.com/library/ms690968(v=VS.85).aspx">CI_STATE</a> structure that receives the catalog state.
...
The <a href="https://msdn.microsoft.com/library/ms690968(v=VS.85).aspx">CI_STATE</a> structure must be initialized (the <b>cbStruct</b> member must be correctly set) before calling the <b>CIState</b> function.
...
<a href="https://msdn.microsoft.com/library/ms690968(v=VS.85).aspx">CI_STATE</a>
 
