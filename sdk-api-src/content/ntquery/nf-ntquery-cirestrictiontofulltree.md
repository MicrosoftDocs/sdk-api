...
Converts a query restriction tree with columns, sort columns, and grouping columns to a <a href="https://msdn.microsoft.com/en-us/library/ms689889(v=VS.85).aspx">DBCOMMANDTREE</a> structure.
...
A pointer to a <a href="https://msdn.microsoft.com/en-us/library/ms689889(v=VS.85).aspx">DBCOMMANDTREE</a> structure that is the top node defining a <b>SELECT</b> tree for a query.
...
A pointer to an output variable that receives a pointer to a <a href="https://msdn.microsoft.com/en-us/library/ms689889(v=VS.85).aspx">DBCOMMANDTREE</a> structure. This parameter cannot be <b>NULL</b>.
