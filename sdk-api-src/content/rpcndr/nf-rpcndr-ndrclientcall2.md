...
ms.topic: function
f1_keywords: ["rpcndr/NdrClientCall2"]
req.header: rpcndr.h
...
The <b>NdrClientCall2</b> function is the client-side entry point for the <a href="https://docs.microsoft.com/windows/desktop/Midl/-oi">/Oicf</a> mode stub.
