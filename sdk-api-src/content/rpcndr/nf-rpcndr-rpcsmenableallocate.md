...
<a href="https://www.bing.com/search?q=enable_allocate">enable_allocate</a> attribute. In default (Microsoft-extended) mode, the environment is established only upon request by using the 
<a href="https://www.bing.com/search?q=enable_allocate">enable_allocate</a> attribute. Otherwise, call 
