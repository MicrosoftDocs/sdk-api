...
ms.topic: method
f1_keywords: ["cscobj/IOfflineFilesSuspend.SuspendRoot"]
req.header: cscobj.h
req.include-header: 
...
<a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/cscobj/nn-cscobj-iofflinefilessuspend">IOfflineFilesSuspend</a>
 
