...
Receives the file attribute mask for the item.  One or more of FILE_ATTRIBUTE_XXXXXX as defined in the Windows SDK. For more information, see the <a href="https://msdn.microsoft.com/en-us/library/Aa364944(v=VS.85).aspx">GetFileAttributes</a> function.
