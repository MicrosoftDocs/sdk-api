...
If a recipient does not respond, a COM error is received by the Offline Files service, and the subscriber's connection is deleted.  This is how the Offline Files service detects event subscriber processes that have terminated before calling <a href="/windows/desktop/api/ocidl/nf-ocidl-iconnectionpoint-unadvise.md">IConnectionPoint::Unadvise</a>.
