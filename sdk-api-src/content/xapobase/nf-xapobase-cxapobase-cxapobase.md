...
Creates an instance of the <a href="https://msdn.microsoft.com/library/Ee415236(v=VS.85).aspx">CXAPOBase</a> class.
...
Pointer to an <a href="https://msdn.microsoft.com/library/Ee419210(v=VS.85).aspx">XAPO_REGISTRATION_PROPERTIES</a> structure containing the registration properties for the XAPO. 
...
The object created by this <a href="https://msdn.microsoft.com/library/Ee415236(v=VS.85).aspx">CXAPOBase</a> will have a reference count of 1.
