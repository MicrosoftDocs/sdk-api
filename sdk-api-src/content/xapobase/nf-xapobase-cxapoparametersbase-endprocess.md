...
Notifies <a href="https://msdn.microsoft.com/library/Ee415238(v=VS.85).aspx">CXAPOParametersBase</a> that the XAPO has finished accessing the current process parameters.
...
XAPOs must call this method within their <a href="https://msdn.microsoft.com/library/Ee418456(v=VS.85).aspx">IXAPO::Process</a> implementation to access the current process parameters in a thread-safe manner.
