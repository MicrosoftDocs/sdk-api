...
Called by <a href="https://msdn.microsoft.com/library/Ee418447(v=VS.85).aspx">IXAPOParameters::SetParameters</a> to allow for user-defined parameter validation.
