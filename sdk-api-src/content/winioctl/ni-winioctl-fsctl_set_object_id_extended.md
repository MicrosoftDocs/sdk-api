...
ms.topic: ioctl
f1_keywords: ["winioctl/FSCTL_SET_OBJECT_ID_EXTENDED"]
...
<a href="https://docs.microsoft.com/windows/desktop/api/winioctl/ns-winioctl-_file_objectid_buffer">FILE_OBJECTID_BUFFER</a> structure is ignored. There is no mechanism for modifying the <b>ObjectId</b> member. The typical use of the 
