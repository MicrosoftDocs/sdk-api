...
Enables or disables the placement of line status and modem status values into the regular data stream that an application acquires through the [ReadFile](https://docs.microsoft.com/windows/win32/api/fileapi/nf-fileapi-readfile) function.
