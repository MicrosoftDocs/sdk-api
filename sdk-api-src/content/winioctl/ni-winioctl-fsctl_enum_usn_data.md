...
description: Enumerates the update sequence number (USN) data between two specified boundaries to obtain master file table (MFT) records.helpviewer_keywords: ["FSCTL_ENUM_USN_DATA","FSCTL_ENUM_USN_DATA control","FSCTL_ENUM_USN_DATA control code [Files]","_win32_fsctl_enum_usn_data","base.fsctl_enum_usn_data","fs.fsctl_enum_usn_data","winioctl/FSCTL_ENUM_USN_DATA"]
