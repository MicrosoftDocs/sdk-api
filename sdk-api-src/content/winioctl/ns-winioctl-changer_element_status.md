...
ms.topic: struct
f1_keywords: ["winioctl/CHANGER_ELEMENT_STATUS"]
...
A 
<a href="https://docs.microsoft.com/windows/desktop/api/winioctl/ns-winioctl-_changer_element">CHANGER_ELEMENT</a> structure that represents the element.
