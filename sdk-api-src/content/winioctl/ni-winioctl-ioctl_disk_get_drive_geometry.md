...
> [!NOTE]
> **IOCTL_DISK_GET_DRIVE_GEOMETRY** has been superseded by [IOCTL_DISK_GET_DRIVE_GEOMETRY_EX](ni-winioctl-ioctl_disk_get_drive_geometry_ex), which retrieves additional information.
