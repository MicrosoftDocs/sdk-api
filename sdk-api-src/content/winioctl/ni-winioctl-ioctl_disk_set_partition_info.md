...
ms.topic: ioctl
f1_keywords: ["winioctl/IOCTL_DISK_SET_PARTITION_INFO"]
...
<a href="https://docs.microsoft.com/windows/desktop/api/winioctl/ns-winioctl-_set_partition_information">SET_PARTITION_INFORMATION</a>
 
