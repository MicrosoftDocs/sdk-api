...
ms.topic: ioctl
f1_keywords: ["winioctl/IOCTL_DISK_GET_PARTITION_INFO"]
...
<a href="https://docs.microsoft.com/windows/desktop/api/winioctl/ns-winioctl-_partition_information">PARTITION_INFORMATION</a>
 
