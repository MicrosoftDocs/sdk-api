...
title: Matrix::TransformPoints(IN OUT PointF,IN INT)
...
ms.date: 09/12/2018
ms.keywords: Matrix.TransformPoints, Matrix.TransformPoints(IN OUT PointF,IN INT), Matrix::TransformPoints, Matrix::TransformPoints(IN OUT PointF,IN INT), TransformPoints, TransformPoints methods [GDI+], _gdiplus_CLASS_Matrix_TransformPoints_Methods, gdiplus._gdiplus_CLASS_Matrix_TransformPoints_Methods, gdiplusmatrix/TransformPoints
...
# Matrix::TransformPoints(IN OUT PointF,IN INT)
