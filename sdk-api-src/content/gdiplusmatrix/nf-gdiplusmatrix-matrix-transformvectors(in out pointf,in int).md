...
ms.date: 07/29/2018
ms.keywords: Matrix.TransformVectors, Matrix.TransformVectors(IN OUT PointF,IN INT), Matrix::TransformVectors, Matrix::TransformVectors(IN OUT PointF,IN INT), TransformVectors, TransformVectors methods [GDI+], _gdiplus_CLASS_Matrix_TransformVectors_Methods, gdiplus._gdiplus_CLASS_Matrix_TransformVectors_Methods, gdiplusmatrix/TransformVectors
