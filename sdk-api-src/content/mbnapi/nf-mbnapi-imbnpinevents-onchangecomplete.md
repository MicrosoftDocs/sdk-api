...
A pointer to an <a href="/windows/desktop/api/mbnapi/ns-mbnapi-mbn_pin_info">MBN_PIN_INFO</a> structure that contains information on remaining attempts, in case of failure operations.  The contents of <i>pinInfo</i> are meaningful only when <i>status</i> is <b>E_MBN_FAILURE</b>.
...
The <b>OnChangeComplete</b> method is called by the Mobile Broadband service to report the completion status of a PIN change operation initialized by a call to the <a href="/windows/desktop/api/mbnapi/nf-mbnapi-imbnpin-change">Change</a> method of <a href="/windows/desktop/api/mbnapi/nn-mbnapi-imbnpin">IMbnPin</a>.
