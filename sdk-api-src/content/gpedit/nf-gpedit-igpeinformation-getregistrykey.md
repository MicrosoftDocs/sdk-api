...
title: IGPEInformation::GetRegistryKey method
...
ms.date: 2/15/2018
ms.keywords: GPO_SECTION_MACHINE, GPO_SECTION_USER, GetRegistryKey method [Group Policy], GetRegistryKey method [Group Policy], IGPEInformation interface, GetRegistryKey,IGPEInformation.GetRegistryKey, IGPEInformation, IGPEInformation interface [Group Policy], GetRegistryKey method, IGPEInformation::GetRegistryKey, _win32_igpeinformation_getregistrykey, gpedit/IGPEInformation::GetRegistryKey, policy.igpeinformation_getregistrykey
...
# IGPEInformation::GetRegistryKey method
