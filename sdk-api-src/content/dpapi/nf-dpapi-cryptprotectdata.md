...
> [!IMPORTANT]
> The prompt-based flow controlled by this parameter is deprecated and will be removed in **April 2027**. Pass **NULL**, or pass a struct with `dwPromptFlags` set to 0, to use the non-interactive path which is unaffected. See [CRYPTPROTECT_PROMPTSTRUCT](/windows/win32/api/dpapi/ns-dpapi-cryptprotect_promptstruct) for migration guidance.
