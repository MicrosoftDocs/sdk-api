...
<ul>
<li>Call <a href="https://msdn.microsoft.com/library/Bb787660(v=VS.85).aspx">ITextHost::TxGetDC</a> to get a device context for the control's window and then repaint or update the window. Afterward, call <a href="https://msdn.microsoft.com/library/Bb787712(v=VS.85).aspx">ITextHost::TxReleaseDC</a>. </li>
<li>Call <a href="https://msdn.microsoft.com/library/Bb787706(v=VS.85).aspx">ITextHost::TxInvalidateRect</a> to invalidate the control's window. </li>
<li>Call <a href="https://msdn.microsoft.com/library/Bb787716(v=VS.85).aspx">ITextHost::TxScrollWindowEx</a> to scroll the control's window. </li>
</ul>
