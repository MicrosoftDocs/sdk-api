...
The first four parameters are similar to equivalent parameters in <a href="https://msdn.microsoft.com/library/Bb787690(v=VS.85).aspx">ITextServices::TxDraw</a> and give the same information. In the case where the lines must be recalculated, it should use these values the same ways as in <b>ITextServices::TxDraw</b>.
