...
Erases the newly invalidated region by sending a 
								<a href="https://msdn.microsoft.com/library/ms648055(v=VS.85).aspx">WM_ERASEBKGND</a> message to the window when specified with the SW_INVALIDATE flag.
...
Scrolls all child windows that intersect the rectangle pointed to by the 
								...
								<a href="https://msdn.microsoft.com/library/ms632631(v=VS.85).aspx">WM_MOVE</a> message to all child windows that intersect the 
...
<td width="60%">
                ...
                Scrolls using smooth scrolling. Use the 
								<a href="https://msdn.microsoft.com/library/ms632657(v=VS.85).aspx">HIWORD</a> portion of the 
