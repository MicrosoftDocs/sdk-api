...
New state of the control. Typically it is the value returned by <a href="https://msdn.microsoft.com/library/Bb787636(v=VS.85).aspx">ITextHost::TxActivate</a>. 
...
No matter how many times this method is called, only one call to <a href="https://msdn.microsoft.com/library/Bb787636(v=VS.85).aspx">ITextHost::TxActivate</a> is necessary to activate the control.
