...
<td width="60%">
Message was not processed. Typically indicates that the caller should process the message itself, potentially by calling <a href="https://msdn.microsoft.com/library/ms633572(v=VS.85).aspx">DefWindowProc</a>. 
...
<a href="https://msdn.microsoft.com/library/ms646276(v=VS.85).aspx">WM_CHAR</a> and <a href="https://msdn.microsoft.com/library/ms646280(v=VS.85).aspx">WM_KEYDOWN</a> should return the value S_MSG_KEYIGNORED when a key or character is recognized, but has no effect, given the current state. For example, S_MSG_KEYIGNORED should be returned in the following cases: 
...
<li>Any insertion of the character from <a href="https://msdn.microsoft.com/library/ms646276(v=VS.85).aspx">WM_CHAR</a> that would move the insertion point past the maximum length of the control. </li>
</ul>
