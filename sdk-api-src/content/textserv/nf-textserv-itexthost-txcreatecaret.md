...
title: ITextHost::TxCreateCaret method
...
ms.date: 3/31/2018
ms.keywords: CARET_CUSTOM, CARET_ITALIC, CARET_NONE, CARET_NULL, CARET_ROTATE90, CARET_RTL, ITextHost, ITextHost interface [Windows Controls], TxCreateCaret method, ITextHost::TxCreateCaret, TxCreateCaret method [Windows Controls], TxCreateCaret method [Windows Controls], ITextHost interface, TxCreateCaret,ITextHost.TxCreateCaret, _win32_ITextHost_TxCreateCaret, _win32_ITextHost_TxCreateCaret_cpp, controls.ITextHost_TxCreateCaret, controls._win32_ITextHost_TxCreateCaret, textserv/ITextHost::TxCreateCaret
