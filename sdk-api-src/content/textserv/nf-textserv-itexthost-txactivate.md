...
No matter how many times this method is called, only one <a href="https://msdn.microsoft.com/library/Bb787642(v=VS.85).aspx">ITextHost::TxDeactivate</a> call is necessary to deactivate the control.

This function returns an opaque handle in 
				<i>plOldState</i>. The caller (the text services object) should save this handle and use it in a subsequent call to <a href="https://msdn.microsoft.com/library/Bb787642(v=VS.85).aspx">ITextHost::TxDeactivate</a>.
