...
ms.topic: method
f1_keywords: ["rend/ITDirectoryObjectConference.put_Url"]
req.header: rend.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/rend/nf-rend-itdirectoryobjectconference-get_url">ITDirectoryObjectConference::get_Url</a>
 
