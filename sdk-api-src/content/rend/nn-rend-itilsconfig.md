...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">ITILSConfig</b> interface inherits from the <a href="/previous-versions/windows/desktop/api/oaidl/nn-oaidl-idispatch">IDispatch</a> interface. <b>ITILSConfig</b> also has these types of members:
<ul>
...
<a href="/windows/desktop/api/rend/nf-rend-itilsconfig-get_port">get_Port</a>
</td>
...
<tr data="declared;">
<td align="left" width="37%">
<a href="/windows/desktop/api/rend/nf-rend-itilsconfig-put_port">put_Port</a>
</td>
<td align="left" width="63%">
