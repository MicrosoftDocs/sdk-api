...
A pointer to the <a href="https://msdn.microsoft.com/library/Aa377189(v=VS.85).aspx">CERT_CONTEXT</a> structure that contains the X.509 certificate to be used for signing.
...
<a href="https://msdn.microsoft.com/library/Aa377189(v=VS.85).aspx">CERT_CONTEXT</a>
