...
Type: <b><a href="https://msdn.microsoft.com/en-us/library/Ff476131(v=VS.85).aspx">D3D11_FILL_MODE</a></b>
...
Type: <b><a href="https://msdn.microsoft.com/en-us/library/Ff476108(v=VS.85).aspx">D3D11_CULL_MODE</a></b>
...
Rasterizer state defines the behavior of the rasterizer stage. To create a rasterizer-state object, call <a href="https://msdn.microsoft.com/en-us/library/Hh404586(v=VS.85).aspx">ID3D11Device1::CreateRasterizerState1</a>. To set rasterizer state, call <a href="https://msdn.microsoft.com/en-us/library/Ff476479(v=VS.85).aspx">ID3D11DeviceContext::RSSetState</a>.
