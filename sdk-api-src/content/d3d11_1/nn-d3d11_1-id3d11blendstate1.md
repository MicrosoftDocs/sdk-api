...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">ID3D11BlendState1</b> interface inherits from <a href="https://msdn.microsoft.com/en-us/library/Ff476349(v=VS.85).aspx">ID3D11BlendState</a>. <b>ID3D11BlendState1</b> also has these types of members:
<ul>
...
<a href="https://msdn.microsoft.com/en-us/library/Hh404573(v=VS.85).aspx">GetDesc1</a>
</td>
...
To create a blend-state object, call <a href="https://msdn.microsoft.com/en-us/library/Hh404577(v=VS.85).aspx">ID3D11Device1::CreateBlendState1</a>. To bind the blend-state object to the <a href="https://msdn.microsoft.com/en-us/library/Bb205120(v=VS.85).aspx">output-merger stage</a>, call <a href="https://msdn.microsoft.com/en-us/library/Ff476462(v=VS.85).aspx">ID3D11DeviceContext::OMSetBlendState</a>.
...
<a href="https://msdn.microsoft.com/en-us/library/Ff476349(v=VS.85).aspx">ID3D11BlendState</a>
 
