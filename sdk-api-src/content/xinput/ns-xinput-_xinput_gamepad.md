...
This structure is used by the <a href="https://msdn.microsoft.com/library/Ee419272(v=VS.85).aspx">XINPUT_STATE</a> structure when polling for changes in the state of the controller.
...
<a href="https://msdn.microsoft.com/library/Ee419272(v=VS.85).aspx">XINPUT_STATE</a>
...
<a href="https://msdn.microsoft.com/library/Ee419267(v=VS.85).aspx">XInputGetfState</a>
 
