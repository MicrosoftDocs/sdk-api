...
Pointer to an <a href="https://msdn.microsoft.com/library/Ee419272(v=VS.85).aspx">XINPUT_STATE</a> structure that receives the current state of the controller.
