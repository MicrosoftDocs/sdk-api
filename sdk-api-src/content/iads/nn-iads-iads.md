...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IADs</b> interface inherits from the <a href="https://msdn.microsoft.com/en-us/library/ms221608(v=VS.85).aspx">IDispatch</a> interface. <b>IADs</b> also has these types of members:
<ul>
