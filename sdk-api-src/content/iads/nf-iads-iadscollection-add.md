...
Item value. When the item is an object, this parameter holds the  <a href="https://msdn.microsoft.com/library/ms221608(v=VS.85).aspx">IDispatch</a> interface pointer on the object.
