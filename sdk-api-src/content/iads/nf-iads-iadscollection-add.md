...
Item value. When the item is an object, this parameter holds the  <a href="/previous-versions/windows/desktop/api/oaidl/nn-oaidl-idispatch.md">IDispatch</a> interface pointer on the object.
