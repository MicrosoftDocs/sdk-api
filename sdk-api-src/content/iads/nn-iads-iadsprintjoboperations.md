...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IADsPrintJobOperations</b> interface inherits from <a href="/previous-versions/windows/desktop/api/oaidl/nn-oaidl-idispatch">IDispatch</a> and <a href="/windows/desktop/api/iads/nn-iads-iads">IADs</a>. <b>IADsPrintJobOperations</b> also has these types of members:
<ul>
...
The <b>IADsPrintJobOperations</b> interface has these methods.
...
<tr data="declared;">
<td align="left" width="37%">
<a href="/windows/desktop/api/iads/nf-iads-iadsprintjoboperations-pause">Pause</a>
</td>
<td align="left" width="63%">
...
<tr data="declared;">
<td align="left" width="37%">
<a href="/windows/desktop/api/iads/nf-iads-iadsprintjoboperations-resume">Resume</a>
</td>
<td align="left" width="63%">
...
<h3><a id="properties"></a>Properties</h3>The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IADsPrintJobOperations</b> interface has these properties.
...
<a href="/windows/desktop/ADSI/iadsprintjoboperations-property-methods">PagesPrinted</a>
...
<td align="left" width="63%">
Tracks the number of pages completed.
...
<a href="/windows/desktop/ADSI/iadsprintjoboperations-property-methods">Position</a>
...
<td align="left" width="63%">
Tracks the numeric position of the print job in the print queue.
...
<a href="/windows/desktop/ADSI/iadsprintjoboperations-property-methods">Status</a>
...
<td align="left" width="63%">
Tracks the status of the print job.
...
<a href="/windows/desktop/ADSI/iadsprintjoboperations-property-methods">TimeElapsed</a>
...
<td align="left" width="63%">
Tracks the elapsed time, in seconds, since the job started printing.
