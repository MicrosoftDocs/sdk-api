---
UID: NF:infotech.IITPropList.Set
title: IITPropList::Set method
...
ms.date: 2/15/2018
ms.keywords: IITPropList, IITPropList interface [HTML Help Workshop], Set method, IITPropList::Set, PROP_ADD, PROP_DELETE, PROP_UPDATE, Set method [HTML Help Workshop], Set method [HTML Help Workshop], IITPropList interface, Set,IITPropList.Set, htmlhelp.iitproplist_set1, infotech/IITPropList::Set, refIITPropListSet
