...
description: Retrieves the domains and cookie settings of websites for which site-specific cookie regulations are set. (InternetEnumPerSiteCookieDecisionW)
