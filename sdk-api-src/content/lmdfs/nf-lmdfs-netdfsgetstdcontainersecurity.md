...
ms.topic: function
f1_keywords: ["lmdfs/NetDfsGetStdContainerSecurity"]
req.header: lmdfs.h
...
Pointer to a list of <a href="https://docs.microsoft.com/windows/desktop/api/winnt/ns-winnt-_security_descriptor">SECURITY_DESCRIPTOR</a> structures that contain the security items requested in the <i>SecurityInformation</i> parameter.
