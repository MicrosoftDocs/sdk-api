...
description: REGISTERWORDENUMPROCW (Unicode) is an application-defined callback function used with the ImmEnumRegisterWord function. (registerwordenumprocw)
