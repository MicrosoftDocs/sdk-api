...
description: The COMPOSITIONFORM structure (immdev.h) contains style and position information for a composition window. 
...
f1_keywords:
 - tagCOMPOSITIONFORM
 - immdev/tagCOMPOSITIONFORM
 - PCOMPOSITIONFORM
 - immdev/PCOMPOSITIONFORM
 - COMPOSITIONFORM
