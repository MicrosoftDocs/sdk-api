...
description: The ImmGetConversionListW (Unicode) function (immdev.h) retrieves the conversion result list of characters or words without generating any IME-related messages.
helpviewer_keywords: ["GCL_CONVERSION", "GCL_REVERSECONVERSION", "GCL_REVERSE_LENGTH", "ImmGetConversionList", "ImmGetConversionList function [Internationalization for Windows Applications]", "ImmGetConversionListW", "_win32_ImmGetConversionList", "intl.immgetconversionlist"]
