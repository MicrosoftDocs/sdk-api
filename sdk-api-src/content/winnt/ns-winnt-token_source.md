...
ms.topic: struct
f1_keywords: ["winnt/TOKEN_SOURCE"]
req.header: winnt.h
...
The <b>TOKEN_SOURCE</b> structure identifies the source of an <a href="https://docs.microsoft.com/windows/desktop/SecGloss/a-gly">access token</a>.
