...
title: "_ACCESS_DENIED_CALLBACK_OBJECT_ACE"
...
An 
<a href="https://msdn.microsoft.com/f115ee54-3333-4109-8004-d71904a7a943">ACCESS_MASK</a> that specifies the access rights the system will deny to the trustee.
...
If neither the <b>ObjectType</b> nor <b>InheritedObjectType</b> <b>GUID</b> is specified, the <b>ACCESS_DENIED_CALLBACK_OBJECT_ACE</b> structure has the same semantics as those used by the <a href="https://msdn.microsoft.com/6df77b27-7aa3-455f-bffe-eeb90ba1bc15">ACCESS_DENIED_CALLBACK_ACE</a> structure. In that case, use the 
