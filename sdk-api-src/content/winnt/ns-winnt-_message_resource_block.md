...
The offset, in bytes, from the beginning of the <a href="https://msdn.microsoft.com/library/ms648021(v=VS.85).aspx">MESSAGE_RESOURCE_DATA</a> structure to the <a href="https://msdn.microsoft.com/library/ms648022(v=VS.85).aspx">MESSAGE_RESOURCE_ENTRY</a> structures in this <b>MESSAGE_RESOURCE_BLOCK</b>. The <b>MESSAGE_RESOURCE_ENTRY</b> structures contain the message strings. 
...
<a href="https://msdn.microsoft.com/library/ms648021(v=VS.85).aspx">MESSAGE_RESOURCE_DATA</a>



<a href="https://msdn.microsoft.com/library/ms648022(v=VS.85).aspx">MESSAGE_RESOURCE_ENTRY</a>
