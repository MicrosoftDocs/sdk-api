...
title: ICertEncodeDateArray::Encode method
...
ms.date: 3/27/2018
ms.keywords: CCertEncodeDateArray object [Security], Encode method, Encode method [Security], Encode method [Security], CCertEncodeDateArray object, Encode method [Security], ICertEncodeDateArray interface, Encode,ICertEncodeDateArray.Encode, ICertEncodeDateArray, ICertEncodeDateArray interface [Security], Encode method, ICertEncodeDateArray::Encode, _certsrv_icertencodedatearray_encode, certenc/ICertEncodeDateArray::Encode, security.icertencodedatearray_encode
