...
The <b>Reset</b> method specifies the size of <b>DATE</b> array in this object. The values of all the elements in the array are set to zero. You must call this method before calling the <a href="https://msdn.microsoft.com/en-us/library/Aa384036(v=VS.85).aspx">ICertEncodeDateArray::SetValue</a> method for the first time.
