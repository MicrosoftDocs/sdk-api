...
title: ICertEncodeStringArray::GetValue method
...
ms.date: 4/18/2018
ms.keywords: CCertEncodeStringArray object [Security], GetValue method, GetValue method [Security], GetValue method [Security], CCertEncodeStringArray object, GetValue method [Security], ICertEncodeStringArray interface, GetValue,ICertEncodeStringArray.GetValue, ICertEncodeStringArray, ICertEncodeStringArray interface [Security], GetValue method, ICertEncodeStringArray::GetValue, _certsrv_icertencodestringarray_getvalue, certenc/ICertEncodeStringArray::GetValue, security.icertencodestringarray_getvalue
