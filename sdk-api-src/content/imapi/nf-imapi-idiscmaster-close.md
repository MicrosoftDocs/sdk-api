...
title: IDiscMaster::Close method
...
ms.date: 3/14/2018
ms.keywords: Close method [IMAPI], Close method [IMAPI], IDiscMaster interface, Close,IDiscMaster.Close, IDiscMaster, IDiscMaster interface [IMAPI], Close method, IDiscMaster::Close, _win32_idiscmaster_close, base.idiscmaster_close, imapi.idiscmaster_close, imapi/IDiscMaster::Close
