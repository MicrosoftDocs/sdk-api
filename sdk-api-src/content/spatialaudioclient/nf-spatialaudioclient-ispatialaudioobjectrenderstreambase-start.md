...
Starting the stream causes data flow between the endpoint buffer and the audio engine.  
    ...
    Otherwise, the clock resumes from its position at the time that the stream was last paused with a call to <a href="https://msdn.microsoft.com/library/windows/hardware/dn927275">Stop</a>.  
