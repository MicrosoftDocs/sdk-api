...
description: The SetupQueueRename function places an individual file rename operation on a setup file queue. (Unicode)
helpviewer_keywords: ["SetupQueueRename", "SetupQueueRename function [Setup API]", "SetupQueueRenameW", "_setupapi_setupqueuerename", "setup.setupqueuerename", "setupapi/SetupQueueRename", "setupapi/SetupQueueRenameW"]
