...
description: The SetupSetFileQueueAlternatePlatform function associates the file queue with a target platform that is different from the platform running the function. This is done to enable for non-native signature verification. (ANSI)
helpviewer_keywords: ["SetupSetFileQueueAlternatePlatformA", "setupapi/SetupSetFileQueueAlternatePlatformA"]
...
f1_keywords:
 ...
 - setupapi/SetupSetFileQueueAlternatePlatformA
dev_langs:
 - c++
topic_type:
 - APIRef
