...
title: SP_DRVINFO_DATA_V1_W (setupapi.h)
description: An SP_DRVINFO_DATA structure contains information about a driver. This structure is a member of a driver information list that can be associated with a particular device instance or globally with a device information set. (sp_drvinfo_data_v1_w)
helpviewer_keywords: ["*PSP_DRVINFO_DATA_V1_W","PSP_DRVINFO_DATA","PSP_DRVINFO_DATA structure pointer [Device and Driver Installation]","SP_DRVINFO_DATA","SP_DRVINFO_DATA structure [Device and Driver Installation]","SP_DRVINFO_DATA_V1","SP_DRVINFO_DATA_V1_W","SP_DRVINFO_DATA_W","devinst.sp_drvinfo_data","di-struct_738a1fa5-729a-4464-af75-05591d68eef7.xml","setupapi/PSP_DRVINFO_DATA","setupapi/SP_DRVINFO_DATA"]
...
ms.custom: 19H1
f1_keywords:
 - _SP_DRVINFO_DATA_V1_W
 - setupapi/_SP_DRVINFO_DATA_V1_W
 - PSP_DRVINFO_DATA_V1_W
 - setupapi/PSP_DRVINFO_DATA_V1_W
 - SP_DRVINFO_DATA_V1_W
 - setupapi/SP_DRVINFO_DATA_V1_W
dev_langs:
 - c++
topic_type:
 - APIRef
