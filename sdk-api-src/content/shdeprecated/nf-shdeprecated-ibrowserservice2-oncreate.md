...
Type: <b>tagCREATESTRUCTW*</b>
          ...
          A pointer to a <a href="https://msdn.microsoft.com/library/ms632603(v=VS.85).aspx">CREATESTRUCT</a> structure that receives the initialization parameters passed to the window procedure (WinProc) of the class.
