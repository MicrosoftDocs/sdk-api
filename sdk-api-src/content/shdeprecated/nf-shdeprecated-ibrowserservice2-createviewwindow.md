...
title: IBrowserService2::CreateViewWindow method
...
ms.date: 4/26/2018
ms.keywords: CreateViewWindow method [Windows Shell], CreateViewWindow method [Windows Shell], IBrowserService2 interface, CreateViewWindow,IBrowserService2.CreateViewWindow, IBrowserService2, IBrowserService2 interface [Windows Shell], CreateViewWindow method, IBrowserService2::CreateViewWindow, shdeprecated/IBrowserService2::CreateViewWindow, shell.IBrowserService2_CreateViewWindow, zone_IBrowserService2_CreateViewWindow
...
# IBrowserService2::CreateViewWindow method
...
A pointer to a <a href="https://msdn.microsoft.com/library/windows/hardware/ff569234">RECT</a> structure that specifies the current dimensions of the browser view.
