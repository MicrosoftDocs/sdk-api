...
title: IFsrmReportJob::EnumReports method
...
ms.date: 3/14/2018
ms.keywords: EnumReports method [File Server Resource Manager], EnumReports method [File Server Resource Manager], IFsrmReportJob interface, EnumReports,IFsrmReportJob.EnumReports, IFsrmReportJob, IFsrmReportJob interface [File Server Resource Manager], EnumReports method, IFsrmReportJob::EnumReports, fs.ifsrmreportjob_enumreports, fsrm.ifsrmreportjob_enumreports, fsrmreports/IFsrmReportJob::EnumReports
