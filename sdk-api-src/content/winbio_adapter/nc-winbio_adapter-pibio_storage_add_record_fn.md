...
ms.topic: callback
f1_keywords: ["winbio_adapter/StorageAdapterAddRecord"]
...
Pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/winbio_adapter/ns-winbio_adapter-_winbio_storage_record">WINBIO_STORAGE_RECORD</a> structure that contains the template to add.
...
<td width="60%">
The size of the  index vector specified in the <a href="https://docs.microsoft.com/windows/desktop/api/winbio_adapter/ns-winbio_adapter-_winbio_storage_record">WINBIO_STORAGE_RECORD</a> structure does not match the index size specified when the database was created.
