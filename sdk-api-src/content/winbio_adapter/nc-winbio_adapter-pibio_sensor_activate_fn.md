...
helpviewer_keywords: ["PIBIO_SENSOR_ACTIVATE_FN","PIBIO_SENSOR_ACTIVATE_FN callback","SensorAdapterActivate","SensorAdapterActivate callback function [Windows Biometric Framework API]","secbiomet.sensoradapteractivate","winbio_adapter/SensorAdapterActivate"]
...
f1_keywords:
 ...
 - winbio_adapter/PIBIO_SENSOR_ACTIVATE_FN
dev_langs:
 - c++
topic_type:
 - APIRef
