...
ms.date: 4/24/2018
ms.keywords: EngineAdapterAcceptSampleData, EngineAdapterAcceptSampleData callback function [Windows Biometric Framework API], PIBIO_ENGINE_ACCEPT_SAMPLE_DATA_FN, secbiomet.engineadapteracceptsampledata, winbio_adapter/EngineAdapterAcceptSampleData
...
# PIBIO_ENGINE_ACCEPT_SAMPLE_DATA_FN callback


## -description


Called by the <a href="https://msdn.microsoft.com/dea49f4b-668d-4b30-a16f-b74f260785c2">SensorAdapterPushDataToEngine</a>  function implemented by the sensor adapter to notify the engine adapter to accept a raw biometric sample and extract a feature set. The feature set can be used for matching or enrollment.
...
<a href="https://msdn.microsoft.com/9ac11720-7dbf-4479-b2c5-78cd53494e21">EngineAdapterExportEngineData</a>
