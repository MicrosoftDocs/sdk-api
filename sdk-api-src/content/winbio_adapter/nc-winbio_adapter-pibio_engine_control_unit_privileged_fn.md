...
title: PIBIO_ENGINE_CONTROL_UNIT_PRIVILEGED_FN
...
ms.date: 4/24/2018
ms.keywords: EngineAdapterControlUnitPrivileged, EngineAdapterControlUnitPrivileged callback function [Windows Biometric Framework API], PIBIO_ENGINE_CONTROL_UNIT_PRIVILEGED_FN, secbiomet.engineadaptercontrolunitprivileged, winbio_adapter/EngineAdapterControlUnitPrivileged
...
# PIBIO_ENGINE_CONTROL_UNIT_PRIVILEGED_FN callback


## -description


Called by the Windows Biometric Framework to perform a vendor-defined control operation that requires elevated privilege. Call the <a href="https://msdn.microsoft.com/e0b61709-948f-4adf-8391-b904cf8a1648">EngineAdapterControlUnit</a> function to perform a vendor-defined control operation that does not require elevated privilege.
...
Your implementation of this function should be identical to your implementation of the <a href="https://msdn.microsoft.com/e0b61709-948f-4adf-8391-b904cf8a1648">EngineAdapterControlUnit</a> function except that elevated privileges are required to perform the operations specified by the <i>ControlCode</i> parameter. You are responsible for defining the operations and deciding which will require elevated privilege.
...
<a href="https://msdn.microsoft.com/e0b61709-948f-4adf-8391-b904cf8a1648">EngineAdapterControlUnit</a>
