...
This routine releases memory allocated by <a href="https://msdn.microsoft.com/library/windows/hardware/ff564178">EngAllocUserMem</a>. The memory block must not be accessed after it is freed.
