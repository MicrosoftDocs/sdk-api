...
ms.topic: function
f1_keywords: ["winddi/FLOATOBJ_DivLong"]
req.header: winddi.h
...
The <b>FLOATOBJ_DivLong</b> function divides the <a href="https://docs.microsoft.com/windows/desktop/api/winddi/ns-winddi-_floatobj">FLOATOBJ</a> by the value of type LONG, and returns with the result in the first parameter.
