...
The <b>FLOATOBJ_GetFloat</b> function calculates and returns the FLOAT-equivalent value of the specified <a href="https://docs.microsoft.com/windows/desktop/api/winddi/ns-winddi-_floatobj">FLOATOBJ</a>.
