...
ms.topic: function
f1_keywords: ["winddi/FLOATOBJ_SubLong"]
req.header: winddi.h
...
The <b>FLOATOBJ_SubLong</b> function subtracts the value of type LONG from the <a href="https://docs.microsoft.com/windows/desktop/api/winddi/ns-winddi-_floatobj">FLOATOBJ</a>, and returns with the result in the first parameter.
