...
The <b>FLOATOBJ_SubFloat</b> function subtracts the value of type FLOATL from the <a href="https://msdn.microsoft.com/library/windows/hardware/ff565804">FLOATOBJ</a>, and returns with the result in the first parameter.
