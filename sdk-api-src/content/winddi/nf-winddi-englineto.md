...
The driver that has hooked <a href="https://msdn.microsoft.com/library/windows/hardware/ff556245">DrvLineTo</a> can call <b>EngLineTo</b> when the rendering surface is a device-independent bitmap (DIB).
