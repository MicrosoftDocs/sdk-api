...
ms.topic: function
f1_keywords: ["winddi/FLOATOBJ_SetLong"]
req.header: winddi.h
...
The <b>FLOATOBJ_SetLong</b> function assigns the value of type LONG to the <a href="https://docs.microsoft.com/windows/desktop/api/winddi/ns-winddi-_floatobj">FLOATOBJ</a>.
