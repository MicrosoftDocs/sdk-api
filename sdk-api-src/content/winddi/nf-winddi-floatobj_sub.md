...
The <b>FLOATOBJ_Sub</b> function subtracts the second <a href="https://docs.microsoft.com/windows/desktop/api/winddi/ns-winddi-floatobj">FLOATOBJ</a> from the first, and returns with the result in the first parameter.
