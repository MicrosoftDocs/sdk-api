...
Flags used by the <a href="https://msdn.microsoft.com/library/Aa969523(v=VS.85).aspx">DwmSetPresentParameters</a> function to specify the frame sampling type.
...
The maximum recognized <a href="https://msdn.microsoft.com/library/Aa969531(v=VS.85).aspx">DWM_SOURCE_FRAME_SAMPLING</a> value, used for validation purposes.
