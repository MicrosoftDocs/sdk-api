...
A pointer to a <a href="https://msdn.microsoft.com/library/Bb773244(v=VS.85).aspx">MARGINS</a> structure that describes the margins to use when extending the frame into the client area.
...
This function must be called whenever Desktop Window Manager (DWM) composition is toggled. Handle the <a href="https://msdn.microsoft.com/library/Dd388199(v=VS.85).aspx">WM_DWMCOMPOSITIONCHANGED</a> message for composition change notification. 
