...
A pointer to a <a href="https://msdn.microsoft.com/library/Aa969501(v=VS.85).aspx">DWM_PRESENT_PARAMETERS</a> structure that contains DWM video frame parameters for frame composition.
