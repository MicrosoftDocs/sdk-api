...
ms.topic: method
f1_keywords: ["ctfutb/ITfLangBarItemMgr.AdviseItemSink"]
req.header: ctfutb.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/ctfutb/nf-ctfutb-itflangbaritemmgr-unadviseitemssink">ITfLangBarItemMgr::UnadviseItemsSink
      </a>
