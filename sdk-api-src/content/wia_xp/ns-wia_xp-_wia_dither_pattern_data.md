...
The <b>WIA_DITHER_PATTERN_DATA</b> structure specifies a dither pattern for scanners. It is used in conjunction with the <a href="https://msdn.microsoft.com/library/ms630195(v=VS.85).aspx">scanner device property constant</a> WIA_DPS_DITHER_PATTERN_DATA.
