...
<div class="alert"><b>Note</b>  For Windows Vista applications, use <a href="https://msdn.microsoft.com/library/ms629914(v=VS.85).aspx">IWiaTransferCallback</a> instead of <b>IWiaDataCallback</b>.</div><div> </div>
...
<a href="https://msdn.microsoft.com/library/ms630156(v=VS.85).aspx">BandedDataCallback</a>
</td>
<td align="left" width="63%">
Provides data transfer status notifications. WIA data transfer methods of the <a href="https://msdn.microsoft.com/library/ms630155(v=VS.85).aspx">IWiaDataTransfer</a> interface periodically call this method. 
