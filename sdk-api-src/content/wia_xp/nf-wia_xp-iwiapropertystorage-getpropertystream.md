...
Applications use this method to get a snapshot of the current properties of an item. These are subsequently restored by calling <a href="https://msdn.microsoft.com/library/ms629940(v=VS.85).aspx">IWiaPropertyStorage::SetPropertyStream</a>.
