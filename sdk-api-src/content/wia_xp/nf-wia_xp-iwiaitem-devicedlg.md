...
Specifies what type of data the image is intended to represent. For a list of image intent values, see <a href="https://msdn.microsoft.com/library/ms630190(v=VS.85).aspx">Image Intent Constants</a>.
...
Receives the address of an array of pointers to <a href="https://msdn.microsoft.com/library/ms630113(v=VS.85).aspx">IWiaItem</a> interfaces. 
...
After this method returns, the application can use the <a href="https://msdn.microsoft.com/library/ms630155(v=VS.85).aspx">IWiaDataTransfer</a> interface to acquire the image.
