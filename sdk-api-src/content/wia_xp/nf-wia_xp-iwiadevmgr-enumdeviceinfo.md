...
Type: <b><a href="https://msdn.microsoft.com/library/ms630162(v=VS.85).aspx">IEnumWIA_DEV_INFO</a>**</b>

Receives the address of a pointer to the <a href="https://msdn.microsoft.com/library/ms630162(v=VS.85).aspx">IEnumWIA_DEV_INFO</a> interface.
