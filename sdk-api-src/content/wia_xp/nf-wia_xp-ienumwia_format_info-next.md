...
The <b>IEnumWIA_FORMAT_INFO::Next</b> method returns an array of <a href="https://msdn.microsoft.com/library/ms629878(v=VS.85).aspx">WIA_FORMAT_INFO</a> structures.
...
Receives the address of the array of <a href="https://msdn.microsoft.com/library/ms629878(v=VS.85).aspx">WIA_FORMAT_INFO</a> structures.
...
On output, receives the address of a <b>ULONG</b> that contains the number of <a href="https://msdn.microsoft.com/library/ms629878(v=VS.85).aspx">WIA_FORMAT_INFO</a> structures actually returned in the <i>rgelt</i> parameter.
