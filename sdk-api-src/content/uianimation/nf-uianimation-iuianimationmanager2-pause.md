...
When an animation manager is paused, its status is set to <a href="https://msdn.microsoft.com/en-us/library/Dd317043(v=VS.85).aspx">UI_ANIMATION_MANAGER_IDLE</a>.
