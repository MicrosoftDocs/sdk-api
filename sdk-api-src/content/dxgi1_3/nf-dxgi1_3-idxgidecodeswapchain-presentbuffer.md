...
Presents a frame on the output adapter. The frame is a subresource of the <a href="https://msdn.microsoft.com/en-us/library/Bb174560(v=VS.85).aspx">IDXGIResource</a> object that was used to create the decode swap chain.
...
<ul>
<li><a href="https://msdn.microsoft.com/en-us/library/Bb509553(v=VS.85).aspx">DXGI_ERROR_DEVICE_REMOVED</a></li>
<li><a href="https://msdn.microsoft.com/en-us/library/Cc308061(v=VS.85).aspx">DXGI_STATUS_OCCLUDED</a></li>
<li><a href="https://msdn.microsoft.com/en-us/library/Bb509553(v=VS.85).aspx">DXGI_ERROR_INVALID_CALL</a></li>
