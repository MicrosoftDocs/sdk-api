...
helpviewer_keywords: ["CHARSET_SYMBOL","CHARSET_UNICODE","EMBED_EDITABLE","EMBED_INSTALLABLE","EMBED_NOEMBEDDING","EMBED_PREVIEWPRINT","TTEMBED_EMBEDEUDC","TTEMBED_RAW","TTEMBED_SUBSET","TTEMBED_TTCOMPRESSED","TTEmbedFontEx","TTEmbedFontEx function [Windows GDI]","_win32_TTEmbedFontEx","gdi.ttembedfontex","t2embapi/TTEmbedFontEx"]
...
<b>TTEmbedFontEx</b> is used the same way as <a href="/windows/desktop/api/t2embapi/nf-t2embapi-ttembedfont">TTEmbedFont</a>, but accepts a character code set given in UCS-4 (32 bits).
...
### -param pulCharCodeSet [in]

Pointer to the buffer containing the optional UCS-4 character codes for subsetting. This field is only used for subsetting a font and is ignored if the <i>ulFlags</i> field does not specify TTEMBED_SUBSET.

### -param usCharCodeCount [in]

The number of characters in the list of characters indicated by <i>pulCharCodeSet</i>. This field is only used for subsetting a font and is ignored if the ulFlags field does not specify TTEMBED_SUBSET.
...
For information on embedding Unicode characters, see <a href="/windows/desktop/api/t2embapi/nf-t2embapi-ttembedfont">TTEmbedFont</a>; for information on embedding Unicode characters from a file, see <a href="/windows/desktop/api/t2embapi/nf-t2embapi-ttembedfontfromfilea">TTEmbedFontFromFileA</a>.
