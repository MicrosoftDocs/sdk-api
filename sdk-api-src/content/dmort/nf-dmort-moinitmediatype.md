...
ms.topic: function
f1_keywords: ["dmort/MoInitMediaType"]
req.header: dmort.h
...
Pointer to an uninitialized <a href="https://docs.microsoft.com/windows/desktop/api/mediaobj/ns-mediaobj-_dmomediatype">DMO_MEDIA_TYPE</a> structure allocated by the caller.
