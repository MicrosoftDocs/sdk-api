...
ms.topic: function
f1_keywords: ["dmort/MoCreateMediaType"]
req.header: dmort.h
...
Receives a pointer to an allocated <a href="https://docs.microsoft.com/windows/desktop/api/mediaobj/ns-mediaobj-_dmomediatype">DMO_MEDIA_TYPE</a> structure.
