...
ms.topic: function
f1_keywords: ["tapi/lineGetTranslateCaps"]
req.header: tapi.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/tapi/ns-tapi-linetranslatecaps_tag">LINETRANSLATECAPS</a> structure is loaded. Prior to calling 
