...
Represents a range of pages in a print job. A print job can have more than one page range. This information is supplied in the <a href="https://msdn.microsoft.com/library/ms646844(v=VS.85).aspx">PRINTDLGEX</a> structure when calling the <a href="https://msdn.microsoft.com/library/ms646942(v=VS.85).aspx">PrintDlgEx</a> function.
