...
Contains information about a <a href="https://msdn.microsoft.com/library/ms646862(v=VS.85).aspx">CDN_INCLUDEITEM</a> notification message. 
...
A pointer to an <a href="https://msdn.microsoft.com/library/ms646839(v=VS.85).aspx">OPENFILENAME</a> structure containing the values specified when the <b>Open</b> or <b>Save As</b> dialog box was created. 
...
<a href="https://msdn.microsoft.com/library/ms646862(v=VS.85).aspx">CDN_INCLUDEITEM</a>
...
<a href="https://msdn.microsoft.com/library/ms646836(v=VS.85).aspx">OFNOTIFY</a>
