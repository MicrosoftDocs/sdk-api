...
req.assembly: 
req.type-library: 
req.typenames: CHOOSECOLORW, *LPCHOOSECOLORW, CHOOSECOLORW, *LPCHOOSECOLORW
topic_type:
-	APIRef
-	kbSyntax
api_type:
