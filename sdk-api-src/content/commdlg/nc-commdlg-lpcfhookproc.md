...
Receives messages or notifications intended for the default dialog box procedure of the <b>Font</b> dialog box. This is an application-defined or library-defined callback procedure that is used with the <a href="https://docs.microsoft.com/previous-versions/windows/desktop/legacy/ms646914(v=vs.85)">ChooseFont</a> function.
