...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IWSDAsyncCallback</b> interface inherits from the <a href="/windows/desktop/api/unknwn/nn-unknwn-iunknown">IUnknown</a> interface. <b>IWSDAsyncCallback</b> also has these types of members:
<ul>
...
<a href="/windows/desktop/api/wsdclient/nf-wsdclient-iwsdasynccallback-asyncoperationcomplete">AsyncOperationComplete</a>
</td>
