...
<a href="https://msdn.microsoft.com/library/ms680694(v=VS.85).aspx">OleUIConvert</a> function) that an object is to be converted, the container must take the following steps:
...
<a href="https://msdn.microsoft.com/library/ms695230(v=VS.85).aspx">OleDoAutoConvert</a> to handle any needed object conversion, unless you call 
<a href="https://msdn.microsoft.com/library/ms694338(v=VS.85).aspx">OleLoad</a>, which calls it internally.</li>
</ol>
