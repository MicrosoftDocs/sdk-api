...
The application can identify synthesized messages by calling the <a href="https://msdn.microsoft.com/library/ms644937(v=VS.85).aspx">GetMessageExtraInfo</a> function. For more information about using <b>GetMessageExtraInfo</b> to distinguish between mouse input and Windows Touch input,  see <a href="https://msdn.microsoft.com/dfdc5a97-aa0a-4011-8f61-6e405e28b6f8">Troubleshooting Applications</a>.
