...
The 
<b>IWbemQuery</b> interface provides an entry point through which a <a href="https://www.bing.com/search?q=WMI+Query+Language">WMI Query Language</a> (WQL) query can be parsed. For more information about WQL, see <a href="https://msdn.microsoft.com/72a7ec04-9af3-41ae-9189-6e1d46803fa9">WQL (SQL for WMI</a>).
