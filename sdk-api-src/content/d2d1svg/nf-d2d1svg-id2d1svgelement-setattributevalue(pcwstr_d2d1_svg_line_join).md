...
# ID2D1SvgElement::SetAttributeValue(PCWSTR,D2D1_SVG_LINE_JOIN)
...
Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d2d1svg/ne-d2d1svg-d2d1_svg_line_join">D2D1_SVG_LINE_JOIN</a></b>
