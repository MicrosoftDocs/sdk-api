---
UID: NF:d2d1svg.ID2D1SvgPaint.GetIdLength
title: ID2D1SvgPaint::GetIdLength (d2d1svg.h)
description: Gets the string length of the element id which acts as the paint server. This id is used if the paint type is D2D1_SVG_PAINT_TYPE_URI.
helpviewer_keywords: ["GetIdLength","GetIdLength method [Direct2D]","GetIdLength method [Direct2D]","ID2D1SvgPaint interface","ID2D1SvgPaint interface [Direct2D]","GetIdLength method","ID2D1SvgPaint.GetIdLength","ID2D1SvgPaint::GetIdLength","d2d1svg/ID2D1SvgPaint::GetIdLength","direct2d.id2d1svgpaint_getidlength"]
old-location: direct2d\id2d1svgpaint_getidlength.htm
tech.root: Direct2D
