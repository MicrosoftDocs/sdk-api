...
ms.topic: method
f1_keywords: ["d2d1svg/ID2D1SvgElement.SetAttributeValue"]
...
# ID2D1SvgElement::SetAttributeValue(PCWSTR,D2D1_SVG_VISIBILITY)
...
Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d2d1svg/ne-d2d1svg-d2d1_svg_visibility">D2D1_SVG_VISIBILITY</a></b>
