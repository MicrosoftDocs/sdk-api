---
UID: NF:d2d1svg.ID2D1SvgElement.GetAttributeValue(PCWSTR,D2D1_SVG_PRESERVE_ASPECT_RATIO)
title: ID2D1SvgElement::GetAttributeValue(PCWSTR,D2D1_SVG_PRESERVE_ASPECT_RATIO) (d2d1svg.h)
...
ms.topic: method
f1_keywords: ["d2d1svg/ID2D1SvgElement.GetAttributeValue"]
...
# ID2D1SvgElement::GetAttributeValue(PCWSTR,D2D1_SVG_PRESERVE_ASPECT_RATIO)
...
Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d2d1svg/ns-d2d1svg-d2d1_svg_preserve_aspect_ratio">D2D1_SVG_PRESERVE_ASPECT_RATIO</a>*</b>
