...
The <b>IUnknown_QueryInterface_Proxy</b> function implements the <a href="https://msdn.microsoft.com/library/ms682521(v=VS.85).aspx">QueryInterface</a> method for all interface proxies.
