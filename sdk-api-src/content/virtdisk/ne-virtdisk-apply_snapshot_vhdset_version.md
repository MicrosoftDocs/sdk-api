...
req.irql: 
targetos: Windows
req.typenames: APPLY_SNAPSHOT_VHDSET_VERSION
req.redist: 
ms.custom: 19H1
f1_keywords:
 - _APPLY_SNAPSHOT_VHDSET_VERSION
 - virtdisk/_APPLY_SNAPSHOT_VHDSET_VERSION
...
# APPLY_SNAPSHOT_VHDSET_VERSION enumeration


## -description

Enumerates the possible versions for parameters for the 
    <a href="/windows/win32/api/virtdisk/nf-virtdisk-applysnapshotvhdset">ApplySnapshotVhdSet</a> function.

## -enum-fields

### -field APPLY_SNAPSHOT_VHDSET_VERSION_UNSPECIFIED

Not Supported.

### -field APPLY_SNAPSHOT_VHDSET_VERSION_1
