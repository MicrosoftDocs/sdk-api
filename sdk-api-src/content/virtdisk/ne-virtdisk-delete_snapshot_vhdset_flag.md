...
ms.topic: enum
f1_keywords: ["virtdisk/DELETE_SNAPSHOT_VHDSET_FLAG"]
...
Contains flags affecting the behavior of the <a href="https://docs.microsoft.com/windows/desktop/api/vdssys/nf-vdssys-deletesnapshotvhdset">DeleteSnapshotVhdSet</a> function.
