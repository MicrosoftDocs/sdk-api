...
ms.topic: enum
f1_keywords: ["virtdisk/MERGE_VIRTUAL_DISK_VERSION"]
...
Contains the version of the virtual hard disk (VHD) 
    <a href="https://docs.microsoft.com/windows/desktop/api/vdssys/ns-vdssys-_merge_virtual_disk_parameters">MERGE_VIRTUAL_DISK_PARAMETERS</a> structure to 
