...
ms.topic: interface
f1_keywords: ["dxgi1_4/IDXGIOutput4"]
...
Represents an adapter output (such as a monitor). The <b>IDXGIOutput4</b> interface exposes a method to check for overlay color space support.
