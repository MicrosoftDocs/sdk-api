...
A member of the [SERVICE_REGISTRY_STATE_TYPE](/windows/win32/api/winsvc/ne-winsvc-service_registry_state_type) specifying the state type for which the service registry key is retreived.
