...
<td width="60%">
The event is a custom event generated by an <a href="https://msdn.microsoft.com/library/bb968803.aspx">Event Tracing for Windows</a> (ETW) provider.  This trigger event can be used to start or stop a service.
