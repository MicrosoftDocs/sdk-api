...
A condition variable with no waiting threads is in its initial state and can be copied, moved, and forgotten about with no need to be explicitly destroyed.
