...
ms.topic: method
f1_keywords: ["xpsobjectmodel/IXpsOMObjectFactory.CreatePath"]
...
A pointer to the new <a href="https://docs.microsoft.com/windows/desktop/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsompath">IXpsOMPath</a> interface.
