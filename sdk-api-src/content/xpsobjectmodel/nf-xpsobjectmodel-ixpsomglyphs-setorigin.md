...
The <a href="https://msdn.microsoft.com/en-us/library/Dd372977(v=VS.85).aspx">XPS_POINT</a> structure that contains the coordinates to be set as the text's starting position.
