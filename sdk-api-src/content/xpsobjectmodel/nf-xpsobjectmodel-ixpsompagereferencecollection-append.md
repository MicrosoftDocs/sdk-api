...
ms.topic: method
f1_keywords: ["xpsobjectmodel/IXpsOMPageReferenceCollection.Append"]
...
A pointer to the <a href="https://docs.microsoft.com/windows/desktop/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsompagereference">IXpsOMPageReference</a> interface that is to be appended to the collection.
