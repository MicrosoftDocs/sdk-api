...
ms.topic: method
f1_keywords: ["xpsobjectmodel/IXpsOMVisualCollection.Append"]
...
A pointer to the <a href="https://docs.microsoft.com/windows/desktop/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsomvisual">IXpsOMVisual</a> interface that is to be appended to the collection.
