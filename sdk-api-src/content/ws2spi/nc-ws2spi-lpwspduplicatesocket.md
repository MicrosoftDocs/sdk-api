...
## -description
The <b>LPWSPDuplicateSocket</b> function returns a <b><a href="https://docs.microsoft.com/en-us/windows/win32/api/winsock2/ns-winsock2-wsaprotocol_infoa?redirectedfrom=MSDN">WSAPROTOCOL_INFO</a></b> structure that can be used to create a new socket descriptor for a shared socket.
...
## -returns
If no error occurs, <b>LPWSPDuplicateSocket</b> returns zero. Otherwise, the value of SOCKET_ERROR is returned, and a specific error number is available in <i>lpErrno</i>.
...
<td width="40%">
<dl>                                              
<dt><b><a href="https://docs.microsoft.com/en-us/windows/win32/winsock/windows-sockets-error-codes-2#WSAEMFILE">WSAEMFILE</a></b></dt>
</dl>
</td>
<td width="60%">
...
<dl>                                              
<dt>
5) Calls <b>LPWSPDuplicateSocket</b> to get a special <b><a href="https://docs.microsoft.com/en-us/windows/win32/api/winsock2/ns-winsock2-wsaprotocol_infoa?redirectedfrom=MSDN">WSAPROTOCOL_INFO</a></b> structure.
</dt>
</dl>
</td>
<td width="10%">
