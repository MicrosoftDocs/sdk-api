...
The following example demonstrates the use of the <b>WSCEnumProtocols32</b> function  for use on 64-bit platforms to retrieve an array of <a href="https://docs.microsoft.com/windows/desktop/api/winsock2/ns-winsock2-wsaprotocol_infow">WSAPROTOCOL_INFOW</a> structures for protocols installed on the local computer in the 32-bit catalog.
