...
### -param level [in]
The level at which the option is defined; the supported levels include <b><a href="https://docs.microsoft.com/en-us/windows/win32/winsock/sol-socket-socket-options">SOL_SOCKET</a></b>. For more information, see [Winsock Annexes](winsock-annexes.md).
...
| SO_DONTROUTE                         | BOOL                       | Disabled routing: send directly to an interface. Setting this socket option succeeds but is ignored on AF_INET sockets; fails on AF_INET6 sockets with <a href="https://docs.microsoft.com/en-us/windows/win32/winsock/windows-sockets-error-codes-2#WSAENOPROTOOPT">WSAENOPROTOOPT</a> . This option is not supported on ATM sockets (results in an error). |
| SO_GROUP_PRIORITY                   | int                        | Reserved.                                                                                                                                                                                                                                                                                       |
| <b><a href="https://docs.microsoft.com/en-us/windows/win32/winsock/so-keepalive">SO_KEEPALIVE</a></b> | BOOL                       | Sends keep-alives. Not supported on ATM sockets (results in an error).                                                                                                                                                                                                                          |
...
| SO_REUSEADDR                         | BOOL                       | Allows the socket to be bound to an address that is already in use. (See <b><a href="https://docs.microsoft.com/en-us/windows/win32/api/winsock/nf-winsock-bind">Bind</a></b>.) Not applicable on ATM sockets.                                                                                                                                                                |
...
Calling <b><a href="https://docs.microsoft.com/en-us/windows/win32/api/ws2spi/nc-ws2spi-lpwspgetsockopt">LPWSPGetSockopt</a></b> with an unsupported option will result in an error code of <a href="https://docs.microsoft.com/en-us/windows/win32/winsock/windows-sockets-error-codes-2#WSAENOPROTOOPT">WSAENOPROTOOPT</a>  returned in <i>lpErrno</i>.
