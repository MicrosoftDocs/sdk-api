...
ms.topic: function
f1_keywords: ["ws2spi/WSCRemoveQOSTemplate"]
req.header: ws2spi.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/ws2spi/nf-ws2spi-wscinstallqostemplate">WSCInstallQOSTemplate</a>
 
