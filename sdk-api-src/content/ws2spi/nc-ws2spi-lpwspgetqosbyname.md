...
## -description
The **WSPGetQOSByName** function initializes a <b><a href="/previous-versions/windows/desktop/qos/qos-structures">QOS</a></b> structure based on a named template, or retrieves an enumeration of the available template names.
