...
## -description
The <b>LPWSPShutdown</b> function disables sends and/or receives on a socket.
...
## -returns
If no error occurs, <b>LPWSPShutdown</b> returns zero. Otherwise, a value of SOCKET_ERROR is returned, and a specific error code is available in <i>lpErrno</i>.
...
## -remarks
The <b>LPWSPShutdown</b> function is used on all types of sockets to disable reception, transmission, or both.
