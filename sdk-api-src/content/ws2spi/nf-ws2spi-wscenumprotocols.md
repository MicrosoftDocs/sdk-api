...
helpviewer_keywords: ["WSCEnumProtocols","WSCEnumProtocols function [Winsock]","_win32_wscenumprotocols_2","winsock.wscenumprotocols_2","ws2spi/WSCEnumProtocols"]
...
The **WSCEnumProtocols** function is used to discover information about the collection of transport protocols installed on the local computer. This function differs from its API counterpart (<a href="/windows/desktop/api/winsock2/nf-winsock2-wsaenumprotocolsa">WSAEnumProtocols</a>) in that 
...
The following example demonstrates the use of the **WSCEnumProtocols** function to retrieve an array of <a href="/windows/desktop/api/winsock2/ns-winsock2-wsaprotocol_infow">WSAPROTOCOL_INFOW</a> structures for protocols installed on the local computer.
