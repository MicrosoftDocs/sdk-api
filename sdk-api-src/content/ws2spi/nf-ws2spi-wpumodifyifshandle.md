...
<a href="https://docs.microsoft.com/previous-versions/windows/hardware/network/ff566309(v%3dvs.85)">WSPRecv</a> in the procedure dispatch table it returns at the time of 
...
<a href="https://docs.microsoft.com/previous-versions/windows/hardware/network/ff566296(v%3dvs.85)">WSPIoctl</a> has to be a pass-through operation to the underlying provider.</li>
</ul>
