...
A device is not required to support this method. If this method fails to retrieve a name, try requesting the <a href="https://msdn.microsoft.com/library/ms221160(v=VS.85).aspx">WPD_OBJECT_NAME</a> property of the device object (the object with the ID WPD_DEVICE_OBJECT_ID).
