...
<ul>
<li>The <a href="https://www.bing.com/search?q=WPD_PROPERTY_COMMON_HRESULT">WPD_PROPERTY_COMMON_HRESULT</a> property indicates if the command succeeded.</li>
<li>If the command failed, the <a href="https://www.bing.com/search?q=WPD_PROPERTY_COMMON_DRIVER_ERROR_CODE">WPD_PROPERTY_COMMON_DRIVER_ERROR_CODE</a> property will contain driver-specific error codes.</li>
</ul>
The object referenced by the <i>pParameters</i> parameter must specify at least these properties:

<ul>
<li><a href="https://www.bing.com/search?q=WPD_PROPERTY_COMMON_COMMAND_CATEGORY">WPD_PROPERTY_COMMON_COMMAND_CATEGORY</a>, which should contain a command category, such as the <b>fmtid</b> member of the <a href="https://msdn.microsoft.com/library/windows/hardware/ff597754">WPD_COMMAND_COMMON_RESET_DEVICE</a> property</li>
<li><a href="https://www.bing.com/search?q=WPD_PROPERTY_COMMON_COMMAND_ID">WPD_PROPERTY_COMMON_COMMAND_ID</a>, which should contain a command identifier, such as the <b>pid</b> member of the  <a href="https://msdn.microsoft.com/library/windows/hardware/ff597754">WPD_COMMAND_COMMON_RESET_DEVICE</a> property.</li>
</ul>
