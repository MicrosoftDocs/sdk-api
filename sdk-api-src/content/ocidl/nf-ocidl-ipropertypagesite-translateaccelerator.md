...
ms.topic: method
f1_keywords: ["ocidl/IPropertyPageSite.TranslateAccelerator"]
req.header: ocidl.h
req.include-header: 
...
A pointer to the <a href="https://docs.microsoft.com/windows/desktop/api/winuser/ns-winuser-tagmsg">MSG</a> structure to be processed.
