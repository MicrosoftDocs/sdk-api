...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IQuickActivate</b> interface inherits from the <a href="iunknown.htm">IUnknown</a> interface. <b>IQuickActivate</b> also has these types of members:
<ul>
