...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IEnumConnectionPoints</b> interface inherits from the <a href="https://msdn.microsoft.com/library/ms680509(v=VS.85).aspx">IUnknown</a> interface. <b>IEnumConnectionPoints</b> also has these types of members:
<ul>
