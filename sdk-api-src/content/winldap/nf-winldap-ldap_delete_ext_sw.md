...
ms.topic: function
f1_keywords: ["winldap/ldap_delete_ext_s"]
...
<a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/winldap/nf-winldap-ldap_delete_s">ldap_delete_s</a>
 
