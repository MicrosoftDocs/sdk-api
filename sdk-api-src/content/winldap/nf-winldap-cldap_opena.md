...
description: Establishes a session with an LDAP server over a connectionless User Datagram Protocol (UDP) service. (cldap_openA)
helpviewer_keywords: ["cldap_openA", "ldap.cldap__open", "winldap/cldap_openA"]
