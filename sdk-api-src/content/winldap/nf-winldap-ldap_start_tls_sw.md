...
description: Used in an active LDAP session to begin using TLS encryption. (Unicode)
helpviewer_keywords: ["ldap.ldap_start_tls_s", "ldap_start_tls_s", "ldap_start_tls_s function [LDAP]", "ldap_start_tls_sW", "winldap/ldap_start_tls_s", "winldap/ldap_start_tls_sW"]
