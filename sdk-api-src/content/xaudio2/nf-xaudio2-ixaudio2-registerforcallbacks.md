...
Adds an <a href="https://msdn.microsoft.com/library/Ee415910(v=VS.85).aspx">IXAudio2EngineCallback</a> pointer to the <a href="https://msdn.microsoft.com/library/Ee415908(v=VS.85).aspx">XAudio2</a> engine callback list.
...
<a href="https://msdn.microsoft.com/library/Ee415910(v=VS.85).aspx">IXAudio2EngineCallback</a> pointer to add to the <a href="https://msdn.microsoft.com/library/Ee415908(v=VS.85).aspx">XAudio2</a> engine callback list.
...
It is invalid to call <b>RegisterForCallbacks</b> from within a callback (that is, <a href="https://msdn.microsoft.com/library/Ee415910(v=VS.85).aspx">IXAudio2EngineCallback</a> or <a href="https://msdn.microsoft.com/library/Ee415919(v=VS.85).aspx">IXAudio2VoiceCallback</a>). If <b>RegisterForCallbacks</b> is called within a callback, it returns XAUDIO2_E_INVALID_CALL.
