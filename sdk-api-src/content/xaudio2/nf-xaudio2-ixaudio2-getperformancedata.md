...
On success, pointer to an <a href="https://msdn.microsoft.com/library/Ee419239(v=VS.85).aspx">XAUDIO2_PERFORMANCE_DATA</a> structure that is returned. 
...
For specific information on the statistics returned by <b>GetPerformanceData</b>, see the <a href="https://msdn.microsoft.com/library/Ee419239(v=VS.85).aspx">XAUDIO2_PERFORMANCE_DATA</a> structure reference.
