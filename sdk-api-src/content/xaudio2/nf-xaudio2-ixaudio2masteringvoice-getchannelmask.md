...
The <i>pChannelMask</i> argument is a bit-mask of the various channels in the speaker geometry reported by the audio system. This information is needed for the <a href="https://msdn.microsoft.com/library/Ee419053(v=VS.85).aspx">X3DAudioInitialize</a> <i>SpeakerChannelMask</i> parameter.
...
<a href="https://msdn.microsoft.com/library/Ee415912(v=VS.85).aspx">IXAudio2MasteringVoice</a>
 
