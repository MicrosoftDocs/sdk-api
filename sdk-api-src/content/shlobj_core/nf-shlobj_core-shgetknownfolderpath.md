...
ms.topic: function
f1_keywords: ["shlobj_core/SHGetKnownFolderPath"]
...
Retrieves the full path of a known folder identified by the folder's <a href="https://docs.microsoft.com/windows/desktop/shell/knownfolderid">KNOWNFOLDERID</a>.
