...
description: The GetFileNameFromBrowse function creates an Open dialog box so that the user can specify the drive, directory, and name of a file to open. (GetFileNameFromBrowse)
...
f1_keywords:
 ...
 - shlobj_core/GetFileNameFromBrowse
dev_langs:
 - c++
topic_type:
 - APIRef
