...
Returns a null-terminated Unicode string that is the localized string. The calling application must free the returned string by calling <a href="https://msdn.microsoft.com/library/ms680722(v=VS.85).aspx">CoTaskMemFree</a>. If the method does not succeed, this parameter is set to <b>NULL</b>.
