...
Type: <b><a href="https://msdn.microsoft.com/library/Bb231326(v=VS.85).aspx">ISchemaProvider</a>**</b>
              ...
              Receives the address of a pointer to an <a href="https://msdn.microsoft.com/library/Bb231326(v=VS.85).aspx">ISchemaProvider</a> object. The calling application must release it by invoking its <a href="https://msdn.microsoft.com/library/Dd757102(v=VS.85).aspx">IUnknown::Release</a> method.
