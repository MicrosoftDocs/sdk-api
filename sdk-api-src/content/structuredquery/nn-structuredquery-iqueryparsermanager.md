...
Provides methods to create, initialize, and change options for an <a href="https://msdn.microsoft.com/library/Bb231353(v=VS.85).aspx">IQueryParser</a> object.
...
<a href="https://msdn.microsoft.com/library/Bb231347(v=VS.85).aspx">CreateLoadedParser</a>
</td>
...
<tr data="declared;">
<td align="left" width="37%">
<a href="https://msdn.microsoft.com/library/Bb231348(v=VS.85).aspx">InitializeOptions</a>
</td>
<td align="left" width="63%">
...
<tr data="declared;">
<td align="left" width="37%">
<a href="https://msdn.microsoft.com/library/Bb231350(v=VS.85).aspx">SetOption</a>
</td>
<td align="left" width="63%">
