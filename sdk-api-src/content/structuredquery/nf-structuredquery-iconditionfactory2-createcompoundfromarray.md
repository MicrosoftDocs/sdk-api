...
## -description
          ...
          Creates a leaf condition node that is a conjunction (AND) or a disjunction (OR) from an array of condition nodes. The returned object supports             <a href="https://msdn.microsoft.com/library/Bb231395(v=VS.85).aspx">ICondition</a> and <a href="https://msdn.microsoft.com/library/Dd742811(v=VS.85).aspx">ICondition2</a>.
...
Type: <b><a href="https://msdn.microsoft.com/library/Aa965692(v=VS.85).aspx">CONDITION_TYPE</a></b>

A <a href="https://msdn.microsoft.com/library/Aa965692(v=VS.85).aspx">CONDITION_TYPE</a> enumeration that must be set to either the <i>CT_AND_CONDITION</i> or <i>CT_OR_CONDITION</i> flag.
...
The desired IID of the enumerating interface: either <a href="https://msdn.microsoft.com/library/ms683764(v=VS.85).aspx">IEnumUnknown</a>, IID_IEnumVARIANT, or (for a negation condition) IID_ICondition.
...
A collection of zero or more <a href="https://msdn.microsoft.com/library/Bb231395(v=VS.85).aspx">ICondition</a> and <a href="https://msdn.microsoft.com/library/Dd742811(v=VS.85).aspx">ICondition2</a> objects.
...
Each element of the <i>ppCondSubs</i> parameter must implement <a href="https://msdn.microsoft.com/library/Bb231395(v=VS.85).aspx">ICondition</a>. 
