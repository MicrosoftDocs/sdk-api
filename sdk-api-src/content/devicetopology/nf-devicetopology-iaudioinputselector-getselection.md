...
title: IAudioInputSelector::GetSelection method
...
ms.date: 3/30/2018
ms.keywords: GetSelection method [Core Audio], GetSelection method [Core Audio], IAudioInputSelector interface, GetSelection,IAudioInputSelector.GetSelection, IAudioInputSelector, IAudioInputSelector interface [Core Audio], GetSelection method, IAudioInputSelector::GetSelection, IAudioInputSelectorGetSelection, coreaudio.iaudioinputselector_getselection, devicetopology/IAudioInputSelector::GetSelection
