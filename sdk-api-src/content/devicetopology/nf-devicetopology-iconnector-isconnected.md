...
title: IConnector::IsConnected method
...
ms.date: 4/4/2018
ms.keywords: IConnector, IConnector interface [Core Audio], IsConnected method, IConnector::IsConnected, IConnectorIsConnected, IsConnected method [Core Audio], IsConnected method [Core Audio], IConnector interface, IsConnected,IConnector.IsConnected, coreaudio.iconnector_isconnected, devicetopology/IConnector::IsConnected
