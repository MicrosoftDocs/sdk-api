...
Contains information associated with an <a href="https://msdn.microsoft.com/library/Bb787987(v=VS.85).aspx">EN_SELCHANGE</a> notification code. A rich edit control sends this notification to its parent window when the current selection changes.
...
<a href="https://msdn.microsoft.com/library/Bb787987(v=VS.85).aspx">EN_SELCHANGE</a>
 
