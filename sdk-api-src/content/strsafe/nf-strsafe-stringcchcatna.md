...
description: Concatenates the specified number of characters from one string to another string. (StringCchCatNA)
helpviewer_keywords: ["StringCchCatNA", "strsafe/StringCchCatNA"]
