...
ms.topic: function
f1_keywords: ["strsafe/StringCchPrintf_l"]
...
<b>StringCchPrintf_l</b> is similar to <a href="https://docs.microsoft.com/windows/desktop/api/strsafe/nf-strsafe-stringcchprintfa">StringCchPrintf</a> but includes a parameter for locale information.
...
Neither <i>pszFormat</i> nor <i>pszDest</i> should be <b>NULL</b>. See <a href="https://docs.microsoft.com/windows/desktop/api/strsafe/nf-strsafe-stringcchprintf_lexa">StringCchPrintf_lEx</a> if you require the handling of null string pointer values.
