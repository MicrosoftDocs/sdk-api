...
description: Determines whether a string exceeds the specified length, in bytes. (Unicode)
helpviewer_keywords: ["StringCbLength", "StringCbLength function [Menus and Other Resources]", "StringCbLengthW", "UnalignedStringCbLength", "_shell_StringCbLength", "_shell_stringcblength_cpp", "menurc.stringcblength", "strsafe/StringCbLength", "strsafe/StringCbLengthW", "winui._shell_stringcblength"]
