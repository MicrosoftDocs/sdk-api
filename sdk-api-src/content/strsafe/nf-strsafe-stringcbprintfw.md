...
ms.topic: function
f1_keywords: ["strsafe/StringCbPrintf"]
...
Neither <i>pszFormat</i> nor <i>pszDest</i> should be <b>NULL</b>. See <a href="https://docs.microsoft.com/windows/desktop/api/strsafe/nf-strsafe-stringcbprintfexa">StringCbPrintfEx</a> if you require the handling of null string pointer values.
