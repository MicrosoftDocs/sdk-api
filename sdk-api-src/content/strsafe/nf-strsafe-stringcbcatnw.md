...
Compared to  the functions it replaces, <b>StringCbCatN</b> provides additional processing for proper buffer handling in your code. Poor buffer handling is implicated in many security issues that involve buffer overruns. <b>StringCbCatN</b>
...
Neither <i>pszSrc</i> nor <i>pszDest</i> should be <b>NULL</b>. See <a href="https://msdn.microsoft.com/library/ms647498(v=VS.85).aspx">StringCbCatNEx</a> if you require the handling of null string pointer values.
