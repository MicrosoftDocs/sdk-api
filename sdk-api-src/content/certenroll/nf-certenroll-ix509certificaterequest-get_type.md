...
You can use this property with the <a href="https://msdn.microsoft.com/en-us/library/Aa377662(v=VS.85).aspx">GetInnerRequest</a> method to determine the type of the inner request object.
