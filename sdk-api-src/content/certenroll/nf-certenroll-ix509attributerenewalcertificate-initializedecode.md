...
ms.topic: method
f1_keywords: ["certenroll/IX509AttributeRenewalCertificate.InitializeDecode"]
...
The <b>InitializeDecode</b> method initializes the object from a  <a href="https://docs.microsoft.com/windows/desktop/SecGloss/d-gly">Distinguished Encoding Rules</a> (DER) encoded byte array that contains the certificate to be renewed. The byte array is represented by a Unicode-encoded string.
