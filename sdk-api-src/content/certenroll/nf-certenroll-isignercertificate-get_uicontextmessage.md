...
description: Specifies or retrieves a string that contains user interface text associated with the signing certificate. (Get)
...
f1_keywords:
 ...
 - certenroll/ISignerCertificate::get_UIContextMessage
dev_langs:
 - c++
topic_type:
 - APIRef
