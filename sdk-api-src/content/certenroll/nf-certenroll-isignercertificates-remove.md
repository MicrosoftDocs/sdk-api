...
ms.topic: method
f1_keywords: ["certenroll/ISignerCertificates.Remove"]
...
The <b>Remove</b> method removes an <a href="https://docs.microsoft.com/windows/desktop/api/certenroll/nn-certenroll-isignercertificate">ISignerCertificate</a> object from the collection by index number.
