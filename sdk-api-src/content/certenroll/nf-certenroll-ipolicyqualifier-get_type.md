...
You must call  <a href="https://msdn.microsoft.com/en-us/library/Aa376813(v=VS.85).aspx">InitializeEncode</a> to initialize the qualifier object before you can retrieve this property. The value retrieved is one of the following  values of the <a href="https://msdn.microsoft.com/en-us/library/Aa379084(v=VS.85).aspx">PolicyQualifierType</a> enumeration.<table>
<tr>
<th>Value</th>
<th>Description</th>
</tr>
