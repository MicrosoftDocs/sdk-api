...
The <b>InitializeFromName</b> method initializes the object from a  <a href="https://msdn.microsoft.com/en-us/library/Aa374855(v=VS.85).aspx">CERTENROLL_OBJECTID</a> enumeration value. This method is web enabled.
...
A <a href="https://msdn.microsoft.com/en-us/library/Aa374855(v=VS.85).aspx">CERTENROLL_OBJECTID</a> enumeration value.
