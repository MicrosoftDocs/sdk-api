...
description: Specifies or retrieves a string that contains a message associated with the status of the enrollment process. (Put)
...
f1_keywords:
 ...
 - certenroll/IX509EnrollmentStatus::put_Text
dev_langs:
 - c++
topic_type:
 - APIRef
