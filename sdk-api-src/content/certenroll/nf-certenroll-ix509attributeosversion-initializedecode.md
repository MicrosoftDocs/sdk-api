...
ms.topic: method
f1_keywords: ["certenroll/IX509AttributeOSVersion.InitializeDecode"]
...
The <b>InitializeDecode</b> method initializes the object from a  <a href="https://docs.microsoft.com/windows/desktop/SecGloss/d-gly">Distinguished Encoding Rules</a> (DER) encoded byte array that contains the operating system version information.  The byte array is represented by a Unicode-encoded string.
