...
A value from the <a href="https://msdn.microsoft.com/en-us/library/Aa379074(v=VS.85).aspx">Pkcs10AllowedSignatureTypes</a> enumeration. This can be a bitwise combination of the following values.
