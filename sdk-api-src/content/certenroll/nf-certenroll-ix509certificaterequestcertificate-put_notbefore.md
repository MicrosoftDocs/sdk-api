...
title: IX509CertificateRequestCertificate::put_NotBefore (certenroll.h)
description: Specifies or retrieves the date and time before which the certificate is not valid. (Put)
...
f1_keywords:
 ...
 - certenroll/IX509CertificateRequestCertificate::put_NotBefore
dev_langs:
 - c++
topic_type:
 - APIRef
