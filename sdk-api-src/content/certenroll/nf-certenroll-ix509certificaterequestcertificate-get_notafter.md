...
title: IX509CertificateRequestCertificate::get_NotAfter (certenroll.h)
description: Specifies or retrieves the date and time after which the certificate is no longer valid. (Get)
...
f1_keywords:
 ...
 - certenroll/IX509CertificateRequestCertificate::get_NotAfter
dev_langs:
 - c++
topic_type:
 - APIRef
