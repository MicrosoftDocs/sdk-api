...
ms.topic: macro
f1_keywords: ["http/HTTP_GREATER_VERSION"]
req.header: http.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/http/ns-http-_httpapi_version">HTTPAPI_VERSION</a> structure is greater than a specified major/minor version combination, or zero otherwise.
