...
ms.topic: macro
f1_keywords: ["http/HTTP_NOT_EQUAL_VERSION"]
req.header: http.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/http/ns-http-_http_version">HTTP_VERSION</a> structure is greater or less than a specified major/minor version combination, or zero if it is equal.
