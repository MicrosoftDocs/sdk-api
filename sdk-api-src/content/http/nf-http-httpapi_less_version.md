...
<a href="https://docs.microsoft.com/windows/desktop/api/http/ns-http-_httpapi_version">HTTPAPI_VERSION</a> structure is less than a specified major/minor version combination, or zero otherwise.
