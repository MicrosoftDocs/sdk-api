...
description: The put_MeasurementPeriod method (tapi3.h) sets the period (in seconds) for which the switch and/or implementation stores and calculates information.
...
f1_keywords:
 ...
 - tapi3/ITAgent::put_MeasurementPeriod
dev_langs:
 - c++
topic_type:
 - APIRef
