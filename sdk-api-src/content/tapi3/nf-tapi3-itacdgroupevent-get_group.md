...
description: The ITACDGroupEvent::get_Group method (tapi3.h) gets the ITACDGroup interface pointer for the group on which the event occurred.
...
f1_keywords:
 ...
 - tapi3/ITACDGroupEvent::get_Group
dev_langs:
 - c++
topic_type:
 - APIRef
