...
description: The ITACDGroup::get_Queues method (tapi3.h) for Automation client applications creates a collection of queues associated with the current ACD group.
