...
description: The get_AgentHandlers method creates a collection of agent handlers that are currently associated with the call center. (ITTAPICallCenter.get_AgentHandlers)
...
f1_keywords:
 ...
 - tapi3/ITTAPICallCenter::get_AgentHandlers
dev_langs:
 - c++
topic_type:
 - APIRef
