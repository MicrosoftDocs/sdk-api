...
description: The ITQueue::get_LongestEverWaitTime (tapi3.h) method gets the longest time any call waited in the queue (in seconds) during the current measurement period.
