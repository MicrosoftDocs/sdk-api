---
UID: NF:tapi3.ITAgentSession.get_TotalWrapUpTime
title: ITAgentSession::get_TotalWrapUpTime (tapi3.h)
description: The ITAgentSession::get_TotalWrapUpTime (tapi3.h) method gets the number of seconds spent on ACD call wrap-up (after-call work) during this agent session.
...
f1_keywords:
 ...
 - tapi3/ITAgentSession::get_TotalWrapUpTime
dev_langs:
 - c++
topic_type:
 - APIRef
