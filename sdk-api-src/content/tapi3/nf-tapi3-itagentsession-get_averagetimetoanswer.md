...
description: The get_AverageTimeToAnswer method gets the average time (in seconds) that calls waited to be answered. (ITAgentSession.get_AverageTimeToAnswer)
