...
ms.topic: method
f1_keywords: ["tapi3/ITAgentSession.get_Address"]
req.header: tapi3.h
...
<a href="https://docs.microsoft.com/windows/desktop/api/tapi3if/nn-tapi3if-itaddress">ITAddress</a> interface associated with this session.
