...
ms.date: 3/27/2018
ms.keywords: IEnumAgent, IEnumAgent interface [TAPI 2.2], Next method, IEnumAgent::Next, Next method [TAPI 2.2], Next method [TAPI 2.2], IEnumAgent interface, Next,IEnumAgent.Next, _tapi3_ienumagent_next, tapi3.ienumagent_next, tapi3cc/IEnumAgent::Next
...
Pointer to 
<a href="https://msdn.microsoft.com/6c1409c9-da73-4d21-bf56-07e9ab7b33a0">ITAgent</a> pointer.
...
<a href="https://msdn.microsoft.com/6c1409c9-da73-4d21-bf56-07e9ab7b33a0">ITAgent</a> interface returned by <b>IEnumAgent::Next</b>. The application must call <b>Release</b> on the 
