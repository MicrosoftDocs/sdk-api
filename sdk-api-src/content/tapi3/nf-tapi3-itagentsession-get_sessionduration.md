...
title: ITAgentSession::get_SessionDuration (tapi3.h)
description: The ITAgentSession::get_SessionDuration (tapi3.h) method gets the duration of the Agent session in seconds.
...
f1_keywords:
 ...
 - tapi3/ITAgentSession::get_SessionDuration
dev_langs:
 - c++
topic_type:
 - APIRef
