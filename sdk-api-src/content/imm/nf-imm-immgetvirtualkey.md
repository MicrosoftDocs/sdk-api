...
If <a href="https://msdn.microsoft.com/library/ms644955(v=VS.85).aspx">TranslateMessage</a> has been called by the application, <b>ImmGetVirtualKey</b> returns VK_PROCESSKEY; otherwise, it returns the virtual key.
...
the <a href="https://msdn.microsoft.com/library/ms646280(v=VS.85).aspx">WM_KEYDOWN</a> (VK_PROCESSKEY) message, and before <a href="https://msdn.microsoft.com/library/ms644955(v=VS.85).aspx">TranslateMessage</a> is called in its own 
