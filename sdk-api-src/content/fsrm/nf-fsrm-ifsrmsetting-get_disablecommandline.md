...
description: Retrieves or sets a value that determines whether FSRM prevents command line actions from running. (Get)
...
f1_keywords:
 ...
 - fsrm/IFsrmSetting::get_DisableCommandLine
dev_langs:
 - c++
topic_type:
 - APIRef
