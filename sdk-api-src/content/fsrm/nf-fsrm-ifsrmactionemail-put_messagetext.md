...
title: IFsrmActionEmail::put_MessageText method
...
-	SrmSvc.dll
api_name:
-	IFsrmActionEmail2.MessageText
-	IFsrmActionEmail2.get_MessageText
-	IFsrmActionEmail2.put_MessageText
-	IFsrmActionEmail.MessageText
...
# IFsrmActionEmail::put_MessageText method
...
Retrieves or sets the message text of the email that is sent when this action generates 
    email.
