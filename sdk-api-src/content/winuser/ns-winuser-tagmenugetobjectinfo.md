...
The <b>MENUGETOBJECTINFO</b> structure is used only in drag-and-drop menus. When the 
				<a href="https://msdn.microsoft.com/library/ms647607(v=VS.85).aspx">WM_MENUGETOBJECT</a>  message is sent, 
				<i>lParam</i> is a pointer to this structure. 

To create a drag-and-drop menu, call <a href="https://msdn.microsoft.com/library/ms647997(v=VS.85).aspx">SetMenuInfo</a> with <b>MNS_DRAGDROP</b> set.
...
<a href="https://msdn.microsoft.com/library/ms647997(v=VS.85).aspx">SetMenuInfo</a>
 
