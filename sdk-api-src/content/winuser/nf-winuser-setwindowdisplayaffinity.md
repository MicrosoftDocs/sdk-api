...
## -remarks
		...
		This function and <a href="https://msdn.microsoft.com/library/Dd375338(v=VS.85).aspx">GetWindowDisplayAffinity</a> are designed to support the window content protection feature that is new to Windows 7. This feature enables applications to protect their
		...
		and <a href="https://msdn.microsoft.com/library/Dd375338(v=VS.85).aspx">GetWindowDisplayAffinity</a>, and other necessary functions such as <a href="https://msdn.microsoft.com/library/Aa969518(v=VS.85).aspx">DwmIsCompositionEnabled</a>, will strictly protect windowed content, for example where someone takes a photograph of the screen.
...
<a href="https://msdn.microsoft.com/library/Dd375340(v=VS.85).aspx">SetWindowDisplayAffinity</a>
