...
Sets the thread's <a href="hidpi._dpi_hosting_behavior">DPI_HOSTING_BEHAVIOR</a>. This behavior allows windows created in the thread to host child windows with a different <b>DPI_AWARENESS_CONTEXT</b>.
...
The new <a href="hidpi._dpi_hosting_behavior">DPI_HOSTING_BEHAVIOR</a> value for the current thread.
