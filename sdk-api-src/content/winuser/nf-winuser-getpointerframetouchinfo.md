...
ms.topic: function
f1_keywords: ["winuser/GetPointerFrameTouchInfo"]
...
Gets the entire frame of touch-based information for the specified pointers (of type <a href="https://docs.microsoft.com/windows/desktop/api/winuser/ne-winuser-tagpointer_input_type">PT_TOUCH</a>) associated with the current message. 
...
Address of an array of <a href="https://docs.microsoft.com/windows/desktop/api/winuser/ns-winuser-tagpointer_touch_info">POINTER_TOUCH_INFO</a> structures to receive the pointer information. This parameter can be NULL if <i>*pointerCount</i> is zero.
