...
A handle to the <a href="https://msdn.microsoft.com/library/ms645562(v=VS.85).aspx">RAWINPUT</a> structure. This comes from the 
					<i>lParam</i> in <a href="https://msdn.microsoft.com/library/ms645590(v=VS.85).aspx">WM_INPUT</a>. 
...
<td width="60%">
Get the header information from the <a href="https://msdn.microsoft.com/library/ms645562(v=VS.85).aspx">RAWINPUT</a> structure.
...
<td width="60%">
Get the raw data from the <a href="https://msdn.microsoft.com/library/ms645562(v=VS.85).aspx">RAWINPUT</a> structure.
...
A pointer to the data that comes from the <a href="https://msdn.microsoft.com/library/ms645562(v=VS.85).aspx">RAWINPUT</a> structure. This depends on the value of 
					<i>uiCommand</i>. If 
...
<b>GetRawInputData</b> gets the raw input one <a href="https://msdn.microsoft.com/library/ms645562(v=VS.85).aspx">RAWINPUT</a> structure at a time. In contrast, <a href="https://msdn.microsoft.com/library/ms645595(v=VS.85).aspx">GetRawInputBuffer</a> gets an array of <b>RAWINPUT</b> structures.
