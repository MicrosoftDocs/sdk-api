...
Defines the message parameters passed to a <b>WH_CALLWNDPROC</b> hook procedure, <a href="https://msdn.microsoft.com/library/ms644975(v=VS.85).aspx">CallWndProc</a>. 
