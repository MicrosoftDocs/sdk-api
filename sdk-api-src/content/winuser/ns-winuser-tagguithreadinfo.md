...
This structure is used with the <a href="https://msdn.microsoft.com/library/ms633506(v=VS.85).aspx">GetGUIThreadInfo</a> function to retrieve information about the active window or a specified GUI thread. 
