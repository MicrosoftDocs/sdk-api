...
If the target window is owned by the current process, <b>GetWindowTextLength</b> causes a <a href="https://msdn.microsoft.com/library/ms632628(v=VS.85).aspx">WM_GETTEXTLENGTH</a> message to be sent to the specified window or control. 
...
To obtain the exact length of the text, use the <a href="https://msdn.microsoft.com/library/ms632627(v=VS.85).aspx">WM_GETTEXT</a>, <a href="https://msdn.microsoft.com/library/Bb761313(v=VS.85).aspx">LB_GETTEXT</a>, or <a href="https://msdn.microsoft.com/library/Bb775862(v=VS.85).aspx">CB_GETLBTEXT</a> messages, or the <a href="https://msdn.microsoft.com/library/ms633520(v=VS.85).aspx">GetWindowText</a> function.
...
<a href="https://msdn.microsoft.com/library/ms632628(v=VS.85).aspx">WM_GETTEXTLENGTH</a>
