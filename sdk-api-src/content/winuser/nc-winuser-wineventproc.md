...
The <a href="/windows/desktop/api/winuser/nc-winuser-wineventproc.md">WINEVENTPROC</a> type defines a pointer to this callback function. <i>WinEventProc</i> is a placeholder for the application-defined function name.
