...
Hiding is cumulative. If your application calls <a href="https://msdn.microsoft.com/library/ms648403(v=VS.85).aspx">HideCaret</a> five times in a row, it must also call <b>ShowCaret</b> five times before the caret reappears. 
