...
For information about keyboard types, subtypes, scan code modes, see the documentation in *i8042prt.h* header in Windows Driver Kit (WDK) and *ntddkbd.h* header in Windows SDK.
