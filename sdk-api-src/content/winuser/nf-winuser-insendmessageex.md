...
<td width="60%">
The message was sent using the <a href="https://msdn.microsoft.com/library/ms644951(v=VS.85).aspx">SendMessageCallback</a> function. The thread that sent the message is not blocked.
...
<td width="60%">
The message was sent using the <a href="https://msdn.microsoft.com/library/ms644953(v=VS.85).aspx">SendNotifyMessage</a> function. The thread that sent the message is not blocked.
...
<td width="60%">
The message was sent using the <a href="https://msdn.microsoft.com/library/windows/hardware/jj151552">SendMessage</a> or <a href="https://msdn.microsoft.com/library/ms644952(v=VS.85).aspx">SendMessageTimeout</a> function. If <b>ISMEX_REPLIED</b> is not set, the thread that sent the message is blocked.
