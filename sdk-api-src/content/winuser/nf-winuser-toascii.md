...
The buffer that receives the translated character or characters packed into a single <b>WORD</b> value. The low-order byte contains first character and the high-order byte contains second character, if present.
