...
Contains information about a window that denied a request from <a href="https://msdn.microsoft.com/library/ms644933(v=VS.85).aspx">BroadcastSystemMessageEx</a>. 
...
A desktop handle to the window specified by 
					<b>hwnd</b>. This value is returned only if <a href="https://msdn.microsoft.com/library/ms644933(v=VS.85).aspx">BroadcastSystemMessageEx</a> specifies <b>BSF_RETURNHDESK</b> and <b>BSF_QUERY</b>. 
...
A handle to the window that denied the request. This value is returned if <a href="https://msdn.microsoft.com/library/ms644933(v=VS.85).aspx">BroadcastSystemMessageEx</a> specifies <b>BSF_QUERY</b>. 
