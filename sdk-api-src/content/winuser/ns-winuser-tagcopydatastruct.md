...
Contains data to be passed to another application by the <a href="https://msdn.microsoft.com/library/ms649011(v=VS.85).aspx">WM_COPYDATA</a> message. 
...
<a href="https://msdn.microsoft.com/library/ms649011(v=VS.85).aspx">WM_COPYDATA</a>
 
