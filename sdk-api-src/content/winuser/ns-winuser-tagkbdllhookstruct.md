...
A <a href="https://msdn.microsoft.com/library/Dd375731(v=VS.85).aspx">virtual-key code</a>. The code must be a value in the range 1 to 254. 
...
The time stamp for this message, equivalent to what <a href="https://msdn.microsoft.com/library/ms644939(v=VS.85).aspx">GetMessageTime</a> would return for this message.
