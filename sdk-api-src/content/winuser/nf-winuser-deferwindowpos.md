...
Updates the specified multiple-window 
			– position structure for the specified window. The function then returns a handle to the updated structure. The <a href="https://msdn.microsoft.com/library/ms633440(v=VS.85).aspx">EndDeferWindowPos</a> function uses the information in this structure to change the position and size of a number of windows simultaneously. The <a href="https://msdn.microsoft.com/library/ms632672(v=VS.85).aspx">BeginDeferWindowPos</a> function creates the structure. 
...
A handle to a multiple-window 
					– position structure that contains size and position information for one or more windows. This structure is returned by <a href="https://msdn.microsoft.com/library/ms632672(v=VS.85).aspx">BeginDeferWindowPos</a> or by the most recent call to <b>DeferWindowPos</b>. 
...
The return value identifies the updated multiple-window 
						– position structure. The handle returned by this function may differ from the handle passed to the function. The new handle that this function returns should be passed during the next call to the <b>DeferWindowPos</b> or <a href="https://msdn.microsoft.com/library/ms633440(v=VS.85).aspx">EndDeferWindowPos</a> function. 
...
If a call to <b>DeferWindowPos</b> fails, the application should abandon the window-positioning operation and not call <a href="https://msdn.microsoft.com/library/ms633440(v=VS.85).aspx">EndDeferWindowPos</a>. 
