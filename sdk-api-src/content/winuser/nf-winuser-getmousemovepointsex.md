...
The size, in bytes, of the <a href="https://msdn.microsoft.com/library/ms645603(v=VS.85).aspx">MOUSEMOVEPOINT</a> structure. 
...
A pointer to a <a href="https://msdn.microsoft.com/library/ms645603(v=VS.85).aspx">MOUSEMOVEPOINT</a> structure containing valid mouse coordinates (in screen coordinates). It may also contain a time stamp. 
...
An application should call this function using the mouse coordinates received from the <a href="https://msdn.microsoft.com/library/ms645616(v=VS.85).aspx">WM_MOUSEMOVE</a> message and convert them to screen coordinates. 
...
<ul>
<li>If negative coordinates are passed in the <a href="https://msdn.microsoft.com/library/ms645603(v=VS.85).aspx">MOUSEMOVEPOINT</a> structure. </li>
...
<a href="https://msdn.microsoft.com/library/ms645603(v=VS.85).aspx">MOUSEMOVEPOINT</a>
