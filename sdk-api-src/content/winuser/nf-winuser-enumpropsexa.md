...
A pointer to the callback function. For more information about the callback function, see the <a href="https://msdn.microsoft.com/library/ms633566(v=VS.85).aspx">PropEnumProcEx</a> function. 
...
For an example, see <a href="https://msdn.microsoft.com/library/ms633561(v=VS.85).aspx">Listing Window Properties for a Given Window</a>.
...
<a href="https://msdn.microsoft.com/library/ms633566(v=VS.85).aspx">PropEnumProcEx</a>
