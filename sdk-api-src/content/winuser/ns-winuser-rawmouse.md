...
The device-specific additional information for the event. See [Distinguishing Pen Input from Mouse and Touch](/windows/win32/tablet/system-events-and-mouse-messages#distinguishing-pen-input-from-mouse-and-touch) for more info.
