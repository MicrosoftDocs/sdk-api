...
Before closing, an application must call the <a href="https://msdn.microsoft.com/library/ms648063(v=VS.85).aspx">DestroyIcon</a> function to free any system resources associated with the icon.
