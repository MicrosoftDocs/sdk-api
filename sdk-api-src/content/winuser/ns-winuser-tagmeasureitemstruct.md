...
The identifier for a menu item or the position of a list box or combo box item. This value is specified for a list box only if it has the <a href="https://msdn.microsoft.com/library/Bb775149(v=VS.85).aspx">LBS_OWNERDRAWVARIABLE</a> style; this value is specified for a combo box only if it has the <a href="https://msdn.microsoft.com/library/Bb775796(v=VS.85).aspx">CBS_OWNERDRAWVARIABLE</a> style. 
