...
A handle to the parent window whose child windows are to be enumerated. If this parameter is <b>NULL</b>, this function is equivalent to <a href="https://msdn.microsoft.com/library/ms633497(v=VS.85).aspx">EnumWindows</a>.
...
A pointer to an application-defined callback function. For more information, see <a href="https://msdn.microsoft.com/library/ms633493(v=VS.85).aspx">EnumChildProc</a>. 
...
<a href="https://msdn.microsoft.com/library/ms633493(v=VS.85).aspx">EnumChildProc</a>



<a href="https://msdn.microsoft.com/library/ms633495(v=VS.85).aspx">EnumThreadWindows</a>
