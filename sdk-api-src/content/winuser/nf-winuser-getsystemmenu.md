...
Menu items on the window menu send <a href="https://msdn.microsoft.com/library/ms646360(v=VS.85).aspx">WM_SYSCOMMAND</a> messages. 
...
The system automatically grays items on the standard window menu, depending on the situation. The application can perform its own checking or graying by responding to the <a href="https://msdn.microsoft.com/library/ms646344(v=VS.85).aspx">WM_INITMENU</a> message that is sent before any menu is displayed. 
