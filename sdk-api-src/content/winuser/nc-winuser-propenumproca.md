...
An application-defined callback function used with the <a href="https://msdn.microsoft.com/library/ms633562(v=VS.85).aspx">EnumProps</a> function. The function receives property entries from a window's property list. The <b>PROPENUMPROC</b> type defines a pointer to this callback function. <i>PropEnumProc</i> is a placeholder for the application-defined function name. 
...
<a href="https://msdn.microsoft.com/library/ms633562(v=VS.85).aspx">EnumProps</a>
