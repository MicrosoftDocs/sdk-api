...
The accelerator key. This member can be either a <a href="https://msdn.microsoft.com/library/Dd375731(v=VS.85).aspx">virtual-key code</a> or a character code. 
...
The accelerator identifier. This value is placed in the low-order word of the <i>wParam</i> parameter of the <a href="https://msdn.microsoft.com/library/ms647591(v=VS.85).aspx">WM_COMMAND</a> or <a href="https://msdn.microsoft.com/library/ms646360(v=VS.85).aspx">WM_SYSCOMMAND</a> message when the accelerator is pressed. 
