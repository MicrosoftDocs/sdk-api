...
A pointer to a buffer of <a href="https://msdn.microsoft.com/library/ms645562(v=VS.85).aspx">RAWINPUT</a> structures that contain the raw input data. If <b>NULL</b>, the minimum required buffer, in bytes, is returned in *<i>pcbSize</i>. 
...
The size, in bytes, of a <a href="https://msdn.microsoft.com/library/ms645562(v=VS.85).aspx">RAWINPUT</a> structure. 
...
If 
						...
						<i>pData</i> is not NULL and the function is successful, the return value is the number of <a href="https://msdn.microsoft.com/library/ms645562(v=VS.85).aspx">RAWINPUT</a> structures written to 
						<i>pData</i>.
...
Using <b>GetRawInputBuffer</b>, the raw input data is buffered in the array of <a href="https://msdn.microsoft.com/library/ms645562(v=VS.85).aspx">RAWINPUT</a> structures. For an unbuffered read, use the <a href="https://msdn.microsoft.com/library/ms644936(v=VS.85).aspx">GetMessage</a> function to read in the raw input data. 

The <a href="https://msdn.microsoft.com/library/ms645593(v=VS.85).aspx">NEXTRAWINPUTBLOCK</a> macro allows an application to traverse an array of <a href="https://msdn.microsoft.com/library/ms645562(v=VS.85).aspx">RAWINPUT</a> structures.

<div class="alert"><b>Note</b>  To get the correct size of the raw input buffer, do not use *<i>pcbSize</i>, use *<i>pcbSize</i> * 8 instead.   To ensure <b>GetRawInputBuffer</b> behaves properly on WOW64, you must align the <a href="https://msdn.microsoft.com/library/ms645562(v=VS.85).aspx">RAWINPUT</a> structure by 8 bytes. The following code shows how to align <b>RAWINPUT</b>  for WOW64.  <div class="code"><span codelanguage=""><table>
<tr>
<th></th>
</tr>
<tr>
...
<a href="https://msdn.microsoft.com/library/ms645593(v=VS.85).aspx">NEXTRAWINPUTBLOCK</a>
