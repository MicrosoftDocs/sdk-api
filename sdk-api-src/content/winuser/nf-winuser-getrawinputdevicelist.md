...
An array of <a href="https://msdn.microsoft.com/library/ms645568(v=VS.85).aspx">RAWINPUTDEVICELIST</a> structures for the devices attached to the system. If <b>NULL</b>, the number of devices are returned in *<i>puiNumDevices</i>. 
...
The size of a <a href="https://msdn.microsoft.com/library/ms645568(v=VS.85).aspx">RAWINPUTDEVICELIST</a> structure, in bytes.
...
To get more detailed information about the attached devices, call <a href="https://msdn.microsoft.com/library/ms645597(v=VS.85).aspx">GetRawInputDeviceInfo</a> using the hDevice from <a href="https://msdn.microsoft.com/library/ms645568(v=VS.85).aspx">RAWINPUTDEVICELIST</a>. 
...
<a href="https://msdn.microsoft.com/library/ms645597(v=VS.85).aspx">GetRawInputDeviceInfo</a>



<a href="https://msdn.microsoft.com/library/ms645568(v=VS.85).aspx">RAWINPUTDEVICELIST</a>
