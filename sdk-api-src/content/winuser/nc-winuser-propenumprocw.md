...
> [!NOTE]
> The parameters are defined in the header with no names: `typedef BOOL (CALLBACK* PROPENUMPROCW)(HWND, LPCWSTR, HANDLE);`. Therefore, the syntax block lists them as `unnamedParam1` - `unnamedParam3`. You can name these parameters anything in your app. However, they are usually named as shown in the parameter descriptions.
...
[EnumProps](/windows/desktop/api/winuser/nf-winuser-enumpropsw)
