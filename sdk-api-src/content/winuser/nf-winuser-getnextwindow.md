...
Retrieves a handle to the next or previous window in the <a href="https://msdn.microsoft.com/library/ms632599(v=VS.85).aspx">Z-Order</a>. The next window is below the specified window; the previous window is above.
...
This function is implemented as a call to the <a href="https://msdn.microsoft.com/library/ms633515(v=VS.85).aspx">GetWindow</a> function.
...
<a href="https://msdn.microsoft.com/library/ms633514(v=VS.85).aspx">GetTopWindow</a>
