...
When called as an ANSI function, <b>CharPrev</b> uses the system default code-page, whereas <a href="https://msdn.microsoft.com/library/ms647472(v=VS.85).aspx">CharPrevExA</a> specifies a code-page to use.
