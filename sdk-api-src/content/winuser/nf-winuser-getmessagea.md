...
Unlike <b>GetMessage</b>, the <a href="https://msdn.microsoft.com/library/ms644943(v=VS.85).aspx">PeekMessage</a> function does not wait for a message to be posted before returning.
...
A pointer to an <a href="https://msdn.microsoft.com/library/ms644958(v=VS.85).aspx">MSG</a> structure that receives message information from the thread's message queue.
...
Use <a href="https://msdn.microsoft.com/library/ms645590(v=VS.85).aspx">WM_INPUT</a> here and in <i>wMsgFilterMax</i> to specify only the <b>WM_INPUT</b> messages.
...
Use <a href="https://msdn.microsoft.com/library/ms645590(v=VS.85).aspx">WM_INPUT</a> here and in <i>wMsgFilterMin</i> to specify only the <b>WM_INPUT</b> messages.
...
If the function retrieves a message other than <a href="https://msdn.microsoft.com/library/ms632641(v=VS.85).aspx">WM_QUIT</a>, the return value is nonzero.

If the function retrieves the <a href="https://msdn.microsoft.com/library/ms632641(v=VS.85).aspx">WM_QUIT</a> message, the return value is zero. 
...
The <b>GetMessage</b> function retrieves messages associated with the window identified by the <i>hWnd</i> parameter or any of its children, as specified by the <a href="https://msdn.microsoft.com/library/ms633524(v=VS.85).aspx">IsChild</a> function, and within the range of message values given by the <i>wMsgFilterMin</i> and <i>wMsgFilterMax</i> parameters. Note that an application can only use the low word in the <i>wMsgFilterMin</i> and <i>wMsgFilterMax</i> parameters; the high word is reserved for the system.


Note that <b>GetMessage</b> always retrieves <a href="https://msdn.microsoft.com/library/ms632641(v=VS.85).aspx">WM_QUIT</a> messages, no matter which values you specify for <i>wMsgFilterMin</i> and <i>wMsgFilterMax</i>.
