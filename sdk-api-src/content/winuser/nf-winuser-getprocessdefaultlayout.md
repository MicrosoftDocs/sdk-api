...
The current default process layout. For a list of values, see <a href="https://msdn.microsoft.com/library/ms633542(v=VS.85).aspx">SetProcessDefaultLayout</a>.
...
The layout specifies how text and graphics are laid out in a window; the default is left to right. The <b>GetProcessDefaultLayout</b> function lets you know if the default layout has changed, from using <a href="https://msdn.microsoft.com/library/ms633542(v=VS.85).aspx">SetProcessDefaultLayout</a>.
...
<a href="https://msdn.microsoft.com/library/ms633542(v=VS.85).aspx">SetProcessDefaultLayout</a>
