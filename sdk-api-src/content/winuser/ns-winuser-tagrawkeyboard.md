...
Windows message compatible virtual-key code. For more information, see <a href="https://msdn.microsoft.com/library/Dd375731(v=VS.85).aspx">Virtual Key Codes</a>. 
...
The corresponding window message, for example <a href="https://msdn.microsoft.com/library/ms646280(v=VS.85).aspx">WM_KEYDOWN</a>, <a href="https://msdn.microsoft.com/library/ms646286(v=VS.85).aspx">WM_SYSKEYDOWN</a>, and so forth. 
