...
<td width="60%">
If set, this enables the caller to receive <a href="https://msdn.microsoft.com/library/ms645591(v=VS.85).aspx">WM_INPUT_DEVICE_CHANGE</a> notifications for device arrival and device removal.
...
If <b>RIDEV_NOLEGACY</b> is set for a mouse or a keyboard, the system does not generate any legacy message for that device for the application. For example, if the mouse TLC is set with <b>RIDEV_NOLEGACY</b>, <a href="https://msdn.microsoft.com/library/ms645607(v=VS.85).aspx">WM_LBUTTONDOWN</a> and related legacy mouse messages are not generated. Likewise, if the keyboard TLC is set with <b>RIDEV_NOLEGACY</b>, <a href="https://msdn.microsoft.com/library/ms646280(v=VS.85).aspx">WM_KEYDOWN</a> and related legacy keyboard messages are not generated.
...
<a href="https://msdn.microsoft.com/library/ms645599(v=VS.85).aspx">GetRegisteredRawInputDevices</a>
