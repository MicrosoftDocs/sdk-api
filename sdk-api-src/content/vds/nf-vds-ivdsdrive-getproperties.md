...
ms.topic: method
f1_keywords: ["vds/IVdsDrive.GetProperties"]
req.header: vds.h
req.include-header: 
...
The address of the <a href="https://docs.microsoft.com/windows/desktop/api/vdshwprv/ns-vdshwprv-_vds_drive_prop">VDS_DRIVE_PROP</a> structure 
