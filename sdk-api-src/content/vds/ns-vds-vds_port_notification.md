...
ms.topic: struct
f1_keywords: ["vds/VDS_PORT_NOTIFICATION"]
req.header: vds.h
req.include-header: 
...
<td width="60%">
A member of the <a href="https://docs.microsoft.com/windows/desktop/api/vdshwprv/ns-vdshwprv-_vds_port_prop">VDS_PORT_PROP</a> structure changed.
