...
description: Returns an enumeration of currently associated iSCSI targets�the targets through which the LUN is accessible. (IVdsLunIscsi.QueryAssociatedTargets)
