...
The address of a variable that receives an <a href="https://msdn.microsoft.com/c09aa32f-d859-44b1-8656-973ba1b6a167">IVdsProvider</a> interface pointer. Callers must release the interface when it is no longer needed by calling the <a href="_com_iunknown_release">IUnknown::Release</a> method.
