...
ms.topic: method
f1_keywords: ["vds/IVdsIscsiPortal.GetProperties"]
req.header: vds.h
req.include-header: 
...
The address of an <a href="https://docs.microsoft.com/windows/desktop/api/vdshwprv/ns-vdshwprv-_vds_iscsi_portal_prop">VDS_ISCSI_PORTAL_PROP</a> structure.
