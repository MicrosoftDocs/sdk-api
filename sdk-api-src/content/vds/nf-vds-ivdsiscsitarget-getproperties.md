...
ms.topic: method
f1_keywords: ["vds/IVdsIscsiTarget.GetProperties"]
req.header: vds.h
req.include-header: 
...
The address of a <a href="https://docs.microsoft.com/windows/desktop/api/vdshwprv/ns-vdshwprv-_vds_iscsi_target_prop">VDS_ISCSI_TARGET_PROP</a> 
