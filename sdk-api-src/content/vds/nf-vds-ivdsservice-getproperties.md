...
ms.topic: method
f1_keywords: ["vds/IVdsService.GetProperties"]
req.header: vds.h
req.include-header: 
...
The address of the <a href="https://docs.microsoft.com/windows/desktop/api/vds/ns-vds-_vds_service_prop">VDS_SERVICE_PROP</a> structure 
