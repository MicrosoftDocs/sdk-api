...
ms.topic: struct
f1_keywords: ["vds/VDS_PORTAL_NOTIFICATION"]
req.header: vds.h
req.include-header: 
...
An existing iSCSI portal has changed. An example of change that triggers this notification would be
        changes to the <a href="https://docs.microsoft.com/windows/desktop/api/vdshwprv/ns-vdshwprv-_vds_iscsi_portal_prop">VDS_ISCSI_PORTAL_PROP</a> 
