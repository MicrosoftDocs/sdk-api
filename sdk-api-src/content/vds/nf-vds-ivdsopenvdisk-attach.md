...
A bitmask  of  <a href="https://docs.microsoft.com/windows/desktop/api/virtdisk/ne-virtdisk-_attach_virtual_disk_flag">ATTACH_VIRTUAL_DISK_FLAG</a> enumeration values specifying how the virtual disk is to be attached. Possible values include the following.
