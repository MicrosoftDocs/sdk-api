...
title: IVdsLun::QueryHints method
...
ms.date: 3/27/2018
ms.keywords: IVdsLun, IVdsLun interface [VDS], QueryHints method, IVdsLun::QueryHints, QueryHints method [VDS], QueryHints method [VDS], IVdsLun interface, QueryHints,IVdsLun.QueryHints, base.ivdslun_queryhints, vds/IVdsLun::QueryHints, vdshwprv/IVdsLun::QueryHints
...
Callers can specify hints by passing in the <i>pHints</i> parameter to the 
    <a href="https://msdn.microsoft.com/e8097364-1f23-4cda-8f12-a750bbb4eb4c">IVdsSubSystem::CreateLun</a> method when 
    creating a LUN or by using the <a href="https://msdn.microsoft.com/2582913a-bc13-45dc-b0c8-9429945014da">IVdsLun::ApplyHints</a> 
