...
description: Returns the hints currently applied to the LUN. (IVdsLun.QueryHints)
...
Callers can specify hints by passing in the <i>pHints</i> parameter to the 
    <a href="/windows/desktop/api/vdshwprv/nf-vdshwprv-ivdssubsystem-createlun">IVdsSubSystem::CreateLun</a> method when 
    creating a LUN or by using the <a href="/windows/desktop/api/vdshwprv/nf-vdshwprv-ivdslun-applyhints">IVdsLun::ApplyHints</a> 
