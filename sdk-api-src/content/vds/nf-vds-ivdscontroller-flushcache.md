...
ms.topic: method
f1_keywords: ["vds/IVdsController.FlushCache"]
req.header: vds.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/vdshwprv/nf-vdshwprv-ivdscontroller-invalidatecache">IVdsController::InvalidateCache</a>
