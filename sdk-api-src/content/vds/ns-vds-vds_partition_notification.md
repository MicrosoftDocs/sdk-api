...
ms.topic: struct
f1_keywords: ["vds/VDS_PARTITION_NOTIFICATION"]
req.header: vds.h
req.include-header: 
...
<td width="60%">
A member was changed in the <a href="https://docs.microsoft.com/windows/desktop/api/vds/ns-vds-_vds_partition_prop">VDS_PARTITION_PROP</a> 
