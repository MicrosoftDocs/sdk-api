...
description: Sets the target CHAP shared secret that is used for CHAP authentication when the target authenticates the initiator. (IVdsIscsiTarget.SetSharedSecret)
