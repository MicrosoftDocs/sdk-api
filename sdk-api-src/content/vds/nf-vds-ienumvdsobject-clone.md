...
ms.topic: method
f1_keywords: ["vds/IEnumVdsObject.Clone"]
req.header: vds.h
req.include-header: 
...
The address of an <a href="https://docs.microsoft.com/windows/desktop/api/vdshwprv/nn-vdshwprv-ienumvdsobject">IEnumVdsObject</a> pointer, which 
