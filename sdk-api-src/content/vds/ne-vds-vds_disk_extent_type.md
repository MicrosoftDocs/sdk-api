...
The <a href="https://docs.microsoft.com/windows/desktop/api/vds/ns-vds-_vds_disk_extent">VDS_DISK_EXTENT</a> structure includes a <b>VDS_DISK_EXTENT_TYPE</b> value as a member to indicate an existing disk extent type.
