...
ms.topic: method
f1_keywords: ["vds/IVdsIscsiInitiatorAdapter.GetProperties"]
req.header: vds.h
req.include-header: 
...
The address of a 
      <a href="https://docs.microsoft.com/windows/desktop/api/vdshwprv/ns-vdshwprv-_vds_iscsi_initiator_adapter_prop">VDS_ISCSI_INITIATOR_ADAPTER_PROP</a> 
