...
title: IVdsVdProvider::AddVDisk method
...
ms.date: 3/27/2018
ms.keywords: AddVDisk method, AddVDisk method, IVdsVdProvider interface, AddVDisk,IVdsVdProvider.AddVDisk, IVdsVdProvider, IVdsVdProvider interface, AddVDisk method, IVdsVdProvider::AddVDisk, base.ivdsvdprovider_addvdisk, vds/IVdsVdProvider::AddVDisk
...
# IVdsVdProvider::AddVDisk method
...
A pointer to a variable that receives an <a href="https://msdn.microsoft.com/2b4f81f9-81ec-4288-a26c-8ed4d378358a">IVdsVDisk</a> interface pointer to the newly created virtual disk object. Callers must release the interface pointer when it is no longer needed by calling the <a href="_com_iunknown_release">IUnknown::Release</a> method.
