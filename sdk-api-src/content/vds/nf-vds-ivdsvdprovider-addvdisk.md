...
ms.topic: method
f1_keywords: ["vds/IVdsVdProvider.AddVDisk"]
req.header: vds.h
req.include-header: 
...
The address of  a <a href="https://docs.microsoft.com/windows/desktop/api/vdssys/ns-vdssys-_virtual_storage_type">VIRTUAL_STORAGE_TYPE</a> structure 
