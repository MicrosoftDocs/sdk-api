...
ms.topic: method
f1_keywords: ["vds/IVdsService.ClearFlags"]
req.header: vds.h
req.include-header: 
...
The flags enumerated by <a href="https://docs.microsoft.com/windows/desktop/api/vds/ne-vds-_vds_service_flag">VDS_SERVICE_FLAG</a>. Callers can clear the <b>VDS_SVF_AUTO_MOUNT_OFF</b> flag.
