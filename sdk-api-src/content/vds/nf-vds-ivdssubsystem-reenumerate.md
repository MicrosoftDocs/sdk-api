...
title: IVdsSubSystem::Reenumerate (vds.h)
description: The IVdsSubSystem::Reenumerate method (vds.h) prompts the subsystem to scan its bus to discover newly-connected drives or newly-disconnected drives.
