...
ms.topic: method
f1_keywords: ["vds/IVdsSubSystem2.GetProperties2"]
req.header: vds.h
req.include-header: 
...
The address of the <a href="https://docs.microsoft.com/windows/desktop/api/vdshwprv/ns-vdshwprv-_vds_sub_system_prop2">VDS_SUB_SYSTEM_PROP2</a> 
