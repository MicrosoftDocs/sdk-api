...
title: IVdsDiskPartitionMF::FormatPartitionEx method
...
ms.date: 3/27/2018
ms.keywords: FormatPartitionEx method, FormatPartitionEx method, IVdsDiskPartitionMF interface, FormatPartitionEx,IVdsDiskPartitionMF.FormatPartitionEx, IVdsDiskPartitionMF, IVdsDiskPartitionMF interface, FormatPartitionEx method, IVdsDiskPartitionMF::FormatPartitionEx, base.ivdsdiskpartitionmf_formatpartitionex, vds/IVdsDiskPartitionMF::FormatPartitionEx
...
# IVdsDiskPartitionMF::FormatPartitionEx method
...
Pointer to an <a href="https://msdn.microsoft.com/7814b8ef-84b4-453e-b480-c32b67e5af93">IVdsAsync</a> interface that upon successful completion receives the <b>IVdsAsync</b> interface to monitor and control this operation.  Callers must release the interface received when they are done with it.
