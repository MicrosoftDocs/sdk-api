...
ms.topic: struct
f1_keywords: ["vds/VDS_VOLUME_NOTIFICATION"]
req.header: vds.h
req.include-header: 
...
<td width="60%">
A member of the <a href="https://docs.microsoft.com/windows/desktop/api/vds/ns-vds-_vds_volume_prop">VDS_VOLUME_PROP</a> structure 
