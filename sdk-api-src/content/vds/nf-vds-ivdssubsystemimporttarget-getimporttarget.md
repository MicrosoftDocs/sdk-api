...
ms.topic: method
f1_keywords: ["vds/IVdsSubSystemImportTarget.GetImportTarget"]
req.header: vds.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/vds/nn-vds-ivdssubsystemimporttarget">IVdsSubSystemImportTarget</a>
