...
Gets the disk <a href="https://docs.microsoft.com/windows/desktop/api/vds/ne-vds-_vds_san_policy">SAN policy</a> for the operating system.
...
A pointer to a variable that receives a value from the <a href="https://docs.microsoft.com/windows/desktop/api/vds/ne-vds-_vds_san_policy">VDS_SAN_POLICY</a> enumeration.
