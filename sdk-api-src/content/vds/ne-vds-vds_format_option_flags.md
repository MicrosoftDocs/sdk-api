...
ms.topic: enum
f1_keywords: ["vds/VDS_FORMAT_OPTION_FLAGS"]
req.header: vds.h
req.include-header: 
...
Defines the set of valid formatting options for the <a href="https://docs.microsoft.com/windows/desktop/api/vds/nf-vds-ivdsdiskpartitionmf2-formatpartitionex2">IVdsDiskPartitionMF2::FormatPartitionEx2</a> method.
