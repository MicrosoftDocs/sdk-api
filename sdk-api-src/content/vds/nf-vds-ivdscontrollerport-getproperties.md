...
ms.topic: method
f1_keywords: ["vds/IVdsControllerPort.GetProperties"]
req.header: vds.h
req.include-header: 
...
The address of a member of the <a href="https://docs.microsoft.com/windows/desktop/api/vdshwprv/ns-vdshwprv-_vds_port_prop">VDS_PORT_PROP</a> 
