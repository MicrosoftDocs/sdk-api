...
ms.topic: method
f1_keywords: ["vds/IVdsSubSystem.QueryLuns"]
req.header: vds.h
req.include-header: 
...
This return value signals a software or communication problem inside a provider that caches 
        ...
        followed by the 
        <a href="https://docs.microsoft.com/windows/desktop/api/vdshwprv/nf-vdshwprv-ivdshwprovider-refresh">IVdsHwProvider::Refresh</a> method 
