...
ms.topic: method
f1_keywords: ["faxcom/IFaxTiff.RecipientName"]
req.header: faxcom.h
req.include-header: 
...
Retrieves the <b>RecipientName</b> property for a <a href="https://docs.microsoft.com/previous-versions/windows/desktop/fax/-mfax-faxtiff">FaxTiff</a> object. The <b>RecipientName</b> property is a null-terminated string that contains the name of the recipient for the specified fax file.
