...
You can use the <a href="https://msdn.microsoft.com/library/ms690868(v=VS.85).aspx">UseDeviceTsid</a> property to determine if the fax server is configured to permit user-specified TSIDs. 
