...
title: IDXGISwapChain::Present method
...
ms.date: 3/23/2018
ms.keywords: 5dfc8ba6-2dcd-cb78-b6d3-50ba63314d3c, IDXGISwapChain, IDXGISwapChain interface [DXGI], Present method, IDXGISwapChain::Present, Present method [DXGI], Present method [DXGI], IDXGISwapChain interface, Present,IDXGISwapChain.Present, direct3ddxgi.idxgiswapchain_present, dxgi/IDXGISwapChain::Present
...
If the update region straddles more than one output (each represented by <a href="https://msdn.microsoft.com/c641995e-a4d9-4bfb-bdc0-7ffbe77c3599">IDXGIOutput</a>), <b>Present</b> performs the synchronization to the output that contains the largest sub-rectangle of the target window's client area.
...
Because calling <b>Present</b> might cause the render thread to wait on the message-pump thread, be careful when calling this method in an application that uses multiple threads. For more details, see <a href="https://msdn.microsoft.com/0522ccbf-e754-470a-8199-004fcbaa927d">Multithreading Considerations</a>.
