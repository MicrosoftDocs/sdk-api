...
Returns S_OK if successful; otherwise, returns <a href="https://www.bing.com/search?q=DXGI_ERROR_NOT_FOUND">DXGI_ERROR_NOT_FOUND</a> if the index is greater than or equal to the number of adapters in the local 
      system, or <a href="https://www.bing.com/search?q=DXGI_ERROR_INVALID_CALL">DXGI_ERROR_INVALID_CALL</a> if <i>ppAdapter</i> parameter is <b>NULL</b>.
