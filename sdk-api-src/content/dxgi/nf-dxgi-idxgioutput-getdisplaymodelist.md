...
The color format (see <a href="https://msdn.microsoft.com/library/Bb173059(v=VS.85).aspx">DXGI_FORMAT</a>).
...
Options for modes to include (see <a href="https://msdn.microsoft.com/library/Cc308060(v=VS.85).aspx">DXGI_ENUM_MODES</a>).
...
A pointer to a list of display modes (see <a href="https://msdn.microsoft.com/library/Bb173064(v=VS.85).aspx">DXGI_MODE_DESC</a>); set to <b>NULL</b> to get the number of display modes.
...
Returns one of the following <a href="https://msdn.microsoft.com/library/Bb509553(v=VS.85).aspx">DXGI_ERROR</a>. It is rare, but possible, that the display modes available can change immediately after calling 
