...
Type: <b>const <a href="https://msdn.microsoft.com/library/Bb173061(v=VS.85).aspx">DXGI_GAMMA_CONTROL</a>*</b>

A pointer to a <a href="https://msdn.microsoft.com/library/Bb173061(v=VS.85).aspx">DXGI_GAMMA_CONTROL</a> structure that describes the gamma curve to set.
