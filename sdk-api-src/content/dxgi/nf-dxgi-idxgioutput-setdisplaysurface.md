...
A pointer to a surface (see <a href="https://msdn.microsoft.com/library/Bb174565(v=VS.85).aspx">IDXGISurface</a>) used for rendering an image to the screen. The surface must have been created as a back buffer (DXGI_USAGE_BACKBUFFER).
...
This method should only be called between <a href="https://msdn.microsoft.com/library/Bb174558(v=VS.85).aspx">IDXGIOutput::TakeOwnership</a> and <a href="https://msdn.microsoft.com/library/Bb174554(v=VS.85).aspx">IDXGIOutput::ReleaseOwnership</a> calls.
...
If a Windows Store app uses <b>SetDisplaySurface</b>, it fails with <a href="https://msdn.microsoft.com/library/Bb509553(v=VS.85).aspx">DXGI_ERROR_NOT_CURRENTLY_AVAILABLE</a>.
