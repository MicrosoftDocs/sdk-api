...
<li>
      ...
      a <a href="https://msdn.microsoft.com/library/Bb173058(v=VS.85).aspx">DXGI_ADAPTER_DESC</a> structure that contains the amount of available graphics memory.
