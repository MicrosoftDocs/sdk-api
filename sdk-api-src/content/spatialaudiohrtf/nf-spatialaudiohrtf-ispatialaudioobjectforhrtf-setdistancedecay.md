...
ms.topic: method
f1_keywords: ["spatialaudiohrtf/ISpatialAudioObjectForHrtf.SetDistanceDecay"]
...
Sets the decay model that is applied over distance from the position of an <a href="https://docs.microsoft.com/windows/desktop/api/spatialaudiohrtf/nn-spatialaudiohrtf-ispatialaudioobjectforhrtf">ISpatialAudioObjectForHrtf</a> to the position of the listener.
