---
UID: NF:mmdeviceapi.IAudioSystemEffectsPropertyStore.OpenDefaultPropertyStore
tech.root: audio
title: IAudioSystemEffectsPropertyStore::OpenDefaultPropertyStore
ms.date: 06/18/2021
targetos: Windows
description: Opens the audio system effects default property store.
prerelease: false
req.assembly: 
...
f1_keywords:
 - IAudioSystemEffectsPropertyStore::OpenDefaultPropertyStore
 - mmdeviceapi/IAudioSystemEffectsPropertyStore::OpenDefaultPropertyStore
dev_langs:
 - c++
---
...
Receives a pointer to an [IPropertyStore](../propsys/nn-propsys-ipropertystore.md) representing the default property store.
