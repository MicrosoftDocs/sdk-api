---
UID: NF:mmdeviceapi.IAudioSystemEffectsPropertyStore.OpenUserPropertyStore
tech.root: audio
title: IAudioSystemEffectsPropertyStore::OpenUserPropertyStore
ms.date: 06/18/2021
targetos: Windows
description: Opens the audio system effects user property store.
prerelease: false
req.assembly: 
...
f1_keywords:
 - IAudioSystemEffectsPropertyStore::OpenUserPropertyStore
 - mmdeviceapi/IAudioSystemEffectsPropertyStore::OpenUserPropertyStore
dev_langs:
 - c++
---
...
Receives a pointer to an [IPropertyStore](../propsys/nn-propsys-ipropertystore.md) representing the user property store.
