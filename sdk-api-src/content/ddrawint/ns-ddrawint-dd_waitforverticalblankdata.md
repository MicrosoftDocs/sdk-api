...
ms.topic: struct
f1_keywords: ["ddrawint/DDHAL_WAITFORVERTICALBLANKDATA"]
...
<a href="https://docs.microsoft.com/windows/desktop/api/ddrawint/nc-ddrawint-pdd_waitforverticalblank">DdWaitForVerticalBlank</a>
 
