...
helpviewer_keywords: ["ICreateObject","ICreateObject interface [Windows Shell]","ICreateObject interface [Windows Shell]","described","_shell_ICreateObject","propsys/ICreateObject","shell.ICreateObject"]
...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">ICreateObject</b> interface inherits from the <a href="/windows/desktop/api/unknwn/nn-unknwn-iunknown">IUnknown</a> interface. <b>ICreateObject</b> also has these types of members:
<ul>
...
<a href="/windows/desktop/api/propsys/nf-propsys-icreateobject-createobject">CreateObject</a>
</td>
