...
Gets the address of a pointer to the <a href="/windows/desktop/api/propsys/nn-propsys-ipropertydescriptionlist.md">IPropertyDescriptionList</a> interface, which contains additional sort column values.
...
A reference to the identifier of the requested <a href="/windows/desktop/api/propsys/nn-propsys-ipropertydescriptionlist.md">IPropertyDescriptionList</a> interface.
...
When this method returns successfully, contains the address of a pointer to an <a href="/windows/desktop/api/propsys/nn-propsys-ipropertydescriptionlist.md">IPropertyDescriptionList</a> interface.
...
<a href="/windows/desktop/api/propsys/nn-propsys-ipropertydescriptionaliasinfo.md">IPropertyDescriptionAliasInfo</a>



<a href="/windows/desktop/api/propsys/nf-propsys-ipropertydescriptionaliasinfo-getsortbyalias.md">IPropertyDescriptionAliasInfo::GetSortByAlias</a>
 
