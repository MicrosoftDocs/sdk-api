...
A reference to the identifier of the requested <a href="https://msdn.microsoft.com/library/Bb761511(v=VS.85).aspx">IPropertyDescriptionList</a> interface.
...
When this method returns successfully, contains the address of a pointer to an <a href="https://msdn.microsoft.com/library/Bb761511(v=VS.85).aspx">IPropertyDescriptionList</a> interface.
