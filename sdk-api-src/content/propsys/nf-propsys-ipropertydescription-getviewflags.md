...
Type: <b><a href="https://msdn.microsoft.com/library/Bb762528(v=VS.85).aspx">PROPDESC_VIEW_FLAGS</a>*</b>

When this method returns, contains a pointer to a value that includes one or more of the following flags. See <a href="https://msdn.microsoft.com/library/Bb762528(v=VS.85).aspx">PROPDESC_VIEW_FLAGS</a> for valid values.
