...
Pointer to a value that, when this method returns successfully, receives the value of the maxSize attribute of the <a href="https://msdn.microsoft.com/library/Bb773885(v=VS.85).aspx">searchInfo</a> element. The default is:
