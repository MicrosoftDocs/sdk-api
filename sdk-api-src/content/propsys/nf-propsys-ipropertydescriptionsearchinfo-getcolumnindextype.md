...
Type: <b><a href="/windows/desktop/api/propsys/ne-propsys-propdesc_columnindex_type.md">PROPDESC_COLUMNINDEX_TYPE</a>*</b>


                  When this method returns successfully, contains a pointer to a <a href="/windows/desktop/api/propsys/ne-propsys-propdesc_columnindex_type.md">PROPDESC_COLUMNINDEX_TYPE</a> constant. This constant describes whether the property is indexed and if so, if it is indexed in memory or on disk.
...
<a href="/windows/desktop/api/propsys/ne-propsys-propdesc_columnindex_type.md">PROPDESC_COLUMNINDEX_TYPE</a>
 
