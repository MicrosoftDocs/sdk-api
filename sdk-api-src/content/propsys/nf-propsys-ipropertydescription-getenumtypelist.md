...
Gets an instance of an <a href="/windows/desktop/api/propsys/nn-propsys-ipropertyenumtypelist.md">IPropertyEnumTypeList</a>, which can be used to enumerate the possible values for a property.
...
Type: <b><a href="/windows/desktop/api/propsys/nn-propsys-ipropertyenumtypelist.md">IPropertyEnumTypeList</a>**</b>

When this method returns, contains the address of an <a href="/windows/desktop/api/propsys/nn-propsys-ipropertyenumtypelist.md">IPropertyEnumTypeList</a> interface pointer.
