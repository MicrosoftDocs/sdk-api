...
ms.topic: method
f1_keywords: ["mswmdm/IMDSPDevice3.DeviceIoControl"]
req.header: mswmdm.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/mswmdm/nf-mswmdm-imdspdevice-sendopaquecommand">IMDSPDevice::SendOpaqueCommand</a>
