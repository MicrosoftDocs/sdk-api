...
ms.topic: method
f1_keywords: ["mswmdm/IMDSPDevice2.GetCanonicalName"]
req.header: mswmdm.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/mswmdm/nf-mswmdm-imdserviceprovider2-createdevice">IMDServiceProvider2::CreateDevice</a>
 
