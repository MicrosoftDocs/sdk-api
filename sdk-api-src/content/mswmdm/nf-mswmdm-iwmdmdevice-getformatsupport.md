...
ms.topic: method
f1_keywords: ["mswmdm/IWMDMDevice.GetFormatSupport"]
req.header: mswmdm.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/mswmdm/nf-mswmdm-iwmdmdevice3-getformatcapability">IWMDMDevice3::GetFormatCapability</a>
