...
ms.topic: method
f1_keywords: ["mswmdm/IMDSPStorageGlobals.GetTotalSize"]
req.header: mswmdm.h
req.include-header: 
...
<a href="https://docs.microsoft.com/windows/desktop/api/mswmdm/nf-mswmdm-imdspstorageglobals-gettotalfree">IMDSPStorageGlobals::GetTotalFree</a>
 
