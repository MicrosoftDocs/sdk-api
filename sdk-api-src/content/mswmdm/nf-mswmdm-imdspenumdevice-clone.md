...
ms.topic: method
f1_keywords: ["mswmdm/IMDSPEnumDevice.Clone"]
req.header: mswmdm.h
req.include-header: 
...
Pointer to an <a href="https://docs.microsoft.com/windows/desktop/api/mswmdm/nn-mswmdm-imdspenumdevice">IMDSPEnumDevice</a> interface.
