...
ms.date: 2/15/2018
ms.keywords: IMDSPObject, IMDSPObject interface [windows Media Device Manager], Move method, IMDSPObject::Move, IMDSPObjectMove, Move method [windows Media Device Manager], Move method [windows Media Device Manager], IMDSPObject interface, Move,IMDSPObject.Move, mswmdm/IMDSPObject::Move, wmdm.imdspobject_move
