...
ms.topic: method
f1_keywords: ["mswmdm/IMDSPObject.Delete"]
req.header: mswmdm.h
req.include-header: 
...
Pointer to an application-implemented <a href="https://docs.microsoft.com/windows/desktop/api/mswmdm/nn-mswmdm-iwmdmprogress">IWMDMProgress</a> interface that enables the application to receive progress notifications for lengthy <b>Delete</b> operations.
