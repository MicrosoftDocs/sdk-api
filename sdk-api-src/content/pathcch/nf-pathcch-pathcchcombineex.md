...
title: PathCchCombineEx function
...
This function differs from <a href="https://msdn.microsoft.com/506a4165-f572-4521-958f-56a0296f9c05">PathCchCombine</a> in that it allows for a longer final path to be constructed.
...
<td width="60%">
Allow the construction of \\?\ paths longer than MAX_PATH. Note that <i>cchPathOut</i> must be greater than MAX_PATH. Note that <i>cchPathOut</i> must be greater than MAX_PATH. If it is not, this flag is ignored.
