...
ms.topic: function
f1_keywords: ["evntprov/EventDescGetId"]
...
Event descriptor from which to retrieve the event identifier. See <a href="https://docs.microsoft.com/windows/desktop/api/evntprov/ns-evntprov-_event_descriptor">EVENT_DESCRIPTOR</a>.
