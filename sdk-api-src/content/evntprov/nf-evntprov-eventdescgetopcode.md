...
ms.topic: function
f1_keywords: ["evntprov/EventDescGetOpcode"]
...
Event descriptor from which to retrieve the operation code. See <a href="https://docs.microsoft.com/windows/desktop/api/evntprov/ns-evntprov-_event_descriptor">EVENT_DESCRIPTOR</a>.
