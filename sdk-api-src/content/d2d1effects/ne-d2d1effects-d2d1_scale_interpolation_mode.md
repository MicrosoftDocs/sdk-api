...
The interpolation mode the <a href="/windows/desktop/Direct2D/high-quality-scale">Scale effect</a> uses to scale the image. There are 6 scale modes that range in quality and speed.

## -enum-fields

### -field D2D1_SCALE_INTERPOLATION_MODE_NEAREST_NEIGHBOR:0

Samples the nearest single point and uses that. This mode uses less processing time, but outputs the lowest quality image.

### -field D2D1_SCALE_INTERPOLATION_MODE_LINEAR:1
...
### -field D2D1_SCALE_INTERPOLATION_MODE_CUBIC:2
...
### -field D2D1_SCALE_INTERPOLATION_MODE_MULTI_SAMPLE_LINEAR:3
...
### -field D2D1_SCALE_INTERPOLATION_MODE_ANISOTROPIC:4

Uses anisotropic filtering to sample a pattern according to the transformed shape of the bitmap.

### -field D2D1_SCALE_INTERPOLATION_MODE_HIGH_QUALITY_CUBIC:5
...
### -field D2D1_SCALE_INTERPOLATION_MODE_FORCE_DWORD:0xffffffff
