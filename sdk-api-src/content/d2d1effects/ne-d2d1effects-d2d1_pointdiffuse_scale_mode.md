...
ms.topic: enum
f1_keywords: ["d2d1effects/D2D1_POINTDIFFUSE_SCALE_MODE"]
...
The interpolation mode the <a href="https://docs.microsoft.com/windows/desktop/Direct2D/point-diffuse-lighting">Point-diffuse lighting effect</a> 
