...
ms.topic: function
f1_keywords: ["pdh/PdhGetDataSourceTimeRange"]
req.header: pdh.h
req.include-header: 
...
A 
<a href="https://docs.microsoft.com/windows/desktop/api/pdh/ns-pdh-_pdh_time_info">PDH_TIME_INFO</a> structure that receives the time range.
