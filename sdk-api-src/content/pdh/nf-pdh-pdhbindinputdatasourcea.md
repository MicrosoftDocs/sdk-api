...
description: Binds one or more binary log files together for reading log data. (ANSI)
helpviewer_keywords: ["PdhBindInputDataSourceA", "pdh/PdhBindInputDataSourceA"]
