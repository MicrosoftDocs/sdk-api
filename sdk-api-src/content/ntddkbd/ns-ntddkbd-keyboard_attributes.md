...
For information about keyboard types, subtypes, scan code modes, and related keyboard layouts, see the documentation in *i8042prt.h* header in Windows Driver Kit (WDK) and *ntddkbd.h* header in Windows SDK, and the [Keyboard Layout Samples](https://docs.microsoft.com/samples/microsoft/windows-driver-samples/keyboard-layout-samples/). 
