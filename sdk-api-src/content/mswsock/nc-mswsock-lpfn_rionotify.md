...
| <dl> <dt>**[WSAEALREADY](/windows/win32/winsock/windows-sockets-error-codes-2#wsaealready)**</dt> </dl> | An operation was attempted on a non-blocking socket that already had an operation in progress.<br/> This error is returned if a previous [**RIONotify**](/windows/win32/api/mswsock/nf-mswsock-rionotify) request has not yet completed.<br/>                                        |
