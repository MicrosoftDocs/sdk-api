...
A portion of a registered buffer is passed to the [**RIOSend**](/windows/win32/winsock/riosend), [**RIOSendEx**](/windows/win32/winsock/riosendex), [**RIOReceive**](/windows/win32/api/mswsock/nf-mswsock-rioreceive), and [**RIOReceiveEx**](/windows/win32/api/mswsock/nf-mswsock-rioreceiveex) functions in the *pData* parameter for sending or receiving data.

When the buffer identifier is no longer needed, call the [**RIODeregisterBuffer**](/windows/win32/api/mswsock/nf-mswsock-rioderegisterbuffer) function to deregister the buffer identifier.
