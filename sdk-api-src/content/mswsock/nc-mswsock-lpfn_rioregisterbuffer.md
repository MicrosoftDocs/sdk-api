...
f1_keywords: ["mswsock/LPFN_RIOREGISTERBUFFER"]
targetos: Windows
product: Windows
req.assembly: 
...
The **RIORegisterBuffer** function registers a [**RIO\_BUFFERID**](rio-bufferid.md), a registered buffer descriptor, with a specified buffer for use with the Winsock registered I/O extensions.
...
A portion of a registered buffer is passed to the [**RIOSend**](riosend.md), [**RIOSendEx**](riosendex.md), [**RIOReceive**](rioreceive.md), and [**RIOReceiveEx**](rioreceiveex.md) functions in the *pData* parameter for sending or receiving data.
