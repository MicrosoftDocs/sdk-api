...
Determines whether this font face's resource supports any variable axes. When `true`, at least one [DWRITE_FONT_AXIS_RANGE](/windows/desktop/api/dwrite_3/ns-dwrite_3-dwrite_font_axis_range) in the font resource has a non-empty range (*maxValue* > *minValue*).
