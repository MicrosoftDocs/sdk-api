...
ms.topic: interface
f1_keywords: ["imepad/IImeSpecifyApplets"]
req.header: imepad.h
req.include-header: 
...
The <b>IImeSpecifyApplets</b> interface specifies methods called from the <a href="https://docs.microsoft.com/windows/desktop/api/imepad/nn-imepad-iimepad">IImePad</a> interface object to emulate the <a href="https://docs.microsoft.com/windows/desktop/api/imepad/nn-imepad-iimepadapplet">IImePadApplet</a> interface.


## -inheritance

The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IImeSpecifyApplets</b> interface inherits from the <a href="https://docs.microsoft.com/windows/desktop/api/unknwn/nn-unknwn-iunknown">IUnknown</a> interface. <b>IImeSpecifyApplets</b> also has these types of members:
<ul>
...
<a href="https://docs.microsoft.com/windows/desktop/api/imepad/nf-imepad-iimespecifyapplets-getappletiidlist">GetAppletIIDList</a>
</td>
