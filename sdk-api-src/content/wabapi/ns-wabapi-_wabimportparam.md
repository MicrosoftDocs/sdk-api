...
Do not use. Structure passed to <a href="https://msdn.microsoft.com/library/ms629466(v=VS.85).aspx">Import</a> that gives information about importing .wab files.
...
Type: <b><a href="https://msdn.microsoft.com/library/ms629649(v=VS.85).aspx">IAddrBook</a>*</b>

Pointer to an <a href="https://msdn.microsoft.com/library/ms629649(v=VS.85).aspx">IAddrBook</a> interface that specifies the address book object to import to.
...
Causes <a href="https://msdn.microsoft.com/library/ms629466(v=VS.85).aspx">Import</a> to show a dialog box with a progress bar indicating the progress of the import process.
