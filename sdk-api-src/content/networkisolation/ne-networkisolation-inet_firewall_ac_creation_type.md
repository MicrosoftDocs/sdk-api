...
description: Specifies the type of app container creation events for which notifications will be delivered. (INET_FIREWALL_AC_CREATION_TYPE)
...
f1_keywords:
 ...
 - networkisolation/_INET_FIREWALL_AC_CREATION_TYPE
