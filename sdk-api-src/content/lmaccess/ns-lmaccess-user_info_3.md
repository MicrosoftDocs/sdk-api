...
ms.topic: struct
f1_keywords: ["lmaccess/USER_INFO_3"]
...
Note that the 
<a href="https://docs.microsoft.com/windows/desktop/api/lmaccess/ns-lmaccess-_user_info_4">USER_INFO_4</a> structure supersedes the 
