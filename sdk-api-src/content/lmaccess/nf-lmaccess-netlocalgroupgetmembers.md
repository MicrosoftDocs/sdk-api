...
<td width="60%">
Return the 
<a href="https://www.bing.com/search?q=security+identifier">security identifier</a> (SID) associated with the local group member. The <i>bufptr</i> parameter points to an array of 
