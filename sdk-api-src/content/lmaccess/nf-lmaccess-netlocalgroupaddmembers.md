...
<td width="60%">
Specifies the 
<a href="https://docs.microsoft.com/windows/desktop/SecAuthZ/security-identifiers">security identifier</a> (SID) of the new local group member. The <i>buf</i> parameter points to an array of 
