...
<td width="60%">
Specifies the 
<a href="https://www.bing.com/search?q=security+identifier">security identifier</a> (SID) of the new local group member. The <i>buf</i> parameter points to an array of 
