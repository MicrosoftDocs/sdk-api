...
ms.date: 10/05/2018
ms.keywords: "*LPPROPSHEETPAGEA_V2, LPCPROPSHEETPAGE, LPCPROPSHEETPAGE structure pointer [MMC], LPPROPSHEETPAGE, LPPROPSHEETPAGE structure pointer [MMC], PROPSHEETPAGE, PROPSHEETPAGE structure [MMC], PROPSHEETPAGEA, PROPSHEETPAGEA_V2, PROPSHEETPAGEW, PSP_DEFAULT, PSP_DLGINDIRECT, PSP_HASHELP, PSP_HIDEHEADER, PSP_RTLREADING, PSP_USECALLBACK, PSP_USEHEADERSUBTITLE, PSP_USEHEADERTITLE, PSP_USEHICON, PSP_USEICONID, PSP_USEREFPARENT, PSP_USETITLE, _PROPSHEETPAGEA_V2, _slate_propsheetpage, mmc.propsheetpage, prsht/LPCPROPSHEETPAGE, prsht/LPPROPSHEETPAGE, prsht/PROPSHEETPAGE"
ms.prod: windows
