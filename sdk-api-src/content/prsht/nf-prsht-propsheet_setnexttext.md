...
Sets the text of the <b>Next</b> button in a wizard. You can use this macro or send the <a href="https://msdn.microsoft.com/library/Bb774625(v=VS.85).aspx">PSM_SETNEXTTEXT</a> message explicitly.
