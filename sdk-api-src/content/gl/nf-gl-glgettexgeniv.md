...
old-location: opengl\glgettexgeniv.htm
old-project: OpenGL
ms.assetid: 62c481d1-4862-43bb-9319-5a282c4e47d3
ms.author: windowsdriverdev
ms.date: 2/15/2018
ms.keywords: GL_EYE_PLANE, GL_OBJECT_PLANE, GL_TEXTURE_GEN_MODE, gl/glGetTexGeniv, glGetTexGeniv, glGetTexGeniv function [OpenGL], opengl.glgettexgeniv
...
The <a href="https://msdn.microsoft.com/bce26bde-071b-476e-9e33-c43a8c997cdd">glGetTexGendv</a>, <a href="https://msdn.microsoft.com/3b5b78a2-6db6-4931-aabb-25624c5af2f6">glGetTexGenfv</a>, and <b>glGetTexGeniv</b> functions return texture coordinate generation parameters.
