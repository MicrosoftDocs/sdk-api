...
old-location: opengl\glindexsv.htm
old-project: OpenGL
ms.assetid: 4b7f4edf-a7c8-4e81-8448-5181295d5174
ms.author: windowsdriverdev
ms.date: 2/15/2018
ms.keywords: gl/glIndexsv, glIndexsv, glIndexsv function [OpenGL], opengl.glindexsv
...
The <b>glIndexsv</b> function sets the current color index.
...
The <b>glIndexsv</b> function updates the current (single-valued) color index. It takes one argument: the new value for the current color index.
...
The current index can be updated at any time. In particular, <b>glIndexsv</b> can be called between a call to <a href="https://msdn.microsoft.com/8e8e98f8-89e8-40f5-89c1-492c9e3bbd74">glBegin</a> and the corresponding call to <a href="https://msdn.microsoft.com/040f8573-683c-4a8a-ae51-66abb0541ac4">glEnd</a>.


The following function retrieves information related to <b>glIndexsv</b>:
