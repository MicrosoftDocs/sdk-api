---
UID: NF:gl.glTexCoord2s
title: glTexCoord2s function
author: windows-driver-content
description: Sets the current texture coordinates.
old-location: opengl\gltexcoord2s.htm
old-project: OpenGL
ms.assetid: d1bd7286-e32e-43ef-919a-4debf62a50ef
ms.author: windowsdriverdev
ms.date: 2/15/2018
ms.keywords: gl/glTexCoord2s, glTexCoord2s, glTexCoord2s function [OpenGL], opengl.gltexcoord2s
