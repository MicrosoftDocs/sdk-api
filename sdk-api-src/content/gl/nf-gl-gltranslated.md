...
old-location: opengl\gltranslated.htm
old-project: OpenGL
ms.assetid: 9f066a92-ee78-44d1-b8f8-0eacde0e1a47
ms.author: windowsdriverdev
ms.date: 2/15/2018
ms.keywords: gl/glTranslated, glTranslated, glTranslated function [OpenGL], opengl.gltranslated
...
The <b>glTranslated</b> function multiplies the current matrix by a translation matrix.
...
The <b>glTranslated</b> function produces the translation specified by (<i>x</i>, <i>y</i>, <i>z</i>). The translation vector is used to compute a 4x4 translation matrix:
...
If the matrix mode is either GL_MODELVIEW or GL_PROJECTION, all objects drawn after <b>glTranslated</b> is called are translated. Use <a href="https://msdn.microsoft.com/97d8e644-50bb-4130-b6b7-d87df4468e73">glPushMatrix</a> and <b>glPopMatrix</b> to save and restore the untranslated coordinate system.

The following functions retrieve information related to <a href="https://msdn.microsoft.com/7aa8dc2c-c353-48d3-88a9-389521bed7c9">glTranslated</a>:
