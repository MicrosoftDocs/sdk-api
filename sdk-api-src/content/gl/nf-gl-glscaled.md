...
old-location: opengl\glscaled.htm
old-project: OpenGL
ms.assetid: 3846289f-5c7b-4bb6-95a8-90a58dd8b9d9
ms.author: windowsdriverdev
ms.date: 2/15/2018
ms.keywords: gl/glScaled, glScaled, glScaled function [OpenGL], opengl.glscaled
...
The <b>glScaled</b> and <a href="https://msdn.microsoft.com/bf039bbc-7669-4282-b629-71440b798cb1">glScalef</a> functions multiply the current matrix by a general scaling matrix.
...
The <b>glScaled</b> function produces a general scaling along the <i>x</i>, <i>y</i>, and <i>z</i> axes. The three arguments indicate the desired scale factors along each of the three axes. The resulting matrix is
...
The following functions retrieve information related to <b>glScaled</b>:
