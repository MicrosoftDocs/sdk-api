---
UID: NF:gl.glRasterPos4s
title: glRasterPos4s function
author: windows-driver-content
description: Specifies the raster position for pixel operations.
old-location: opengl\glrasterpos4s.htm
old-project: OpenGL
ms.assetid: 60e6ced4-a542-4189-a3da-eed36f81cafb
ms.author: windowsdriverdev
ms.date: 2/15/2018
ms.keywords: gl/glRasterPos4s, glRasterPos4s, glRasterPos4s function [OpenGL], opengl.glrasterpos4s
