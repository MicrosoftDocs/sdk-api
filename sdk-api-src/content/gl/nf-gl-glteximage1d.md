---
UID: NF:gl.glTexImage1D
title: glTexImage1D function
author: windows-driver-content
description: The glTexImage1D function specifies a one-dimensional texture image.
old-location: opengl\glteximage1d.htm
old-project: OpenGL
ms.assetid: 4f537b89-2ea2-4e2e-8c57-c372bf53f12c
ms.author: windowsdriverdev
ms.date: 2/15/2018
ms.keywords: GL_ALPHA, GL_BGRA_EXT, GL_BGR_EXT, GL_BLUE, GL_COLOR_INDEX, GL_GREEN, GL_LUMINANCE, GL_LUMINANCE_ALPHA, GL_RED, GL_RGB, GL_RGBA, _ogl_glTexImage1D, gl/glTexImage1D, glTexImage1D, glTexImage1D function [OpenGL], opengl.glteximage1d
...
The <b>glTexImage1D</b> function specifies a one-dimensional texture image.
...
The width of the texture image. Must be 2<i>ⁿ</i> + 2( <i>border</i> ) for some integer <i>n</i>. The height of the texture image is 1.
...
The following functions retrieve information related to <b>glTexImageID</b>:
