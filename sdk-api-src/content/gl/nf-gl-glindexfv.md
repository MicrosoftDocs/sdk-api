...
old-location: opengl\glindexfv.htm
old-project: OpenGL
ms.assetid: 355d1896-ea9d-4a80-9dee-285f3bf638e5
ms.author: windowsdriverdev
ms.date: 2/15/2018
ms.keywords: gl/glIndexfv, glIndexfv, glIndexfv function [OpenGL], opengl.glindexfv
...
The <b>glIndexfv</b> function sets the current color index.
...
The <b>glIndexfv</b> function updates the current (single-valued) color index. It takes one argument: the new value for the current color index.
...
The current index can be updated at any time. In particular, <b>glIndexfv</b> can be called between a call to <a href="https://msdn.microsoft.com/8e8e98f8-89e8-40f5-89c1-492c9e3bbd74">glBegin</a> and the corresponding call to <a href="https://msdn.microsoft.com/040f8573-683c-4a8a-ae51-66abb0541ac4">glEnd</a>.


The following function retrieves information related to <b>glIndexfv</b>:
