---
UID: NF:gl.glColor3iv
title: glColor3iv function
author: windows-driver-content
description: Sets the current color from an already existing array of color values.
old-location: opengl\glcolor3iv.htm
old-project: OpenGL
ms.assetid: b083fd09-fe92-4afa-bcb7-f36e9eeffbab
ms.author: windowsdriverdev
ms.date: 2/15/2018
ms.keywords: gl/glColor3iv, glColor3iv, glColor3iv function [OpenGL], opengl.glcolor3iv
