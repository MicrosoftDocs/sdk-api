...
and xₑ, yₑ, zₑ, and wₑ are the eye coordinates of the vertex, p₁, p₂, p₃, and p₄ are the values supplied in <i>param</i>, and M is the modelview matrix when you <b>callglTexGen</b>. If M is poorly conditioned or singular, texture coordinates generated by the resulting function can be inaccurate or undefined.
