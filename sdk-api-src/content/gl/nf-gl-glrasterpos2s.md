---
UID: NF:gl.glRasterPos2s
title: glRasterPos2s function
author: windows-driver-content
description: Specifies the raster position for pixel operations.
old-location: opengl\glrasterpos2s.htm
old-project: OpenGL
ms.assetid: e8055d0e-10b7-4878-92b1-a8019aaa89d1
ms.author: windowsdriverdev
ms.date: 2/15/2018
ms.keywords: gl/glRasterPos2s, glRasterPos2s, glRasterPos2s function [OpenGL], opengl.glrasterpos2s
