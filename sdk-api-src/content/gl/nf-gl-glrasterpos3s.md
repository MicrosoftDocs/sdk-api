---
UID: NF:gl.glRasterPos3s
title: glRasterPos3s function
author: windows-driver-content
description: Specifies the raster position for pixel operations.
old-location: opengl\glrasterpos3s.htm
old-project: OpenGL
ms.assetid: 8bfa48a5-1858-4ac8-8d33-15d72c86320f
ms.author: windowsdriverdev
ms.date: 2/15/2018
ms.keywords: gl/glRasterPos3s, glRasterPos3s, glRasterPos3s function [OpenGL], opengl.glrasterpos3s
