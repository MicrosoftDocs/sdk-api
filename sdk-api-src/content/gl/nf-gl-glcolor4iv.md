---
UID: NF:gl.glColor4iv
title: glColor4iv function
author: windows-driver-content
description: Sets the current color from an already existing array of color values.
old-location: opengl\glcolor4iv.htm
old-project: OpenGL
ms.assetid: 2d14f697-1796-4fd2-b007-3a84c6093644
ms.author: windowsdriverdev
ms.date: 2/15/2018
ms.keywords: gl/glColor4iv, glColor4iv, glColor4iv function [OpenGL], opengl.glcolor4iv
...
A pointer to an array that contains red, green, blue, and alpha values. 
