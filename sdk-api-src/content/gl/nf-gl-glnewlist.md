...
old-location: opengl\glnewlist.htm
old-project: OpenGL
ms.assetid: 9c6556d4-855f-4cba-94cc-27b5f1e4607a
ms.author: windowsdriverdev
ms.date: 2/15/2018
ms.keywords: GL_COMPILE, GL_COMPILE_AND_EXECUTE, gl/glNewList, glNewList, glNewList function [OpenGL], opengl.glnewlist
...
The <b>glNewList</b> and <a href="https://msdn.microsoft.com/dd749932-7b3c-47e5-8d91-90d272a7dc41">glEndList</a> functions create or replace a display list.
...
<tr>
<td width="40%"><a id="GL_COMPILE"></a><a id="gl_compile"></a><dl>
<dt><b>GL_COMPILE</b></dt>
</dl>
</td>
<td width="60%">
...
<tr>
<td width="40%"><a id="GL_COMPILE_AND_EXECUTE"></a><a id="gl_compile_and_execute"></a><dl>
<dt><b>GL_COMPILE_AND_EXECUTE</b></dt>
</dl>
</td>
<td width="60%">
...
When the <b>glEndList</b> function is encountered, the display list definition is completed by associating the list with the unique name <i>list</i> (specified in the <b>glNewList</b> command). If a display list with name <i>list</i> already exists, it is replaced only when <b>glEndList</b> is called.
...
The following function retrieves information related to <b>glNewList</b>:
...
<a href="https://msdn.microsoft.com/dd749932-7b3c-47e5-8d91-90d272a7dc41">glEndList</a>
