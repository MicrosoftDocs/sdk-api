---
UID: NF:gl.glColor3fv
title: glColor3fv function
author: windows-driver-content
description: Sets the current color from an already existing array of color values.
old-location: opengl\glcolor3fv.htm
old-project: OpenGL
ms.assetid: 4ffaaa7e-4fa3-45b8-acf0-850e1e9d9a60
ms.author: windowsdriverdev
ms.date: 2/15/2018
ms.keywords: gl/glColor3fv, glColor3fv, glColor3fv function [OpenGL], opengl.glcolor3fv
