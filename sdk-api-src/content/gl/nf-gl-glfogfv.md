...
old-location: opengl\glfogfv.htm
old-project: OpenGL
ms.assetid: a2243ff4-4f3a-4b8c-b4fb-ce2cd74815e4
ms.author: windowsdriverdev
ms.date: 2/15/2018
ms.keywords: GL_FOG_COLOR, GL_FOG_DENSITY, GL_FOG_END, GL_FOG_INDEX, GL_FOG_MODE, GL_FOG_START, gl/glFogfv, glFogfv, glFogfv function [OpenGL], opengl.glfogfv
...
<td width="60%">
The <i>params</i> parameter is a floating-point value that specifies <i>density</i>, the fog density used in both exponential fog equations. Only nonnegative densities are accepted. The default fog density is 1.0.
...
<td width="60%">
The <i>params</i> parameter is a floating-point value that specifies <i>start</i>, the near distance used in the linear fog equation. The default near distance is 0.0.
...
<td width="60%">
The <i>params</i> parameter is a floating-point value that specifies <i>end</i>, the far distance used in the linear fog equation. The default far distance is 1.0.
...
<td width="60%">
The <i>params</i> parameter is a floating-point value that specifies <i>i</i><sub>f</sub> , the fog color index. The default fog index is 0.0.
...
<td width="60%">
The <i>params</i> parameter contains four floating-point values that specify <i>C</i><sub>f</sub> , the fog color. Integer values are mapped linearly such that the most positive representable value maps to 1.0, and the most negative representable value maps to -1.0. Floating-point values are mapped directly. After conversion, all color components are clamped to the range [0,1]. The default fog color is (0,0,0,0).
...
The <b>glFogfv</b> function assigns the value or values in <i>params</i> to the fog parameter specified by <i>pname</i>.
