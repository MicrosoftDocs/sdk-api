...
old-location: opengl\glindexd.htm
old-project: OpenGL
ms.assetid: 4cd72d32-e796-4c94-94cb-591f1ee3b26e
ms.author: windowsdriverdev
ms.date: 2/15/2018
ms.keywords: gl/glIndexd, glIndexd, glIndexd function [OpenGL], opengl.glindexd
...
The <b>glIndexd</b> function sets the current color index.
...
The <b>glIndexd</b> function updates the current (single-valued) color index. It takes one argument: the new value for the current color index.
...
The current index can be updated at any time. In particular, <b>glIndexd</b> can be called between a call to <a href="https://msdn.microsoft.com/8e8e98f8-89e8-40f5-89c1-492c9e3bbd74">glBegin</a> and the corresponding call to <a href="https://msdn.microsoft.com/040f8573-683c-4a8a-ae51-66abb0541ac4">glEnd</a>.


The following function retrieves information related to <b>glIndexd</b>:
