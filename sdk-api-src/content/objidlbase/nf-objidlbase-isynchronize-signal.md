...
description: The ISynchronize::Signal (objidlbase.h) method sets the synchronization object to the signaled state and causes pending wait operations to return S_OK.
...
f1_keywords:
 - ISynchronize::Signal
 - objidlbase/ISynchronize::Signal
dev_langs:
 - c++
topic_type:
 - APIRef
