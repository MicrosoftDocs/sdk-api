...
helpviewer_keywords: ["DirectX::PackedVector.XMStoreByte2","XMStoreByte2","XMStoreByte2 method [DirectX Math Support APIs]","dxmath.xmstorebyte2"]
...
f1_keywords:
 - XMStoreByte2
 - directxpackedvector/XMStoreByte2
dev_langs:
 - c++
topic_type:
 - APIRef
...
Stores an <a href="https://docs.microsoft.com/windows/desktop/dxmath/xmvector-data-type">XMVECTOR</a> in an <a href="https://docs.microsoft.com/windows/desktop/api/directxpackedvector/ns-directxpackedvector-xmbyte2">XMBYTE2</a>.
