...
title: XMStoreDec4 function (directxpackedvector.h)
description: Stores an XMVECTOR in an XMDEC4.
helpviewer_keywords: ["DirectX::PackedVector.XMStoreDec4","XMStoreDec4","XMStoreDec4 method [DirectX Math Support APIs]","dxmath.xmstoredec4"]
...
f1_keywords:
- directxpackedvector/XMStoreDec4
dev_langs:
- c++
...
Stores an <a href="https://docs.microsoft.com/windows/desktop/dxmath/xmvector-data-type">XMVECTOR</a> in an <a href="https://docs.microsoft.com/windows/desktop/api/directxpackedvector/ns-directxpackedvector-xmdec4">XMDEC4</a>.
