...
ms.date: 11/02/2018
ms.keywords: XMHALF2 constructor [DirectX Math Support APIs], XMHALF2 constructor [DirectX Math Support APIs],XMHALF2 structure, XMHALF2 structure [DirectX Math Support APIs],XMHALF2 constructor, XMHALF2.XMHALF2(float,float), dxmath.xmhalf2_ctor_4
