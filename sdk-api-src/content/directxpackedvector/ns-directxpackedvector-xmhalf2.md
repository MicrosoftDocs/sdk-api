...
## -description
	...
	using <code>XMHALF2</code> when you are programming in C++, see <a href="https://msdn.microsoft.com/library/Ee415317(v=VS.85).aspx">XMHALF2 Extensions</a>.
...
<code>XMHALF2</code>
	    can be loaded into instances of <a href="https://msdn.microsoft.com/1a044094-444d-e787-fa6a-76e88531aef1">XMVECTOR</a> by using <a href="https://msdn.microsoft.com/library/Ee419893(v=VS.85).aspx">XMLoadHalf2</a>.
	


	    Instances of <code>XMVECTOR</code> can be stored into an instance of <code>XMHALF2</code> with <a href="https://msdn.microsoft.com/library/Ee420354(v=VS.85).aspx">XMStoreHalf2</a>.
...
<a href="https://msdn.microsoft.com/library/Ee415317(v=VS.85).aspx">XMHALF2 Extensions</a>
 
