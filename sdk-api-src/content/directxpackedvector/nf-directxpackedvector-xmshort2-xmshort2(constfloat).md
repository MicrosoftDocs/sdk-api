...
Initializes a new instance of <a href="https://msdn.microsoft.com/en-us/library/Ee420195(v=VS.85).aspx">XMSHORT2</a> from a two element <code>float</code> array argument.
