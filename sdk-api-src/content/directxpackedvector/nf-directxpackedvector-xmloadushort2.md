...
helpviewer_keywords: ["Use DirectX..XMLoadUShort2","XMLoadUShort2","XMLoadUShort2 method [DirectX Math Support APIs]","dxmath.xmloadushort2"]
...
Loads an <a href="/windows/desktop/api/directxpackedvector/ns-directxpackedvector-xmushort2">XMUSHORT2</a> into an <a href="/windows/desktop/dxmath/xmvector-data-type">XMVECTOR</a>.

## -parameters

### -param pSource [in]

Address of the <a href="/windows/desktop/api/directxpackedvector/ns-directxpackedvector-xmushort2">XMUSHORT2</a> structure to load. This parameter must point to cached
        memory.
