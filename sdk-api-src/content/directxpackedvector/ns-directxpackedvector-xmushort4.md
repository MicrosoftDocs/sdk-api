...
## -description
	...
	using <code>XMUSHORT4</code> when you are programming in C++, see <a href="https://msdn.microsoft.com/library/Ee415502(v=VS.85).aspx">XMUSHORT4 Extensions</a>.
...
<code>XMUSHORT4</code> can be loaded into instances of <a href="https://msdn.microsoft.com/1a044094-444d-e787-fa6a-76e88531aef1"> XMVECTOR</a> by
	    using <a href="https://msdn.microsoft.com/library/Ee419946(v=VS.85).aspx">XMLoadUShort4</a>.
	


	    Instances of <code>XMVECTOR</code> can be stored into an instance of <code>XMUSHORT4</code> with <a href="https://msdn.microsoft.com/library/Ee420388(v=VS.85).aspx">XMStoreUShort4</a>.
...
<a href="https://msdn.microsoft.com/library/Ee415502(v=VS.85).aspx">XMUSHORT4 Extensions</a>
 
