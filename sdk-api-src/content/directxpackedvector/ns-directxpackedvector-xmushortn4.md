...
## -description
	...
	using <code>XMUSHORTN4</code> when you are programming in C++, see <a href="https://msdn.microsoft.com/library/Ee415516(v=VS.85).aspx">XMUSHORTN4 Extensions</a>.
...
## -remarks
	    ...
	    normalized values by using <a href="https://msdn.microsoft.com/library/Ee419948(v=VS.85).aspx">XMLoadUShortN4</a>, which divides each
	    ...
	    using <a href="https://msdn.microsoft.com/library/Ee420390(v=VS.85).aspx">XMStoreUShortN4</a>, which multiplies each component by 65535.0f,
...
<a href="https://msdn.microsoft.com/library/Ee415516(v=VS.85).aspx">XMUSHORTN4 Extensions</a>
 
