...
ms.date: 11/15/2018
ms.keywords: XMXDEC4 constructor [DirectX Math Support APIs], XMXDEC4 constructor [DirectX Math Support APIs],XMXDEC4 structure, XMXDEC4 structure [DirectX Math Support APIs],XMXDEC4 constructor, XMXDEC4.XMXDEC4(uint32_t), dxmath.xmxdec4_ctor_2
