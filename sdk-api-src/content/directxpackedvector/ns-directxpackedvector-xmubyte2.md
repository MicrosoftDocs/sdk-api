...
For a list of additional functionality such as constructors and operators that are available using <code>XMUBYTE2</code> when you
  are programming in C++, see <a href="https://msdn.microsoft.com/library/Hh449524(v=VS.85).aspx">XMUBYTE2 Extensions</a>.
...
## -remarks
     ...
     You can use <a href="https://msdn.microsoft.com/library/Hh404678(v=VS.85).aspx">XMLoadUByte2</a> to load <code>XMUBYTE2</code> 
     into instances of <a href="https://msdn.microsoft.com/1a044094-444d-e787-fa6a-76e88531aef1">XMVECTOR</a>.

You can use <a href="https://msdn.microsoft.com/library/Hh404704(v=VS.85).aspx">XMStoreUByte2</a> to store instances of <code>XMVECTOR</code> 
...
<a href="https://msdn.microsoft.com/library/Hh449524(v=VS.85).aspx">XMUBYTE2 Extensions</a>
 
