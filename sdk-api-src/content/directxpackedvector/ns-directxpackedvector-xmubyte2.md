...
ms.topic: struct
f1_keywords: ["directxpackedvector/_XMUBYTE2"]
...
For a list of additional functionality such as constructors and operators that are available using <code>XMUBYTE2</code> when you
  are programming in C++, see <a href="https://docs.microsoft.com/windows/desktop/dxmath/ovw-xmubyte2-extensions">XMUBYTE2 Extensions</a>.
...
You can use <a href="https://docs.microsoft.com/windows/desktop/api/directxpackedvector/nf-directxpackedvector-xmstoreubyte2">XMStoreUByte2</a> to store instances of <code>XMVECTOR</code> 
