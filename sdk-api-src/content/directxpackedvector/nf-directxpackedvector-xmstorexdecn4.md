...
title: XMStoreXDecN4 function (directxpackedvector.h)
description: Stores an XMVECTOR in an XMXDECN4.
helpviewer_keywords: ["DirectX::PackedVector.XMStoreXDecN4","XMStoreXDecN4","XMStoreXDecN4 method [DirectX Math Support APIs]","dxmath.xmstorexdecn4"]
...
f1_keywords:
- directxpackedvector/XMStoreXDecN4
dev_langs:
- c++
...
Stores an <a href="https://docs.microsoft.com/windows/desktop/dxmath/xmvector-data-type">XMVECTOR</a> in an <a href="https://docs.microsoft.com/windows/desktop/api/directxpackedvector/ns-directxpackedvector-xmxdecn4">XMXDECN4</a>.
