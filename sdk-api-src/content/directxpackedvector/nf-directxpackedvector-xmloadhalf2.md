...
helpviewer_keywords: ["DirectX::PackedVector.XMLoadHalf2","XMLoadHalf2","XMLoadHalf2 method [DirectX Math Support APIs]","dxmath.xmloadhalf2"]
...
Loads an <a href="/windows/desktop/api/directxpackedvector/ns-directxpackedvector-xmhalf2">XMHALF2</a> into an <a href="/windows/desktop/dxmath/xmvector-data-type">XMVECTOR</a>.

## -parameters

### -param pSource [in]

Address of the <a href="/windows/desktop/api/directxpackedvector/ns-directxpackedvector-xmhalf2">XMHALF2</a> structure to load.
...
The <b>x</b> and <b>y</b> members of the <a href="/windows/desktop/api/directxpackedvector/ns-directxpackedvector-xmhalf2">XMHALF2</a> are converted to
