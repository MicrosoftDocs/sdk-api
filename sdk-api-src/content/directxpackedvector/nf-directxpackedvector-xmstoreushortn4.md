---
UID: NF:directxpackedvector.XMStoreUShortN4
title: XMStoreUShortN4 function (directxpackedvector.h)
description: Stores an XMVECTOR in an XMUSHORTN4.
helpviewer_keywords: ["DirectX::PackedVector.XMStoreUShortN4","XMStoreUShortN4","XMStoreUShortN4 method [DirectX Math Support APIs]","dxmath.xmstoreushortn4"]
old-location: dxmath\xmstoreushortn4.htm
tech.root: dxmath
...
Stores an <a href="https://docs.microsoft.com/windows/desktop/dxmath/xmvector-data-type">XMVECTOR</a> in an <a href="https://docs.microsoft.com/windows/desktop/api/directxpackedvector/ns-directxpackedvector-xmushortn4">XMUSHORTN4</a>.
