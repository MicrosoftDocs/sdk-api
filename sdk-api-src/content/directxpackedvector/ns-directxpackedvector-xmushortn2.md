...
ms.topic: struct
f1_keywords: ["directxpackedvector/XMUSHORTN2"]
...
For a list of more functionality such as constructors and operators that are available
	using <code>XMUSHORTN2</code> when you are programming in C++, see <a href="https://docs.microsoft.com/windows/desktop/dxmath/ovw-xmushortn2-extensions">XMUSHORTN2 Extensions</a>.
...
You can use <code>XMUSHORTN2</code> to load instances of <a href="https://docs.microsoft.com/windows/desktop/dxmath/xmvector-data-type">XMVECTOR</a> from
...
You can store <code>XMVECTOR</code> instances containing normalized values into <code>XMUSHORTN2</code>using <a href="https://docs.microsoft.com/windows/desktop/api/directxpackedvector/nf-directxpackedvector-xmstoreshortn4">XMStoreShortN4</a>, which multiplies each component by 65535.0f
...
<a href="https://docs.microsoft.com/windows/desktop/dxmath/ovw-xmushortn2-extensions">XMUSHORTN2 Extensions</a>
 
