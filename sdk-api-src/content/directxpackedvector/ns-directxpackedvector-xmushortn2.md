...
For a list of more functionality such as constructors and operators that are available
	using <code>XMUSHORTN2</code> when you are programming in C++, see <a href="https://msdn.microsoft.com/en-us/library/Ee415509(v=VS.85).aspx">XMUSHORTN2 Extensions</a>.
...
You can store <code>XMVECTOR</code> instances containing normalized values into <code>XMUSHORTN2</code>using <a href="https://msdn.microsoft.com/en-us/library/Ee420373(v=VS.85).aspx">XMStoreShortN4</a>, which multiplies each component by 65535.0f
...
<a href="https://msdn.microsoft.com/en-us/library/Ee415509(v=VS.85).aspx">XMUSHORTN2 Extensions</a>
 
