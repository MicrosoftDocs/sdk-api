---
UID: NF:directxpackedvector.XMUSHORTN4.XMUSHORTN4(const float)
...
Initializes a new instance of <a href="https://msdn.microsoft.com/en-us/library/Ee420726(v=VS.85).aspx">XMUSHORTN4</a> from a four element <code>float</code> array argument.
