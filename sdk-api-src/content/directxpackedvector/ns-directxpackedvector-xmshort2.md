...
## -description
	...
	using <code>XMSHORT2</code> when you are programming in C++, see <a href="https://msdn.microsoft.com/library/Ee415426(v=VS.85).aspx">XMSHORT2 Extensions</a>.
...
## -remarks
	    ...
	    The components are normalized when this structure is loaded into an <a href="https://msdn.microsoft.com/1a044094-444d-e787-fa6a-76e88531aef1">XMVECTOR</a> using <a href="https://msdn.microsoft.com/library/Ee419924(v=VS.85).aspx">XMLoadShort2</a>. Each component will be divided by 32767.0f.
...
<a href="https://msdn.microsoft.com/library/Ee415426(v=VS.85).aspx">XMSHORT2 Extensions</a>
 
