...
Assigns the vector component data packed in an instance of **uint32_t** to the current instance of <a href="https://msdn.microsoft.com/en-us/library/Ee420508(v=VS.85).aspx">XMUDEC4</a>.
