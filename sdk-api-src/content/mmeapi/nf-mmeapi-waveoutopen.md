...
ms.topic: function
f1_keywords: ["mmeapi/waveOutOpen"]
req.header: mmeapi.h
...
<a href="https://docs.microsoft.com/windows/desktop/Multimedia/using-a-window-or-thread-to-process-driver-messages">Using a Window or Thread to Process Driver Messages</a>



<a href="https://docs.microsoft.com/windows/desktop/Multimedia/using-an-callback-to-process-driver-messages">Using an Event Callback to Process Driver Messages</a>
