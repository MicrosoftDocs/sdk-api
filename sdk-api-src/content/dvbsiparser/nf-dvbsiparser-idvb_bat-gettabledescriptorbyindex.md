...
Specifies which descriptor to retrieve, indexed from zero. Call the <a href="/previous-versions/windows/desktop/api/dvbsiparser/nf-dvbsiparser-idvb_bat-getcountoftabledescriptors">IDVB_BAT::GetCountOfTableDescriptors</a> method to get the number of table descriptors in the BAT.
