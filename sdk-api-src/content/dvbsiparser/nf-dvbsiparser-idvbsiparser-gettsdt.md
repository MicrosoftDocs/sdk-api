...
Address of a variable that receives an <a href="https://msdn.microsoft.com/en-us/library/Dd694980(v=VS.85).aspx">ITSDT</a> interface pointer. The caller must release the interface.
