...
This method applies only to <i>next</i> tables that have become current. Before calling this method, call <a href="/previous-versions/windows/desktop/api/dvbsiparser/nf-dvbsiparser-idvb_bat-registerforwhencurrent">IDVB_BAT::RegisterForWhenCurrent</a> and wait for the event to be signaled.
