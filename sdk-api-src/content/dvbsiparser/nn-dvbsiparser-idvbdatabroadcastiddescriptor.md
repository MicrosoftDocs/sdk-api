...
The <b>IDvbDataBroadcastIDDescriptor</b> interface inherits from the <a href="/windows/desktop/api/unknwn/nn-unknwn-iunknown">IUnknown</a> interface. <b>IDvbDataBroadcastIDDescriptor</b> also has these types of members:
<ul>
