...
title: IISDB_NBIT::GetRecordInformationId method
...
ms.date: 4/26/2018
ms.keywords: GetRecordInformationId method [Microsoft TV Technologies], GetRecordInformationId method [Microsoft TV Technologies], IISDB_NBIT interface, GetRecordInformationId,IISDB_NBIT.GetRecordInformationId, IISDB_NBIT, IISDB_NBIT interface [Microsoft TV Technologies], GetRecordInformationId method, IISDB_NBIT::GetRecordInformationId, dvbsiparser/IISDB_NBIT::GetRecordInformationId, mstv.iisdb_nbit_getrecordinformationid
...
# IISDB_NBIT::GetRecordInformationId method
