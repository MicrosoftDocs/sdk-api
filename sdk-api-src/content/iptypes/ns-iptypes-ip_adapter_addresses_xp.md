...
description: The IP_ADAPTER_ADDRESSES_XP structure (iptypes.h) is the header node for a linked list of addresses for a particular adapter.
...
f1_keywords:
 ...
 - iptypes/_IP_ADAPTER_ADDRESSES_XP
 - PIP_ADAPTER_ADDRESSES_XP
 - iptypes/PIP_ADAPTER_ADDRESSES_XP
 - IP_ADAPTER_ADDRESSES_XP
 - iptypes/IP_ADAPTER_ADDRESSES_XP
dev_langs:
 - c++
topic_type:
 - APIRef
