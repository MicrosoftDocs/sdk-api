...
ms.topic: function
f1_keywords: ["d2d1helper/GradientStop"]
...
Creates a <a href="https://docs.microsoft.com/windows/desktop/api/d2d1/ns-d2d1-d2d1_gradient_stop">D2D1_GRADIENT_STOP</a> structure. 
