...
Creates a <a href="https://msdn.microsoft.com/en-us/library/Dd368122(v=VS.85).aspx">D2D1_HWND_RENDER_TARGET_PROPERTIES</a> structure.
...
The size of the render target, in pixels. The default value is a <a href="https://msdn.microsoft.com/en-us/library/Dd368162(v=VS.85).aspx">D2D1_SIZE_U</a> that has a width and height of 0.
...
A value that specifies whether the render target retains the frame after it is presented and whether the render target waits for the device to refresh before presenting. The default value is <a href="https://msdn.microsoft.com/en-us/library/Dd368144(v=VS.85).aspx">D2D1_PRESENT_OPTIONS_NONE</a>.
...
Type: <b><a href="https://msdn.microsoft.com/en-us/library/Dd368122(v=VS.85).aspx">D2D1_HWND_RENDER_TARGET_PROPERTIES</a></b>
