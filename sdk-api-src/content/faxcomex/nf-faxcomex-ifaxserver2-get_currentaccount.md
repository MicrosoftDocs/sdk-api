...
f1_keywords:
 ...
 - faxcomex/IFaxServer2::get_CurrentAccount
dev_langs:
 - c++
topic_type:
 - APIRef
...
The <b>IFaxServer2::CurrentAccount</b> property returns the fax account for the user account that has connected to the fax server.
