...
ms.custom: 19H1
f1_keywords:
 - IFaxOutgoingMessage::get_Id
 - faxcomex/IFaxOutgoingMessage::get_Id
dev_langs:
 - c++
topic_type:
 - APIRef
...
The <b>IFaxOutgoingMessage::get_Id</b> property is a null-terminated string that contains a unique identifier for the outbound fax message.
