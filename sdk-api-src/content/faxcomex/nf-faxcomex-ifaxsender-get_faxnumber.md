...
description: The IFaxSender::get_FaxNumber property is a null-terminated string that contains the fax number associated with the sender. (Get)
...
f1_keywords:
 ...
 - faxcomex/IFaxSender::get_FaxNumber
dev_langs:
 - c++
topic_type:
 - APIRef
