---
UID: NF:faxcomex.IFaxDocument.put_GroupBroadcastReceipts
title: IFaxDocument::put_GroupBroadcastReceipts (faxcomex.h)
description: The IFaxDocument::get_GroupBroadcastReceipts property is a Boolean value that indicates whether to send an individual delivery receipt for each recipient of the broadcast, or to send a summary receipt for all the recipients. (Put)
