...
If this property is equal to <a href="https://msdn.microsoft.com/en-us/library/ms687973(v=VS.85).aspx">frrcANY_CODE</a>, the outbound routing rule applies to all area codes.
