...
f1_keywords:
 - _IFaxServerNotify2::OnOutgoingQueueConfigChange
 - faxcomex/_IFaxServerNotify2::OnOutgoingQueueConfigChange
dev_langs:
 - c++
topic_type:
 - APIRef
...
The fax service calls the <b>IFaxServerNotify2::OnOutgoingQueueConfigChange</b> method when there is a configuration change related to the outgoing fax job queue.
