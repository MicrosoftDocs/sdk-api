...
description: Sets or retrieves a value that indicates the length of time the fax service should wait before retrying a failed fax transmission. (Put)
...
f1_keywords:
 ...
 - faxcomex/IFaxConfiguration::put_RetryDelay
dev_langs:
 - c++
topic_type:
 - APIRef
