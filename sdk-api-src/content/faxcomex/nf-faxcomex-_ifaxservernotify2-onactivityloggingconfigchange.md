...
ms.topic: method
f1_keywords: ["faxcomex/IFaxServerNotify2.OnActivityLoggingConfigChange"]
...
The fax service calls the <b>IFaxServerNotify2::OnActivityLoggingConfigChange</b> method when there is a configuration change related to activity logging.
