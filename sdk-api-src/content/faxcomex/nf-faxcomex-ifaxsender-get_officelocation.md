...
description: The IFaxSender::get_OfficeLocation property is a null-terminated string that contains the office location of the sender. (Get)
...
f1_keywords:
 ...
 - faxcomex/IFaxSender::get_OfficeLocation
dev_langs:
 - c++
topic_type:
 - APIRef
