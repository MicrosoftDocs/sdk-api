...
ms.topic: method
f1_keywords: ["faxcomex/IFaxIncomingMessage.TSID"]
...
The <b>TSID</b> property is a null-terminated string that contains the transmitting station identifier (TSID) associated with the inbound fax message.
