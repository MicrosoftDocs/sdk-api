...
If both the <a href="https://msdn.microsoft.com/en-us/library/Aa359051(v=VS.85).aspx">SizeLow</a> and <b>SizeHigh</b> properties have the value 0xffffffff, they specify an invalid archive size, and you should ignore both property values.
