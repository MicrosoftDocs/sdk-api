...
f1_keywords:
 ...
 - faxcomex/IFaxServer::get_ServerName
dev_langs:
 - c++
topic_type:
 - APIRef
...
The <b>IFaxServer::get_ServerName</b> property retrieves the name of the active fax server to which the fax client is connected.
