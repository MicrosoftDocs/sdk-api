...
description: The IFaxReceiptOptions::get_SMTPUser property is a null-terminated string that contains the Simple Mail Transport Protocol (SMTP) user name used for authenticated connections. (Get)
...
f1_keywords:
 ...
 - faxcomex/IFaxReceiptOptions::get_SMTPUser
dev_langs:
 - c++
topic_type:
 - APIRef
