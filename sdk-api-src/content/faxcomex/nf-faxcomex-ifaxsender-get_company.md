...
description: The IFaxSender::get_Company property is a null-terminated string that contains the company name associated with the sender. (Get)
...
f1_keywords:
 ...
 - faxcomex/IFaxSender::get_Company
dev_langs:
 - c++
topic_type:
 - APIRef
...
The <b>IFaxSender::get_Company</b> property is a null-terminated string that contains the company name associated with the sender.
