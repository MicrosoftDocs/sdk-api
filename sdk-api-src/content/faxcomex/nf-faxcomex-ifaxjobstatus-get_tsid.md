...
ms.topic: method
f1_keywords: ["faxcomex/IFaxJobStatus.TSID"]
...
The <b>TSID</b> property is a null-terminated string that contains the transmitting station identifier (TSID) associated with the fax job.
