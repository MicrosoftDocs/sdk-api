...
f1_keywords:
 ...
 - faxcomex/IFaxOutgoingJob::get_TSID
dev_langs:
 - c++
topic_type:
 - APIRef
...
The <b>IFaxOutgoingJob::get_TSID</b> property is a null-terminated string that contains the transmitting station identifier (TSID) associated with the fax outbound job.
