...
title: IFaxServer::get_OutboundRouting method
...
ms.date: 3/22/2018
ms.keywords: IFaxServer, IFaxServer interface [Fax Service], OutboundRouting property, IFaxServer.OutboundRouting, IFaxServer::get_OutboundRouting, OutboundRouting property [Fax Service], OutboundRouting property [Fax Service], IFaxServer interface, _mfax_faxserver.outboundrouting_cpp, fax._mfax_faxserver_outboundrouting_cpp, faxcomex/IFaxServer::OutboundRouting, faxcomex/IFaxServer::get_OutboundRouting, get_OutboundRouting,IFaxServer.get_OutboundRouting
...
# IFaxServer::get_OutboundRouting method
