...
ms.topic: method
f1_keywords: ["faxcomex/IFaxOutgoingJob.CSID"]
...
The <b>IFaxOutgoingJob::get_CSID</b> property is a null-terminated string that contains the called station identifier (CSID) associated with the fax outbound job.
