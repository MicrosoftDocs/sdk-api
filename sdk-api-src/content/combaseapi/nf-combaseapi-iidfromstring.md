...
Converts a string generated by the <a href="https://msdn.microsoft.com/en-us/library/ms688692(v=VS.85).aspx">StringFromIID</a> function back into the original interface identifier (IID).
...
<a href="https://msdn.microsoft.com/en-us/library/ms688692(v=VS.85).aspx">StringFromIID</a>
 
