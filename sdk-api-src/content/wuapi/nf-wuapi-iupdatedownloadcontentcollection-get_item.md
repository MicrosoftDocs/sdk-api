...
Gets the download content for  an update from an <a href="/windows/desktop/api/wuapi/nn-wuapi-iupdatedownloadcontentcollection">IUpdateDownloadContentCollection</a> interface.
