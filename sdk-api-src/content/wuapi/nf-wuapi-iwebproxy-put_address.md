...
title: IWebProxy::put_Address method
...
ms.date: 3/15/2018
ms.keywords: Address property [Windows Update Agent], Address property [Windows Update Agent], IWebProxy interface, IWebProxy, IWebProxy interface [Windows Update Agent], Address property, IWebProxy.Address, IWebProxy::get_Address, IWebProxy::put_Address, put_Address,IWebProxy.put_Address, wua.iwebproxy_address, wuapi/IWebProxy::Address, wuapi/IWebProxy::get_Address, wuapi/IWebProxy::put_Address
