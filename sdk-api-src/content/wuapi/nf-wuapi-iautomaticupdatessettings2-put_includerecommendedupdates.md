...
description: Gets and sets a Boolean value that indicates whether to include optional or recommended updates when a search for updates and installation of updates is performed. (Put)
...
f1_keywords:
 ...
 - wuapi/IAutomaticUpdatesSettings2::put_IncludeRecommendedUpdates
dev_langs:
 - c++
topic_type:
 - APIRef
