...
The <b>IUpdateLockdown</b> interface is derived from <a href="https://msdn.microsoft.com/library/ms680509(v=VS.85).aspx">IUnknown</a>, not <a href="https://msdn.microsoft.com/library/ms221608(v=VS.85).aspx">IDispatch</a>. It cannot be accessed by using a script. This interface restricts access to the Windows Update  website.
