...
title: IUpdateCollection::get_Item method
...
ms.date: 3/15/2018
ms.keywords: IUpdateCollection, IUpdateCollection interface [Windows Update Agent], Item property, IUpdateCollection.Item, IUpdateCollection::get_Item, IUpdateCollection::put_Item, Item property [Windows Update Agent], Item property [Windows Update Agent], IUpdateCollection interface, get_Item,IUpdateCollection.get_Item, wua.iupdatecollection_item, wuapi/IUpdateCollection::Item, wuapi/IUpdateCollection::get_Item, wuapi/IUpdateCollection::put_Item
...
# IUpdateCollection::get_Item method
