...
title: IWebProxy::put_BypassProxyOnLocal (wuapi.h)
description: Gets and sets a Boolean value that indicates whether local addresses bypass the proxy server. (Put)
...
f1_keywords:
 ...
 - wuapi/IWebProxy::put_BypassProxyOnLocal
dev_langs:
 - c++
topic_type:
 - APIRef
