...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">ISearchCompletedCallback</b> interface inherits from the <a href="/windows/desktop/api/unknwn/nn-unknwn-iunknown">IUnknown</a> interface. <b>ISearchCompletedCallback</b> also has these types of members:
<ul>
...
<a href="/windows/desktop/api/wuapi/nf-wuapi-isearchcompletedcallback-invoke">Invoke</a>
</td>
<td align="left" width="63%">
Handles the notification of the completion of an asynchronous search initiated by calling <a href="/windows/desktop/api/wuapi/nf-wuapi-iupdatesearcher-beginsearch">IUpdateSearcher.BeginSearch</a>
