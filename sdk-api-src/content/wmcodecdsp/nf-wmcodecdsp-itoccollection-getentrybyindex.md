...
ms.topic: method
f1_keywords: ["wmcodecdsp/ITocCollection.GetEntryByIndex"]
...
Pointer to a variable that receives a pointer to an <a href="https://docs.microsoft.com/windows/desktop/api/wmcodecdsp/nn-wmcodecdsp-itoc">IToc</a> interface that represents the table of contents.
