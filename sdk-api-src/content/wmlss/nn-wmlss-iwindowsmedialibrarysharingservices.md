...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IWindowsMediaLibrarySharingServices</b> interface inherits from the <a href="/previous-versions/windows/desktop/api/oaidl/nn-oaidl-idispatch.md">IDispatch</a> interface. <b>IWindowsMediaLibrarySharingServices</b> also has these types of members:
<ul>
...
To obtain an <b>IWindowsMediaLibrarySharingServices</b> interface, call <a href="https://msdn.microsoft.com/library/windows/desktop/7295a55b-12c7-4ed0-a7a4-9ecee16afdec">CoCreateInstance</a> to create a <b>WindowsMediaLibrarySharingServices</b> object.
