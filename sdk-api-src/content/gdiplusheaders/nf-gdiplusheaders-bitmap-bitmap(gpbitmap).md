---
UID: NF:gdiplusheaders.Bitmap.Bitmap(GpBitmap)
title: Bitmap::Bitmap(GpBitmap)
...
ms.date: 07/29/2018
ms.keywords: Bitmap, Bitmap constructors [GDI+], Bitmap.Bitmap, Bitmap.Bitmap(GpBitmap), Bitmap::Bitmap, Bitmap::Bitmap(GpBitmap), _gdiplus_CLASS_Bitmap_Constructors, gdiplus._gdiplus_CLASS_Bitmap_Constructors, gdiplusheaders/Bitmap
ms.prod: windows
