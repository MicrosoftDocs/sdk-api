...
title: Bitmap::Bitmap(IN HINSTANCE,IN const WCHAR)
...
ms.date: 07/13/2018
ms.keywords: Bitmap, Bitmap constructors [GDI+], Bitmap.Bitmap, Bitmap.Bitmap(IN HINSTANCE,IN const WCHAR), Bitmap::Bitmap, Bitmap::Bitmap(IN HINSTANCE,IN const WCHAR), _gdiplus_CLASS_Bitmap_Constructors, gdiplus._gdiplus_CLASS_Bitmap_Constructors, gdiplusheaders/Bitmap
ms.prod: windows
