...
The <a href="https://msdn.microsoft.com/library/ms535390(v=VS.85).aspx">Image::GetPropertyItem</a> method returns a <a href="https://msdn.microsoft.com/library/ms534493(v=VS.85).aspx">PropertyItem</a> object. Before you call 
				...
				<a href="https://msdn.microsoft.com/library/ms534462(v=VS.85).aspx">Image</a> object to get the size, in bytes, of the required buffer.
...
#### Examples
			...
			The following example creates an 
						<a href="https://msdn.microsoft.com/library/ms534462(v=VS.85).aspx">Image</a> object based on a JPEG file. The code calls the <b>Image::GetPropertyItemSize</b> method of that 
						<b>Image</b> object to get the size of the property item that holds the make of the camera used to capture the image. Then the code calls the <a href="https://msdn.microsoft.com/library/ms535390(v=VS.85).aspx">Image::GetPropertyItem</a> method to retrieve that property item.
