---
UID: NF:gdiplusheaders.Region.Xor(INconstGraphicsPath)
...
Pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/gdipluspath/nl-gdipluspath-graphicspath">GraphicsPath</a> that specifies the path to use to update this region. 
