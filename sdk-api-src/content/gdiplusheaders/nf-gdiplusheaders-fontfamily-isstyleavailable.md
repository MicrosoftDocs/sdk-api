...
The following example creates a <a href="https://msdn.microsoft.com/library/ms534439(v=VS.85).aspx">FontFamily</a> object. If the font family has a regular style available, the example draws text.
