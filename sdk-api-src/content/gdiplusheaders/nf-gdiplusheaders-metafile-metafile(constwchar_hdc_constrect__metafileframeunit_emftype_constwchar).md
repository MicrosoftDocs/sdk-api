---
UID: NF:gdiplusheaders.Metafile.Metafile(constWCHAR,HDC,constRect&,MetafileFrameUnit,EmfType,constWCHAR)
...
description: Creates a Metafile::Metafile object for recording. (overload 2/6)
