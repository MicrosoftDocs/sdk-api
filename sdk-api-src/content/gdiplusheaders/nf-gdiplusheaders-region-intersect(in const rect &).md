...
old-location: gdiplus\_gdiplus_CLASS_Region_Intersect_Rect_rect_.htm
tech.root: gdiplus
ms.assetid: VS|gdicpp|~\gdiplus\gdiplusreference\classes\regionclass\regionmethods\regionintersectmethods\intersect_14rectamprect.htm
ms.author: windowssdkdev
ms.date: 11/09/2018
ms.keywords: Intersect, Intersect method [GDI+], Intersect method [GDI+],Region class, Region class [GDI+],Intersect method, Region.Intersect, Region.Intersect(IN const Rect &), Region.Intersect(const Rect&), Region::Intersect, Region::Intersect(IN const Rect &), _gdiplus_CLASS_Region_Intersect_Rect_rect_, gdiplus._gdiplus_CLASS_Region_Intersect_Rect_rect_
