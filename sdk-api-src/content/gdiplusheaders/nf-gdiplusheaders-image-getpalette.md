...
The <b>Image::GetPalette</b> method gets the <a href="https://msdn.microsoft.com/library/ms534064(v=VS.85).aspx">ColorPalette</a> of this 
...
Pointer to a <a href="https://msdn.microsoft.com/library/ms534064(v=VS.85).aspx">ColorPalette</a> structure that receives the palette. 
...
Integer that specifies the size, in bytes, of the palette. Call the <a href="https://msdn.microsoft.com/library/ms535385(v=VS.85).aspx">Image::GetPaletteSize</a> method to determine the size. 
...
<a href="https://msdn.microsoft.com/library/ms535385(v=VS.85).aspx">Image::GetPaletteSize</a>
