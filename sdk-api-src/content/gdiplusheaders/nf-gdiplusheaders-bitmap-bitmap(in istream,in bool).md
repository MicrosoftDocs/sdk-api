...
ms.date: 07/29/2018
ms.keywords: Bitmap, Bitmap constructors [GDI+], Bitmap.Bitmap, Bitmap.Bitmap(IN IStream,IN BOOL), Bitmap::Bitmap, Bitmap::Bitmap(IN IStream,IN BOOL), _gdiplus_CLASS_Bitmap_Constructors, gdiplus._gdiplus_CLASS_Bitmap_Constructors, gdiplusheaders/Bitmap
ms.prod: windows
