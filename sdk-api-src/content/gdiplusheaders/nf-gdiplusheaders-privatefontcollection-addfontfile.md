...
The following example creates a <a href="https://msdn.microsoft.com/library/ms534491(v=VS.85).aspx">PrivateFontCollection</a> object and adds three font files to the collection. The code then gets the font families that are in the collection and, for each family in the collection, creates a font which is used to draw text.
