---
UID: NF:gdiplusheaders.Region.IsVisible(REAL,REAL,REAL,REAL,constGraphics)
title: Region::IsVisible(IN REAL,IN REAL,IN REAL,IN REAL,IN const Graphics) (gdiplusheaders.h)
description: The Region::IsVisible method determines whether a rectangle intersects this region. (overload 1/4)
