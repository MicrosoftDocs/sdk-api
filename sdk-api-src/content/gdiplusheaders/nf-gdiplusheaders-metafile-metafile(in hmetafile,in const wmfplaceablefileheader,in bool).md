...
ms.date: 05/24/2018
ms.keywords: Metafile, Metafile constructors [GDI+], Metafile.Metafile, Metafile.Metafile(IN HMETAFILE,IN const WmfPlaceableFileHeader,IN BOOL), Metafile::Metafile, Metafile::Metafile(IN HMETAFILE,IN const WmfPlaceableFileHeader,IN BOOL), _gdiplus_CLASS_Metafile_Constructors, gdiplus._gdiplus_CLASS_Metafile_Constructors, gdiplusheaders/Metafile
ms.prod: windows
