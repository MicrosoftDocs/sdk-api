...
This method sets the 
				...
				<a href="https://msdn.microsoft.com/library/ms534477(v=VS.85).aspx">Metafile</a> object to an invalid state. The user is responsible for calling DeleteEnhMetafile, to delete the Windows handle.
...
The following example creates a 
						...
						<a href="https://msdn.microsoft.com/library/ms534477(v=VS.85).aspx">Metafile</a> object from an EMF+ file and gets a Windows handle to the metafile.
