...
Integer that specifies the size, in bytes, of the property item to be retrieved. Call the <a href="https://msdn.microsoft.com/library/ms535391(v=VS.85).aspx">Image::GetPropertyItemSize</a> method to determine the size. 
...
Pointer to a <a href="https://msdn.microsoft.com/library/ms534493(v=VS.85).aspx">PropertyItem</a> object that receives the property item. 
...
The <b>Image::GetPropertyItem</b> method returns a <a href="https://msdn.microsoft.com/library/ms534493(v=VS.85).aspx">PropertyItem</a> object. Before you call 
				<b>Image::GetPropertyItem</b>, you must allocate a buffer large enough to receive that object — the size varies according to data type and value of the property item. You can call the <a href="https://msdn.microsoft.com/library/ms535391(v=VS.85).aspx">Image::GetPropertyItemSize</a> method of an 
...
#### Examples
			...
			The following example creates an 
						<a href="https://msdn.microsoft.com/library/ms534462(v=VS.85).aspx">Image</a> object based on a JPEG file. The code gets the make of the camera that captured the image by passing the PropertyTagEquipMake constant to the <b>Image::GetPropertyItem</b> method of the 
						<b>Image</b> object.
