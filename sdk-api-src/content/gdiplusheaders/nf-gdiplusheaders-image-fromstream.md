...
The <b>Image::FromStream</b> method creates a new 
			<a href="https://msdn.microsoft.com/library/ms534462(v=VS.85).aspx">Image</a> object based on a stream.
...
Pointer to an 
					<a href="https://msdn.microsoft.com/library/Aa380034(v=VS.85).aspx">IStream</a> interface. The implementation of 
...
Optional. Boolean value that specifies whether the new 
					<a href="https://msdn.microsoft.com/library/ms534462(v=VS.85).aspx">Image</a> object applies color correction according to color management information that is embedded in the stream. Embedded information can include International Color Consortium (ICC) profiles, gamma values, and chromaticity information. <b>TRUE</b> specifies that color correction is enabled, and <b>FALSE</b> specifies that color correction is not enabled. The default value is <b>FALSE</b>. 
...
<a href="https://msdn.microsoft.com/library/Aa380034(v=VS.85).aspx">IStream</a>
...
<a href="https://msdn.microsoft.com/library/Aa380341(v=VS.85).aspx">StgOpenStorage</a>
 
