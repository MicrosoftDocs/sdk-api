...
title: Region::Union(IN const GraphicsPath)
...
Pointer to a <a href="https://msdn.microsoft.com/en-us/library/ms534456(v=VS.85).aspx">GraphicsPath</a> object that specifies the path to use to update this 
