---
UID: NF:gdiplusheaders.Metafile.Metafile(constWCHAR,HDC,constRectF&,MetafileFrameUnit,EmfType,constWCHAR)
...
description: Creates a Metafile::Metafile object for recording. (overload 1/6)
