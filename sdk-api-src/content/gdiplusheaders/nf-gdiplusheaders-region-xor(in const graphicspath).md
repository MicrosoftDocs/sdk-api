...
ms.date: 09/12/2018
ms.keywords: Region.Xor, Region.Xor(IN const GraphicsPath), Region::Xor, Region::Xor(IN const GraphicsPath), Xor, Xor methods [GDI+], _gdiplus_CLASS_Region_Xor_Methods, gdiplus._gdiplus_CLASS_Region_Xor_Methods, gdiplusheaders/Xor
