...
When searching from the root element, be sure to specify <a href="https://msdn.microsoft.com/library/Ee671699(v=VS.85).aspx">TreeScope_Children</a> in the scope of the search, not <a href="https://msdn.microsoft.com/library/Ee671699(v=VS.85).aspx">TreeScope_Descendants</a>. A search through the entire subtree of the desktop could iterate through thousands of items and lead to a stack overflow.
