...
Children are cached only if the scope of the cache request included <a href="https://msdn.microsoft.com/library/Ee671699(v=VS.85).aspx">TreeScope_Subtree</a>, <a href="https://msdn.microsoft.com/library/Ee671699(v=VS.85).aspx">TreeScope_Children</a>, or <a href="https://msdn.microsoft.com/library/Ee671699(v=VS.85).aspx">TreeScope_Descendants</a>.
