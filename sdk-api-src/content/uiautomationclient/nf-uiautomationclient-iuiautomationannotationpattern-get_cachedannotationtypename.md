...
The name of the annotation type can correspond to one of the annotation type identifiers (for example, “Comment” for  <a href="https://www.bing.com/search?q=AnnotationType_Comment">AnnotationType_Comment</a>), but it is not required to.
