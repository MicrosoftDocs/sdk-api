...
description: Specifies whether calls to UI Automation control pattern methods automatically set focus to the target element. (Get)
...
f1_keywords:
 ...
 - uiautomationclient/IUIAutomation2::get_AutoSetFocus
dev_langs:
 - c++
topic_type:
 - APIRef
