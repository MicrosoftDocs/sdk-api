...
A value from the <a href="https://msdn.microsoft.com/library/windows/hardware/ff568540">TransportStatus</a> enumeration, indicating the current transport status reported by the DMR.
