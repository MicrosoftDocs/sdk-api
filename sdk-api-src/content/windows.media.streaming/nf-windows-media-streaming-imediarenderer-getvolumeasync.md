...
Receives a reference to a <a href="/windows/desktop/mediastreaming/getvolumeoperation">GetVolumeOperation</a> object that is used to get results from the asynchronous operation.
