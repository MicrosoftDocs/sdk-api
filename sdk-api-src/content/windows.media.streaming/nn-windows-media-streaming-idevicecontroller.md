...
The <b>IDeviceController</b> interface inherits from <a href="/windows/desktop/api/inspectable/nn-inspectable-iinspectable">IInspectable</a>. <b>IDeviceController</b> also has these types of members:
<ul>
