...
A pointer to a <b>GUID</b> structure that identifies the action to add  and the <a href="https://docs.microsoft.com/windows/desktop/SecGloss/t-gly">trust provider</a> that supports that action.
...
A pointer to the <a href="https://docs.microsoft.com/windows/desktop/api/wintrust/ns-wintrust-_crypt_register_actionid">CRYPT_REGISTER_ACTIONID</a> structure that defines the information for the trust provider.
...
<a href="https://docs.microsoft.com/windows/desktop/api/wintrust/nf-wintrust-wintrustremoveactionid">WintrustRemoveActionID</a>
 
