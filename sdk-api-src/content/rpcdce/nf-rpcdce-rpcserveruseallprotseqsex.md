...
ms.topic: function
f1_keywords: ["rpcdce/RpcServerUseAllProtseqsEx"]
req.header: rpcdce.h
...
Pointer to the 
<a href="https://docs.microsoft.com/windows/desktop/api/rpcdce/ns-rpcdce-_rpc_policy">RPC_POLICY</a> structure, which allows you to override the default policies for dynamic port allocation and binding to network interface cards (NICs) on multihomed computers (computers with multiple network cards).
...
<a href="https://docs.microsoft.com/windows/desktop/api/rpcdce/ns-rpcdce-_rpc_policy">RPC_POLICY</a> structure to zero makes this extended API functionally equivalent to the original 
