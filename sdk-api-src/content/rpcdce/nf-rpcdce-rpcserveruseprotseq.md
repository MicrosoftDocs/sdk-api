...
description: The RpcServerUseProtseq function (rpcdce.h) tells the RPC run-time library to use the specified protocol sequence for receiving remote procedure calls.
