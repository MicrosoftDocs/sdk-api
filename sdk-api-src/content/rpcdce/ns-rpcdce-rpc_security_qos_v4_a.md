...
req.irql: 
targetos: Windows
req.typenames: RPC_SECURITY_QOS_V4_A, *PRPC_SECURITY_QOS_V4_A
req.redist: 
ms.custom: 19H1
f1_keywords:
 - _RPC_SECURITY_QOS_V4_A
 - rpcdce/_RPC_SECURITY_QOS_V4_A
 - PRPC_SECURITY_QOS_V4_A
 - rpcdce/PRPC_SECURITY_QOS_V4_A
 - RPC_SECURITY_QOS_V4_A
 - rpcdce/RPC_SECURITY_QOS_V4_A
dev_langs:
 - c++
topic_type:
 - APIRef
