...
<a href="midl.ncadg_mq">ncadg_mq</a> protocol sequence.
...
<a href="midl.ncadg_mq">ncadg_mq</a> protocol.
...
<a href="midl.ncadg_mq">ncadg_mq</a>) is marked as invalid and all calls to <b>RpcServerUseProtseq*</b> functions over that protocol will fail.</div>
<div> </div>
