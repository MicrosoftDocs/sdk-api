...
# tagOLEUICHANGESOURCEW structure
...
Pointer to the <a href="https://msdn.microsoft.com/library/ms646839(v=VS.85).aspx">OPENFILENAME</a> structure, which contains information used by the operating system to initialize the system-defined <b>Open</b> or <b>Save As</b> dialog boxes.
