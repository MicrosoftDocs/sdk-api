...
description: Invokes the Change Source dialog box, allowing the user to change the source of a link. (ANSI)
helpviewer_keywords: ["OleUIChangeSourceA", "oledlg/OleUIChangeSourceA"]
