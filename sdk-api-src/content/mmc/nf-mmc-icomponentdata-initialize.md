...
<b>IComponentData::Initialize</b> is called when a snap-in is created and has items to enumerate in the scope pane. The pointer to <a href="_com_iunknown">IUnknown</a> that is passed in is used to make <a href="_com_iunknown_queryinterface">QueryInterface</a> calls to the console for interfaces such as 
<a href="https://msdn.microsoft.com/9a20d09d-219c-4bcb-95b3-67a44e41629e">IConsole2</a> and 
