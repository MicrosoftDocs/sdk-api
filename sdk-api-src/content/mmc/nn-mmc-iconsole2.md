...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IConsole2</b> interface inherits from <a href="/windows/desktop/api/mmc/nn-mmc-iconsole">IConsole</a>. <b>IConsole2</b> also has these types of members:
<ul>
...
<td align="left" width="63%">
Queries IConsole for the result view object's <a href="/windows/desktop/api/unknwn/nn-unknwn-iunknown">IUnknown</a> interface pointer.
