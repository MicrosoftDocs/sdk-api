...
<a href="/windows/desktop/wmformat/iamwmbufferpass-setnotify">SetNotify</a>
</td>
<td align="left" width="63%">
Used by applications to provide the WM ASF Writer or <a href="/windows/desktop/wmformat/wm-asf-reader-filter">WM ASF Reader</a> filter with a pointer to the <a href="/previous-versions/windows/desktop/legacy/dd798277(v=vs.85)">IAMWMBufferPassCallback</a> interface on an application-defined object.
